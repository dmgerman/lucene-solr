...
name|msg
init|=
literal|"Exception during facet.query of "
operator|+
name|q
decl_stmt|;
name|SolrException
...
name|msg
init|=
literal|"Exception during facet.field of "
operator|+
name|f
decl_stmt|;
name|SolrException
...
comment|// TODO: need a term query that takes a BytesRef to handle binary terms
name|spare
operator|.
name|reset
argument_list|()
...
name|msg
init|=
literal|"Exception during facet.date of "
operator|+
name|f
decl_stmt|;
name|SolrException
...
name|msg
init|=
literal|"Exception during facet.range of "
operator|+
name|f
decl_stmt|;
name|SolrException
