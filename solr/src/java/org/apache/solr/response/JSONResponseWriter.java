...
argument_list|)
expr_stmt|;
comment|// no trivial way to determine map size
name|incLevel
argument_list|()
expr_stmt|;
name|HashMap
...
expr_stmt|;
comment|// no trivial way to determine map size
comment|// TODO: could easily figure out size for SolrDocument if needed...
name|incLevel
argument_list|()
expr_stmt|;
name|boolean
...
block|{
comment|// if multivalued field, write single value as an array
name|SchemaField
name|sf
init|=
name|schema
