...
return|;
block|}
DECL|field|similarityProviderFactory
specifier|private
name|SimilarityProviderFactory
name|similarityProviderFactory
decl_stmt|;
comment|/**    * Returns the SimilarityProvider used for this index    */
...
return|;
block|}
comment|/**    * Returns the SimilarityProviderFactory used for this index    */
DECL|method|getSimilarityProviderFactory
specifier|public
name|SimilarityProviderFactory
name|getSimilarityProviderFactory
parameter_list|()
block|{
return|return
name|similarityProviderFactory
return|;
block|}
DECL|field|fallbackSimilarity
specifier|private
name|Similarity
name|fallbackSimilarity
decl_stmt|;
comment|/** fallback similarity, in the case a field doesnt specify */
DECL|method|getFallbackSimilarity
specifier|public
name|Similarity
...
name|evaluate
argument_list|(
literal|"/schema/similarityProvider"
argument_list|,
name|document
argument_list|,
name|XPathConstants
...
name|debug
argument_list|(
literal|"using default similarityProvider"
argument_list|)
expr_stmt|;
block|}
else|else
...
name|debug
argument_list|(
literal|"using similarityProvider factory"
operator|+
name|similarityProviderFactory
operator|.
name|getClass
