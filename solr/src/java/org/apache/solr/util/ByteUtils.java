...
name|ByteUtils
block|{
comment|/** A binary term consisting of a number of 0xff bytes, likely to be bigger than other terms    *  one would normally encounter, and definitely bigger than any UTF-8 terms */
DECL|field|bigTerm
specifier|public
specifier|static
specifier|final
