...
argument_list|)
decl_stmt|;
comment|// any shift>= 32 should do.
if|if
condition|(
name|c
operator|!=
...
name|c
return|;
comment|/* is there any pattern that the compiler would recognize as a single native CMP instruction? */
comment|/***     if (a<b) return -1;     else if (a>b) return 1;     else return 0;     ***/
if|if
condition|(
name|exists
operator|==
