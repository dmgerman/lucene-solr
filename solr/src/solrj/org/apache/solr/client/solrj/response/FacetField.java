...
expr_stmt|;
block|}
comment|/**     * Date Gap Facet parameter     *      * @return the value specified for facet.date.gap     */
DECL|method|getGap
specifier|public
name|String
name|getGap
...
return|;
block|}
comment|/**     * Date End Facet parameter     *      * @return the value specified for facet.date.end     */
DECL|method|getEnd
specifier|public
name|Date
name|getEnd
