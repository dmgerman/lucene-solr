...
literal|"all"
argument_list|)
comment|// 2 gaps + pre+post+inner = 5
argument_list|,
literal|"*[count("
operator|+
name|pre
...
expr_stmt|;
block|}
comment|/** similar to testDateFacets, but a differnet field with test data        exactly on on boundary marks */
annotation|@
name|Test
