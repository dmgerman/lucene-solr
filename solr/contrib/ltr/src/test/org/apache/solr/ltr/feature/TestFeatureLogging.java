...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/=={'title':'bloomberg bloomberg ', 'description':'bloomberg','id':'7', 'popularity':2,  '[fv]':'c1:1.0;c2:2.0;c3:3.0;pop:2.0;yesmatch:1.0'}"
argument_list|)
expr_stmt|;
name|query
operator|.
...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/=={'[fv]':'c1:1.0;c2:2.0;c3:3.0;pop:2.0;yesmatch:1.0'}"
argument_list|)
expr_stmt|;
name|query
operator|.
...
argument_list|)
expr_stmt|;
comment|// set logging at false but still asking for feature, and it should work anyway
name|query
operator|.
name|add
argument_list|(
...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/=={'fv':'defaultf1:1.0'}"
argument_list|)
expr_stmt|;
...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/=={'fv':'store8f1:2.0'}"
argument_list|)
expr_stmt|;
...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/=={'fv':'store9f1:3.0'}"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
argument_list|()
argument_list|,
literal|"/grouped/title/groups/[0]/doclist/docs/[0]/=={'fv':'c1:1.0;c2:2.0;c3:3.0;pop:5.0'}"
argument_list|)
expr_stmt|;
name|query
operator|.
...
argument_list|)
expr_stmt|;
comment|//json - no feature format check (default to sparse)
specifier|final
name|SolrQuery
name|query
init|=
...
literal|"fl"
argument_list|,
literal|"*,score,fv:[fv store=test4 fvwt=json]"
argument_list|)
expr_stmt|;
name|query
operator|.
...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/fv/=={'match':1.0,'c4':1.0}"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
argument_list|()
argument_list|,
literal|"/response/docs/[1]/fv/=={'c4':1.0}"
argument_list|)
expr_stmt|;
comment|//json - sparse feature format check
name|query
operator|.
name|remove
argument_list|(
...
literal|"fl"
argument_list|,
literal|"*,score,fv:[fv store=test4 format=sparse fvwt=json]"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//json - dense feature format check
name|query
operator|.
name|remove
argument_list|(
...
literal|"fl"
argument_list|,
literal|"*,score,fv:[fv store=test4 format=dense fvwt=json]"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
argument_list|()
argument_list|,
literal|"/response/docs/[1]/fv/=={'match':0.0,'c4':1.0}"
argument_list|)
expr_stmt|;
...
literal|"fl"
argument_list|,
literal|"*,score,fv:[fv store=test4 fvwt=csv]"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
literal|"fl"
argument_list|,
literal|"*,score,fv:[fv store=test4 format=sparse fvwt=csv]"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
literal|"fl"
argument_list|,
literal|"*,score,fv:[fv store=test4 format=dense fvwt=csv]"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
