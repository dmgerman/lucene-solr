...
literal|"rq"
argument_list|,
literal|"{!ltr model=originalScore reRankDocs=4}"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
literal|"rq"
argument_list|,
literal|"{!ltr model=origScore reRankDocs=4}"
argument_list|)
expr_stmt|;
specifier|final
name|String
...
argument_list|()
argument_list|,
literal|"/response/docs/[0]/fv=='origScore:"
operator|+
name|doc0Score
operator|+
literal|";c2:2.0'"
...
argument_list|()
argument_list|,
literal|"/response/docs/[1]/fv=='origScore:"
operator|+
name|doc1Score
operator|+
literal|";c2:2.0'"
...
argument_list|()
argument_list|,
literal|"/response/docs/[2]/fv=='origScore:"
operator|+
name|doc2Score
operator|+
literal|";c2:2.0'"
...
argument_list|()
argument_list|,
literal|"/response/docs/[3]/fv=='origScore:"
operator|+
name|doc3Score
operator|+
literal|";c2:2.0'"
