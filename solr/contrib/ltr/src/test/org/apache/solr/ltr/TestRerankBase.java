...
literal|null
decl_stmt|;
DECL|field|SYSTEM_PROPERTY_SOLR_LTR_TRANSFORMER_FV_DEFAULTFORMAT
specifier|final
specifier|private
specifier|static
name|String
name|SYSTEM_PROPERTY_SOLR_LTR_TRANSFORMER_FV_DEFAULTFORMAT
init|=
literal|"solr.ltr.transformer.fv.defaultFormat"
decl_stmt|;
DECL|field|defaultFeatureFormat
specifier|private
specifier|static
name|String
name|defaultFeatureFormat
decl_stmt|;
DECL|method|chooseDefaultFeatureVector
specifier|protected
name|String
...
condition|)
block|{
comment|// to match<code><str name="defaultFormat">${solr.ltr.transformer.fv.defaultFormat:dense}</str></code> snippet
return|return
name|dense
return|;
block|}
...
name|fail
argument_list|(
literal|"unexpected feature format choice: "
operator|+
name|defaultFeatureFormat
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|chooseDefaultFeatureFormat
specifier|protected
specifier|static
name|void
name|chooseDefaultFeatureFormat
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|unchooseDefaultFeatureFormat
specifier|protected
specifier|static
name|void
name|unchooseDefaultFeatureFormat
parameter_list|()
block|{
name|System
operator|.
