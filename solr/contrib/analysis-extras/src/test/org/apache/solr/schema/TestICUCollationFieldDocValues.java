...
begin_comment
comment|/**  * Tests {@link ICUCollationField} with docValues.  */
end_comment

begin_class
DECL|class|TestICUCollationFieldDocValues
specifier|public
class|class
name|TestICUCollationFieldDocValues
extends|extends
name|SolrTestCaseJ4
block|{
annotation|@
...
name|getFile
argument_list|(
literal|"analysis-extras/solr/collection1/conf/schema-icucollate-dv.xml"
argument_list|)
argument_list|,
operator|new
name|File
...
literal|"//*[@numFound='2']"
argument_list|,
literal|"//result/doc[1]/str[@name='id'][.=11]"
argument_list|,
...
literal|"//*[@numFound='2']"
argument_list|,
literal|"//result/doc[1]/str[@name='id'][.=12]"
argument_list|,
...
literal|"//*[@numFound='2']"
argument_list|,
literal|"//result/doc/str[@name='id'][.=4]"
argument_list|,
literal|"//result/doc/str[@name='id'][.=10]"
argument_list|)
expr_stmt|;
block|}
block|}
