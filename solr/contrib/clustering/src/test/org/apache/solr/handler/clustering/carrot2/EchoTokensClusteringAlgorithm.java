...
begin_comment
comment|/**  * A mock Carrot2 clustering algorithm that outputs each token of each document  * as a separate cluster. Useful only in tests.  */
end_comment
...
argument_list|)
DECL|class|EchoTokensClusteringAlgorithm
specifier|public
class|class
name|EchoTokensClusteringAlgorithm
extends|extends
name|ProcessingComponentBase
