...
parameter_list|)
block|{
comment|// No way to distinguish if the resource was found but failed
comment|// to load or wasn't found at all, so we simply fall back
comment|// to Carrot2 defaults here by returning an empty locations array.
name|log
operator|.
name|debug
argument_list|(
