...
name|Exception
block|{
comment|// custom_tool.vm responds with $!mytool.star("foo"), but $mytool is not defined (only in velocityWithCustomTools)
name|assertEquals
argument_list|(
literal|""
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Test that $number tool uses the specified locale
name|assertEquals
argument_list|(
literal|"2,112"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Test that custom tool extending LocaleConfig gets the right locale
name|assertEquals
argument_list|(
literal|"de_DE"
argument_list|,
