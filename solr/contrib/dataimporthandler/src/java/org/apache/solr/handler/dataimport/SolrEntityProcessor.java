...
expr_stmt|;
block|}
DECL|class|SolrDocumentListCursor
class|class
name|SolrDocumentListCursor
extends|extends
name|SolrDocumentListIterator
...
name|cursorMark
decl_stmt|;
DECL|method|SolrDocumentListCursor
specifier|public
name|SolrDocumentListCursor
parameter_list|(
name|SolrDocumentList
...
name|SEVERE
argument_list|,
literal|"cursorMark can't be used with timeout"
argument_list|)
throw|;
block|}
name|solrQuery
...
annotation|@
name|Override
DECL|method|createNextPageIterator
specifier|protected
name|Iterator
argument_list|<
name|Map
