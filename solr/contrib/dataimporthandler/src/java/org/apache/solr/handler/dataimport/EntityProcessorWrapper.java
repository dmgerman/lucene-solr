...
condition|)
block|{
comment|// The script transformer is a potential vulnerability, esp. when the script is
comment|// provided from an untrusted source. Check and don't proceed if source is untrusted.
name|checkIfTrusted
argument_list|(
name|trans
argument_list|)
...
name|UNAUTHORIZED
argument_list|,
literal|"The configset for this collection was uploaded "
operator|+
literal|"without any authentication in place,"
operator|+
literal|" and this transformer is not available for collections with untrusted configsets. To use this transformer,"
operator|+
literal|" re-upload the configset after enabling authentication and authorization."
argument_list|)
decl_stmt|;
name|String
name|msg
