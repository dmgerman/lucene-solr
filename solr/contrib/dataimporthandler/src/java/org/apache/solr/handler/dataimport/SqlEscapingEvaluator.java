...
begin_comment
comment|/**  *<p> Escapes values in SQL queries.  It escapes the value of the given expression   * by replacing all occurrences of single-quotes by two single-quotes and similarily   * for double-quotes</p>  */
end_comment

begin_class
DECL|class|SqlEscapingEvaluator
specifier|public
class|class
