...
argument_list|)
decl_stmt|;
DECL|field|WARNED_ABOUT_INDEX_TIME_BOOSTS
specifier|private
specifier|static
specifier|final
name|AtomicBoolean
name|WARNED_ABOUT_INDEX_TIME_BOOSTS
init|=
operator|new
name|AtomicBoolean
argument_list|()
...
name|message
init|=
literal|"Ignoring document boost: "
operator|+
name|value
operator|+
literal|" as index-time boosts are not supported anymore"
decl_stmt|;
if|if
condition|(
name|WARNED_ABOUT_INDEX_TIME_BOOSTS
