...
literal|"unchecked"
argument_list|)
DECL|method|testTransformRowMultiValue
specifier|public
name|void
name|testTransformRowMultiValue
parameter_list|()
block|{
name|List
name|fields
...
argument_list|)
expr_stmt|;
comment|// create three variations of date format
name|fields
operator|.
name|add
argument_list|(
