...
argument_list|()
condition|?
literal|" cursorMark='true' sort='id asc'"
else|:
literal|""
operator|)
argument_list|,
...
name|generateDIHConfig
argument_list|(
literal|"query='bogus:3' rows='2' fl='id,desc' onError='"
operator|+
operator|(
name|random
argument_list|()
...
expr_stmt|;
block|}
DECL|method|testCursorMarkNoSort
specifier|public
name|void
name|testCursorMarkNoSort
parameter_list|()
throws|throws
name|SolrServerException
throws|,
...
literal|"sort='id'"
argument_list|,
comment|//wrong sort spec
literal|""
argument_list|,
comment|//no sort spec
literal|"sort='id asc' timeout='12345'"
argument_list|)
decl_stmt|;
comment|// sort is fine, but set timeout
name|Collections
operator|.
name|shuffle
argument_list|(
...
name|attrs
init|=
literal|"query='*:*' rows='2' fl='id,desc' cursorMark='true' "
operator|+
name|errors
operator|.
name|get
