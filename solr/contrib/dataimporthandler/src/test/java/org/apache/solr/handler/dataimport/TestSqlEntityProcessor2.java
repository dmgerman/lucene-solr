...
literal|"unchecked"
argument_list|)
DECL|method|testCompositePk_FullImport_MT
specifier|public
name|void
name|testCompositePk_FullImport_MT
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"</dataConfig>\n"
decl_stmt|;
DECL|field|dataConfig_2threads
specifier|private
specifier|static
name|String
name|dataConfig_2threads
...
literal|"<document>\n"
operator|+
literal|"<entity name=\"x\" pk=\"id\" query=\"select * from x\" threads=\"2\">\n"
operator|+
literal|"<field column=\"id\" />\n"
operator|+
literal|"<entity name=\"y\" query=\"select * from y where y.A=${x.id}\">\n"
