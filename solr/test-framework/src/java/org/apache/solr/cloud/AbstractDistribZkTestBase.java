...
condition|)
block|{
comment|// similar to replica recovering; pretend its the same thing
if|if
condition|(
name|verbose
condition|)
...
name|println
argument_list|(
literal|"Found a slice in construction state; will wait."
argument_list|)
expr_stmt|;
name|sawLiveRecovering
operator|=
...
name|fail
argument_list|(
literal|"Not all shards are ACTIVE - found a shard "
operator|+
name|slice
operator|.
name|getName
...
name|fail
argument_list|(
literal|"Not all replicas are ACTIVE - found a replica "
operator|+
name|replica
operator|.
name|getName
