...
name|info
argument_list|(
literal|"Will use {} replicas unless explicitly asked otherwise"
argument_list|,
name|Replica
operator|.
name|Type
...
name|info
argument_list|(
literal|"create jetty {} in directory {} of type {}"
argument_list|,
name|i
argument_list|,
name|jettyDir
...
name|fail
argument_list|(
literal|"Number of replicas in the state does not match what we set:"
operator|+
name|numReplicas
operator|+
literal|" vs "
...
return|;
block|}
DECL|method|logReplicaTypesReplicationInfo
specifier|protected
name|void
...
name|info
argument_list|(
literal|"## Collecting extra Replica.Type information of the cluster"
argument_list|)
expr_stmt|;
name|zkStateReader
operator|.
...
name|ROOT
argument_list|,
literal|"Replica %s not in liveNodes or is not active%s"
argument_list|,
name|r
operator|.
name|getName
...
name|info
argument_list|(
literal|"Summary of the cluster: "
operator|+
name|builder
operator|.
name|toString
...
expr_stmt|;
block|}
DECL|method|waitForReplicationFromReplicas
specifier|protected
name|void
...
name|fail
argument_list|(
literal|"Unable to get leader indexVersion"
argument_list|)
expr_stmt|;
block|}
for|for
...
argument_list|)
expr_stmt|;
comment|// Make sure the host is serving the correct version
try|try
init|(
name|SolrCore
name|core
...
name|ROOT
argument_list|,
literal|"Timed out waiting for replica %s (%d) to replicate from leader %s (%d)"
argument_list|,
name|pullReplica
operator|.
name|getName
...
block|}
block|}
DECL|method|waitForAllWarmingSearchers
specifier|protected
name|void
name|waitForAllWarmingSearchers
parameter_list|()
throws|throws
name|InterruptedException
block|{
...
name|warn
argument_list|(
literal|"Exception getting version from {}, will return an invalid version to retry."
argument_list|,
name|replica
operator|.
name|getName
...
block|}
block|}
comment|/**     * Logs a WARN if collection can't be deleted, but does not fail or throw an exception    * @return true if success, else false    */
DECL|method|attemptCollectionDelete
specifier|protected
specifier|static
name|boolean
...
name|warn
argument_list|(
literal|"Could not delete collection {} - ignoring"
argument_list|,
name|collectionName
argument_list|)
expr_stmt|;
...
return|;
block|}
DECL|method|logReplicationDetails
specifier|protected
name|void
name|logReplicationDetails
parameter_list|(
...
name|warn
argument_list|(
literal|"Unable to ger replication details for replica {}"
argument_list|,
name|replica
operator|.
name|getName
