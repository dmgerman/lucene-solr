...
return|;
block|}
comment|/**    * Get a connection string for this server with a given chroot    * @param chroot the chroot    * @return the connection string    */
DECL|method|getZkAddress
specifier|public
name|String
name|getZkAddress
...
return|;
block|}
comment|/**    * Check that a path exists in this server    * @param path the path to check    * @throws IOException if an IO exception occurs    */
DECL|method|ensurePathExists
specifier|public
name|void
