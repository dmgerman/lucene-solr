...
return|;
block|}
comment|/**    * Get the Jetty that a particular Replica is located on    */
...
name|IllegalStateException
argument_list|(
literal|"No jetty found for replica with core url "
operator|+
name|replica
operator|.
name|getCoreUrl
...
throw|;
block|}
comment|/**    * Get the Jetty that the leader of a particular collection shard is located on    */
DECL|method|getLeaderJetty
specifier|public
name|JettySolrRunner
name|getLeaderJetty
parameter_list|(
