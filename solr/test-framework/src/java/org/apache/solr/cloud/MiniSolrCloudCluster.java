...
literal|"</solr>\n"
decl_stmt|;
DECL|field|DEFAULT_JETTY_CONFIG
specifier|public
specifier|static
specifier|final
name|JettyConfig
name|DEFAULT_JETTY_CONFIG
init|=
name|JettyConfig
operator|.
name|builder
...
argument_list|()
decl_stmt|;
comment|/**    * Create a MiniSolrCloudCluster with default configuration    *    * @param numServers number of Solr servers to start    * @param baseDir base directory that the mini cluster should be run from    *    * @throws Exception if there was an error starting the cluster    */
...
decl_stmt|;
comment|// Wait up to 60 seconds for number of live_nodes to match up number of servers
do|do
block|{
if|if
condition|(
