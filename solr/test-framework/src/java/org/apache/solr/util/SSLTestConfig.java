...
begin_comment
comment|/**  * An {@link SSLConfig} that supports reading key/trust store information directly from resource   * files provided with the Solr test-framework classes  */
end_comment
...
name|SSLConfig
block|{
comment|/** @deprecated No longer used except by {@link #setSSLSystemProperties} */
...
literal|null
decl_stmt|;
DECL|field|TEST_KEYSTORE_RESOURCE
specifier|private
specifier|static
specifier|final
name|String
name|TEST_KEYSTORE_RESOURCE
init|=
literal|"SSLTestConfig.testing.keystore"
decl_stmt|;
...
name|trustStore
decl_stmt|;
comment|/** Creates an SSLTestConfig that does not use SSL or client authentication */
...
expr_stmt|;
block|}
comment|/**     * Create an SSLTestConfig based on a few caller specified options.  As needed,     * keystore/truststore information will be pulled from a hardocded resource file provided     * by the solr test-framework.    *    * @param useSSL - wether SSL should be required.    * @param clientAuth - whether client authentication should be required.    */
DECL|method|SSLTestConfig
specifier|public
name|SSLTestConfig
parameter_list|(
...
argument_list|(
literal|"Unable to locate keystore resource file in classpath: "
operator|+
name|TEST_KEYSTORE_RESOURCE
argument_list|)
throw|;
block|}
block|}
comment|/**     * Create an SSLTestConfig using explicit paths for files     * @deprecated - use {@link SSLConfig} directly    */
annotation|@
name|Deprecated
DECL|method|SSLTestConfig
specifier|public
...
expr_stmt|;
block|}
comment|/**    * Helper utility for building resources from arbitrary user input paths/urls    * if input is null, returns null; otherwise attempts to build Resource and verifies that Resource exists.    */
DECL|method|tryNewResource
specifier|private
specifier|static
specifier|final
name|Resource
...
return|;
block|}
comment|/** NOTE: This method is meaningless unless you explicitly provide paths when constructing this instance     * @see #SSLTestConfig(boolean,boolean,String,String,String,String)    */
annotation|@
name|Override
...
name|IllegalStateException
argument_list|(
literal|"Unable to build KeyStore from resource: "
operator|+
name|resource
operator|.
name|getName
