...
annotation|@
name|BeforeClass
DECL|method|assertNonBlockingRandomGeneratorAvailable
specifier|public
specifier|static
name|void
name|assertNonBlockingRandomGeneratorAvailable
parameter_list|()
block|{
if|if
condition|(
...
name|getProperty
argument_list|(
literal|"test.solr.allow.any.securerandom"
argument_list|,
literal|"false"
argument_list|)
argument_list|)
condition|)
return|return;
comment|// Use -Djava.security.egd=file:/dev/./urandom VM option if you hit this
name|assertEquals
argument_list|(
literal|"SHA1PRNG"
argument_list|,
