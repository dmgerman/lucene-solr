...
argument_list|)
decl_stmt|;
DECL|field|DEFAULT_STACK_FILTERS
specifier|private
specifier|static
specifier|final
name|List
...
function_decl|;
block|}
comment|/**    * Annotation for test classes that want to disable PointFields.    * PointFields will otherwise randomly used by some schemas.    */
annotation|@
name|Documented
annotation|@
name|Inherited
...
name|TYPE
argument_list|)
DECL|interface|SuppressPointFields
specifier|public
annotation_defn|@interface
...
name|setProperty
argument_list|(
literal|"solr.peerSync.useRangeVersions"
argument_list|,
name|String
operator|.
name|valueOf
...
name|info
argument_list|(
literal|"Waiting for all tracked resources to be released"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|info
argument_list|(
literal|"------------------------------------------------------- Done waiting for tracked resources to be released"
argument_list|)
expr_stmt|;
if|if
condition|(
...
return|;
block|}
DECL|field|savedClassLogLevels
specifier|private
specifier|static
name|Map
argument_list|<
...
argument_list|()
decl_stmt|;
DECL|method|initClassLogLevels
specifier|public
specifier|static
name|void
name|initClassLogLevels
...
expr_stmt|;
block|}
DECL|field|savedMethodLogLevels
specifier|private
name|Map
argument_list|<
name|String
...
annotation|@
name|Before
DECL|method|initMethodLogLevels
specifier|public
name|void
name|initMethodLogLevels
parameter_list|()
block|{
name|Method
name|method
...
annotation|@
name|After
DECL|method|restoreMethodLogLevels
specifier|public
name|void
name|restoreMethodLogLevels
parameter_list|()
block|{
name|LogLevel
operator|.
...
expr_stmt|;
block|}
comment|/**     * Sets system properties to allow generation of random configurations of    * solrconfig.xml and schema.xml.     * Sets properties used on      * {@link #newIndexWriterConfig(org.apache.lucene.analysis.Analyzer)}    *  and base schema.xml (Point Fields)    */
...
expr_stmt|;
block|}
comment|/**    * Find next available local port.    * @return available port number or -1 if none could be found    * @throws Exception on IO errors    */
...
block|}
block|}
comment|/**    * Does a low level delete of all docs in the index.     *    * The behavior of this method is slightly different then doing a normal<code>*:*</code> DBQ because it    * takes advantage of internal methods to ensure all index data is wiped, regardless of optimistic     * concurrency version constraints -- making it suitable for tests that create synthetic versions,     * and/or require a completely pristine index w/o any field metdata.    *    * @see #deleteByQueryAndGetVersion    */
...
expr_stmt|;
block|}
comment|// Creates minimal full setup, including solr.xml
...
expr_stmt|;
block|}
comment|// Just copies the file indicated to the tmp home directory naming it "solr.xml"
DECL|method|copyXmlToHome
specifier|public
specifier|static
name|void
name|copyXmlToHome
...
comment|// the stock files in there.
...
return|;
block|}
comment|/**    * A variant of {@link  org.apache.solr.client.solrj.impl.CloudSolrClient.Builder} that will randomize which nodes recieve updates     * unless otherwise specified by the caller.    *    * @see #sendDirectUpdatesToAnyShardReplica    * @see #sendDirectUpdatesToShardLeadersOnly    */
DECL|class|CloudSolrClientBuilder
specifier|public
specifier|static
class|class
name|CloudSolrClientBuilder
extends|extends
name|CloudSolrClient
operator|.
name|Builder
block|{
DECL|field|configuredDUTflag
specifier|private
name|boolean
name|configuredDUTflag
init|=
literal|false
decl_stmt|;
DECL|method|CloudSolrClientBuilder
specifier|public
name|CloudSolrClientBuilder
parameter_list|()
block|{
...
return|;
block|}
DECL|method|randomlyChooseDirectUpdatesToLeadersOnly
specifier|private
name|void
name|randomlyChooseDirectUpdatesToLeadersOnly
parameter_list|()
block|{
if|if
condition|(
...
condition|)
block|{
comment|// flag value not explicity configured
if|if
condition|(
name|random
argument_list|()
...
condition|)
block|{
comment|// so randomly choose a value
name|randomlyChooseDirectUpdatesToLeadersOnly
argument_list|()
expr_stmt|;
block|}
...
block|{
comment|// or go with whatever the default value is
name|configuredDUTflag
operator|=
literal|true
expr_stmt|;
...
block|}
block|}
comment|/**    * This method<i>may</i> randomize unspecified aspects of the resulting SolrClient.    * Tests that do not wish to have any randomized behavior should use the     * {@link org.apache.solr.client.solrj.impl.CloudSolrClient.Builder} class directly    */
...
return|;
block|}
comment|/**    * This method<i>may</i> randomize unspecified aspects of the resulting SolrClient.    * Tests that do not wish to have any randomized behavior should use the     * {@link org.apache.solr.client.solrj.impl.ConcurrentUpdateSolrClient.Builder} class directly    */
...
return|;
block|}
comment|/**    * This method<i>may</i> randomize unspecified aspects of the resulting SolrClient.    * Tests that do not wish to have any randomized behavior should use the     * {@link org.apache.solr.client.solrj.impl.LBHttpSolrClient.Builder} class directly    */
...
return|;
block|}
comment|/**    * This method<i>may</i> randomize unspecified aspects of the resulting SolrClient.    * Tests that do not wish to have any randomized behavior should use the     * {@link org.apache.solr.client.solrj.impl.HttpSolrClient.Builder} class directly    */
