...
block|}
block|}
DECL|method|persistContainedInOrig
specifier|private
name|void
name|persistContainedInOrig
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|origContainedInPersist
specifier|private
name|void
name|origContainedInPersist
parameter_list|(
...
annotation|@
name|Test
DECL|method|testCreateAndManipulateCores
specifier|public
name|void
name|testCreateAndManipulateCores
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// We know all the original data is in persist, now check for newly-created files.
name|String
index|[]
name|expressions
init|=
...
index|]
operator|=
literal|"/solr/cores/core[@name='new_one' and @instanceDir='"
operator|+
name|instHome
operator|+
literal|"']"
...
argument_list|)
expr_stmt|;
comment|// Next, swap a created core and check
name|resp
operator|=
operator|new
name|SolrQueryResponse
...
name|fromName
init|=
literal|"@name='new_one'"
decl_stmt|;
name|String
name|toName
init|=
literal|"@name='SystemVars2'"
decl_stmt|;
if|if
condition|(
name|persistList
...
argument_list|)
expr_stmt|;
comment|// Then rename the other created core and check
name|admin
operator|.
name|handleRequestBody
argument_list|(
