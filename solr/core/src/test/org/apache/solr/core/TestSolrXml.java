...
expr_stmt|;
block|}
DECL|method|testMultiBackupSectionError
specifier|public
name|void
name|testMultiBackupSectionError
parameter_list|()
throws|throws
name|IOException
block|{
...
name|solrXml
init|=
literal|"<solr><backup></backup><backup></backup></solr>"
decl_stmt|;
name|expectedException
operator|.
name|expect
...
name|expectMessage
argument_list|(
literal|"Multiple instances of backup section found in solr.xml"
argument_list|)
expr_stmt|;
name|SolrXmlConfig
operator|.
