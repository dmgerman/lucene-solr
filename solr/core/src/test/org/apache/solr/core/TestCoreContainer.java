...
literal|"</str>"
operator|+
literal|"<str name=\"configSetsHandler\">"
operator|+
name|CustomConfigSetsHandler
operator|.
name|class
operator|.
name|getName
...
block|}
block|}
DECL|class|CustomConfigSetsHandler
specifier|public
specifier|static
class|class
name|CustomConfigSetsHandler
...
name|ConfigSetsHandler
block|{
DECL|method|CustomConfigSetsHandler
specifier|public
name|CustomConfigSetsHandler
parameter_list|(
name|CoreContainer
...
expr_stmt|;
comment|// -----
comment|// try to add a collection with a configset that doesn't exist
try|try
block|{
