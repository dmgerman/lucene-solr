...
annotation|@
name|Test
DECL|method|testCoresSameName
specifier|public
name|void
name|testCoresSameName
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|assertTrue
argument_list|(
literal|"Should have seen an exception when two cores have the same name"
argument_list|,
name|se
operator|.
name|getMessage
...
name|contains
argument_list|(
literal|"More than one core defined for core named"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testCoresSameDataDir
specifier|public
name|void
name|testCoresSameDataDir
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|assertTrue
argument_list|(
literal|"Should have seen an exception when two cores have the same data dir"
argument_list|,
name|se
operator|.
name|getMessage
...
name|contains
argument_list|(
literal|"More than one core points to data dir"
argument_list|)
argument_list|)
expr_stmt|;
block|}
