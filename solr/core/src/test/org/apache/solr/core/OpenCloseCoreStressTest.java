...
argument_list|)
expr_stmt|;
comment|// Insure that a failed test didn't leave something lying around.
name|jetty
operator|=
operator|new
name|JettySolrRunner
...
annotation|@
name|Slow
DECL|method|test30SecondsOld
specifier|public
name|void
name|test30SecondsOld
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Slow
DECL|method|test30SecondsNew
specifier|public
name|void
name|test30SecondsNew
parameter_list|()
throws|throws
name|Exception
block|{
...
name|testSrcRoot
argument_list|,
literal|"solr-stress.properties"
argument_list|)
argument_list|,
operator|new
name|File
