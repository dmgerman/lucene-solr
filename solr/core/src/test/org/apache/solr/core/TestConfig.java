...
annotation|@
name|Test
DECL|method|testCacheEnablingDisabling
specifier|public
name|void
name|testCacheEnablingDisabling
parameter_list|()
throws|throws
name|Exception
block|{
comment|// ensure if cache is not defined in the config then cache is disabled
name|SolrConfig
name|sc
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// enable all the caches via system properties and verify
name|System
operator|.
name|setProperty
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// disable all the caches via system properties and verify
name|System
operator|.
name|setProperty
argument_list|(
