...
argument_list|)
decl_stmt|;
comment|//    List l = (List) ConfigOverlay.getObjectByPath(map,false, Arrays.asList("config", "initParams"));
comment|//    assertNotNull("no object /config/initParams : "+ TestBlobHandler.getAsString(map) , l);
comment|//    assertEquals( 1, l.size());
comment|//    assertEquals( "val", ((Map)l.get(0)).get("key") );
block|}
