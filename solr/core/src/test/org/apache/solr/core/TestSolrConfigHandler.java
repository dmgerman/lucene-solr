...
operator|+
literal|"                    {name: s2,lookupImpl: FuzzyLookupFactory , dictionaryImpl : DocumentExpressionDictionaryFactory}]"
operator|+
literal|"    }\n"
operator|+
literal|"}"
...
name|getRespMap
argument_list|(
literal|"/dump100?wt=json&json.nl=arrmap&initArgs=true"
argument_list|,
name|writeHarness
argument_list|)
expr_stmt|;
...
literal|"{\n"
operator|+
literal|"'add-requesthandler' : { 'name' : '/dump101', 'class': "
operator|+
literal|"'"
operator|+
name|CacheTest
...
literal|"{\n"
operator|+
literal|"'add-cache' : {name:'lfuCacheDecayFalse', class:'solr.search.LFUCache', size:10 ,initialSize:9 , timeDecay:false },"
operator|+
literal|"'add-cache' : {name: 'perSegFilter', class: 'solr.search.LRUCache', size:10, initialSize:0 , autowarmCount:10}}"
expr_stmt|;
name|runConfigCommand
argument_list|(
name|writeHarness
...
name|getRespMap
argument_list|(
literal|"/dump101?cacheNames=lfuCacheDecayFalse&cacheNames=perSegFilter&wt=json"
argument_list|,
name|writeHarness
argument_list|)
expr_stmt|;
...
argument_list|)
argument_list|,
literal|"org.apache.solr.search.LRUCache"
argument_list|,
name|getObjectByPath
argument_list|(
name|map
...
argument_list|)
argument_list|,
literal|"org.apache.solr.search.LFUCache"
argument_list|,
name|getObjectByPath
argument_list|(
name|map
