...
begin_class
DECL|class|TestManagedSynonymGraphFilterFactory
specifier|public
class|class
name|TestManagedSynonymGraphFilterFactory
extends|extends
name|RestTestBase
block|{
...
comment|//
comment|//<filter class="solr.ManagedSynonymGraphFilterFactory" managed="englishgraph" />
comment|//
name|String
name|endpoint
init|=
literal|"/schema/analysis/synonyms/englishgraph"
decl_stmt|;
name|assertJQ
argument_list|(
name|endpoint
...
name|newFieldName
init|=
literal|"managed_graph_en_field"
decl_stmt|;
...
literal|"/schema"
argument_list|,
literal|"{ add-field :  { name: managed_graph_en_field, type : managed_graph_en}}"
argument_list|,
literal|"/responseHeader/status==0"
argument_list|)
expr_stmt|;
...
name|endpoint
init|=
literal|"/schema/analysis/synonyms/germangraph"
decl_stmt|;
name|assertJQ
argument_list|(
name|endpoint
