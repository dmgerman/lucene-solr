...
expr_stmt|;
block|}
DECL|method|testAnalyzerClass
specifier|public
name|void
name|testAnalyzerClass
parameter_list|()
throws|throws
name|Exception
block|{
name|String
name|addFieldTypeAnalyzerWithClass
init|=
literal|"{\n"
operator|+
literal|"'add-field-type' : {"
operator|+
literal|"    'name' : 'myNewTextFieldWithAnalyzerClass',\n"
operator|+
literal|"    'class':'solr.TextField',\n"
operator|+
literal|"    'analyzer' : {\n"
operator|+
literal|"        'luceneMatchVersion':'5.0.0',\n"
operator|+
literal|"        'class':'org.apache.lucene.analysis.core.WhitespaceAnalyzer'\n"
decl_stmt|;
name|String
name|charFilters
init|=
...
name|filters
init|=
literal|"        'filters' : [{ 'class':'solr.ASCIIFoldingFilterFactory' }]\n"
decl_stmt|;
name|String
name|suffix
init|=
...
name|restTestHarness
argument_list|,
literal|"myNewTextFieldWithAnalyzerClass"
argument_list|,
literal|"fieldTypes"
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|testAddFieldMatchingExistingDynamicField
specifier|public
name|void
name|testAddFieldMatchingExistingDynamicField
parameter_list|()
throws|throws
name|Exception
block|{
...
name|newFieldName
operator|+
literal|"' already exists in the schema"
argument_list|,
name|map
argument_list|)
expr_stmt|;
...
name|newFieldName
operator|+
literal|"' is not in the schema"
argument_list|,
name|map
argument_list|)
expr_stmt|;
block|}
DECL|method|testAddIllegalDynamicField
specifier|public
name|void
name|testAddIllegalDynamicField
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testAddFieldWithExistingCatchallDynamicField
specifier|public
name|void
name|testAddFieldWithExistingCatchallDynamicField
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertNull
argument_list|(
literal|"'*' dynamic field already exists in the schema"
argument_list|,
name|map
argument_list|)
expr_stmt|;
...
name|assertNotNull
argument_list|(
literal|"Dynamic field '*' is not in the schema"
argument_list|,
name|map
argument_list|)
expr_stmt|;
...
literal|"          'add-field-type' : {"
operator|+
literal|"                       'name' : 'myWhitespaceTxtField',\n"
operator|+
literal|"                       'class':'solr.TextField',\n"
operator|+
literal|"                       'analyzer' : {'class' : 'org.apache.lucene.analysis.core.WhitespaceAnalyzer'}\n"
operator|+
literal|"                       },\n"
operator|+
literal|"          'add-field' : {\n"
...
literal|"                       'name':'a5',\n"
operator|+
literal|"                       'type': 'myWhitespaceTxtField',\n"
operator|+
literal|"                       'stored':true\n"
operator|+
literal|"                       },\n"
...
argument_list|)
expr_stmt|;
comment|// unspecified, expect default
name|m
operator|=
name|getObj
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testSimilarityParser
specifier|public
name|void
name|testSimilarityParser
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fieldTypeName
init|=
literal|"MySimilarityField"
decl_stmt|;
name|String
name|fieldName
init|=
literal|"similarityTestField"
decl_stmt|;
name|String
name|payload
init|=
...
literal|"    'analyzer' : {'tokenizer':{'class':'solr.WhitespaceTokenizerFactory'}},\n"
operator|+
literal|"    'similarity' : {'class':'org.apache.solr.search.similarities.BM25SimilarityFactory', 'k1':"
operator|+
name|k1
operator|+
literal|", 'b':"
...
literal|"',\n"
operator|+
literal|"    'type': 'MySimilarityField',\n"
operator|+
literal|"    'stored':true,\n"
operator|+
literal|"    'indexed':true\n"
...
name|post
argument_list|(
literal|"/schema?wt=json&indent=on"
argument_list|,
name|json
argument_list|(
name|payload
...
literal|"    'similarity' : {\n"
operator|+
literal|"      'class':'org.apache.solr.search.similarities.DFISimilarityFactory',\n"
operator|+
...
name|assertEquals
argument_list|(
literal|"Unexpected independenceMeasure"
argument_list|,
name|independenceMeasure
argument_list|,
name|sim
...
name|assertEquals
argument_list|(
literal|"Unexpected discountedOverlaps"
argument_list|,
name|discountOverlaps
argument_list|,
name|sim
...
return|;
block|}
comment|/**    * whitebox checks the Similarity for the specified field according to {@link SolrCore#getLatestSchema}    *     * Executes each of the specified Similarity-accepting validators.    */
annotation|@
name|SafeVarargs
DECL|method|assertFieldSimilarity
specifier|private
specifier|static
parameter_list|<
name|T
...
name|assertTrue
argument_list|(
literal|"test only works with SchemaSimilarityFactory"
argument_list|,
name|simfac
operator|instanceof
name|SchemaSimilarityFactory
...
argument_list|)
expr_stmt|;
comment|// sanity check simfac vs sim in use - also verify infom called on simfac, otherwise exception
name|assertEquals
argument_list|(
name|mainSim
argument_list|,
...
name|assertTrue
argument_list|(
literal|"test only works with PerFieldSimilarityWrapper, SchemaSimilarityFactory redefined?"
argument_list|,
name|mainSim
operator|instanceof
name|PerFieldSimilarityWrapper
