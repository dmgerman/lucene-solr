...
name|SolrQuery
argument_list|(
literal|"{!mlt qf=lowerfilt_u^10,lowerfilt1_u^1000 boost=false mintf=0 mindf=0}30"
argument_list|)
argument_list|)
expr_stmt|;
name|solrDocuments
...
name|SolrQuery
argument_list|(
literal|"{!mlt qf=lowerfilt_u^10,lowerfilt1_u^1000 boost=true mintf=0 mindf=0}30"
argument_list|)
argument_list|)
expr_stmt|;
name|solrDocuments
