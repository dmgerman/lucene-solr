...
name|rf1ToString
init|=
literal|"SolrReturnFields=(globs=[]"
operator|+
literal|",fields=[]"
operator|+
literal|",okFieldNames=[]"
operator|+
literal|",reqFieldNames=null"
operator|+
literal|",transformer=null,wantsScore=false,wantsAllFields=true)"
decl_stmt|;
name|assertEquals
argument_list|(
name|rf1ToString
...
literal|"]"
operator|+
literal|",transformer=score,wantsScore=true,wantsAllFields=false)"
decl_stmt|;
specifier|final
name|String
name|rf2ToStringB
...
argument_list|)
expr_stmt|;
comment|// Don't return 'store_rpt' just because it is required by the transformer
name|rf
operator|=
operator|new
name|SolrReturnFields
