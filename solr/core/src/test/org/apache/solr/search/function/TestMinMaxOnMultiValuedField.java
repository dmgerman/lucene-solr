...
name|assertTrue
argument_list|(
literal|"Unexpected float field"
argument_list|,
name|h
operator|.
name|getCore
...
name|assertTrue
argument_list|(
literal|"Unexpected double field"
argument_list|,
name|h
operator|.
name|getCore
...
literal|"fl"
argument_list|,
literal|"exists_min_i:exists(field("
operator|+
name|intField
operator|+
literal|",min))"
...
literal|"fl"
argument_list|,
literal|"exists_max_i:exists(field("
operator|+
name|intField
operator|+
literal|",max))"
...
literal|"fl"
argument_list|,
literal|"exists_min_l:exists(field("
operator|+
name|longField
operator|+
literal|",min))"
...
literal|"fl"
argument_list|,
literal|"exists_max_l:exists(field("
operator|+
name|longField
operator|+
literal|",max))"
...
literal|"fl"
argument_list|,
literal|"exists_min_f:exists(field("
operator|+
name|floatField
operator|+
literal|",min))"
...
literal|"fl"
argument_list|,
literal|"exists_max_f:exists(field("
operator|+
name|floatField
operator|+
literal|",max))"
...
literal|"fl"
argument_list|,
literal|"exists_min_d:exists(field("
operator|+
name|doubleField
operator|+
literal|",min))"
...
literal|"fl"
argument_list|,
literal|"exists_max_d:exists(field("
operator|+
name|doubleField
operator|+
literal|",max))"
...
expr_stmt|;
block|}
DECL|method|testPointDouble
specifier|public
name|void
name|testPointDouble
parameter_list|()
block|{
name|testSimpleDouble
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// MultiValued point field with dv=false
name|assertFalse
argument_list|(
name|h
operator|.
...
name|assertQEx
argument_list|(
literal|"no error asking for non-dv point fields"
argument_list|,
literal|"docValues"
argument_list|,
name|req
...
literal|"fl"
argument_list|,
literal|"field(val_is_ndv_p,'max')"
argument_list|)
argument_list|,
name|SolrException
operator|.
