...
name|get
argument_list|(
literal|"TLOG.replay.remaining.logs"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
name|get
argument_list|(
literal|"TLOG.replay.remaining.bytes"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// assert that in-place update is retained
name|assertJQ
argument_list|(
name|req
argument_list|(
...
annotation|@
name|Test
DECL|method|testNewDBQAndDocMatchingOldDBQDuringLogReplay
specifier|public
name|void
name|testNewDBQAndDocMatchingOldDBQDuringLogReplay
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// because we're sending updates during log replay, we can't emulate replica logic -- we need to use
comment|// normal updates like a leader / single-node instance would get.
comment|//
comment|// (In SolrCloud mode, when a replica run recoverFromLog, replica in this time period will have state = DOWN,
comment|// so It won't receive any updates.)
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// should be deleted by subsequent DBQ in tlog
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// should be deleted by DBQ that arives during tlog replay
name|updateJ
argument_list|(
name|jsonDelQ
argument_list|(
literal|"id:B1 OR id:B3 OR id:B6"
argument_list|)
argument_list|,
name|params
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// should *NOT* be deleted by previous DBQ in tlog
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// sanity check no updates have been applied yet (just in tlog)
name|assertJQ
argument_list|(
name|req
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// (Attempts to) kick off recovery (which is currently blocked by semaphore)
comment|// verify that previous close didn't do a commit& that recovery should be blocked by our hook
name|assertJQ
argument_list|(
name|req
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// begin recovery (first few items)
name|logReplay
operator|.
name|release
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// ... but before recover is completely unblocked/finished, have a *new* DBQ arrive
comment|// that should delete some items we either have just replayed, or are about to replay (or maybe both)...
name|updateJ
argument_list|(
name|jsonDelQ
argument_list|(
literal|"id:B2 OR id:B4"
argument_list|)
argument_list|,
name|params
argument_list|()
argument_list|)
expr_stmt|;
comment|// ...and re-add a doc that would have matched a DBQ already in the tlog
comment|// (which may/may-not have been replayed yet)
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// should *NOT* be deleted by DBQ from tlog
name|assertU
argument_list|(
name|commit
argument_list|()
argument_list|)
expr_stmt|;
comment|// now completely unblock recovery
name|logReplay
operator|.
name|release
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// verify only the expected docs are found, even with out of order DBQ and DBQ that arived during recovery
name|assertJQ
argument_list|(
name|req
argument_list|(
...
argument_list|)
argument_list|,
literal|"/response/docs==[{'id':'B0'}, {'id':'B3'}, {'id':'B5'}, {'id':'B6'}]"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
annotation|@
name|Test
DECL|method|testLogReplayWithReorderedDBQ
specifier|public
name|void
name|testLogReplayWithReorderedDBQ
parameter_list|()
throws|throws
name|Exception
block|{
name|testLogReplayWithReorderedDBQWrapper
argument_list|(
parameter_list|()
lambda|->
block|{
...
argument_list|)
expr_stmt|;
comment|// This should've arrived after the ver2 update
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
annotation|@
name|Test
DECL|method|testLogReplayWithReorderedDBQByAsterixAndChildDocs
specifier|public
name|void
name|testLogReplayWithReorderedDBQByAsterixAndChildDocs
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// 1018 - should be kept, including child docs
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 1017 - delete should affect only 1010
name|updateJ
argument_list|(
name|jsonDelQ
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 1020 - should be untouched
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
annotation|@
name|Test
DECL|method|testLogReplayWithReorderedDBQByIdAndChildDocs
specifier|public
name|void
name|testLogReplayWithReorderedDBQByIdAndChildDocs
parameter_list|()
throws|throws
name|Exception
block|{
...
annotation|@
name|Test
DECL|method|testLogReplayWithReorderedDBQInsertingChildnodes
specifier|public
name|void
name|testLogReplayWithReorderedDBQInsertingChildnodes
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
comment|// test doc: B1
comment|// 1013 - will be inserted with 3 children
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
annotation|@
name|Test
DECL|method|testLogReplayWithReorderedDBQUpdateWithDifferentChildCount
specifier|public
name|void
name|testLogReplayWithReorderedDBQUpdateWithDifferentChildCount
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|// control
comment|// 1011 - will be inserted with 3 children as 1012
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 1012 - this should be the final
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 1013 - will be inserted with 3 children as 1018
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// 1018 - this should be the final
name|updateJ
argument_list|(
name|jsonAdd
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testLogReplayWithReorderedDBQWrapper
specifier|private
name|void
name|testLogReplayWithReorderedDBQWrapper
parameter_list|(
...
operator|+
literal|"{'id':'B3','_version_':"
operator|+
name|v1030
operator|+
literal|"}"
operator|+
literal|",{'id':'B4','_version_':"
operator|+
name|v1040
operator|+
literal|"}"
operator|+
literal|",{'id':'B5','_version_':"
operator|+
name|v1050
operator|+
literal|"}"
operator|+
literal|",{'id':'B7','_version_':"
operator|+
name|v1070
operator|+
literal|"}"
...
literal|"/response/docs==["
operator|+
literal|"{'id':'C4','_version_':"
operator|+
name|v104
operator|+
literal|"}"
operator|+
literal|",{'id':'C5','_version_':"
operator|+
name|v105
operator|+
literal|"}"
operator|+
literal|",{'id':'C100','_version_':"
operator|+
name|v200
operator|+
literal|"}"
operator|+
literal|",{'id':'C101','_version_':"
operator|+
name|v201
operator|+
literal|"}"
operator|+
literal|",{'id':'C105','_version_':"
operator|+
name|v205
operator|+
literal|"}"
operator|+
literal|",{'id':'C106','_version_':"
operator|+
name|v206
operator|+
literal|"}"
...
literal|"/response/docs==["
operator|+
literal|"{'id':'C302','_version_':"
operator|+
name|v302
operator|+
literal|"}"
operator|+
literal|",{'id':'C301','_version_':"
operator|+
name|v301
operator|+
literal|"}"
...
annotation|@
name|Test
DECL|method|testLogReplayWithInPlaceUpdatesAndDeletes
specifier|public
name|void
name|testLogReplayWithInPlaceUpdatesAndDeletes
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// DBQ of updated document using id
name|versions
operator|.
name|addFirst
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// DBQ of updated document using updated value
name|versions
operator|.
name|addFirst
argument_list|(
...
name|deleteByQueryAndGetVersion
argument_list|(
literal|"val_i_dvo:102"
argument_list|,
literal|null
argument_list|)
argument_list|)
expr_stmt|;
comment|// DBQ using an intermediate update value (shouldn't delete anything)
name|versions
operator|.
name|addFirst
argument_list|(
...
name|deleteByQueryAndGetVersion
argument_list|(
literal|"val_i_dvo:201"
argument_list|,
literal|null
argument_list|)
argument_list|)
expr_stmt|;
comment|// DBI of updated document
name|versions
operator|.
name|addFirst
argument_list|(
