...
argument_list|,
literal|"//result/doc[6]/str[@name='id'][.='5']"
argument_list|)
expr_stmt|;
name|params
operator|=
...
argument_list|,
literal|"//result/doc[6]/str[@name='id'][.='1']"
argument_list|)
expr_stmt|;
...
argument_list|,
literal|"//result/doc[4]/str[@name='id'][.='3']"
argument_list|,
...
literal|"//result/doc[3]/str[@name='id'][.='4']"
argument_list|,
literal|"//result/doc[4]/str[@name='id'][.='2']"
argument_list|,
literal|"//result/doc[5]/str[@name='id'][.='1']"
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|//Last query was added to the cache
name|assertTrue
argument_list|(
name|inserts1
operator|>
...
argument_list|)
expr_stmt|;
comment|//Run same query and see if it was cached. This tests the query result cache hit with rewritten queries
name|params
operator|=
operator|new
name|ModifiableSolrParams
...
argument_list|)
decl_stmt|;
comment|//Last query was NOT added to the cache
name|assertTrue
argument_list|(
name|inserts1
operator|==
...
annotation|@
name|Test
DECL|method|testRerankQueryParsingShouldFailWithoutMandatoryReRankQueryParameter
specifier|public
name|void
name|testRerankQueryParsingShouldFailWithoutMandatoryReRankQueryParameter
parameter_list|()
throws|throws
name|Exception
block|{
