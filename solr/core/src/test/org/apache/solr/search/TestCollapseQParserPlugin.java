...
annotation|@
name|Test
DECL|method|test64BitCollapseFieldException
specifier|public
name|void
name|test64BitCollapseFieldException
parameter_list|()
block|{
name|ModifiableSolrParams
name|doubleParams
...
literal|"fq"
argument_list|,
literal|"{!collapse field=group_d}"
argument_list|)
expr_stmt|;
name|expectThrows
argument_list|(
...
literal|"fq"
argument_list|,
literal|"{!collapse field=group_dt}"
argument_list|)
expr_stmt|;
name|expectThrows
argument_list|(
...
literal|"fq"
argument_list|,
literal|"{!collapse field=group_l}"
argument_list|)
expr_stmt|;
name|expectThrows
argument_list|(
