...
annotation|@
name|Test
DECL|method|testParentLevelFQExclusion
specifier|public
name|void
name|testParentLevelFQExclusion
parameter_list|()
block|{
name|SolrQueryRequest
name|req
...
literal|"q"
argument_list|,
literal|"{!parent which=type_s:parent}+SIZE_s:XL"
argument_list|,
literal|"fq"
argument_list|,
literal|"{!term f=BRAND_s tag=rbrand}Nike"
argument_list|,
literal|"facet"
argument_list|,
literal|"true"
...
name|assertQ
argument_list|(
literal|"no exclusion, brand facet got only one Nike"
argument_list|,
name|req
argument_list|,
literal|"//*[@numFound='"
...
literal|"']"
argument_list|,
literal|"count(//lst[@name='BRAND_s']/int[.='1'])=1"
argument_list|)
expr_stmt|;
name|assertQ
argument_list|(
literal|"nike filter is excluded, expecting both brand in facet"
argument_list|,
name|req
argument_list|(
literal|"qt"
...
literal|"']"
argument_list|,
literal|"count(//lst[@name='BRAND_s']/int[.='1'])=2"
argument_list|)
expr_stmt|;
block|}
block|}
