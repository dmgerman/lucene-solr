...
name|Exception
block|{
comment|// TODO propose convenience API for this?
comment|// This testing approach means no new solrconfig or schema file or per-test temp solr-home!
name|System
operator|.
name|setProperty
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// modify solr config  TODO propose more convenient API for this; maybe with JSON-ification of a map
try|try
init|(
name|SolrQueryRequestBase
name|req
...
operator|+
literal|"'query.enableLazyFieldLoading':true, "
operator|+
literal|"'query.documentCache.class':'solr.LRUCache'"
operator|+
literal|"}}"
argument_list|)
argument_list|)
