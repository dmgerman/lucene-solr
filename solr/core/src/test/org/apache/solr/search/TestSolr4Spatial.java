...
name|fieldName
decl_stmt|;
DECL|field|canCalcDistance
specifier|private
specifier|final
name|boolean
name|canCalcDistance
decl_stmt|;
...
name|assumeTrue
argument_list|(
literal|"dist sorting not supported on field "
operator|+
name|fieldName
argument_list|,
name|canCalcDistance
...
argument_list|)
expr_stmt|;
comment|//far away from these queries; we filter it out
block|}
else|else
block|{
name|assertU
...
argument_list|)
expr_stmt|;
comment|// geodist desc  (simply reverse the assertions)
name|assertJQ
argument_list|(
name|req
argument_list|(
...
expr_stmt|;
comment|//
comment|//  NOTE: the rest work via the score of the spatial query. Generally, you should use geodist() instead.
comment|//
...
annotation|@
name|Test
DECL|method|testSpatialConfig
specifier|public
name|void
name|testSpatialConfig
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
comment|// BBox Config
comment|// Make sure the subfields are not stored
name|SchemaField
name|sub
init|=
name|schema
...
argument_list|)
expr_stmt|;
comment|// Make sure solr field type is also not stored
name|BBoxField
name|bbox
init|=
operator|(
