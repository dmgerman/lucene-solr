...
argument_list|)
expr_stmt|;
comment|// SOLR-8812 user query example
name|assertU
argument_list|(
name|adoc
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// When sow=false, the per-field query structures differ (no "Terminator" query on integer field foo_i),
comment|// so a dismax-per-field is constructed.  As a result, mm=100% is applied per-field instead of per-term;
comment|// since there is only one term (100) required in the foo_i field's dismax, the query can match docs that
comment|// only have the 100 term in the foo_i field, and don't necessarily have "Terminator" in any field.
name|assertQ
argument_list|(
name|req
argument_list|(
...
name|assertQ
argument_list|(
literal|"test minShouldMatch=1<-1 with explicit OR, one impossible clause, and no explicit q.op"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"barbie OR (hair AND nonexistentword)"
argument_list|,
literal|"qf"
argument_list|,
literal|"text_sw"
...
name|assertQ
argument_list|(
literal|"Explicit 'or' in query with lowercaseOperators=true, no explicit mm and q.op=AND => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit OR in query with no explicit mm and no explicit q.op => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"No operator in query with no explicit mm and q.op=OR => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"No operator in query with no explicit mm and q.op=AND => mm = 100%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit '-' operator in query with no explicit mm and no explicit q.op => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit NOT in query with no explicit mm and no explicit q.op => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
argument_list|,
literal|"hair ties NOT barbie"
argument_list|,
literal|"qf"
argument_list|,
literal|"text_sw"
...
name|assertQ
argument_list|(
literal|"Explicit '-' operator in query with no explicit mm and q.op=OR => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit NOT in query with no explicit mm and q.op=OR => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"No explicit non-AND operator in query with no explicit mm and q.op=OR => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"No explicit non-AND operator in query with no explicit mm and q.op=AND => mm = 100%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"No explicit non-AND operator in query with no explicit mm and no explicit q.op => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit '-' operator in query with no explicit mm and q.op=AND => mm = 100%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit NOT in query with no explicit mm and q.op=AND => mm = 100%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit OR in query with no explicit mm and q.op=OR => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertQ
argument_list|(
literal|"Explicit '+' operator in query with no explicit mm and q.op=AND => mm = 0%"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|assertEquals
argument_list|(
literal|"+(((text:\"crow blackbird\" text:grackl) text:wifi)"
operator|+
literal|" | (((+text_sw:crow +text_sw:blackbird) text_sw:grackl) text_sw:wifi))"
argument_list|,
name|q
operator|.
name|toString
...
block|}
block|}
DECL|method|testSowFalseWithBoost
specifier|public
name|void
name|testSowFalseWithBoost
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"+((title:one | subject:on) (title:two | subject:two))"
argument_list|,
name|q
operator|.
name|toString
...
name|assertEquals
argument_list|(
literal|"+(((title:one)^5.0 | subject:on) ((title:two)^5.0 | subject:two))"
argument_list|,
name|q
operator|.
name|toString
...
name|assertEquals
argument_list|(
literal|"+((title:one | (subject:on)^3.0) (title:two | (subject:two)^3.0))"
argument_list|,
name|q
operator|.
name|toString
...
name|assertEquals
argument_list|(
literal|"+(((title:one)^20.0 | (subject:on)^10.0) ((title:two)^20.0 | (subject:two)^10.0))"
argument_list|,
name|q
operator|.
name|toString
...
return|;
block|}
comment|/**         * Handle multi-term queries by repacking boolean queries with frequently misspelled term        * queries rewritten as fuzzy queries.        **/
annotation|@
name|Override
...
literal|false
decl_stmt|;
comment|// dirty flag: rebuild the repacked query?
name|BooleanQuery
operator|.
name|Builder
name|builder
