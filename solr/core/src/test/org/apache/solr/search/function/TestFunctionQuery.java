...
argument_list|)
argument_list|,
literal|"//float[@name='score']='0.5'"
argument_list|)
expr_stmt|;
comment|// 1/sqrt(4)==1/2==0.5
block|}
...
argument_list|)
expr_stmt|;
comment|// Test defaults, constant, field, and function value sources
name|assertQ
argument_list|(
name|req
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Test PayloadFunction's for multiple terms, average being the default
name|assertQ
argument_list|(
name|req
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Test special "first" function, by checking the other functions with same term too
name|assertQ
argument_list|(
name|req
argument_list|(
...
literal|"fl"
argument_list|,
literal|"field:concat(field1_t,field2_t,field4_t)"
argument_list|)
argument_list|,
...
comment|// our doc has no values for, but also that no other doc ever added
...
annotation|@
name|Test
DECL|method|testNumericComparisons
specifier|public
name|void
...
literal|"fl"
argument_list|,
literal|"a:gt(age_i,30),b:lt(age_i,30)"
argument_list|)
argument_list|,
literal|"/response/docs/[0]=={'a':true,'b':false}"
argument_list|)
expr_stmt|;
name|assertJQ
argument_list|(
...
literal|"fl"
argument_list|,
literal|"a:exists(gt(foo_i,30))"
argument_list|)
argument_list|,
literal|"/response/docs/[0]=={'a':false}"
argument_list|)
expr_stmt|;
name|singleTest
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testLongComparisons
specifier|public
name|void
name|testLongComparisons
parameter_list|()
block|{
name|assertU
argument_list|(
...
literal|"1"
argument_list|,
literal|"number_of_atoms_in_universe_l"
argument_list|,
name|Long
operator|.
name|toString
...
literal|"number_of_atoms_in_universe_l"
argument_list|,
literal|"if(gt(number_of_atoms_in_universe_l,"
operator|+
name|Long
operator|.
name|toString
...
literal|"number_of_atoms_in_universe_l"
argument_list|,
literal|"if(lt(number_of_atoms_in_universe_l,"
operator|+
name|Long
operator|.
name|toString
