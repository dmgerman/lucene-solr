...
expr_stmt|;
block|}
comment|/**    * Get standard query parsers registered by default.    *    * @see org.apache.solr.search.QParserPlugin#standardPlugins    * @return Map of classes extending QParserPlugin keyed by the registered name    */
DECL|method|getStandardQParsers
specifier|private
name|Map
argument_list|<
name|String
