...
block|}
block|}
DECL|method|testGraphTermsQuery
specifier|public
name|void
name|testGraphTermsQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|req
argument_list|,
literal|"{!graphTerms f=field1 maxDocFreq=1000}term1,term2"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
block|}
block|}
DECL|method|testTlogitQuery
specifier|public
name|void
name|testTlogitQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testSignificantTermsQuery
specifier|public
name|void
name|testSignificantTermsQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testMatchAllDocsQueryXmlParser
specifier|public
name|void
name|testMatchAllDocsQueryXmlParser
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"<MatchAllDocsQuery/>"
argument_list|,
literal|"<MatchAllDocsQuery></MatchAllDocsQuery>"
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
DECL|method|testLocalParamsWithRepeatingParam
specifier|public
name|void
name|testLocalParamsWithRepeatingParam
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"{!dismax}foo"
argument_list|,
literal|"{!dismax bq=111 bq=222}foo"
argument_list|,
literal|"{!dismax bq=222 bq=111}foo"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
block|}
block|}
DECL|method|testQueryScoreJoin
specifier|public
name|void
name|testQueryScoreJoin
parameter_list|()
throws|throws
name|Exception
block|{
...
name|req
argument_list|,
literal|"{!join from=foo_s to=bar_s score=avg}asdf"
argument_list|,
literal|"{!join from=$ff to=$tt score=Avg}asdf"
argument_list|,
literal|"{!join from=$ff to='bar_s' score=$scoreavg}text:asdf"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
name|req
argument_list|,
literal|"concat(bar_f,bar_t)"
argument_list|,
literal|"concat($myField,bar_t)"
argument_list|,
literal|"concat(bar_f,$myOtherField)"
argument_list|,
literal|"concat($myField,$myOtherField)"
argument_list|)
expr_stmt|;
block|}
finally|finally
...
argument_list|)
expr_stmt|;
comment|// simple VS of single valued field should be same as asking for min/max on that field
name|assertFuncEquals
argument_list|(
literal|"field(\"foo_i\")"
argument_list|,
literal|"field('foo_i',min)"
argument_list|,
literal|"field(foo_i,'min')"
argument_list|,
literal|"field('foo_i',max)"
argument_list|,
literal|"field(foo_i,'max')"
argument_list|,
literal|"foo_i"
argument_list|)
expr_stmt|;
comment|// multivalued field with selector
name|String
name|multif
init|=
literal|"multi_int_with_docvals"
decl_stmt|;
name|SolrQueryRequest
name|req
init|=
...
argument_list|)
decl_stmt|;
comment|// this test is only viable if it's a multivalued field, sanity check the schema
name|assertTrue
argument_list|(
name|multif
operator|+
literal|" is no longer multivalued, who broke this schema?"
argument_list|,
name|req
operator|.
name|getSchema
...
block|}
block|}
DECL|method|testPayloadScoreQuery
specifier|public
name|void
...
name|Exception
block|{
comment|// I don't see a precedent to test query inequality in here, so doing a `try`
comment|// There was a bug with PayloadScoreQuery's .equals() method that said two queries were equal with different includeSpanScore settings
try|try
block|{
name|assertQueryEquals
argument_list|(
...
argument_list|,
literal|"{!payload_score f=foo_dpf v=query func=min includeSpanScore=false}"
argument_list|,
literal|"{!payload_score f=foo_dpf v=query func=min includeSpanScore=true}"
argument_list|)
expr_stmt|;
name|fail
argument_list|(
literal|"queries should not have been equal"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertTrue
argument_list|(
literal|"queries were not equal, as expected"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
block|}
block|}
DECL|method|testPayloadCheckQuery
specifier|public
name|void
...
argument_list|,
literal|"{!payload_check f=foo_dpf payloads=2}one"
argument_list|,
literal|"{!payload_check f=foo_dpf payloads=2}two"
argument_list|)
expr_stmt|;
name|fail
argument_list|(
...
block|}
block|}
DECL|method|testPayloadFunction
specifier|public
name|void
name|testPayloadFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
name|req
argument_list|,
literal|"payload(foo_dpf,some_term)"
argument_list|,
literal|"payload(foo_dpf,some_term)"
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|// Override req to add df param
DECL|method|req
specifier|public
specifier|static
name|SolrQueryRequest
