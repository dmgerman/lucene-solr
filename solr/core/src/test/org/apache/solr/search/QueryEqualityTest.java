...
block|}
block|}
comment|/**    * NOTE: defType is not only used to pick the parser, but also to record     * the parser being tested for coverage sanity checking    *    * @see QueryUtils#check    * @see QueryUtils#checkEquals    * @see #testParserCoverage    */
DECL|method|assertQueryEquals
specifier|protected
name|void
name|assertQueryEquals
