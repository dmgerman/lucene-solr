...
name|getParser
argument_list|(
literal|"{!join from=dept_id_s to=dept_ss score=none}text_t:develop"
argument_list|,
name|req
argument_list|)
operator|.
...
name|getParser
argument_list|(
literal|"{!join from=dept_ss to=dept_ss score=none}text_t:develop"
argument_list|,
name|req
argument_list|)
operator|.
...
name|assertFalse
argument_list|(
literal|"diff from fields produce equal queries"
argument_list|,
name|x
operator|.
name|equals
