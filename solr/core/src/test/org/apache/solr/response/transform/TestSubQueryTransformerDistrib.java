...
literal|"departments"
decl_stmt|;
DECL|field|differentUniqueId
specifier|private
specifier|static
name|boolean
name|differentUniqueId
decl_stmt|;
annotation|@
name|BeforeClass
...
name|differentUniqueId
condition|?
literal|"schema-minimal-with-another-uniqkey.xml"
else|:
literal|"schema-docValuesJoin.xml"
argument_list|)
operator|.
...
name|differentUniqueId
condition|?
literal|"depts.distrib.singlePass"
else|:
literal|"notnecessary"
block|,
literal|"true"
block|,
literal|"depts.rows"
