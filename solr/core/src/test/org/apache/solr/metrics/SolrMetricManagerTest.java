...
annotation|@
name|Test
DECL|method|testMoveMetrics
specifier|public
name|void
name|testMoveMetrics
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// check the remaining metrics
name|Map
argument_list|<
name|String
argument_list|,
...
expr_stmt|;
block|}
comment|// check the moved metrics
name|Map
argument_list|<
name|String
argument_list|,
...
expr_stmt|;
block|}
comment|// move all remaining metrics
name|metricManager
operator|.
name|moveMetrics
argument_list|(
