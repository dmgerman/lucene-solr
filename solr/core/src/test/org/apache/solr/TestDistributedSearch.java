...
name|bugUrl
operator|=
literal|"https://issues.apache.org/jira/browse/SOLR-9061"
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// Make sure there is no macro expansion for field values
name|query
argument_list|(
literal|"q"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Macro expansion should still work for the parameters
name|query
argument_list|(
literal|"q"
argument_list|,
...
expr_stmt|;
block|}
comment|/** comparing results with facet.method=uif */
DECL|method|queryAndCompareUIF
specifier|private
name|void
name|queryAndCompareUIF
parameter_list|(
