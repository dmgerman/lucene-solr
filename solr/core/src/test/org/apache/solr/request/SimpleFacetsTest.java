...
argument_list|)
argument_list|,
literal|"*[count(//lst[@name='zerolen_s']/int[@name=''])=1]"
argument_list|)
expr_stmt|;
block|}
name|assertQ
...
name|f
argument_list|,
literal|"1976-07-15T00:07:57.890Z"
argument_list|,
name|ff
argument_list|,
literal|"1976-07-04T"
...
name|f
argument_list|,
literal|"1976-07-21T00:07:57.890Z"
argument_list|,
name|ff
argument_list|,
literal|"1976-07-05T"
...
literal|"/../"
decl_stmt|;
comment|// range faceting defaults to including only lower endpoint
...
argument_list|)
expr_stmt|;
comment|//Fixed by SOLR-9080 related to the Gregorian Change Date
name|assertQ
argument_list|(
literal|"check BC era"
argument_list|,
name|req
argument_list|(
literal|"q"
...
name|pre
operator|+
literal|"/int[@name='-0200-01-01T00:00:00Z'][.='0']"
argument_list|,
name|pre
operator|+
literal|"/int[@name='-0100-01-01T00:00:00Z'][.='0']"
argument_list|,
name|pre
operator|+
literal|"/int[@name='0000-01-01T00:00:00Z'][.='0']"
argument_list|,
name|pre
operator|+
literal|"/int[@name='0100-01-01T00:00:00Z'][.='0']"
...
parameter_list|()
block|{
name|helpTestDateRangeFacetsWithIncludeOption
argument_list|(
literal|"a_tdt"
argument_list|)
expr_stmt|;
...
DECL|method|helpTestDateRangeFacetsWithIncludeOption
specifier|private
name|void
name|helpTestDateRangeFacetsWithIncludeOption
parameter_list|(
...
annotation|@
name|Test
DECL|method|testDateRangeFacetsWithTz
specifier|public
name|void
name|testDateRangeFacetsWithTz
parameter_list|()
block|{
name|helpTestDateRangeFacetsWithTz
argument_list|(
literal|"a_tdt"
argument_list|)
expr_stmt|;
block|}
DECL|method|helpTestDateRangeFacetsWithTz
specifier|private
name|void
name|helpTestDateRangeFacetsWithTz
parameter_list|(
...
annotation|@
name|Test
DECL|method|testFacetExistsShouldThrowExceptionForMincountGreaterThanOne
specifier|public
name|void
name|testFacetExistsShouldThrowExceptionForMincountGreaterThanOne
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertQEx
argument_list|(
literal|"checking global method or per field"
argument_list|,
name|msg
operator|.
name|get
...
annotation|@
name|Test
DECL|method|testFacetExclude
specifier|public
name|void
name|testFacetExclude
parameter_list|()
block|{
for|for
control|(
...
name|assertQ
argument_list|(
literal|"test facet.exclude"
argument_list|,
name|req
argument_list|,
literal|"*[count(//lst[@name='facet_fields']/lst/int)=10]"
argument_list|,
name|pre
operator|+
...
name|pre
operator|+
literal|"/int[2][@name='CCC'][.='3']"
argument_list|,
name|pre
operator|+
literal|"/int[3][@name='CCC"
operator|+
name|termSuffix
operator|+
literal|"'][.='3']"
...
name|pre
operator|+
literal|"/int[6][@name='CC'][.='2']"
argument_list|,
name|pre
operator|+
literal|"/int[7][@name='CC"
operator|+
name|termSuffix
operator|+
literal|"'][.='2']"
...
name|pre
operator|+
literal|"/int[8][@name='AAA'][.='1']"
argument_list|,
name|pre
operator|+
literal|"/int[9][@name='AAA"
operator|+
name|termSuffix
operator|+
literal|"'][.='1']"
...
name|assertQ
argument_list|(
literal|"test facet.exclude for grouped facets"
argument_list|,
name|groupReq
argument_list|,
literal|"*[count(//lst[@name='facet_fields']/lst/int)=10]"
...
name|pre
operator|+
literal|"/int[3][@name='BBB'][.='2']"
argument_list|,
name|pre
operator|+
literal|"/int[4][@name='AAA'][.='1']"
argument_list|,
name|pre
operator|+
literal|"/int[5][@name='AAA"
operator|+
name|termSuffix
operator|+
literal|"'][.='1']"
...
name|pre
operator|+
literal|"/int[7][@name='BB'][.='1']"
argument_list|,
name|pre
operator|+
literal|"/int[8][@name='BB"
operator|+
name|termSuffix
operator|+
literal|"'][.='1']"
...
name|pre
operator|+
literal|"/int[9][@name='CC'][.='1']"
argument_list|,
name|pre
operator|+
literal|"/int[10][@name='CC"
operator|+
name|termSuffix
operator|+
literal|"'][.='1']"
...
annotation|@
name|Test
DECL|method|testFacetContainsAndExclude
specifier|public
name|void
name|testFacetContainsAndExclude
parameter_list|()
block|{
for|for
control|(
...
argument_list|)
expr_stmt|;
name|doFacetContainsAndExclude
argument_list|(
literal|"contains_s1"
argument_list|,
literal|"contains_group_s1"
...
block|}
block|}
DECL|method|randomizeStringCasing
specifier|private
name|String
name|randomizeStringCasing
parameter_list|(
...
return|;
block|}
DECL|method|doFacetContainsAndExclude
specifier|private
name|void
name|doFacetContainsAndExclude
parameter_list|(
...
name|assertQ
argument_list|(
literal|"test facet.contains with facet.exclude"
argument_list|,
name|req
argument_list|,
literal|"*[count(//lst[@name='facet_fields']/lst/int)=2]"
...
name|assertQ
argument_list|(
literal|"test facet.contains with facet.exclude for grouped facets"
argument_list|,
name|groupReq
argument_list|,
literal|"*[count(//lst[@name='facet_fields']/lst/int)=5]"
argument_list|,
name|pre
operator|+
...
annotation|@
name|Test
comment|//@Ignore("SOLR-8466 - facet.method=uif ignores facet.contains")
DECL|method|testFacetContainsUif
specifier|public
name|void
name|testFacetContainsUif
parameter_list|()
block|{
...
expr_stmt|;
block|}
DECL|method|doFacetExistsPrefix
specifier|public
name|void
name|doFacetExistsPrefix
parameter_list|(
...
name|assertQ
argument_list|(
literal|"test field facet.method"
argument_list|,
name|req
argument_list|(
name|params
...
name|assertQEx
argument_list|(
literal|"no zero gap error for facet.range: "
operator|+
name|field
argument_list|,
name|req
