...
argument_list|()
expr_stmt|;
comment|// NOTE: segments may be merged in any order, so we can't make any assumptions about
comment|// the relative order of M1 vs M2 unless we have a secondary sort
name|assertU
argument_list|(
name|adoc
argument_list|(
...
literal|"//*[@numFound='5']"
argument_list|,
literal|"//result/doc[1]/str[@name='id'][starts-with(.,'M')]"
argument_list|,
literal|"//result/doc[2]/str[@name='id'][starts-with(.,'M')]"
argument_list|,
...
literal|"//result/doc[3]/str[@name='id'][.='-3']"
argument_list|,
literal|"//result/doc[4]/str[@name='id'][starts-with(.,'M')]"
argument_list|,
literal|"//result/doc[5]/str[@name='id'][starts-with(.,'M')]"
argument_list|)
expr_stmt|;
name|assertQ
argument_list|(
literal|"Sorting Asc w/secondary on id desc: "
operator|+
name|t
operator|+
name|suffix
...
literal|"//*[@numFound='5']"
argument_list|,
literal|"//result/doc[1]/str[@name='id'][.='M2']"
argument_list|,
...
name|assertQ
argument_list|(
literal|"Sorting Desc w/secondary on id asc: "
operator|+
name|t
operator|+
name|suffix
...
literal|"//result/doc[2]/str[@name='id'][starts-with(.,'M')]"
argument_list|,
literal|"//result/doc[3]/str[@name='id'][starts-with(.,'M')]"
argument_list|,
literal|"//result/doc[4]/str[@name='id'][.='+4']"
argument_list|,
literal|"//result/doc[5]/str[@name='id'][.='+5']"
...
literal|"//result/doc[4]/str[@name='id'][.='M2']"
argument_list|,
literal|"//result/doc[5]/str[@name='id'][.='M1']"
argument_list|)
expr_stmt|;
name|assertQ
argument_list|(
