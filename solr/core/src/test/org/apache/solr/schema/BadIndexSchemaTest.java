...
expr_stmt|;
block|}
DECL|method|testRootTypeMissmatchWithUniqueKey
specifier|public
name|void
name|testRootTypeMissmatchWithUniqueKey
parameter_list|()
throws|throws
name|Exception
block|{
name|doTest
argument_list|(
literal|"bad-schema-uniquekey-diff-type-root.xml"
argument_list|,
literal|"using the exact same fieldType as the uniqueKey field (id) uses: string1"
argument_list|)
expr_stmt|;
block|}
DECL|method|testRootTypeDynamicMissmatchWithUniqueKey
specifier|public
name|void
name|testRootTypeDynamicMissmatchWithUniqueKey
parameter_list|()
throws|throws
name|Exception
block|{
comment|// in this case, the core should load fine -- but we should get an error adding docs
try|try
block|{
name|initCore
argument_list|(
...
argument_list|,
literal|"bad-schema-uniquekey-diff-type-dynamic-root.xml"
argument_list|)
expr_stmt|;
name|assertFailedU
argument_list|(
literal|"Unable to index docs with children"
argument_list|,
name|adoc
argument_list|(
