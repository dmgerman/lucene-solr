...
name|assertEquals
argument_list|(
literal|"copyField source :'*too_many_asterisks*' is an invalid glob: either it contains more than one asterisk,"
operator|+
...
name|assertEquals
argument_list|(
literal|"copyField source :'misplaced_*_asterisk' is an invalid glob: either it contains more than one asterisk,"
operator|+
literal|" or the asterisk occurs neither at the start nor at the end."
argument_list|,
name|e
...
name|assertEquals
argument_list|(
literal|"copyField dest :'*too_many_asterisks*' is an invalid glob: either it contains more than one asterisk,"
operator|+
literal|" or the asterisk occurs neither at the start nor at the end."
argument_list|,
name|e
...
name|assertEquals
argument_list|(
literal|"copyField dest :'misplaced_*_asterisk' is an invalid glob: either it contains more than one asterisk,"
operator|+
literal|" or the asterisk occurs neither at the start nor at the end."
argument_list|,
name|e
