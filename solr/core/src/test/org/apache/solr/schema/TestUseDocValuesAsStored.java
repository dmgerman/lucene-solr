...
annotation|@
name|Test
DECL|method|testUseDocValuesAsStoredFalse
specifier|public
name|void
name|testUseDocValuesAsStoredFalse
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"fl"
argument_list|,
literal|"id,nonstored_dv_str"
argument_list|)
argument_list|,
literal|"/response/docs==["
operator|+
literal|"{'id':'myid','nonstored_dv_str':'dont see me'}"
operator|+
literal|"]"
argument_list|)
expr_stmt|;
