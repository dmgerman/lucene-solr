...
annotation|@
name|Test
DECL|method|testIntPointFieldSortAndFunction
specifier|public
name|void
name|testIntPointFieldSortAndFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"*_p_i_ni_dv"
argument_list|,
literal|"*_p_i_ni_dv_ns"
argument_list|,
literal|"*_p_i_ni_ns_dv"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_i_dv_smf"
argument_list|,
literal|"*_p_i_ni_dv_smf"
argument_list|,
literal|"*_p_i_sml"
argument_list|,
literal|"*_p_i_dv_sml"
argument_list|,
literal|"*_p_i_ni_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
argument_list|)
decl_stmt|;
name|doTestPointFieldSortError
argument_list|(
name|field
argument_list|,
literal|"w/o docValues"
argument_list|,
literal|"42"
argument_list|)
expr_stmt|;
name|doTestPointFieldFunctionQueryError
argument_list|(
name|field
argument_list|,
literal|"w/o docValues"
...
literal|"*_p_i_ni_mv"
argument_list|,
literal|"*_p_i_ni_mv_dv"
argument_list|,
literal|"*_p_i_ni_dv_ns_mv"
argument_list|,
literal|"*_p_i_ni_ns_mv"
argument_list|,
literal|"*_p_i_dv_ns_mv"
argument_list|,
literal|"*_p_i_mv_dv"
argument_list|,
literal|"*_p_i_mv_smf"
argument_list|,
literal|"*_p_i_mv_dv_smf"
argument_list|,
literal|"*_p_i_ni_mv_dv_smf"
argument_list|,
literal|"*_p_i_mv_sml"
argument_list|,
literal|"*_p_i_mv_dv_sml"
argument_list|,
literal|"*_p_i_ni_mv_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
block|}
block|}
comment|/** Primary sort by value, with nulls either first or last as specified, and then secondary sort by position. */
specifier|private
parameter_list|<
name|T
extends|extends
...
argument_list|>
parameter_list|>
DECL|method|getPosValComparator
name|Comparator
argument_list|<
name|PosVal
argument_list|<
...
return|;
block|}
comment|/**     * Primary ascending sort by value, with missing values (represented as null) either first or last as specified,    * and then secondary ascending sort by position.     */
DECL|method|toAscendingStringArray
specifier|private
parameter_list|<
name|T
extends|extends
...
return|;
block|}
comment|/**    * Primary ascending sort by value, with missing values (represented as null) either first or last as specified,    * and then secondary ascending sort by position.     *     * @return a list of the (originally) positioned values sorted as described above.    */
DECL|method|toAscendingPosVals
specifier|private
parameter_list|<
name|T
extends|extends
...
return|;
block|}
comment|/**    * Primary descending sort by value, with missing values (represented as null) either first or last as specified,    * and then secondary descending sort by position.     *    * @return a list of the (originally) positioned values sorted as described above.    */
DECL|method|toDescendingPosVals
specifier|private
parameter_list|<
name|T
extends|extends
...
annotation|@
name|Test
DECL|method|testDoublePointFieldSortAndFunction
specifier|public
name|void
name|testDoublePointFieldSortAndFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"*_p_d_ni_dv"
argument_list|,
literal|"*_p_d_ni_dv_ns"
argument_list|,
literal|"*_p_d_ni_ns_dv"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_d_dv_smf"
argument_list|,
literal|"*_p_d_ni_dv_smf"
argument_list|,
literal|"*_p_d_sml"
argument_list|,
literal|"*_p_d_dv_sml"
argument_list|,
literal|"*_p_d_ni_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_d_ni_mv"
argument_list|,
literal|"*_p_d_ni_mv_dv"
argument_list|,
literal|"*_p_d_ni_dv_ns_mv"
argument_list|,
literal|"*_p_d_ni_ns_mv"
argument_list|,
literal|"*_p_d_dv_ns_mv"
argument_list|,
literal|"*_p_d_mv_dv"
argument_list|,
literal|"*_p_d_mv_smf"
argument_list|,
literal|"*_p_d_mv_dv_smf"
argument_list|,
literal|"*_p_d_ni_mv_dv_smf"
argument_list|,
literal|"*_p_d_mv_sml"
argument_list|,
literal|"*_p_d_mv_dv_sml"
argument_list|,
literal|"*_p_d_ni_mv_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
annotation|@
name|Test
DECL|method|testFloatPointFieldSortAndFunction
specifier|public
name|void
name|testFloatPointFieldSortAndFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"*_p_f_ni_dv"
argument_list|,
literal|"*_p_f_ni_dv_ns"
argument_list|,
literal|"*_p_f_ni_ns_dv"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_f_dv_smf"
argument_list|,
literal|"*_p_f_ni_dv_smf"
argument_list|,
literal|"*_p_f_sml"
argument_list|,
literal|"*_p_f_dv_sml"
argument_list|,
literal|"*_p_f_ni_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_f_ni_mv"
argument_list|,
literal|"*_p_f_ni_mv_dv"
argument_list|,
literal|"*_p_f_ni_dv_ns_mv"
argument_list|,
literal|"*_p_f_ni_ns_mv"
argument_list|,
literal|"*_p_f_dv_ns_mv"
argument_list|,
literal|"*_p_f_mv_dv"
argument_list|,
literal|"*_p_f_mv_smf"
argument_list|,
literal|"*_p_f_mv_dv_smf"
argument_list|,
literal|"*_p_f_ni_mv_dv_smf"
argument_list|,
literal|"*_p_f_mv_sml"
argument_list|,
literal|"*_p_f_mv_dv_sml"
argument_list|,
literal|"*_p_f_ni_mv_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
annotation|@
name|Test
DECL|method|testLongPointFieldSortAndFunction
specifier|public
name|void
name|testLongPointFieldSortAndFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"*_p_l_ni_dv"
argument_list|,
literal|"*_p_l_ni_dv_ns"
argument_list|,
literal|"*_p_l_ni_ns_dv"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_l_dv_smf"
argument_list|,
literal|"*_p_l_ni_dv_smf"
argument_list|,
literal|"*_p_l_sml"
argument_list|,
literal|"*_p_l_dv_sml"
argument_list|,
literal|"*_p_l_ni_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_l_ni_mv"
argument_list|,
literal|"*_p_l_ni_mv_dv"
argument_list|,
literal|"*_p_l_ni_dv_ns_mv"
argument_list|,
literal|"*_p_l_ni_ns_mv"
argument_list|,
literal|"*_p_l_dv_ns_mv"
argument_list|,
literal|"*_p_l_mv_dv"
argument_list|,
literal|"*_p_l_mv_smf"
argument_list|,
literal|"*_p_l_mv_dv_smf"
argument_list|,
literal|"*_p_l_ni_mv_dv_smf"
argument_list|,
literal|"*_p_l_mv_sml"
argument_list|,
literal|"*_p_l_mv_dv_sml"
argument_list|,
literal|"*_p_l_ni_mv_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
annotation|@
name|Test
DECL|method|testDatePointFieldSortAndFunction
specifier|public
name|void
name|testDatePointFieldSortAndFunction
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"*_p_dt_ni_dv"
argument_list|,
literal|"*_p_dt_ni_dv_ns"
argument_list|,
literal|"*_p_dt_ni_ns_dv"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_dt_smf"
argument_list|,
literal|"*_p_dt_dv_smf"
argument_list|,
literal|"*_p_dt_ni_dv_smf"
argument_list|,
literal|"*_p_dt_sml"
argument_list|,
literal|"*_p_dt_dv_sml"
argument_list|,
literal|"*_p_dt_ni_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
literal|"*_p_dt_ni_mv"
argument_list|,
literal|"*_p_dt_ni_mv_dv"
argument_list|,
literal|"*_p_dt_ni_dv_ns_mv"
argument_list|,
literal|"*_p_dt_ni_ns_mv"
argument_list|,
literal|"*_p_dt_dv_ns_mv"
argument_list|,
literal|"*_p_dt_mv_dv"
argument_list|,
literal|"*_p_dt_mv_smf"
argument_list|,
literal|"*_p_dt_mv_dv_smf"
argument_list|,
literal|"*_p_dt_ni_mv_dv_smf"
argument_list|,
literal|"*_p_dt_mv_sml"
argument_list|,
literal|"*_p_dt_mv_dv_sml"
argument_list|,
literal|"*_p_dt_ni_mv_dv_sml"
argument_list|)
control|)
block|{
name|assertTrue
...
comment|/**    * Given a FieldType, return the list of DynamicField 'regexes' for all declared     * DynamicFields that use that FieldType.    *    * @see IndexSchema#getDynamicFields    * @see DynamicField#getRegex    */
DECL|method|dynFieldRegexesForType
specifier|private
specifier|static
name|SortedSet
argument_list|<
...
literal|null
decl_stmt|;
comment|// Sometimes leave val as null when we're producing missing values
if|if
condition|(
name|missingVals
operator|==
...
expr_stmt|;
block|}
comment|/**     * Checks that the specified field can not be used as a value source, even if there are documents     * with (all) the specified values in the index.    *    * @param field the field name to try and sort on    * @param errSubStr substring to look for in the error msg    * @param values one or more values to put into the doc(s) in the index - may be more then one for multivalued fields    */
DECL|method|doTestPointFieldFunctionQueryError
specifier|private
name|void
name|doTestPointFieldFunctionQueryError
parameter_list|(
...
name|assertQEx
argument_list|(
literal|"Should not be able to use field in function: "
operator|+
name|field
argument_list|,
name|errSubStr
...
literal|"fq"
argument_list|,
literal|"{!frange l=0 h=100}product(-1, "
operator|+
name|field
operator|+
literal|")"
...
argument_list|)
expr_stmt|;
comment|// empty index should (also) give same error
name|assertQEx
argument_list|(
literal|"Should not be able to use field in function: "
operator|+
...
expr_stmt|;
block|}
comment|/**    * For each value, creates a doc with that value in the specified field and then asserts that    * asc/desc sorts on that field succeeds and that the docs are in the (relatively) expected order    *    * @param field name of field to sort on    * @param values list of values in ascending order    */
...
expr_stmt|;
block|}
comment|// reminder: xpath array indexes start at 1
name|ascXpathChecks
index|[
name|i
index|]
...
expr_stmt|;
block|}
comment|// ensure doc add order doesn't affect results
name|Collections
operator|.
name|shuffle
argument_list|(
...
DECL|method|doTestPointFieldSortError
specifier|private
name|void
name|doTestPointFieldSortError
parameter_list|(
...
name|assertQEx
argument_list|(
literal|"Should not be able to sort on field: "
operator|+
name|field
argument_list|,
name|errSubStr
...
block|{
comment|// Won't use PointInSetQuery if the field is not indexed, but should match the same docs
name|assertQ
argument_list|(
name|req
argument_list|(
...
literal|"//*[@numFound='10']"
argument_list|,
literal|"//result/doc[1]/date[@name='field("
operator|+
name|field
operator|+
literal|")'][.='1995-01-10T10:59:11Z']"
argument_list|,
literal|"//result/doc[2]/date[@name='field("
operator|+
name|field
operator|+
literal|")'][.='1995-01-10T10:59:12Z']"
argument_list|,
literal|"//result/doc[3]/date[@name='field("
operator|+
name|field
operator|+
literal|")'][.='1995-01-10T10:59:13Z']"
argument_list|,
literal|"//result/doc[10]/date[@name='field("
operator|+
name|field
operator|+
literal|")'][.='1995-01-10T10:59:20Z']"
...
argument_list|()
expr_stmt|;
comment|// our own SlowCompositeReader to check DocValues on disk w/o the UninvertingReader added by SolrIndexSearcher
specifier|final
name|LeafReader
name|leafReaderForCheckingDVs
init|=
name|SlowCompositeReaderWrapper
operator|.
name|wrap
