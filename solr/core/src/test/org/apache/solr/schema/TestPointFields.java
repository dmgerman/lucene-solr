...
name|bugUrl
operator|=
literal|"https://issues.apache.org/jira/browse/SOLR-10437"
argument_list|)
DECL|method|testNonReturnableDocValues
specifier|public
name|void
name|testNonReturnableDocValues
parameter_list|()
throws|throws
name|Exception
block|{
comment|// TODO: once SOLR-10437 is resolved, this test method can be folded into testNonReturnable()
comment|// these fields are stored=false, docValues=true, useDocValuesAsStored=false and yet they are
comment|// still returned and failing this test.
name|doTestNonReturnable
argument_list|(
...
expr_stmt|;
block|}
DECL|method|doTestNonReturnable
specifier|public
name|void
name|doTestNonReturnable
parameter_list|(
...
literal|"count(//doc/*)=10"
argument_list|,
comment|// exactly 10 fields across all docs
literal|"count(//doc/*[@name!='id'])=0"
argument_list|)
expr_stmt|;
...
name|Exception
block|{
comment|// TODO: we should have a "coverage" assert that we're looping over all the dynamic (point) fields in the schema
name|String
index|[]
name|typeNames
init|=
