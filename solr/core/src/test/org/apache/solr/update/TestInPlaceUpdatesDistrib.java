...
argument_list|)
expr_stmt|;
comment|// assert that NoMergePolicy was chosen
name|RefCounted
argument_list|<
name|IndexWriter
argument_list|>
...
name|assertTrue
argument_list|(
literal|"Actual merge policy is: "
operator|+
name|writer
operator|.
name|getConfig
...
argument_list|()
expr_stmt|;
name|updatingDVsInAVeryOldSegment
argument_list|()
expr_stmt|;
comment|// TODO Should we combine all/some of these into a single test, so as to cut down on execution time?
name|reorderedDBQIndividualReplicaTest
argument_list|()
expr_stmt|;
name|reorderedDeletesTest
argument_list|()
expr_stmt|;
name|reorderedDBQsSimpleTest
argument_list|()
expr_stmt|;
name|reorderedDBQsResurrectionTest
argument_list|()
expr_stmt|;
name|reorderedDBQsUsingUpdatedValueFromADroppedUpdate
argument_list|()
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/**    * Ingest many documents, keep committing. Then update a document from a very old segment.    */
DECL|method|updatingDVsInAVeryOldSegment
specifier|private
name|void
name|updatingDVsInAVeryOldSegment
parameter_list|()
...
argument_list|)
expr_stmt|;
comment|// create 10 more segments
for|for
control|(
name|int
name|i
...
name|info
argument_list|(
literal|"updatingDVsInAVeryOldSegment: This test passed fine..."
argument_list|)
expr_stmt|;
block|}
...
DECL|method|reorderedDBQsResurrectionTest
specifier|private
name|void
name|reorderedDBQsResurrectionTest
parameter_list|()
...
name|info
argument_list|(
literal|"reorderedDBQsResurrectionTest: This test passed fine..."
argument_list|)
expr_stmt|;
name|clearIndex
argument_list|()
...
DECL|method|reorderedDBQsUsingUpdatedValueFromADroppedUpdate
specifier|private
name|void
name|reorderedDBQsUsingUpdatedValueFromADroppedUpdate
parameter_list|()
...
name|info
argument_list|(
literal|"reorderedDBQsUsingUpdatedValueFromADroppedUpdate: This test passed fine..."
argument_list|)
expr_stmt|;
block|}
annotation|@
