...
expr_stmt|;
block|}
DECL|method|testRequestTimeUrp
specifier|public
name|void
name|testRequestTimeUrp
parameter_list|()
block|{
name|SolrCore
name|core
...
argument_list|,
literal|"id_t:{firstName}_{lastName}"
argument_list|)
operator|.
name|add
argument_list|(
literal|"template.field"
argument_list|,
literal|"another_t:{lastName}_{firstName}"
argument_list|)
operator|.
name|add
argument_list|(
literal|"template.field"
argument_list|,
literal|"missing_t:{lastName}_{unKnown}"
argument_list|)
decl_stmt|;
