...
expr_stmt|;
block|}
DECL|method|testSoftCommitMaxTime
specifier|public
name|void
name|testSoftCommitMaxTime
parameter_list|()
throws|throws
name|Exception
block|{
...
name|verbose
argument_list|(
literal|"###starting to wait for new searcher.  softTracker.getCommitCount()=="
argument_list|,
name|softTracker
operator|.
name|getCommitCount
...
name|verbose
argument_list|(
literal|"###done waiting for new searcher.  softTracker.getCommitCount()=="
argument_list|,
name|softTracker
operator|.
name|getCommitCount
...
argument_list|)
expr_stmt|;
comment|// what's the point of this update?
name|req
operator|.
name|setContentStreams
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testSoftAndHardCommitMaxTime
specifier|public
name|void
name|testSoftAndHardCommitMaxTime
parameter_list|()
throws|throws
name|Exception
block|{
