...
argument_list|()
expr_stmt|;
comment|// adds should be reset to 0 after commit
name|assertEquals
argument_list|(
literal|"new adds after commit"
argument_list|,
literal|0
argument_list|,
name|newAdds
argument_list|)
expr_stmt|;
comment|// not so with cumulative ones!
name|assertEquals
argument_list|(
literal|"new cumulative adds after commit"
argument_list|,
literal|2
argument_list|,
name|newCumulativeAdds
...
argument_list|)
expr_stmt|;
comment|// delsI should be reset to 0 after commit
name|newDelsI
operator|=
operator|(
operator|(
...
name|assertEquals
argument_list|(
literal|"new delsI after commit"
argument_list|,
literal|0
argument_list|,
name|newDelsI
...
name|assertEquals
argument_list|(
literal|"new cumulative delsI after commit"
argument_list|,
literal|1
argument_list|,
name|newCumulativeDelsI
...
name|assertEquals
argument_list|(
literal|"new delsQ after commit"
argument_list|,
literal|0
argument_list|,
name|newDelsQ
...
name|assertEquals
argument_list|(
literal|"new cumulative delsQ after commit"
argument_list|,
literal|1
argument_list|,
name|newCumulativeDelsQ
