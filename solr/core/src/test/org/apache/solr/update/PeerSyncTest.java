...
condition|)
block|{
comment|// if doc with id=5000 is deleted, further in-place-updates should fail
name|delQ
argument_list|(
name|client0
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// current val is 2, this will delete id=5000
name|assertSync
argument_list|(
name|client1
argument_list|,
...
name|containsString
argument_list|(
literal|"Can't find document with id=5000"
argument_list|)
argument_list|)
expr_stmt|;
block|}
