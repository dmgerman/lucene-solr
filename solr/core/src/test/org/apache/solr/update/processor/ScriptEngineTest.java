...
expr_stmt|;
block|}
comment|//  public void testJRuby() throws ScriptException, NoSuchMethodException {  // Simply adding jruby.jar to Solr's lib/ directory gets this test passing
comment|//    ScriptEngine engine = manager.getEngineByName("jruby");
comment|//    assertNotNull(engine);
comment|//    engine.eval("def add(a,b); a + b; end");
comment|//    Long result = (Long) ((Invocable)engine).invokeFunction("add", 1, 2);
comment|//    assertNotNull(result);
comment|//    assertEquals(3, result.intValue());
comment|//  }
block|}
end_class
