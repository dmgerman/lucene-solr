...
expr_stmt|;
block|}
DECL|method|testFieldsWithDefaultValuesWhenAtomicUpdatesAgainstTlog
specifier|public
name|void
name|testFieldsWithDefaultValuesWhenAtomicUpdatesAgainstTlog
parameter_list|()
block|{
for|for
control|(
...
name|asList
argument_list|(
literal|"field_to_update_i1"
argument_list|,
literal|"field_to_update_i_dvo"
argument_list|)
control|)
block|{
name|clearIndex
...
literal|"'][.='666']"
argument_list|,
literal|"//doc/int[@name='intDefault'][.='42']"
argument_list|,
literal|"//doc/int[@name='intDvoDefault'][.='42']"
argument_list|,
literal|"//doc/long[@name='_version_']"
argument_list|,
literal|"//doc/date[@name='timestamp']"
argument_list|,
literal|"//doc/arr[@name='multiDefault']/str[.='muLti-Default']"
argument_list|,
literal|"count(//doc/*)=7"
argument_list|)
expr_stmt|;
comment|// do atomic update
name|assertU
argument_list|(
name|adoc
argument_list|(
...
name|fieldToUpdate
operator|+
literal|": RTG after atomic update"
argument_list|,
name|req
argument_list|(
literal|"qt"
...
specifier|public
name|void
name|testAtomicUpdateOfFieldsWithDefaultValue
parameter_list|()
block|{
comment|// both fields have the same default value (42)
for|for
control|(
name|String
name|fieldToUpdate
...
argument_list|()
expr_stmt|;
comment|// doc where we immediately attempt to inc the default value
name|assertU
argument_list|(
name|adoc
argument_list|(
...
operator|+
literal|"'][.='708']"
comment|// whichever field we did *NOT* update
argument_list|,
literal|"//doc/int[@name!='"
operator|+
name|fieldToUpdate
...
name|fieldToUpdate
operator|+
literal|": RTG#7 after atomic update"
argument_list|,
name|req
argument_list|(
literal|"qt"
...
argument_list|)
expr_stmt|;
comment|// diff doc where we check that we can overwrite the default value
name|assertU
argument_list|(
name|adoc
argument_list|(
