...
decl_stmt|;
DECL|field|solrConfigFileNameSortingMergePolicyFactory
specifier|private
specifier|static
specifier|final
name|String
name|solrConfigFileNameSortingMergePolicyFactory
init|=
...
expr_stmt|;
block|}
DECL|method|testSortingMPSolrIndexConfigCreation
specifier|public
name|void
name|testSortingMPSolrIndexConfigCreation
parameter_list|()
throws|throws
name|Exception
block|{
...
specifier|final
name|boolean
name|expectedFieldSortDescending
init|=
literal|true
decl_stmt|;
name|SolrConfig
...
name|mergePolicy
operator|+
literal|") is not a SortingMergePolicy"
argument_list|,
name|mergePolicy
operator|instanceof
name|SortingMergePolicy
...
name|assertEquals
argument_list|(
literal|"SortingMergePolicy.getSort"
argument_list|,
name|expected
argument_list|,
name|actual
