...
comment|// and for rate limited settings
name|SolrCore
name|core
init|=
name|h
...
argument_list|)
expr_stmt|;
comment|//ugh, what a painful way to get the document
name|DocIterator
name|iterator
init|=
name|response
...
control|)
block|{
comment|//page through some results
name|DocList
name|subset
init|=
name|response
...
literal|"1"
argument_list|,
comment|//only get one doc, and then compare it to gold
name|CommonParams
operator|.
name|PAGEDOC
argument_list|,
