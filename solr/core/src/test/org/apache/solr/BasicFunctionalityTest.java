...
annotation|@
name|Test
DECL|method|testClientErrorOnMalformedDate
specifier|public
name|void
name|testClientErrorOnMalformedDate
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"Didn't encounter an error trying to add a bad date: "
operator|+
name|field
argument_list|)
expr_stmt|;
...
name|assertTrue
argument_list|(
literal|"client error does not mention document id: "
operator|+
name|msg
argument_list|,
name|msg
...
name|fail
argument_list|(
literal|"Didn't encounter an error trying to query a bad date: "
operator|+
name|field
argument_list|)
expr_stmt|;
