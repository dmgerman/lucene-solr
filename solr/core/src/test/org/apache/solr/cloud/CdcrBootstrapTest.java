...
name|resolve
argument_list|(
literal|"configsets/cdcr-source-disabled"
argument_list|)
operator|.
name|toFile
argument_list|()
...
name|println
argument_list|(
literal|"config dir absolute path = "
operator|+
name|configDir
operator|.
...
specifier|final
name|File
name|cdcrEnabledSourceConfigDir
init|=
name|getFile
argument_list|(
literal|"solr"
...
name|resolve
argument_list|(
literal|"configsets/cdcr-source"
argument_list|)
operator|.
name|toFile
argument_list|()
...
name|resolve
argument_list|(
literal|"configsets/cdcr-target"
argument_list|)
operator|.
name|toFile
argument_list|()
...
argument_list|()
decl_stmt|;
comment|// todo investigate why this is necessary???
name|collectionProperties
operator|.
name|putIfAbsent
argument_list|(
