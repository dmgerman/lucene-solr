...
block|}
block|}
comment|/**    * Assert the number of documents in a given collection    */
...
condition|)
block|{
comment|// must close resources for the old entries
for|for
control|(
name|CloudJettyRunner
name|oldRunner
...
block|}
block|}
DECL|method|waitForBootstrapToComplete
specifier|protected
name|void
name|waitForBootstrapToComplete
parameter_list|(
name|String
name|collectionName
parameter_list|,
...
name|rsp
decl_stmt|;
comment|// we need to wait until bootstrap is complete otherwise the replicator thread will never start
name|TimeOut
name|timeOut
init|=
operator|new
