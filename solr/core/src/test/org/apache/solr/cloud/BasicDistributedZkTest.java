...
name|IOException
block|{
comment|// construct the /admin/metrics URL
name|URL
name|url
init|=
operator|new
...
argument_list|()
decl_stmt|;
comment|//params.set("qt", "/admin/metrics?prefix=UPDATE.updateHandler&registry=solr.core." + collection);
name|params
operator|.
name|set
argument_list|(
...
name|get
argument_list|(
literal|"UPDATE.updateHandler.commits"
argument_list|)
decl_stmt|;
return|return
operator|(
