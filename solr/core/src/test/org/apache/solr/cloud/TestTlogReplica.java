...
literal|1
case|:
comment|// Sometimes don't use SolrJ
name|String
name|url
init|=
name|String
...
name|ROOT
argument_list|,
literal|"%s/admin/collections?action=CREATE&name=%s&numShards=%s&tlogReplicas=%s&maxShardsPerNode=%s"
argument_list|,
name|cluster
operator|.
name|getRandomJetty
...
literal|4
argument_list|,
comment|// tlogReplicas
literal|100
argument_list|)
decl_stmt|;
comment|// maxShardsPerNode
name|HttpGet
name|createCollectionGet
init|=
operator|new
name|HttpGet
argument_list|(
...
name|ROOT
argument_list|,
literal|"{create:{name:%s, numShards:%s, tlogReplicas:%s, maxShardsPerNode:%s}}"
argument_list|,
name|collectionName
argument_list|,
literal|2
...
literal|0
case|:
comment|// Add replica with SolrJ
name|CollectionAdminResponse
name|response
init|=
name|CollectionAdminRequest
...
name|assertEquals
argument_list|(
literal|"Unexpected response status: "
operator|+
name|response
operator|.
name|getStatus
...
literal|1
case|:
comment|// Add replica with V1 API
name|String
name|url
init|=
name|String
...
name|ROOT
argument_list|,
literal|"%s/admin/collections?action=ADDREPLICA&collection=%s&shard=%s&type=%s"
argument_list|,
name|cluster
operator|.
name|getRandomJetty
...
literal|2
case|:
comment|// Add replica with V2 API
name|url
operator|=
name|String
operator|.
...
name|ROOT
argument_list|,
literal|"{add-replica:{shard:%s, type:%s}}"
argument_list|,
name|shardName
argument_list|,
name|type
