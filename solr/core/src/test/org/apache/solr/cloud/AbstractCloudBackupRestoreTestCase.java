...
condition|)
block|{
comment|// Try with createNodeSet configuration
name|int
name|nodeSetSize
init|=
name|cluster
...
argument_list|)
expr_stmt|;
comment|// we need to double maxShardsPerNode value since we reduced number of available nodes by half.
if|if
condition|(
name|restore
operator|.
...
name|v
operator|+
literal|" replicas. Expected num replicas : "
operator|+
name|restoreCollection
operator|.
name|getMaxShardsPerNode
