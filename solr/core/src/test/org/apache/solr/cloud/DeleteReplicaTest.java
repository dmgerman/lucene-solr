...
comment|//    if(!shard1.getState().equals(Slice.ACTIVE)) fail("shard is not active");
comment|//    for (Replica replica : shard1.getReplicas()) if("active".equals(replica.getStr("state"))) replica1 =replica;
if|if
condition|(
name|replica1
operator|==
