...
expr_stmt|;
block|}
DECL|method|tryRemoveReplicaByCountAndShard
specifier|protected
name|void
name|tryRemoveReplicaByCountAndShard
parameter_list|(
name|String
name|collectionName
parameter_list|,
...
expr_stmt|;
block|}
DECL|method|tryRemoveReplicaByCountAsync
specifier|protected
name|void
name|tryRemoveReplicaByCountAsync
parameter_list|(
name|String
name|collectionName
parameter_list|,
...
expr_stmt|;
block|}
DECL|method|trackRequestStatus
specifier|protected
name|String
...
try|try
block|{
comment|// Should not be able to delete 2 replicas (non leader ones for a given shard
name|tryRemoveReplicaByCountAndShard
argument_list|(
name|collectionName
argument_list|,
...
name|fail
argument_list|(
literal|"Should have been able to remove the replica successfully"
argument_list|)
expr_stmt|;
block|}
block|}
...
try|try
block|{
comment|// Should not be able to delete 2 replicas from all shards (non leader ones)
name|tryRemoveReplicaByCountAsync
argument_list|(
name|collectionName
argument_list|,
...
argument_list|)
expr_stmt|;
comment|//Make sure request completes
name|String
name|requestStatus
init|=
name|trackRequestStatus
