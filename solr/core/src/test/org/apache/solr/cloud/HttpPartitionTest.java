...
block|}
block|}
comment|// if the old leader is not active or recovering, the add should have failed
if|if
condition|(
name|oldLeaderInRecovery
operator|!=
...
name|fail
argument_list|(
literal|"Send doc 2 to old leader "
operator|+
name|leader
operator|.
name|getName
argument_list|()
operator|+
literal|" should have failed! ClusterState: "
operator|+
name|printClusterStateInfo
argument_list|(
name|testCollectionName
