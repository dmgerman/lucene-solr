...
name|bugUrl
operator|=
literal|"https://issues.apache.org/jira/browse/SOLR-9286"
argument_list|)
...
name|bugUrl
operator|=
literal|"https://issues.apache.org/jira/browse/SOLR-9289"
argument_list|)
...
comment|// TODO: in single node, [docid] is silently ignored for uncommited docs (see SOLR-9288) ...
comment|// here we see even more confusing:  [docid] is silently ignored for both committed& uncommited docs
comment|// behavior shouldn't matter if we are committed or uncommitted
for|for
control|(
name|String
...
argument_list|)
expr_stmt|;
comment|// assertTrue(msg, doc.getFieldValue("[docid]") instanceof Integer); // TODO
name|assertTrue
argument_list|(
name|msg
argument_list|,
