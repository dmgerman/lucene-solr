...
name|Exception
block|{
name|sanityCheckAssertNumerics
argument_list|()
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// put our FACET_PIVOT params in a set in case we just happen to pick the same one twice
name|LinkedHashSet
argument_list|<
name|String
argument_list|>
name|pivotParamValues
init|=
operator|new
name|LinkedHashSet
argument_list|<
...
name|message
decl_stmt|;
comment|// no wiggle room, these should always be exactly equals, regardless of field type
name|assertEquals
argument_list|(
literal|"Count"
operator|+
...
argument_list|)
expr_stmt|;
comment|// precision loss can affect these in some field types depending on shards used
comment|// and the order that values are accumulated
name|assertNumerics
argument_list|(
literal|"Sum"
operator|+
...
name|msg
operator|+
literal|" ... values do not have the same type: "
operator|+
name|expected
operator|+
literal|" vs "
...
name|msg
operator|+
literal|" (w/dates converted to ms)"
expr_stmt|;
block|}
name|assertTrue
argument_list|(
name|msg
operator|+
literal|" ... expected is not a Number: "
operator|+
name|expected
operator|+
literal|"=>"
...
name|msg
operator|+
literal|" ... where did this come from: "
operator|+
name|expected
operator|.
name|getClass
...
DECL|method|sanityCheckAssertNumerics
specifier|private
name|void
name|sanityCheckAssertNumerics
parameter_list|()
