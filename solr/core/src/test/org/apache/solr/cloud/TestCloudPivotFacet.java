...
argument_list|)
decl_stmt|;
comment|// not efficient, but it garuntees that even if people change buildRandomDocument
...
argument_list|)
expr_stmt|;
comment|// need determinism for buildRandomPivot calls
for|for
control|(
name|int
name|i
...
return|;
block|}
comment|/**    * Asserts the number of docs matching the SolrParams aganst the cloudClient    */
