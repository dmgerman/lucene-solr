...
name|ROOT
argument_list|,
literal|"%s/admin/collections?action=CREATE&name=%s&numShards=%s&pullReplicas=%s&maxShardsPerNode=%s"
argument_list|,
name|cluster
operator|.
name|getRandomJetty
...
literal|""
argument_list|,
literal|"&nrtReplicas=1"
argument_list|,
literal|"&replicationFactor=1"
argument_list|)
expr_stmt|;
comment|// These options should all mean the same
name|HttpGet
...
name|ROOT
argument_list|,
literal|"{create:{name:%s, numShards:%s, pullReplicas:%s, maxShardsPerNode:%s %s}}"
argument_list|,
name|collectionName
argument_list|,
literal|2
