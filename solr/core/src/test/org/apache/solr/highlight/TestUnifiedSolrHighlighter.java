...
name|setProperty
argument_list|(
literal|"queryResultCache.enabled"
argument_list|,
literal|"false"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// this is why we use this particular solrconfig
name|initCore
argument_list|(
literal|"solrconfig-cache-enable-disable.xml"
argument_list|,
...
expr_stmt|;
block|}
DECL|method|testBreakIteratorCustom
specifier|public
name|void
name|testBreakIteratorCustom
parameter_list|()
block|{
name|assertU
argument_list|(
...
parameter_list|()
block|{
comment|// We highlight on field text3 (hl.fl), but our query only references the "text" field. Nonetheless, the query word
comment|//  "document" is found in all fields here.
name|assertQ
argument_list|(
name|req
argument_list|(
...
argument_list|)
argument_list|,
comment|//hl.requireFieldMatch is false by default
literal|"count(//lst[@name='highlighting']/lst[@name='101']/arr[@name='text3']/*)=1"
argument_list|)
expr_stmt|;
name|assertQ
argument_list|(
...
argument_list|)
argument_list|,
literal|"count(//lst[@name='highlighting']/lst[@name='101']/arr[@name='text3']/*)=0"
argument_list|)
expr_stmt|;
block|}
block|}
