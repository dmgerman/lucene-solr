...
annotation|@
name|Test
DECL|method|testMethodPostings
specifier|public
name|void
name|testMethodPostings
parameter_list|()
block|{
name|String
name|field
...
name|assertQ
argument_list|(
literal|"Tried PostingsSolrHighlighter but failed due to offsets not in postings"
argument_list|,
name|req
argument_list|(
literal|"q"
...
expr_stmt|;
block|}
comment|// note: the default schema.xml has no offsets in postings to test the PostingsHighlighter. Leave that for another
comment|//  test class.
block|}
annotation|@
name|Test
...
argument_list|)
expr_stmt|;
comment|// test works; no complaints
name|TestHarness
operator|.
...
argument_list|)
expr_stmt|;
comment|// hl.fl ordering need not be preserved in output
specifier|final
name|Set
argument_list|<
name|String
argument_list|>
name|highlightedSetExpected
init|=
operator|new
name|HashSet
argument_list|<
