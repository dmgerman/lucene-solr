...
annotation|@
name|Test
DECL|method|testFailExecuteScript
specifier|public
name|void
name|testFailExecuteScript
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
argument_list|,
literal|"failExecuteScript"
argument_list|)
decl_stmt|;
name|assertTrue
argument_list|(
literal|"Should have been able to create file '"
operator|+
name|toExecute
operator|.
name|getAbsolutePath
...
name|assertTrue
argument_list|(
literal|"Execution should have failed with return code 1"
argument_list|,
name|code
operator|==
literal|1
