...
name|ofPattern
argument_list|(
literal|"G yyyyy MM ww W D dd F E a HH hh mm ss SSS z Z"
argument_list|,
name|Locale
operator|.
name|ROOT
...
argument_list|)
expr_stmt|;
comment|// basically without the 'Z'
block|}
...
name|input
init|=
literal|"1234-07-04T12:08:56.235"
decl_stmt|;
for|for
control|(
name|String
...
name|assertRound
argument_list|(
literal|"1234-07-04T12:08:56.000"
argument_list|,
name|input
argument_list|,
literal|"SECOND"
...
name|assertRound
argument_list|(
literal|"1234-07-04T12:08:00.000"
argument_list|,
name|input
argument_list|,
literal|"MINUTE"
...
name|assertRound
argument_list|(
literal|"1234-07-04T12:00:00.000"
argument_list|,
name|input
argument_list|,
literal|"HOUR"
...
name|assertRound
argument_list|(
literal|"1234-07-04T00:00:00.000"
argument_list|,
name|input
argument_list|,
literal|"DAY"
...
name|assertRound
argument_list|(
literal|"1234-07-01T00:00:00.000"
argument_list|,
name|input
argument_list|,
literal|"MONTH"
...
name|assertRound
argument_list|(
literal|"1234-01-01T00:00:00.000"
argument_list|,
name|input
argument_list|,
literal|"YEAR"
...
name|assertAdd
argument_list|(
literal|"1234-07-04T12:08:56.236"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertAdd
argument_list|(
literal|"1234-07-04T12:08:57.235"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertAdd
argument_list|(
literal|"1234-07-04T12:09:56.235"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertAdd
argument_list|(
literal|"1234-07-04T13:08:56.235"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertAdd
argument_list|(
literal|"1234-07-05T12:08:56.235"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertAdd
argument_list|(
literal|"1234-08-04T12:08:56.235"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertAdd
argument_list|(
literal|"1235-07-04T12:08:56.235"
argument_list|,
name|input
argument_list|,
literal|1
...
name|assertMath
argument_list|(
literal|"1234-07-04T12:08:56.234"
argument_list|,
name|p
argument_list|,
literal|"-1MILLISECOND"
...
name|assertMath
argument_list|(
literal|"1234-07-04T12:08:55.235"
argument_list|,
name|p
argument_list|,
literal|"-1SECOND"
...
name|assertMath
argument_list|(
literal|"1234-07-04T12:07:56.235"
argument_list|,
name|p
argument_list|,
literal|"-1MINUTE"
...
name|assertMath
argument_list|(
literal|"1234-07-04T11:08:56.235"
argument_list|,
name|p
argument_list|,
literal|"-1HOUR"
...
name|assertMath
argument_list|(
literal|"1234-07-03T12:08:56.235"
argument_list|,
name|p
argument_list|,
literal|"-1DAY"
...
name|assertMath
argument_list|(
literal|"1234-06-04T12:08:56.235"
argument_list|,
name|p
argument_list|,
literal|"-1MONTH"
...
name|assertMath
argument_list|(
literal|"1233-07-04T12:08:56.235"
argument_list|,
name|p
argument_list|,
literal|"-1YEAR"
...
name|assertMath
argument_list|(
literal|"1233-07-04T12:08:56.236"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-04T12:08:57.235"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-04T12:09:56.235"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-04T13:08:56.235"
argument_list|,
name|p
argument_list|,
literal|"+1HOUR-1YEAR"
...
name|assertMath
argument_list|(
literal|"1233-07-05T12:08:56.235"
argument_list|,
name|p
argument_list|,
literal|"+1DAY-1YEAR"
...
name|assertMath
argument_list|(
literal|"1233-08-04T12:08:56.235"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-01T00:00:00.000"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-04T00:00:00.000"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-04T13:00:00.000"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-07-05T12:08:56.000"
argument_list|,
name|p
argument_list|,
...
name|assertMath
argument_list|(
literal|"1233-08-04T12:08:56.000"
argument_list|,
name|p
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// assert same as ISO_INSTANT
name|assertEquals
argument_list|(
name|millis
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// assert DMP has same result
block|}
