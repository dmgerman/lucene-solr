...
comment|//create pub key in advance because it can take time and it should be
comment|//created before the header is set
name|PublicKey
name|key
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|/*test4 mock the restart of a node*/
name|MockPKIAuthenticationPlugin
name|mock1
init|=
operator|new
