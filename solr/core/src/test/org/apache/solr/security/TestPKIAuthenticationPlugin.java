...
annotation|@
name|Test
DECL|method|testGetBaseUrlForNodeNameLocal
specifier|public
name|void
name|testGetBaseUrlForNodeNameLocal
parameter_list|()
block|{
...
name|assertEquals
argument_list|(
literal|"http://my.host:9876/solr2"
argument_list|,
name|mock
operator|.
name|getBaseUrlForNodeNameLocal
argument_list|(
literal|"my.host:9876_solr2"
argument_list|)
argument_list|)
expr_stmt|;
name|System
...
name|assertEquals
argument_list|(
literal|"https://my.host:9876/solr2"
argument_list|,
name|mock
operator|.
name|getBaseUrlForNodeNameLocal
...
annotation|@
name|Test
DECL|method|testResolveUrlScheme
specifier|public
name|void
name|testResolveUrlScheme
parameter_list|()
block|{
synchronized|synchronized
init|(
