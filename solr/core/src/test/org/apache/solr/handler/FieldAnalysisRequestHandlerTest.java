...
expr_stmt|;
block|}
DECL|method|testRequiredParamHandling
specifier|public
name|void
name|testRequiredParamHandling
parameter_list|()
throws|throws
name|Exception
block|{
...
name|fail
argument_list|(
literal|"A request with no parameters should not have succeeded"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|fail
argument_list|(
literal|"A request with no paramters should not result in NPE"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
name|assertEquals
argument_list|(
literal|"A request with no parameters should have returned a BAD_REQUEST error"
argument_list|,
name|e
operator|.
name|code
