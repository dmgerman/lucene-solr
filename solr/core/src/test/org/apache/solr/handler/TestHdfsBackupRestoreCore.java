...
operator|+
literal|"<str name=\"solr.hdfs.permissions.umask-mode\">${solr.hdfs.permissions.umask-mode:000}</str>\n"
operator|+
literal|"</repository>\n"
operator|+
literal|"</backup>\n"
...
name|info
argument_list|(
literal|"Running Backup via replication handler"
argument_list|)
expr_stmt|;
name|BackupRestoreUtils
operator|.
...
name|info
argument_list|(
literal|"Running Backup via core admin api"
argument_list|)
expr_stmt|;
name|Map
argument_list|<
...
name|info
argument_list|(
literal|"Running Restore via replication handler"
argument_list|)
expr_stmt|;
comment|// Snapshooter prefixes "snapshot." to the backup name.
name|BackupRestoreUtils
...
name|info
argument_list|(
literal|"Running Restore via core admin api"
argument_list|)
expr_stmt|;
name|Map
argument_list|<
...
argument_list|)
expr_stmt|;
comment|// Verify the permissions for the backup folder.
name|FileStatus
name|status
init|=
name|fs
