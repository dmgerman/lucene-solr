...
annotation|@
name|Test
DECL|method|testCollateExtendedResultsWithJsonNl
specifier|public
name|void
name|testCollateExtendedResultsWithJsonNl
parameter_list|()
throws|throws
name|Exception
block|{
...
name|add
argument_list|(
literal|"/spellcheck/collations/collation/collationQuery=='document brown'"
argument_list|)
expr_stmt|;
name|testsList
operator|.
name|add
argument_list|(
literal|"/spellcheck/collations/collation/hits==0"
argument_list|)
expr_stmt|;
switch|switch
condition|(
...
name|add
argument_list|(
literal|"/spellcheck/collations/collation/misspellingsAndCorrections/documemtsss=='document'"
argument_list|)
expr_stmt|;
name|testsList
operator|.
name|add
argument_list|(
literal|"/spellcheck/collations/collation/misspellingsAndCorrections/broens=='brown'"
argument_list|)
expr_stmt|;
break|break;
default|default:
name|fail
argument_list|(
literal|"unexpected json.nl choice: "
operator|+
name|jsonNl
argument_list|)
expr_stmt|;
...
index|]
decl_stmt|;
name|implTestCollateExtendedResultsWithJsonNl
argument_list|(
name|q
argument_list|,
name|jsonNl
...
expr_stmt|;
block|}
DECL|method|implTestCollateExtendedResultsWithJsonNl
specifier|private
name|void
name|implTestCollateExtendedResultsWithJsonNl
parameter_list|(
