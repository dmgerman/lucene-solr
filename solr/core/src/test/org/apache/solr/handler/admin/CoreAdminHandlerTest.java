...
annotation|@
name|Test
DECL|method|testUnloadForever
specifier|public
name|void
name|testUnloadForever
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|//assertEquals(1,result.getResults().getNumFound());
name|fail
argument_list|(
literal|"expect 404"
argument_list|)
...
annotation|@
name|Test
DECL|method|testDeleteInstanceDirAfterCreateFailure
specifier|public
name|void
name|testDeleteInstanceDirAfterCreateFailure
parameter_list|()
throws|throws
name|Exception
block|{
name|assumeFalse
argument_list|(
literal|"Ignore test on windows because it does not delete data directory immediately after unload"
argument_list|,
name|Constants
operator|.
name|WINDOWS
...
name|top
argument_list|,
literal|"bad-error-solrconfig.xml"
argument_list|)
argument_list|,
operator|new
name|File
...
parameter_list|)
block|{
comment|// this is expected because we put a bad solrconfig -- ignore
block|}
name|CoreAdminRequest
operator|.
name|Unload
...
argument_list|)
expr_stmt|;
comment|// important because the data directory is inside the instance directory
name|req
operator|.
name|setCoreName
argument_list|(
...
name|assertTrue
argument_list|(
literal|"The data directory was not cleaned up on unload after a failed core reload"
argument_list|,
name|Files
operator|.
name|notExists
