...
expr_stmt|;
block|}
comment|// Check for overflow of sumOfSquares
DECL|method|testFieldStatisticsResultsDateFieldOverflow
specifier|public
name|void
name|testFieldStatisticsResultsDateFieldOverflow
parameter_list|()
throws|throws
name|Exception
block|{
...
name|req
argument_list|,
literal|"//long[@name='count'][.='1']"
argument_list|,
literal|"//date[@name='min'][.='2015-12-14T09:00:00Z']"
argument_list|,
...
argument_list|,
literal|"//double[@name='sumOfSquares'][.='"
operator|+
name|Double
operator|.
name|toString
argument_list|(
literal|2102742446988960000000000.0
argument_list|)
operator|+
literal|"']"
argument_list|)
...
name|toString
argument_list|(
literal|83555549895529430000000000.0
argument_list|)
operator|+
literal|"']"
argument_list|,
comment|// The following number matches the number returned by the current solr
comment|// implementation of standard deviation. Should be 3155673600000.
comment|// That number is not precise, and the implementation should be fixed.
literal|"//double[@name='stddev'][.='"
operator|+
name|Double
operator|.
name|toString
argument_list|(
literal|3155673599999.999
argument_list|)
operator|+
literal|"']"
argument_list|)
...
argument_list|)
expr_stmt|;
comment|// force constant score for matches so we aren't dependent on similarity
specifier|final
name|float
name|constScore
init|=
