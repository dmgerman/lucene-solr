...
argument_list|,
literal|"/response/result/doc[1]/str[@name='id'][.='2']"
argument_list|,
literal|"/response/result/doc[2]/str[@name='id'][.='6']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='1"
operator|+
name|floatAppend
operator|+
literal|"']/doc[1]/str[@name='id'][.='1']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='1"
operator|+
name|floatAppend
operator|+
literal|"']/doc[2]/str[@name='id'][.='7']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='2"
operator|+
name|floatAppend
operator|+
literal|"']/doc[1]/str[@name='id'][.='5']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='2"
operator|+
name|floatAppend
operator|+
literal|"']/doc[2]/str[@name='id'][.='8']"
argument_list|)
expr_stmt|;
...
argument_list|,
literal|"/response/result/doc[1]/str[@name='id'][.='6']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='2"
operator|+
name|floatAppend
...
name|floatAppend
operator|+
literal|"']/doc[1]/str[@name='id'][.='7']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='1"
operator|+
name|floatAppend
operator|+
literal|"']/doc[2]/str[@name='id'][.='1']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='2"
operator|+
name|floatAppend
operator|+
literal|"']/doc[1]/str[@name='id'][.='8']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='2"
operator|+
name|floatAppend
operator|+
literal|"']/doc[2]/str[@name='id'][.='5']"
argument_list|)
expr_stmt|;
...
literal|"*[count(/response/lst[@name='expanded']/result)=2]"
argument_list|,
literal|"/response/result/doc[1]/str[@name='id'][.='3']"
argument_list|,
literal|"/response/result/doc[2]/str[@name='id'][.='2']"
argument_list|,
literal|"/response/result/doc[3]/str[@name='id'][.='6']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='1"
operator|+
name|floatAppend
...
literal|"*[count(/response/lst[@name='expanded']/result)=2]"
argument_list|,
literal|"/response/result/doc[1]/str[@name='id'][.='1']"
argument_list|,
literal|"/response/result/doc[2]/str[@name='id'][.='5']"
argument_list|,
literal|"/response/lst[@name='expanded']/result[@name='1"
operator|+
name|floatAppend
...
annotation|@
name|Test
DECL|method|testExpandWithEmptyIndexReturnsZeroResults
specifier|public
name|void
name|testExpandWithEmptyIndexReturnsZeroResults
parameter_list|()
block|{
comment|//We make sure the index is cleared
name|clearIndex
argument_list|()
expr_stmt|;
name|assertU
