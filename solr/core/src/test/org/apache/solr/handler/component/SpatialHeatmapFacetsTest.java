...
argument_list|)
expr_stmt|;
comment|// now this time we add a filter query and exclude it
name|QueryResponse
name|response
init|=
name|query
...
literal|"fq"
argument_list|,
literal|"{!tag=excludeme}id:0"
argument_list|,
comment|// filter to only be id:0
name|FacetParams
operator|.
name|FACET_HEATMAP
argument_list|,
literal|"{!ex=excludeme}"
operator|+
name|FIELD
argument_list|,
comment|// exclude the filter
name|FacetParams
operator|.
name|FACET_HEATMAP_GEOM
argument_list|,
