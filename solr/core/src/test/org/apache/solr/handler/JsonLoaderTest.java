...
name|req
argument_list|(
name|PARENT_TWO_CHILDREN_PARAMS
argument_list|)
expr_stmt|;
name|req
operator|.
...
expr_stmt|;
block|}
DECL|field|PARENT_TWO_CHILDREN_JSON
specifier|private
specifier|static
specifier|final
name|String
...
literal|"}"
decl_stmt|;
DECL|field|PARENT_TWO_CHILDREN_PARAMS
specifier|private
specifier|static
specifier|final
name|String
...
block|}
decl_stmt|;
DECL|method|testFewParentsJsonDoc
specifier|public
name|void
name|testFewParentsJsonDoc
parameter_list|()
throws|throws
name|Exception
block|{
