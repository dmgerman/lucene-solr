...
literal|500
decl_stmt|;
comment|// TODO: fix this test to not require FSDirectory.. doesnt even work with MockFSDirectory... wtf?
...
name|Exception
block|{
comment|/* doTestReplicateAfterCoreReload();     doTestDetails();     doTestReplicateAfterWrite2Slave();     doTestIndexAndConfigReplication();     doTestStopPoll();     doTestSnapPullWithMasterUrl();     doTestReplicateAfterStartup();     doTestIndexAndConfigAliasReplication();*/
name|doTestBackup
argument_list|()
expr_stmt|;
block|}
...
name|println
argument_list|(
literal|"replicate slave to master"
argument_list|)
expr_stmt|;
...
comment|//e.printStackTrace();
block|}
comment|// get the details
comment|// just ensures we don't get an exception
name|NamedList
argument_list|<
name|Object
argument_list|>
...
argument_list|)
decl_stmt|;
comment|//System.out.println("details:" + details);
