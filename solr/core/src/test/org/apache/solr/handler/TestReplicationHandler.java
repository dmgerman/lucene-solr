...
argument_list|()
operator|+
literal|"/solr/update?prepareCommit=true"
decl_stmt|;
name|URL
name|url
init|=
...
control|)
block|{
comment|// we randomly trigger a configuration replication
comment|// if (random().nextBoolean()) {
name|master
operator|.
name|copyConfigFile
argument_list|(
...
annotation|@
name|Test
comment|//@Ignore("ignore while i track down the intermittent problem with this test")
...
argument_list|)
expr_stmt|;
comment|// we need to wait until the core is reloaded
name|rQuery
argument_list|(
literal|1
argument_list|,
