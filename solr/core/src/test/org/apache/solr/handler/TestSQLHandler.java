...
argument_list|()
expr_stmt|;
name|testCatalogStream
argument_list|()
expr_stmt|;
name|testSchemasStream
argument_list|()
expr_stmt|;
name|testTablesStream
argument_list|()
expr_stmt|;
block|}
...
name|sql
operator|=
literal|"select a from b where c = 5"
expr_stmt|;
name|statement
operator|=
name|parser
