...
condition|)
block|{
comment|// There will be reversed tokens starting with u0001 that we want to exclude, so
comment|// lets start at u0002 inclusive instead.
name|char
index|[]
name|buf
init|=
