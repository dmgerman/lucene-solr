...
argument_list|)
decl_stmt|;
DECL|field|THREAD_POOL_MAX_THREADS
specifier|private
specifier|static
specifier|final
name|int
...
literal|10000
decl_stmt|;
comment|// NOTE: needs to be larger than SolrHttpClient.threadPoolSweeperMaxIdleTime
DECL|field|THREAD_POOL_MAX_IDLE_TIME_MS
specifier|private
specifier|static
specifier|final
name|int
name|THREAD_POOL_MAX_IDLE_TIME_MS
init|=
literal|120000
decl_stmt|;
DECL|field|server
...
return|;
block|}
comment|/**      * Introduce a delay of specified milliseconds for the specified request.      *      * @param reason Info message logged when delay occurs      * @param count The count-th request will experience a delay      * @param delay There will be a delay of this many milliseconds      */
DECL|method|addDelay
specifier|public
name|void
name|addDelay
parameter_list|(
...
expr_stmt|;
block|}
comment|/**      * Remove any delay introduced before.      */
DECL|method|unsetDelay
specifier|public
name|void
name|unsetDelay
parameter_list|()
...
name|info
argument_list|(
literal|"Pausing this socket connection for "
operator|+
name|delayMs
operator|+
literal|"ms..."
...
name|info
argument_list|(
literal|"Waking up after the delay of "
operator|+
name|delayMs
operator|+
literal|"ms..."
...
return|;
block|}
comment|/**    * @return the {@link CoreContainer} for this node    */
...
return|;
block|}
comment|/**    * @return this node's properties    */
