...
block|{
DECL|field|JETTY_ID_COUNTER
specifier|private
specifier|static
specifier|final
name|AtomicLong
name|JETTY_ID_COUNTER
init|=
operator|new
name|AtomicLong
argument_list|()
...
expr_stmt|;
block|}
comment|/**    * Constructor taking an ordered list of additional (servlet holder -&gt; path spec) mappings    * to add to the servlet context    * @deprecated use {@link #JettySolrRunner(String,String,String,JettyConfig)}    */
annotation|@
name|Deprecated
DECL|method|JettySolrRunner
specifier|public
...
expr_stmt|;
block|}
comment|/**    * Construct a JettySolrRunner    *    * @param solrHome    the base path to run from    * @param jettyConfig the configuration    */
DECL|method|JettySolrRunner
specifier|public
name|JettySolrRunner
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Construct a JettySolrRunner    *    * @param solrHome            the base path to run from    * @param solrConfigFilename  the name of the solrconfig file to use    * @param schemaFileName      the name of the schema file to use    * @param jettyConfig         the configuration    */
DECL|method|JettySolrRunner
specifier|public
name|JettySolrRunner
parameter_list|(
