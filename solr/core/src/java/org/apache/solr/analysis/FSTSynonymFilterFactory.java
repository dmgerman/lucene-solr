...
begin_comment
comment|/**  * @deprecated (3.4) use {@link SynonymFilterFactory} instead. this is only a backwards compatibility  *                   mechanism that will be removed in Lucene 5.0  */
end_comment

begin_comment
comment|// NOTE: rename this to "SynonymFilterFactory" and nuke that delegator in Lucene 5.0!
end_comment

begin_class
annotation|@
name|Deprecated
DECL|class|FSTSynonymFilterFactory
specifier|final
class|class
