...
expr_stmt|;
block|}
comment|/** Creates a stored or un-stored LegacyFloatField with the provided value    *  and default<code>precisionStep</code> {@link    *  org.apache.solr.legacy.LegacyNumericUtils#PRECISION_STEP_DEFAULT_32} (8).    *  @param name field name    *  @param value 32-bit double value    *  @param stored Store.YES if the content should also be stored    *  @throws IllegalArgumentException if the field name is null.    */
...
expr_stmt|;
block|}
comment|/** Expert: allows you to customize the {@link    *  LegacyFieldType}.     *  @param name field name    *  @param value 32-bit float value    *  @param type customized field type: must have {@link LegacyFieldType#numericType()}    *         of {@link LegacyNumericType#FLOAT}.    *  @throws IllegalArgumentException if the field name or type is null, or    *          if the field type does not have a FLOAT numericType()    */
DECL|method|LegacyFloatField
specifier|public
name|LegacyFloatField
parameter_list|(
