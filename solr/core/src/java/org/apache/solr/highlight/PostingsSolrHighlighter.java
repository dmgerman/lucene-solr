...
begin_comment
comment|/**   * Highlighter impl that uses {@link PostingsHighlighter}  *<p>  * Example configuration:  *<pre class="prettyprint">  *&lt;searchComponent class="solr.HighlightComponent" name="highlight"&gt;  *&lt;highlighting class="org.apache.solr.highlight.PostingsSolrHighlighter"  *                      preTag="&amp;lt;em&amp;gt;"  *                      postTag="&amp;lt;/em&amp;gt;"  *                      ellipsis="... "  *                      maxLength=10000/&gt;  *&lt;/searchComponent&gt;  *</pre>  *<p>  * Notes:  *<ul>  *<li>fields to highlight must be configured with storeOffsetsWithPositions="true"  *<li>hl.fl specifies the field list.  *<li>hl.snippets specifies how many underlying sentence fragments form the resulting snippet.  *</ul>  *    * @lucene.experimental   */
end_comment
...
return|;
block|}
comment|/** Converts solr's DocList to a lucene TopDocs */
DECL|method|toTopDocs
specifier|protected
name|TopDocs
name|toTopDocs
parameter_list|(
