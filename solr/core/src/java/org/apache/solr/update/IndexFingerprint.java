...
name|info
argument_list|(
literal|"IndexFingerprint millis:{} result:{}"
argument_list|,
name|duration
argument_list|,
name|f
...
parameter_list|)
block|{
comment|// acc should have maxVersionSpecified already set in it using IndexFingerprint(long maxVersionSpecified) constructor
name|acc
operator|.
name|maxDoc
operator|=
