...
block|}
block|}
comment|/**    * Call the {@link SolrCoreAware#inform(SolrCore)} on all the applicable registered listeners.    */
DECL|method|informEventListeners
specifier|public
name|void
...
argument_list|)
decl_stmt|;
comment|// If this is a replica of type PULL, don't create the update log
name|boolean
name|skipUpdateLog
init|=
name|core
