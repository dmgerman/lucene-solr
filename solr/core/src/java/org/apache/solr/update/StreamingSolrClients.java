...
name|getInteger
argument_list|(
literal|"solr.cloud.replication.runners"
argument_list|,
literal|1
argument_list|)
decl_stmt|;
...
operator|=
operator|new
name|ErrorReportingConcurrentUpdateSolrClient
argument_list|(
name|url
argument_list|,
name|httpClient
...
return|;
block|}
DECL|class|ErrorReportingConcurrentUpdateSolrClient
class|class
name|ErrorReportingConcurrentUpdateSolrClient
extends|extends
name|ConcurrentUpdateSolrClient
...
name|req
decl_stmt|;
DECL|method|ErrorReportingConcurrentUpdateSolrClient
specifier|public
name|ErrorReportingConcurrentUpdateSolrClient
parameter_list|(
name|String
