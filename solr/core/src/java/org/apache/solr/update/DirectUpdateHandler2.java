...
condition|?
literal|". Perhaps the document has an indexed string field (solr.StrField) which is too large"
else|:
literal|""
operator|)
argument_list|,
...
return|;
block|}
DECL|method|allowDuplicateUpdate
specifier|private
name|void
name|allowDuplicateUpdate
parameter_list|(
...
init|)
block|{
comment|// We are reopening a searcher before applying the deletes to overcome LUCENE-7344.
comment|// Once LUCENE-7344 is resolved, we can consider removing this.
if|if
condition|(
name|ulog
operator|!=
...
literal|true
decl_stmt|;
comment|// TODO: make this a real config option or move it to TestInjection
