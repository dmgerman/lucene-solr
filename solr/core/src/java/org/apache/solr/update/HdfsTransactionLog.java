...
comment|// now the commit command is written we will never write to this log again
name|closeOutput
argument_list|()
expr_stmt|;
comment|//assert fos.size() == channel.size();
...
name|error
argument_list|(
literal|"Could not close tlog output"
argument_list|,
name|e
argument_list|)
expr_stmt|;
comment|// This situation is not fatal to the caller
block|}
block|}
DECL|method|doCloseOutput
specifier|private
name|void
name|doCloseOutput
parameter_list|()
...
block|}
block|}
DECL|class|HDFSSortedLogReader
specifier|public
class|class
name|HDFSSortedLogReader
extends|extends
...
name|iterator
decl_stmt|;
DECL|method|HDFSSortedLogReader
specifier|public
name|HDFSSortedLogReader
parameter_list|(
name|long
