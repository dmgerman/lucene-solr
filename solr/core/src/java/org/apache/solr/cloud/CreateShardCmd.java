...
argument_list|)
decl_stmt|;
comment|//    int repFactor = message.getInt(REPLICATION_FACTOR, collection.getInt(REPLICATION_FACTOR, 1));
name|int
name|numNrtReplicas
init|=
name|message
...
argument_list|)
decl_stmt|;
comment|//      String coreName = collectionName + "_" + sliceName + "_replica" + j;
name|log
operator|.
name|info
argument_list|(
literal|"Creating replica "
operator|+
name|coreName
operator|+
