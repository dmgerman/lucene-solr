...
argument_list|)
expr_stmt|;
comment|// we do this after the above super. call so that we don't
comment|// briefly think we are the leader and then end up not being
comment|// able to publish that we are the leader.
name|core
operator|.
name|getCoreDescriptor
argument_list|()
...
condition|)
block|{
comment|// a previous leader went down - wait for one less than the total
comment|// known shards
name|log
operator|.
name|info
argument_list|(
...
name|info
argument_list|(
literal|"I am Active and live, it's okay to be the leader."
argument_list|)
expr_stmt|;
return|return
literal|true
...
name|info
argument_list|(
literal|"I am not Active but no one else is either, it's okay to be the leader"
argument_list|)
expr_stmt|;
try|try
block|{
...
name|info
argument_list|(
literal|"I am not Active and someone else appears to be a better leader candidate."
argument_list|)
expr_stmt|;
block|}
return|return
