...
expr_stmt|;
empty_stmt|;
comment|//        String routerName = message.getStr(OverseerCollectionProcessor.ROUTER,DocRouter.DEFAULT_NAME);
name|DocRouter
name|router
init|=
name|DocRouter
...
argument_list|)
decl_stmt|;
comment|/*}         for (int i = 0; i< numShards; i++) {           final String sliceName = "shard" + (i+1);*/
name|Map
argument_list|<
name|String
argument_list|,
