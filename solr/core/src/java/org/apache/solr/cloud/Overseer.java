...
name|ShardLeaderListener
block|{
DECL|field|ASSIGNMENTS_NODE
specifier|public
specifier|static
specifier|final
name|String
name|ASSIGNMENTS_NODE
init|=
literal|"/node_assignments"
decl_stmt|;
...
name|info
argument_list|(
literal|"Constructing new Overseer"
argument_list|)
expr_stmt|;
name|this
operator|.
...
argument_list|)
expr_stmt|;
comment|//removes loeader for shard
block|}
block|}
...
name|SERVER_ERROR
argument_list|,
literal|"Interrupted while publishing new state"
argument_list|,
name|e
argument_list|)
throw|;
...
argument_list|)
expr_stmt|;
comment|// get fresh copy of the state
specifier|final
name|CloudState
name|state
init|=
...
condition|)
block|{
comment|// if same instance was returned no need to
comment|// update state
name|log
operator|.
name|info
argument_list|(
literal|"Announcing new leader: coll: "
operator|+
name|collection
operator|+
literal|" shard: "
...
name|warn
argument_list|(
literal|"Could not announce new leader coll:"
operator|+
name|collection
operator|+
literal|" shard:"
...
name|warn
argument_list|(
literal|"Could not promote new leader coll:"
operator|+
name|collection
operator|+
literal|" shard:"
