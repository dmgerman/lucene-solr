...
condition|)
block|{
comment|// TODO should we abort here?
name|log
operator|.
name|warn
argument_list|(
...
name|info
argument_list|(
literal|"Waiting for coreNodeName for core {} in collection {} to be assigned"
argument_list|,
name|descriptor
operator|.
name|getName
...
name|SERVER_ERROR
argument_list|,
literal|"Timed out getting coreNodeName for "
operator|+
name|descriptor
operator|.
name|getName
...
name|SERVER_ERROR
argument_list|,
literal|"Timed out getting shard id for core: "
operator|+
name|cd
operator|.
name|getName
