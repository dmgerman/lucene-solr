...
name|info
argument_list|(
literal|"SolrCore connected to ZooKeeper - we are "
operator|+
name|ourUrl
operator|+
...
name|nodeName
decl_stmt|;
comment|// we don't retry if there is a problem - count on ephem timeout
name|zkClient
operator|.
name|delete
argument_list|(
...
name|log
argument_list|,
literal|"Error trying to remove our ephem live node"
argument_list|,
name|e
argument_list|)
expr_stmt|;
