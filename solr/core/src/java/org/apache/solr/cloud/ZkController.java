...
block|}
name|String
name|zkCredentialProviderClass
init|=
name|cc
operator|.
name|getConfig
...
name|errMsg
init|=
literal|"Failed to persist resource at {0} - version mismatch"
decl_stmt|;
try|try
block|{
try|try
...
block|}
block|}
DECL|field|confDirectoryWatchers
specifier|private
name|Map
argument_list|<
name|String
...
parameter_list|()
block|{
comment|//running in a separate thread so that the zk event thread is not
comment|// unnecessarily held up
for|for
control|(
name|Runnable
name|listener
