...
name|warn
argument_list|(
literal|"Not enough nodes available to satisfy create collection request for collection:"
operator|+
name|collectionName
operator|+
literal|" nodes needed:"
operator|+
name|numNodes
operator|+
literal|" nodes available:"
operator|+
name|nodeList
operator|.
name|size
