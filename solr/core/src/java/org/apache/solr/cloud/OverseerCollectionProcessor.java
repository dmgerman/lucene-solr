...
name|info
argument_list|(
literal|" found an overseer designate to be promoted to the front : {}, pushing others back"
argument_list|,
name|s
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"Could not make the Overseer designate '{}' the frontrunner"
argument_list|,
name|newOverseerDesignate
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|invokeRejoinOverseer
specifier|private
name|void
name|invokeRejoinOverseer
parameter_list|(
