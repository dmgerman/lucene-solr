...
name|MS
decl_stmt|;
comment|/**    * This filter can limit what properties of a metric are returned.    */
DECL|interface|PropertyFilter
specifier|public
interface|interface
name|PropertyFilter
block|{
...
literal|true
decl_stmt|;
comment|/**      * Return only properties that match.      * @param name property name      * @return true if this property should be returned, false otherwise.      */
DECL|method|accept
name|boolean
name|accept
parameter_list|(
...
begin_comment
comment|/**    * Convert an instance of {@link AggregateMetric}.    * @param name metric name    * @param metric an instance of {@link AggregateMetric}    * @param propertyFilter limit what properties of a metric are returned    * @param skipAggregateValues discard internal values of {@link AggregateMetric}-s.    * @param simple use simplified representation for complex metrics - instead of a (name, map)    *             only the selected (name "." key, value) pairs will be produced.    * @param consumer consumer that accepts produced objects    */
end_comment
...
begin_comment
comment|/**    * Convert a {@link Counter}    * @param counter counter instance    * @param propertyFilter limit what properties of a metric are returned    * @param compact if true then only return {@link Counter#getCount()}. If false    *                then return a map with a "count" field.    */
end_comment
