...
return|;
block|}
comment|// Files.createDirectories has odd behavior if the path is a symlink and it already exists
comment|// _even if it's a symlink to a directory_.
comment|//
comment|// oddly, if the path to be created just contains a symlink in intermediate levels, Files.createDirectories
comment|// works just fine.
comment|//
comment|// This works around that issue
...
name|FileExistsException
argument_list|(
literal|"Tried to create a directory at to an existing non-directory symlink: "
operator|+
name|path
operator|.
name|toString
