...
name|info
argument_list|(
literal|"Basic Authentication enabled, user="
operator|+
name|user
argument_list|)
expr_stmt|;
...
literal|")\n"
operator|+
literal|"  -Dbasicauth=<user:pass> (sets Basic Authentication credentials)\n"
operator|+
...
name|warn
argument_list|(
literal|"An error occurred getting data from "
operator|+
name|url
operator|+
...
name|fatal
argument_list|(
literal|"POST failed with error "
operator|+
name|e
operator|.
name|getMessage
...
name|fatal
argument_list|(
literal|"Looks like Solr is secured and would not let us in. Try with another user in '-u' parameter"
argument_list|)
expr_stmt|;
block|}
block|}
...
name|BASIC_AUTH
operator|+
literal|"' must be of format user:pass"
argument_list|)
throw|;
block|}
name|urlc
...
name|GeneralSecurityException
argument_list|(
literal|"Solr requires authentication (response 401). Please try again with '-u' option"
argument_list|)
throw|;
block|}
if|if
...
name|GeneralSecurityException
argument_list|(
literal|"You are not authorized to perform this action against Solr. (response 403)"
argument_list|)
throw|;
block|}
return|return
