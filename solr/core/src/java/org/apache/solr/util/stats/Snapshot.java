...
begin_comment
comment|/**  * A statistical snapshot of a {@link Snapshot}.  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * Returns the value at the given quantile.    *    * @param quantile    a given quantile, in {@code [0..1]}    * @return the value in the distribution at {@code quantile}    */
...
DECL|method|get999thPercentile
specifier|public
name|double
