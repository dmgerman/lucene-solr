...
name|cleanupThread
decl_stmt|;
DECL|field|ramLowerWatermark
DECL|field|ramUpperWatermark
specifier|private
specifier|final
name|long
name|ramLowerWatermark
decl_stmt|,
name|ramUpperWatermark
decl_stmt|;
DECL|field|ramBytes
specifier|private
specifier|final
...
name|AssertionError
argument_list|(
literal|"ConcurrentLRUCache initialized with neither size limits nor ram limits"
argument_list|)
throw|;
block|}
block|}
...
block|}
block|}
comment|/*     Must be called after acquiring markAndSweeoLock    */
DECL|method|markAndSweepByRamSize
specifier|private
name|void
name|markAndSweepByRamSize
parameter_list|()
...
name|lastAccessed
expr_stmt|;
comment|// important because we want to avoid volatile read during comparisons
name|entriesInAccessOrder
operator|.
name|add
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// newer access is smaller, older access is bigger
comment|// iterate in oldest to newest order
for|for
control|(
name|int
name|i
...
block|}
comment|/*     Must be called after acquiring markAndSweeoLock    */
DECL|method|markAndSweepByCacheSize
specifier|private
name|void
name|markAndSweepByCacheSize
parameter_list|()
