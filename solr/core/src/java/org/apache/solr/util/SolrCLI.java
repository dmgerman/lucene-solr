...
name|Exception
function_decl|;
comment|// It's a little awkward putting this in ToolBase, but to re-use it in upconfig and create, _and_ have access
comment|// to the (possibly) redirected "stdout", it needs to go here unless we reorganize things a bit.
