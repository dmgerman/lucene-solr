...
name|withDescription
argument_list|(
literal|"Name of the configuration for this collection; default is "
operator|+
name|DEFAULT_CONFIG_SET
argument_list|)
operator|.
...
argument_list|)
decl_stmt|;
comment|// first, test to see if that config exists in ZK
if|if
condition|(
operator|!
name|cloudSolrServer
...
name|println
argument_list|(
literal|"Creating new collection '"
operator|+
name|collectionName
operator|+
...
name|withDescription
argument_list|(
literal|"Name of the configuration for this core; default is "
operator|+
name|DEFAULT_CONFIG_SET
argument_list|)
operator|.
