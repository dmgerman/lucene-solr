...
name|withDescription
argument_list|(
literal|"Asserts that Solr is NOT started on a certain URL"
argument_list|)
operator|.
name|withLongOpt
argument_list|(
...
name|withDescription
argument_list|(
literal|"Asserts that Solr is started on a certain URL"
argument_list|)
operator|.
name|withLongOpt
argument_list|(
...
expr_stmt|;
block|}
comment|// Custom run method which may return exit code
...
name|exitOrException
argument_list|(
literal|"Solr is running on url "
operator|+
name|url
argument_list|)
return|;
