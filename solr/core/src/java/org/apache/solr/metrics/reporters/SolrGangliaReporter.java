...
begin_class
DECL|class|SolrGangliaReporter
specifier|public
class|class
...
literal|null
decl_stmt|;
comment|/**    * Create a Ganglia reporter for metrics managed in a named registry.    *    * @param metricManager metric manager instance that manages the selected registry    * @param registryName  registry to use, one of registries managed by    *                      {@link SolrMetricManager}    */
DECL|method|SolrGangliaReporter
specifier|public
name|SolrGangliaReporter
parameter_list|(
name|SolrMetricManager
...
expr_stmt|;
block|}
comment|// due to vagaries of SolrPluginUtils.invokeSetters we need this too
DECL|method|setFilter
specifier|public
name|void
name|setFilter
...
expr_stmt|;
block|}
comment|// only for unit tests!
DECL|method|setTesting
specifier|public
name|void
name|setTesting
parameter_list|(
...
name|IllegalStateException
argument_list|(
literal|"Init argument 'host' must be set to a valid Ganglia server name."
argument_list|)
throw|;
block|}
if|if
...
name|IllegalStateException
argument_list|(
literal|"Init argument 'port' must be set to a valid Ganglia server port."
argument_list|)
throw|;
block|}
if|if
