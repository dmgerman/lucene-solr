...
expr_stmt|;
comment|// all metrics
comment|// XXX anything interesting here?
comment|//add(new SolrReporter.Specification(OVERSEER_GROUP, "node", SolrMetricManager.overridableRegistryName(SolrInfoMBean.Group.node.toString()),
comment|//    Collections.emptySet())); // all metrics
name|add
argument_list|(
operator|new
name|SolrReporter
