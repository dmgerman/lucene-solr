...
init|=
literal|"org.apache.solr.security.kerberosplugin.requestcontinues"
decl_stmt|;
...
decl_stmt|;
comment|// allows test to specify an alternate auth handler
annotation|@
name|VisibleForTesting
DECL|field|AUTH_HANDLER_PARAM
specifier|public
specifier|static
specifier|final
name|String
...
init|=
literal|"solr.kerberos.auth.handler"
decl_stmt|;
...
block|{
comment|// allow tests which specify AUTH_HANDLER_PARAM to avoid specifying kerberos principal/keytab
