...
begin_comment
comment|/**  * This is an authentication filter based on Hadoop's {@link DelegationTokenAuthenticationFilter}.  */
end_comment

begin_class
DECL|class|HadoopAuthFilter
specifier|public
class|class
...
name|DelegationTokenAuthenticationFilter
block|{
comment|/**    * This property defines the configuration parameter storing the Solr zookeeper client ref    * in the servlet filter config.    */
