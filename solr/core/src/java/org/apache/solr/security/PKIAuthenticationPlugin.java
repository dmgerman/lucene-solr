...
name|url
operator|=
name|getBaseUrlForNodeNameLocal
argument_list|(
name|nodename
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|getBaseUrlForNodeNameLocal
specifier|protected
name|String
name|getBaseUrlForNodeNameLocal
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// TODO: Find a better way of resolving urlScheme when not using ZK?
name|String
name|urlScheme
init|=
name|resolveUrlScheme
argument_list|()
decl_stmt|;
return|return
name|urlScheme
...
block|}
block|}
comment|/**    * Resolve urlScheme first from sysProp "urlScheme", if not set or invalid value, peek at ssl sysProps    * @return "https" if SSL is enabled, else "http"    */
DECL|method|resolveUrlScheme
specifier|protected
specifier|static
name|String
name|resolveUrlScheme
