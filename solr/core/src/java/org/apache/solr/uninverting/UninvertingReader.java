...
name|DOUBLE_POINT
block|,
comment|/**       * Single-valued Integer, (e.g. indexed with {@link org.apache.solr.legacy.LegacyIntField})      *<p>      * Fields with this type act as if they were indexed with      * {@link NumericDocValuesField}.      * @deprecated Index with points and use {@link #INTEGER_POINT} instead.      */
...
name|LEGACY_INTEGER
block|,
comment|/**       * Single-valued Long, (e.g. indexed with {@link org.apache.solr.legacy.LegacyLongField})      *<p>      * Fields with this type act as if they were indexed with      * {@link NumericDocValuesField}.      * @deprecated Index with points and use {@link #LONG_POINT} instead.      */
DECL|enum constant|Deprecated
annotation|@
name|Deprecated
...
name|LEGACY_LONG
block|,
comment|/**       * Single-valued Float, (e.g. indexed with {@link org.apache.solr.legacy.LegacyFloatField})      *<p>      * Fields with this type act as if they were indexed with      * {@link NumericDocValuesField}.      * @deprecated Index with points and use {@link #FLOAT_POINT} instead.      */
DECL|enum constant|Deprecated
annotation|@
name|Deprecated
...
name|LEGACY_FLOAT
block|,
comment|/**       * Single-valued Double, (e.g. indexed with {@link org.apache.solr.legacy.LegacyDoubleField})      *<p>      * Fields with this type act as if they were indexed with      * {@link NumericDocValuesField}.      * @deprecated Index with points and use {@link #DOUBLE_POINT} instead.      */
DECL|enum constant|Deprecated
annotation|@
name|Deprecated
...
block|,
comment|/**       * Multi-valued Integer, (e.g. indexed with {@link org.apache.solr.legacy.LegacyIntField})      *<p>      * Fields with this type act as if they were indexed with      * {@link SortedSetDocValuesField}.      */
DECL|enum constant|SORTED_SET_INTEGER
name|SORTED_SET_INTEGER
block|,
comment|/**       * Multi-valued Float, (e.g. indexed with {@link org.apache.solr.legacy.LegacyFloatField})      *<p>      * Fields with this type act as if they were indexed with      * {@link SortedSetDocValuesField}.      */
DECL|enum constant|SORTED_SET_FLOAT
name|SORTED_SET_FLOAT
block|,
comment|/**       * Multi-valued Long, (e.g. indexed with {@link org.apache.solr.legacy.LegacyLongField})      *<p>      * Fields with this type act as if they were indexed with      * {@link SortedSetDocValuesField}.      */
DECL|enum constant|SORTED_SET_LONG
name|SORTED_SET_LONG
block|,
comment|/**       * Multi-valued Double, (e.g. indexed with {@link org.apache.solr.legacy.LegacyDoubleField})      *<p>      * Fields with this type act as if they were indexed with      * {@link SortedSetDocValuesField}.      */
DECL|enum constant|SORTED_SET_DOUBLE
name|SORTED_SET_DOUBLE
block|}
comment|/**    *     * Wraps a provided DirectoryReader. Note that for convenience, the returned reader    * can be used normally (e.g. passed to {@link DirectoryReader#openIfChanged(DirectoryReader)})    * and so on.     *     * @param in input directory reader    * @param perSegmentMapper function to map a segment reader to a mapping of fields to their uninversion type    * @return a wrapped directory reader    */
DECL|method|wrap
specifier|public
specifier|static
name|DirectoryReader
...
name|fieldInfos
decl_stmt|;
comment|/**     * Create a new UninvertingReader with the specified mapping     *<p>    * Expert: This should almost never be used. Use {@link #wrap(DirectoryReader, Function)}    * instead.    *      * @lucene.internal    */
