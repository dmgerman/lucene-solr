...
function_decl|;
block|}
comment|/**    * Base class for points parsers. These parsers do not use the inverted index, but instead    * uninvert point data.    *     * This abstraction can be cleaned up when Parser.termsEnum is removed.    */
DECL|class|PointParser
specifier|public
specifier|abstract
class|class
name|PointParser
...
argument_list|(
literal|"makes no sense for parsing points"
argument_list|)
throw|;
block|}
block|}
...
argument_list|()
decl_stmt|;
comment|/**    * A parser instance for int values encoded by {@link org.apache.lucene.util.NumericUtils}, e.g. when indexed    * via {@link org.apache.lucene.document.IntPoint}.    */
DECL|field|INT_POINT_PARSER
specifier|public
specifier|static
specifier|final
name|Parser
...
argument_list|()
operator|+
literal|".INT_POINT_PARSER"
return|;
block|}
block|}
decl_stmt|;
comment|/**    * A parser instance for long values encoded by {@link org.apache.lucene.util.NumericUtils}, e.g. when indexed    * via {@link org.apache.lucene.document.LongPoint}.    */
DECL|field|LONG_POINT_PARSER
specifier|public
specifier|static
specifier|final
name|Parser
...
argument_list|()
operator|+
literal|".LONG_POINT_PARSER"
return|;
block|}
block|}
decl_stmt|;
comment|/**    * A parser instance for float values encoded by {@link org.apache.lucene.util.NumericUtils}, e.g. when indexed    * via {@link org.apache.lucene.document.FloatPoint}.    */
DECL|field|FLOAT_POINT_PARSER
specifier|public
specifier|static
specifier|final
name|Parser
...
argument_list|()
operator|+
literal|".FLOAT_POINT_PARSER"
return|;
block|}
block|}
decl_stmt|;
comment|/**    * A parser instance for double values encoded by {@link org.apache.lucene.util.NumericUtils}, e.g. when indexed    * via {@link org.apache.lucene.document.DoublePoint}.    */
DECL|field|DOUBLE_POINT_PARSER
specifier|public
specifier|static
specifier|final
name|Parser
...
block|}
decl_stmt|;
comment|/** Checks the internal cache for an appropriate entry, and if none is found,    *  reads the terms/points in<code>field</code> and returns a bit set at the size of    *<code>reader.maxDoc()</code>, with turned on bits for each docid that     *  does have a value for this field.    *  @param parser May be {@code null} if coming from the inverted index, otherwise    *                can be a {@link PointParser} to compute from point values.    */
