...
name|info
argument_list|(
literal|"[{}] Added {} libs to classloader, from paths: {}"
argument_list|,
name|getCoreName
argument_list|(
literal|"null"
...
return|;
block|}
comment|// Logs a message only once per startup
DECL|method|logOnceInfo
specifier|private
specifier|static
name|void
name|logOnceInfo
