...
name|getBool
argument_list|(
literal|"peerSync/useRangeVersions"
argument_list|,
literal|true
argument_list|)
expr_stmt|;
...
name|warn
argument_list|(
literal|"solrconfig.xml:<jmx> is no longer supported, use solr.xml:/metrics/reporter section instead"
argument_list|)
expr_stmt|;
block|}
...
name|enableLazyFieldLoading
decl_stmt|;
DECL|field|useRangeVersionsForPeerSync
specifier|public
specifier|final
name|boolean
name|useRangeVersionsForPeerSync
