...
try|try
block|{
comment|// ConfigSet properties are loaded from ConfigSetProperties.DEFAULT_FILENAME file.
comment|// ConfigSet flags are loaded from the metadata of the ZK node of the configset.
name|NamedList
name|properties
init|=
