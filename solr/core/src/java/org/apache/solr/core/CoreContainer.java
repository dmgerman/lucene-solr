...
argument_list|)
expr_stmt|;
comment|// initialize gauges for reporting the number of cores
name|Gauge
argument_list|<
name|Integer
argument_list|>
...
begin_comment
comment|// Builds a node name to be used with PKIAuth.
end_comment

begin_function
DECL|method|getNodeNameLocal
specifier|private
name|String
name|getNodeNameLocal
parameter_list|()
