...
return|;
block|}
comment|/**    * Create a new CoreDescriptor with a given name and instancedir    * @param name          the CoreDescriptor's name    * @param instanceDir   the CoreDescriptor's instancedir    * @param containerProperties the enclosing container properties for variable resolution    * @param isZooKeeperAware whether we are part of SolrCloud or not.     */
DECL|method|CoreDescriptor
specifier|public
name|CoreDescriptor
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Create a new CoreDescriptor.    * @param name            the CoreDescriptor's name    * @param instanceDir     a Path resolving to the instanceDir    * @param coreProps       a Map of the properties for this core    * @param containerProperties the properties from the enclosing container.    * @param isZooKeeperAware if true, we ar in SolrCloud mode.    */
DECL|method|CoreDescriptor
specifier|public
name|CoreDescriptor
parameter_list|(
