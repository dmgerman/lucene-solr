...
decl_stmt|;
comment|// May be set by sub classes as data root, in which case getDataHome will use it as base
DECL|field|dataHomePath
specifier|protected
name|Path
name|dataHomePath
decl_stmt|;
...
return|;
block|}
comment|/**    * Get the data home folder. If solr.data.home is set, that is used, else base on instanceDir    * @param cd core descriptor instance    * @return a String with absolute path to data direcotry    */
...
name|info
argument_list|(
literal|"Will not remove most recent old directory after reload {}"
argument_list|,
name|oldIndexDirs
index|[
literal|0
...
return|;
block|}
comment|/**    * Create a new DirectoryFactory instance from the given SolrConfig and tied to the specified core container.    */
DECL|method|loadDirectoryFactory
specifier|static
name|DirectoryFactory
