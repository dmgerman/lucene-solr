...
argument_list|(
name|getTransientCoreCacheFactoryPluginInfo
argument_list|(
name|config
argument_list|)
argument_list|)
...
argument_list|(
name|getBackupRepositoryPluginInfos
argument_list|(
name|config
argument_list|)
argument_list|)
...
break|break;
case|case
literal|"createCollectionWaitTimeTillActive"
case|:
name|builder
operator|.
...
break|break;
case|case
literal|"createCollectionCheckLeaderActive"
case|:
name|builder
operator|.
...
return|;
block|}
DECL|method|getBackupRepositoryPluginInfos
specifier|private
specifier|static
name|PluginInfo
index|[]
...
name|evaluate
argument_list|(
literal|"solr/backup/repository"
argument_list|,
name|XPathConstants
operator|.
name|NODESET
...
argument_list|)
argument_list|,
literal|"BackupRepositoryFactory"
argument_list|,
literal|true
argument_list|,
literal|true
...
name|getNode
argument_list|(
literal|"solr/metrics/suppliers/counter"
argument_list|,
literal|false
argument_list|)
decl_stmt|;
...
name|getNode
argument_list|(
literal|"solr/metrics/suppliers/meter"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|getNode
argument_list|(
literal|"solr/metrics/suppliers/timer"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|getNode
argument_list|(
literal|"solr/metrics/suppliers/histogram"
argument_list|,
literal|false
argument_list|)
expr_stmt|;
...
name|PluginInfo
index|[]
name|reporterPlugins
init|=
name|getMetricReporterPluginInfos
argument_list|(
name|config
argument_list|)
decl_stmt|;
...
return|;
block|}
DECL|method|getMetricReporterPluginInfos
specifier|private
specifier|static
name|PluginInfo
index|[]
...
block|}
block|}
comment|// if there's an MBean server running but there was no JMX reporter then add a default one
name|MBeanServer
name|mBeanServer
init|=
name|JmxUtil
...
name|info
argument_list|(
literal|"MBean server found: "
operator|+
name|mBeanServer
operator|+
literal|", but no JMX reporters were configured - adding default JMX reporter."
argument_list|)
expr_stmt|;
name|Map
argument_list|<
...
name|evaluate
argument_list|(
literal|"solr/metrics/hiddenSysProps/str"
argument_list|,
name|XPathConstants
operator|.
name|NODESET
...
block|}
block|}
DECL|method|getTransientCoreCacheFactoryPluginInfo
specifier|private
specifier|static
name|PluginInfo
name|getTransientCoreCacheFactoryPluginInfo
...
name|getNode
argument_list|(
literal|"solr/transientCoreCacheFactory"
argument_list|,
literal|false
argument_list|)
decl_stmt|;
...
name|node
argument_list|,
literal|"transientCoreCacheFactory"
argument_list|,
literal|false
argument_list|,
literal|true
