...
decl_stmt|;
DECL|field|createCollectionWaitTimeTillActive
specifier|private
specifier|final
name|int
name|createCollectionWaitTimeTillActive
decl_stmt|;
DECL|field|createCollectionCheckLeaderActive
specifier|private
specifier|final
name|boolean
name|createCollectionCheckLeaderActive
decl_stmt|;
...
return|;
block|}
DECL|method|getCreateCollectionWaitTimeTillActive
specifier|public
name|int
...
return|;
block|}
DECL|method|isCreateCollectionCheckLeaderActive
specifier|public
name|boolean
...
literal|180000
decl_stmt|;
DECL|field|DEFAULT_CREATE_COLLECTION_ACTIVE_WAIT
specifier|private
specifier|static
specifier|final
name|int
name|DEFAULT_CREATE_COLLECTION_ACTIVE_WAIT
init|=
literal|30
decl_stmt|;
comment|// 30 seconds
DECL|field|DEFAULT_CREATE_COLLECTION_CHECK_LEADER_ACTIVE
specifier|private
specifier|static
specifier|final
name|boolean
name|DEFAULT_CREATE_COLLECTION_CHECK_LEADER_ACTIVE
init|=
literal|false
decl_stmt|;
...
return|;
block|}
DECL|method|setCreateCollectionWaitTimeTillActive
specifier|public
name|CloudConfigBuilder
name|setCreateCollectionWaitTimeTillActive
parameter_list|(
name|int
name|createCollectionWaitTimeTillActive
parameter_list|)
...
return|;
block|}
DECL|method|setCreateCollectionCheckLeaderActive
specifier|public
name|CloudConfigBuilder
name|setCreateCollectionCheckLeaderActive
parameter_list|(
name|boolean
name|createCollectionCheckLeaderActive
parameter_list|)
