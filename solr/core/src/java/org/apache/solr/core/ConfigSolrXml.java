...
argument_list|)
expr_stmt|;
comment|// These have no counterpart in 5.0, asking for any o fthese in Solr 5.0 will result in an error being
comment|// thrown.
name|insureFail
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// find the core with this datadir and remove it
name|List
argument_list|<
name|String
argument_list|>
...
condition|)
block|{
comment|// Record that the first core is also a bad core.
name|badCores
operator|.
name|put
argument_list|(
