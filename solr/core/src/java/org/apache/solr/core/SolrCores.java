...
argument_list|)
expr_stmt|;
comment|//addCoreProperty(coreAttribs, loader, node, CoreDescriptor.CORE_INSTDIR, dcore.getRawInstanceDir(), null);
name|addCoreProperty
argument_list|(
name|coreAttribs
argument_list|,
