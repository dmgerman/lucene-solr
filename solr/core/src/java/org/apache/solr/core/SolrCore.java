...
return|;
block|}
comment|/**    * Creates a new core and register it in the list of cores.    * If a core with the same name already exists, it will be stopped and replaced by this one.    *    * @param dataDir the index directory    * @param config a solr config instance    * @param schema a solr schema instance    *    * @since solr 1.3    * @deprecated will be removed in the next release    */
...
expr_stmt|;
block|}
comment|/**    * Creates a new core that is to be loaded lazily. i.e. lazyLoad="true" in solr.xml    *     * @since solr 4.1    * @deprecated will be removed in the next release    */
DECL|method|SolrCore
specifier|public
name|SolrCore
parameter_list|(
