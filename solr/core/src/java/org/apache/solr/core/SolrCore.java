...
name|SAXException
block|{
comment|// TODO - null descriptor and what if indexwriter settings have changed
name|SolrResourceLoader
name|solrLoader
init|=
operator|new
...
expr_stmt|;
block|}
comment|/**    * Creates a new core and register it in the list of cores.    * If a core with the same name already exists, it will be stopped and replaced by this one.    *     * @param name    * @param dataDir the index directory    * @param config a solr config instance    * @param schema a solr schema instance    * @param cd    *     * @since solr 1.3    */
DECL|method|SolrCore
specifier|public
name|SolrCore
parameter_list|(
