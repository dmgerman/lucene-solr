...
argument_list|)
expr_stmt|;
comment|// Allow the directory factory to register MBeans as well
for|for
control|(
name|SolrInfoMBean
name|bean
...
name|debug
argument_list|(
literal|"Registering JMX bean [{}] from directory factory."
argument_list|,
name|bean
operator|.
name|getName
...
argument_list|)
expr_stmt|;
comment|// Not worried about concurrency, so no reason to use putIfAbsent
if|if
condition|(
name|infoRegistry
operator|.
