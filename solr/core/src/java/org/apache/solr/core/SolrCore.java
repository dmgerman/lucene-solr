...
name|SAXException
block|{
comment|// TODO - what if indexwriter settings have changed
name|SolrConfig
name|config
init|=
operator|new
...
block|{
comment|// make sure we use the default if nothing is configured
name|cp
operator|=
name|CodecProvider
operator|.
...
argument_list|)
expr_stmt|;
comment|// verbose("added searcher ",newSearchHolder.get()," to _searchers");
if|if
condition|(
name|_searcher
operator|==
