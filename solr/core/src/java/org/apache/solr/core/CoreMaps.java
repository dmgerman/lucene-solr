...
comment|// addPersistOneCore(cfg, container.loader, core.getCoreDescriptor(), getCoreToOrigName(core));
name|core
operator|.
name|close
argument_list|()
...
parameter_list|)
block|{
comment|// Have to check
comment|// loaded cores
comment|// transient cores
comment|// dynamic cores
synchronized|synchronized
init|(
name|locker
init|)
