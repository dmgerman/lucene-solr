...
block|}
block|}
comment|/**    * Check if any of the mentioned names are missing. If yes, return the Set of missing names    */
DECL|method|checkContains
specifier|public
name|Set
argument_list|<
name|String
...
name|SERVER_ERROR
argument_list|,
literal|"this should not happen, looking up for v2 API at the wrong place"
argument_list|)
throw|;
block|}
return|return
