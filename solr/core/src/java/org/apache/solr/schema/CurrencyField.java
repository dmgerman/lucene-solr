...
init|=
literal|"org.apache.solr.schema.FileExchangeRateProvider"
decl_stmt|;
...
literal|"_currency"
decl_stmt|;
DECL|field|FIELD_TYPE_CURRENCY
specifier|protected
specifier|static
specifier|final
name|String
name|FIELD_TYPE_CURRENCY
init|=
literal|"string"
decl_stmt|;
DECL|field|FIELD_TYPE_AMOUNT_RAW
specifier|protected
specifier|static
specifier|final
name|String
name|FIELD_TYPE_AMOUNT_RAW
init|=
literal|"tlong"
decl_stmt|;
DECL|field|schema
...
try|try
block|{
comment|// TODO: Are we using correct classloader?
name|Class
argument_list|<
name|?
argument_list|>
...
name|BAD_REQUEST
argument_list|,
literal|"exchangeRateProvider "
operator|+
name|exchangeRateProviderClass
operator|+
literal|" needs to implement ExchangeRateProvider"
argument_list|)
throw|;
block|}
block|}
...
parameter_list|)
block|{
comment|// TODO: Should we allow configurable field-types or in another way not be dependent on static type names types in schema?
name|createDynamicCurrencyField
argument_list|(
name|FIELD_SUFFIX_CURRENCY
argument_list|,
...
return|;
block|}
DECL|class|CurrencyValueSource
class|class
name|CurrencyValueSource
extends|extends
name|ValueSource
...
name|sf
decl_stmt|;
DECL|method|CurrencyValueSource
specifier|public
name|CurrencyValueSource
parameter_list|(
name|SchemaField
...
name|BAD_REQUEST
argument_list|,
literal|"Could not find from currency specified in exchange rate: "
operator|+
name|rateNode
argument_list|)
throw|;
