...
specifier|final
name|String
name|OLD_SPATIAL4J_PREFIX
init|=
literal|"com.spatial4j.core"
decl_stmt|;
specifier|final
name|String
name|NEW_SPATIAL4J_PREFIX
init|=
literal|"org.locationtech.spatial4j"
decl_stmt|;
for|for
control|(
name|Map
...
control|)
block|{
comment|// "JTS" is a convenience alias
if|if
condition|(
name|argEntry
operator|.
...
continue|continue;
block|}
comment|// Warn about using old Spatial4j class names
if|if
condition|(
name|argEntry
operator|.
...
argument_list|)
throw|;
comment|// If the first char is promising, try to parse with SpatialUtils.parsePoint
name|char
name|firstChar
init|=
name|str
...
name|msg
init|=
literal|"Unable to parse shape given formats"
operator|+
literal|" \"lat,lon\", \"x y\" or as "
operator|+
name|shapeReader
operator|.
name|getFormatName
