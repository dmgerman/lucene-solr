...
literal|null
return|;
comment|/*org.apache.lucene.document.FieldType newType = new org.apache.lucene.document.FieldType();       newType.setTokenized(field.isTokenized());       newType.setStored(field.stored());       newType.setOmitNorms(field.omitNorms());       newType.setIndexOptions(field.indexed() ? getIndexOptions(field, val) : IndexOptions.NONE);       newType.setStoreTermVectors(field.storeTermVector());       newType.setStoreTermVectorOffsets(field.storeTermOffsets());       newType.setStoreTermVectorPositions(field.storeTermPositions());       newType.setStoreTermVectorPayloads(field.storeTermPayloads());*/
return|return
name|createField
argument_list|(
name|field
...
decl_stmt|;
DECL|field|ENABLE_GRAPH_QUERIES
specifier|protected
specifier|static
specifier|final
name|String
name|ENABLE_GRAPH_QUERIES
init|=
literal|"enableGraphQueries"
decl_stmt|;
DECL|field|ARGS
specifier|private
specifier|static
