...
name|BAD_REQUEST
argument_list|,
literal|"can not sort on a field w/o docValues unless it is indexed and supports Uninversion: "
operator|+
name|getName
argument_list|()
argument_list|)
...
name|BAD_REQUEST
argument_list|,
literal|"can not use FieldCache on a field w/o docValues unless it is indexed and supports Uninversion: "
operator|+
name|getName
argument_list|()
argument_list|)
