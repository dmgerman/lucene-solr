...
argument_list|)
expr_stmt|;
comment|// looks good for the add, notify ResoureLoaderAware objects
for|for
control|(
name|FieldType
name|fieldType
...
argument_list|()
decl_stmt|;
comment|// create a unified collection of field types from zk and in the local
name|newSchema
operator|.
name|mergeFieldTypesFromZk
argument_list|(
name|document
argument_list|,
name|xpath
...
expr_stmt|;
block|}
comment|// notify analyzers and other objects for our fieldTypes
for|for
control|(
name|FieldType
name|fieldType
...
return|;
block|}
comment|/**    * Loads FieldType objects defined in the schema.xml document.    *    * @param document Schema XML document where field types are defined.    * @param xpath Used for evaluating xpath expressions to find field types defined in the schema.xml.    * @throws javax.xml.xpath.XPathExpressionException if an error occurs when finding field type elements in the document.    */
DECL|method|mergeFieldTypesFromZk
specifier|protected
