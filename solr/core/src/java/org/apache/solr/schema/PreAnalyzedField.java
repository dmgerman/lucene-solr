...
argument_list|)
expr_stmt|;
comment|// TODO: why can't I lookup the OffsetAttribute up in ctor instead?
name|lastEndOffset
operator|=
name|addAttribute
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// we must set the end offset correctly so multi-valued fields don't try to send offsets backwards:
name|addAttribute
argument_list|(
name|OffsetAttribute
operator|.
