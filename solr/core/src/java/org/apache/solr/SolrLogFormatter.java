...
name|url
decl_stmt|;
DECL|field|coreState
name|CoreState
name|coreState
decl_stmt|;
comment|// should be fine to keep a hard reference to this
comment|// CloudState cloudState;  // should be fine to keep this hard reference since cloudstate is immutable and doesn't have pointers to anything heavyweight (like SolrCore, CoreContainer, etc)
block|}
...
expr_stmt|;
block|}
comment|// look to see if local core state changed
name|CoreState
name|coreState
init|=
name|zkController
