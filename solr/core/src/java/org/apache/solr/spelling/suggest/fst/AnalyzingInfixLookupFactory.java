...
decl_stmt|;
comment|/**     * Boolean clause matching option for multiple terms     * Default is true - all terms required.     */
DECL|field|ALL_TERMS_REQUIRED
specifier|protected
specifier|static
specifier|final
name|String
...
decl_stmt|;
comment|/** Highlight suggest terms  - default is true. */
