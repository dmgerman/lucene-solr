...
literal|1
decl_stmt|;
DECL|field|permittedLoadBalancerRequestsMinimumAbsolute
name|int
name|permittedLoadBalancerRequestsMinimumAbsolute
init|=
literal|0
decl_stmt|;
DECL|field|permittedLoadBalancerRequestsMaximumFraction
name|float
...
literal|"sizeOfQueue"
decl_stmt|;
comment|// The minimum number of replicas that may be used
...
init|=
literal|"loadBalancerRequestsMinimumAbsolute"
decl_stmt|;
comment|// The maximum proportion of replicas to be used
...
init|=
literal|"loadBalancerRequestsMaximumFraction"
decl_stmt|;
...
return|;
block|}
DECL|method|newLBHttpSolrClientReq
specifier|protected
name|LBHttpSolrClient
operator|.
name|Req
