...
argument_list|)
decl_stmt|;
DECL|field|bootstrapInProgress
specifier|private
specifier|final
name|AtomicBoolean
name|bootstrapInProgress
init|=
operator|new
name|AtomicBoolean
argument_list|(
...
return|;
block|}
comment|/**    * @return true if a bootstrap operation is in progress, false otherwise    */
DECL|method|isBootstrapInProgress
name|boolean
...
return|;
block|}
DECL|method|setBootstrapInProgress
name|void
...
expr_stmt|;
block|}
DECL|method|getNumBootstraps
specifier|public
name|int
name|getNumBootstraps
parameter_list|()
block|{
return|return
name|numBootstraps
