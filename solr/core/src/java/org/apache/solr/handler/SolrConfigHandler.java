...
argument_list|)
expr_stmt|;
comment|//SolrParams.wrapDefaults(maskUseParams, req.getParams())
name|MapSolrParams
name|mask
init|=
operator|new
...
argument_list|,
literal|"core.config.Params"
argument_list|,
literal|"core.config.Params.Commands"
argument_list|)
return|;
block|}
annotation|@
