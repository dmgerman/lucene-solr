...
condition|)
block|{
comment|// missing is always a candidate for refinement if at least one shard met the minimum
name|PivotFacetValue
name|missing
init|=
name|valueCollection
...
operator|||
operator|(
comment|// 'missing' value isn't affected by limit, needs refined if shard didn't provide
literal|null
operator|==
name|value
operator|.
