...
argument_list|()
decl_stmt|;
comment|//the terms parameter is also used by json facet API. So we will get errors if we try to parse as boolean
if|if
condition|(
name|params
operator|.
...
condition|)
block|{
comment|//Always use lexical sort when TERM_LIST is provided
name|sort
operator|=
literal|false
expr_stmt|;
...
argument_list|()
decl_stmt|;
comment|// Since splitTerms is already sorted, this array will also be sorted
name|Term
index|[]
name|terms
init|=
