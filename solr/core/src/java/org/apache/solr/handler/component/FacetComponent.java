...
literal|"="
decl_stmt|;
comment|/**    * incrememented counter used to track the values being refined in a given request.      * This counter is used in conjunction with {@link PivotFacet#REFINE_PARAM} to identify    * which refinement values are associated with which pivots    */
...
block|}
name|boolean
name|pivotFacetRefinementRequestsExistForShard
init|=
...
condition|)
block|{
comment|// nothing to refine, short circuit out
continue|continue;
block|}
name|String
name|shard
...
comment|// If nshards becomes to great, we way want to move to hashing for
