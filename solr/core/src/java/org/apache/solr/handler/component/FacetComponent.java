...
block|}
block|}
comment|/* Custom facet components can return a custom SimpleFacets object */
DECL|method|newSimpleFacets
specifier|protected
name|SimpleFacets
name|newSimpleFacets
parameter_list|(
name|SolrQueryRequest
name|req
parameter_list|,
...
condition|)
block|{
comment|// cap facet count by 1 with this method
name|ff
operator|=
operator|new
name|DistribFacetExistsField
argument_list|(
name|rb
argument_list|,
name|field
...
block|}
block|}
DECL|class|DistribFacetExistsField
specifier|private
specifier|static
specifier|final
class|class
...
name|DistribFieldFacet
block|{
DECL|method|DistribFacetExistsField
specifier|private
name|DistribFacetExistsField
parameter_list|(
name|ResponseBuilder
