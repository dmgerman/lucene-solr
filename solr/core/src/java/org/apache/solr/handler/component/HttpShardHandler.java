...
name|ShardHandler
block|{
comment|/**    * If the request context map has an entry with this key and Boolean.TRUE as value,    * {@link #prepDistributed(ResponseBuilder)} will only include {@link org.apache.solr.common.cloud.Replica.Type#NRT} replicas as possible    * destination of the distributed request (or a leader replica of type {@link org.apache.solr.common.cloud.Replica.Type#TLOG}). This is used     * by the RealtimeGet handler, since other types of replicas shouldn't respond to RTG requests    */
DECL|field|ONLY_NRT_REPLICAS
specifier|public
specifier|static
name|String
name|ONLY_NRT_REPLICAS
init|=
literal|"distribOnlyRealtime"
decl_stmt|;
...
argument_list|()
decl_stmt|;
comment|// Some requests may only be fulfilled by replicas of type Replica.Type.NRT
name|boolean
name|onlyNrtReplicas
init|=
name|Boolean
operator|.
name|TRUE
...
argument_list|)
expr_stmt|;
comment|// And now recreate the | delimited list of equivalent servers
name|rb
operator|.
name|shards
index|[
...
name|debug
argument_list|(
literal|"Exception finding leader for shard {} in collection {}. Collection State: {}"
argument_list|,
name|slice
operator|.
name|getName
...
name|Replica
argument_list|>
name|eligibleSliceReplicas
init|=
name|collectEligibleReplicas
argument_list|(
name|slice
argument_list|,
name|clusterState
...
name|shardUrls
init|=
name|transformReplicasToShardUrls
argument_list|(
name|replicaListTransformer
argument_list|,
name|eligibleSliceReplicas
...
block|}
block|}
DECL|method|collectEligibleReplicas
specifier|private
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|transformReplicasToShardUrls
specifier|private
specifier|static
name|List
argument_list|<
...
return|;
block|}
DECL|method|createSliceShardsStr
specifier|private
specifier|static
name|String
name|createSliceShardsStr
