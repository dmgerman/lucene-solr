...
name|req
decl_stmt|;
comment|// determine if we should apply the local preference
if|if
condition|(
operator|!
name|req
...
condition|)
return|return;
comment|// Get this node's base URL from ZK
name|SolrCore
name|core
init|=
name|req
...
operator|+
literal|"because either core is null? {} or there is no ZkController? {}"
argument_list|,
name|Boolean
operator|.
name|valueOf
