...
name|info
argument_list|(
literal|"Initializing SuggesterComponent"
argument_list|)
expr_stmt|;
name|boolean
name|hasDefault
...
block|}
block|}
comment|// Register event listeners for this Suggester
name|core
operator|.
...
name|info
argument_list|(
literal|"Suggester prepare with : "
operator|+
name|params
argument_list|)
expr_stmt|;
...
argument_list|(
literal|"Error in configuration, no suggester found"
argument_list|)
throw|;
block|}
if|if
...
name|info
argument_list|(
literal|"Suggester distributedProcess with : "
operator|+
name|params
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Suggester process with : "
operator|+
name|params
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Suggester finishStage with : "
operator|+
name|params
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|"Loading suggester index for: "
operator|+
name|suggester
operator|.
name|getName
...
name|error
argument_list|(
literal|"Exception in reloading suggester index for: "
operator|+
name|suggester
operator|.
name|getName
