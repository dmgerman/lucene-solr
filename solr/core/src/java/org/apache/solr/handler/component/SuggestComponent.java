...
name|info
argument_list|(
literal|"Registering searcher listener for suggester: "
operator|+
name|suggester
operator|.
name|getName
...
name|info
argument_list|(
literal|"Skipping first newSearcher call for suggester "
operator|+
name|suggester
operator|+
literal|" in core reload"
argument_list|)
expr_stmt|;
return|return;
block|}
...
block|{
return|return
literal|"SuggesterListener [core="
operator|+
name|core
operator|+
literal|", suggester="
