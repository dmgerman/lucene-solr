...
name|BAD_REQUEST
argument_list|,
literal|"Invalid request. collections can be accessed only in SolrCloud mode"
argument_list|)
throw|;
block|}
name|SolrResponse
...
name|BAD_REQUEST
argument_list|,
literal|"Unknown index backup strategy "
operator|+
name|strategy
argument_list|)
throw|;
...
name|BAD_REQUEST
argument_list|,
literal|"Cannot restore with a CREATE_NODE_SET of CREATE_NODE_SET_EMPTY."
argument_list|)
throw|;
block|}
name|Map
...
argument_list|)
operator|,
DECL|enum constant|MOVEREPLICA_OP
name|MOVEREPLICA_OP
argument_list|(
name|MOVEREPLICA
argument_list|,
