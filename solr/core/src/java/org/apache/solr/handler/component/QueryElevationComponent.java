...
block|}
block|}
comment|/**    * Simple stripping of localParam at start of query    * @param queryString the raw query string    * @return the query string without localParams, or the original queryString if no valid localParam found at beginning of string    */
DECL|method|stripLocalParams
specifier|protected
specifier|static
name|String
name|stripLocalParams
