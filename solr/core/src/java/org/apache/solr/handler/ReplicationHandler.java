...
decl_stmt|;
DECL|field|pollListener
specifier|private
name|PollListener
name|pollListener
decl_stmt|;
DECL|interface|PollListener
specifier|public
interface|interface
name|PollListener
block|{
...
expr_stmt|;
block|}
comment|// Throw exception on directory traversal attempts
DECL|method|validateFilenameOrError
specifier|protected
name|String
name|validateFilenameOrError
parameter_list|(
...
name|FORBIDDEN
argument_list|,
literal|"File name cannot contain .."
argument_list|)
throw|;
block|}
block|}
...
name|FORBIDDEN
argument_list|,
literal|"File name must be relative"
argument_list|)
throw|;
block|}
return|return
