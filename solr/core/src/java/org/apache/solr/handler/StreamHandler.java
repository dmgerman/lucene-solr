...
parameter_list|)
block|{
comment|// Catch exceptions that occur while the stream is being created. This will include streaming expression parse
comment|// rules.
name|SolrException
operator|.
name|log
