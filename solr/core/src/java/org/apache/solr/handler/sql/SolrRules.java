...
name|SolrFilterRule
operator|.
name|FILTER_PROJECT_RULE
block|,
name|SolrProjectRule
operator|.
name|PROJECT_RULE
block|,
comment|//      SolrSortRule.SORT_RULE,
...
argument_list|)
decl_stmt|;
DECL|field|FILTER_PROJECT_RULE
specifier|private
specifier|static
specifier|final
name|SolrFilterRule
...
name|SolrRule
block|{
comment|//    static final SolrSortRule SORT_RULE = new SolrSortRule(operand(Sort.class, any()), "SolrSortRule");
