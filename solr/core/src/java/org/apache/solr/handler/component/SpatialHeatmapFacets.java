...
literal|null
return|;
comment|// means match everything (all live docs). This can speedup things a lot.
block|}
elseif|else
if|if
condition|(
...
argument_list|)
return|;
comment|// can speedup things a lot
block|}
elseif|else
if|if
condition|(
...
block|{
comment|// TODO DocSetBase.calcBits ought to be at DocSet level?
name|FixedBitSet
name|bits
init|=
operator|new
...
comment|// We re-write the facet.heatmap list with PNG format in local-params where it has highest precedence.
