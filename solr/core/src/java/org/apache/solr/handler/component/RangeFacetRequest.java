...
name|DV
operator|+
literal|"' is not supported on PointFields without docValues."
operator|+
literal|"Will use method '"
operator|+
name|FacetParams
...
name|BAD_REQUEST
argument_list|,
literal|"Unable to range facet on Trie field of unexpected type:"
operator|+
name|this
operator|.
name|facetOn
...
name|BAD_REQUEST
argument_list|,
literal|"Unable to range facet on Point field of unexpected type:"
operator|+
name|this
operator|.
name|facetOn
