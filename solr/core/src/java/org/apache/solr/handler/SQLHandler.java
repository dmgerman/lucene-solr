...
name|IOException
block|{
comment|// Return a metadata tuple as the first tuple and then pass through to the JDBCStream.
if|if
condition|(
name|firstTuple
condition|)
