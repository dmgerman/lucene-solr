...
block|}
block|}
comment|// This does not work for the general case of forwarding requests.  It probably currently
comment|// works OK for real-time get (which is all that BlobHandler uses it for).
DECL|method|forward
specifier|private
specifier|static
name|void
...
name|this
argument_list|,
literal|"core.system.blob"
argument_list|,
literal|"core.system.blob.upload"
argument_list|)
return|;
block|}
block|}
