...
return|;
block|}
DECL|method|parsePropertyFilter
specifier|private
name|MetricUtils
operator|.
name|PropertyFilter
...
name|types
operator|+
literal|" specified. Must be one of "
operator|+
name|MetricType
operator|.
name|SUPPORTED_TYPES_MSG
argument_list|,
name|e
argument_list|)
throw|;
...
begin_decl_stmt
DECL|field|SUPPORTED_TYPES_MSG
specifier|public
specifier|static
specifier|final
name|String
