...
name|ROOT
argument_list|,
literal|"%s can't handle realtime get requests. Replicas of type %s do not support these type of requests"
argument_list|,
name|cloudDesc
operator|.
...
throw|;
block|}
comment|// non-leader TLOG replicas should not respond to distrib /get requests, but internal requests are OK
block|}
block|}
if|if
condition|(
