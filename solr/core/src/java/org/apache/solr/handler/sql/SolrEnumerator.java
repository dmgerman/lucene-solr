...
parameter_list|)
block|{
comment|// Check if Double is really a Long
if|if
condition|(
name|val
operator|instanceof
...
name|val
decl_stmt|;
comment|//make sure that double has no decimals and fits within Long
if|if
condition|(
name|doubleVal
operator|%
...
return|;
block|}
comment|// Wasn't a double so just return original Object
return|return
name|val
return|;
block|}
