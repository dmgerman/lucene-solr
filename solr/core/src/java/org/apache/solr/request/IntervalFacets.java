...
condition|)
block|{
name|getCountMultiValuedNumeric
argument_list|()
expr_stmt|;
block|}
else|else
...
block|}
block|}
DECL|method|getCountMultiValuedNumeric
specifier|private
name|void
name|getCountMultiValuedNumeric
parameter_list|()
...
condition|)
block|{
name|accumIntervalWithMultipleValues
argument_list|(
name|longs
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|accumIntervalWithMultipleValues
specifier|private
name|void
name|accumIntervalWithMultipleValues
parameter_list|(
...
name|IOException
block|{
comment|// longs should be already positioned to the correct doc
assert|assert
name|longs
operator|.
name|docID
...
literal|0
operator|:
literal|"Should have at least one value for this document"
assert|;
name|int
...
break|break;
block|}
comment|//Maybe return if currentInterval == intervals.length?
block|}
block|}
block|}
