...
condition|)
block|{
comment|// if mincount<=0 and we're not examining the values for the term filter, then
comment|// we won't discard any terms and we know exactly where to start.
name|i
operator|+=
name|off
expr_stmt|;
