...
name|coresInit
expr_stmt|;
comment|// crucially final assignment
name|init
operator|.
name|countDown
argument_list|()
...
argument_list|)
expr_stmt|;
comment|// todo should we use CachedThreadStatesGaugeSet instead?
name|MetricsMap
name|sysprops
init|=
operator|new
...
name|warn
argument_list|(
literal|"Error registering JVM metrics"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
name|info
argument_list|(
literal|" ___      _       Welcome to Apache Solrâ¢ version {}"
argument_list|,
name|solrVersion
argument_list|()
argument_list|)
...
name|info
argument_list|(
literal|"/ __| ___| |_ _   Starting in {} mode on port {}"
argument_list|,
name|isCloudMode
argument_list|()
condition|?
...
name|info
argument_list|(
literal|"|___/\\___/_|_|    Start time: {}"
argument_list|,
name|Instant
operator|.
name|now
...
return|;
block|}
comment|/* We are in cloud mode if Java option zkRun exists OR zkHost exists and is non-empty */
DECL|method|isCloudMode
specifier|private
name|boolean
name|isCloudMode
parameter_list|()
...
name|warn
argument_list|(
literal|"Exception closing FileCleaningTracker"
argument_list|,
name|e
argument_list|)
expr_stmt|;
