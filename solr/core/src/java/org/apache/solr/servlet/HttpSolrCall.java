...
condition|)
block|{
comment|// extra mem barriers, so don't look at this before trying to get core
throw|throw
operator|new
name|SolrException
argument_list|(
...
argument_list|,
literal|"SolrCore is loading"
argument_list|)
throw|;
block|}
else|else
block|{
comment|// the core may have just finished loading
name|core
operator|=
name|cores
operator|.
...
expr_stmt|;
block|}
DECL|method|autoCreateSystemColl
specifier|protected
name|void
name|autoCreateSystemColl
parameter_list|(
...
name|info
argument_list|(
literal|"Going to auto-create .system collection"
argument_list|)
expr_stmt|;
name|SolrQueryResponse
name|rsp
...
name|SERVER_ERROR
argument_list|,
literal|"Could not auto-create .system collection: "
operator|+
name|Utils
operator|.
name|toJSONString
...
name|SERVER_ERROR
argument_list|,
literal|"Could not find .system collection even after 3 seconds"
argument_list|)
throw|;
block|}
name|Thread
...
literal|false
return|;
comment|//admin/info/key is the path where public key is exposed . it is always unsecured
if|if
condition|(
name|cores
operator|.
...
argument_list|)
decl_stmt|;
comment|// Prevent close of container streams
name|HttpEntity
name|entity
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Prevent close of container streams, see SOLR-8933
name|QueryResponseWriterUtil
operator|.
...
return|;
block|}
DECL|method|randomlyGetSolrCore
specifier|private
name|SolrCore
name|randomlyGetSolrCore
parameter_list|(
...
name|BAD_REQUEST
argument_list|,
literal|"Error reading commands"
argument_list|)
throw|;
block|}
break|break;
...
return|;
block|}
comment|/**    * A faster method for randomly picking items when you do not need to    * consume all items.    */
DECL|class|RandomIterator
specifier|private
specifier|static
class|class
name|RandomIterator
