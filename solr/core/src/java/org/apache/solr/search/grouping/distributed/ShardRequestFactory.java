...
begin_interface
DECL|interface|ShardRequestFactory
specifier|public
interface|interface
name|ShardRequestFactory
block|{
comment|/**    * Returns {@link ShardRequest} instances.    * Never returns<code>null</code>. If no {@link ShardRequest} instances are constructed an empty array is returned.    *    * @param rb The response builder    * @return {@link ShardRequest} instances    */
