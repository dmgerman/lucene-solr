...
return|;
block|}
comment|/**    * A helper method for other plugins to create (non-scoring) JoinQueries wrapped around arbitrary queries against the same core.    *     * @param subQuery the query to define the starting set of documents on the "left side" of the join    * @param fromField "left side" field name to use in the join    * @param toField "right side" field name to use in the join    */
...
name|fromIndex
decl_stmt|;
comment|// TODO: name is missleading here compared to JoinQParserPlugin usage - here it must be a core name
DECL|field|q
name|Query
name|q
decl_stmt|;
