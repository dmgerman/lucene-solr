...
return|;
block|}
comment|/** @lucene.experimental Query is in the context of a filter, where scores don't matter */
...
name|flags
expr_stmt|;
comment|// TODO: this would be better passed in to the constructor... change to a ParserContext object?
name|nestedParser
operator|.
name|recurseCount
operator|=
