...
name|contexts
decl_stmt|;
DECL|field|collapseValuesProducer
specifier|private
specifier|final
name|DocValuesProducer
name|collapseValuesProducer
decl_stmt|;
...
name|IOException
argument_list|(
literal|"min/max must be either Int/Long/Float based field types"
argument_list|)
throw|;
block|}
switch|switch
...
name|IOException
argument_list|(
literal|"min/max must be either Int/Long/Float field types"
argument_list|)
throw|;
block|}
block|}
...
name|numType
assert|;
comment|// shouldn't make it here for non-numeric types
switch|switch
condition|(
name|numType
condition|)
...
name|IOException
argument_list|(
literal|"min/max must be Int or Float field types when collapsing on numeric fields"
argument_list|)
throw|;
block|}
block|}
...
name|CollectorFactory
block|{
comment|/** @see #isNumericCollapsible */
DECL|field|NUMERIC_COLLAPSIBLE_TYPES
specifier|private
specifier|final
specifier|static
name|EnumSet
...
name|NumberType
argument_list|>
name|NUMERIC_COLLAPSIBLE_TYPES
init|=
name|EnumSet
operator|.
name|of
...
argument_list|)
decl_stmt|;
DECL|method|isNumericCollapsible
specifier|private
name|boolean
name|isNumericCollapsible
parameter_list|(
name|FieldType
...
literal|0
decl_stmt|;
comment|// must be non-null at this point
if|if
condition|(
name|collapseFieldType
operator|.
