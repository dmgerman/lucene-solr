...
parameter_list|)
block|{
comment|//Uses the unique id for equals to ensure that the query result cache always fails.
if|if
condition|(
name|o
operator|instanceof
...
name|o
decl_stmt|;
comment|//Do object comparison to be sure only the same object will return true.
if|if
condition|(
name|this
operator|.
