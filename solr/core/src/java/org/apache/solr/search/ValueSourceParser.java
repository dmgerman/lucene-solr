...
name|SyntaxError
block|{
comment|// payload(field,value[,default, ['min|max|average|first']])
comment|//   defaults to "average" and 0.0 default value
name|TInfo
name|tinfo
init|=
name|parseTerm
...
argument_list|)
decl_stmt|;
comment|// would have made this parser a new separate class and registered it, but this handy method is private :/
name|ValueSource
...
argument_list|)
expr_stmt|;
comment|// Support func="first" by payloadFunction=null
if|if
condition|(
name|payloadFunction
operator|==
...
condition|)
block|{
comment|// not "first" (or average, min, or max)
throw|throw
operator|new
name|SolrException
argument_list|(
...
name|BAD_REQUEST
argument_list|,
literal|"Invalid payload function: "
operator|+
name|func
argument_list|)
throw|;
...
name|BAD_REQUEST
argument_list|,
literal|"No payload decoder found for field: "
operator|+
name|tinfo
operator|.
name|field
...
argument_list|)
expr_stmt|;
comment|/***      addParser("agg_multistat", new ValueSourceParser() {     @Override     public ValueSource parse(FunctionQParser fp) throws SyntaxError {     return null;     }     });      ***/
name|addParser
argument_list|(
literal|"agg_min"
argument_list|,
