...
name|queryFields
decl_stmt|;
comment|/**     * The field names specified by 'uf' that users are     * allowed to include literally in their query string.  The Float    * boost values will be applied automaticly to any clause using that     * field name. '*' will be treated as an alias for any     * field that exists in the schema. Wildcards are allowed to    * express dynamicFields.    */
...
parameter_list|)
block|{
comment|//      analyzer.removeStopFilter = remove;
name|removeStopFilter
operator|=
name|remove
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|//      System.out.println("** userF="+userFieldsMap+", dynUF="+Arrays.toString(dynamicUserFields)+", negDynUF="+Arrays.toString(negativeDynamicUserFields));
block|}
