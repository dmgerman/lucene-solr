...
comment|// TODO what happens if updates came out of order, would cached fingerprint still be valid?
comment|// May be caching fingerprint may lead more problems
name|IndexFingerprint
name|fingerprint
init|=
name|maxVersionFingerprintCache
...
name|info
argument_list|(
literal|"Fingerprint for max version: "
operator|+
name|maxVersion
operator|+
