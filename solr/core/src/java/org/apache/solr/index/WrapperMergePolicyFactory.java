...
return|;
block|}
comment|/** Returns an instance of the wrapping {@link MergePolicy} without configuring its set parameters. */
...
parameter_list|)
function_decl|;
comment|/** Returns a wrapping {@link MergePolicy} with its set parameters configured. */
annotation|@
name|Override
