...
name|info
argument_list|(
literal|"createInboundRoot started for /config"
argument_list|)
expr_stmt|;
name|router
operator|.
...
argument_list|)
expr_stmt|;
comment|// attach all the dynamically registered /config resources
name|RestManager
name|restManager
init|=
name|RestManager
...
name|info
argument_list|(
literal|"createInboundRoot complete for /config"
argument_list|)
expr_stmt|;
return|return
name|router
