...
name|expr
init|=
literal|"featuresSelection(collection1, q=\"*:*\", featureSet=\"first\", field=\"tv_text\", outcome=\"out_i\", numTerms=4, positiveLabel=2)"
decl_stmt|;
name|FeaturesSelectionStream
name|stream
init|=
...
annotation|@
name|Test
DECL|method|testTextLogitStreamWithFeaturesSelection
specifier|public
name|void
name|testTextLogitStreamWithFeaturesSelection
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"name=\"model\", "
operator|+
literal|"featuresSelection(collection1, q=\"*:*\", featureSet=\"first\", field=\"tv_text\", outcome=\"out_i\", numTerms=4), "
operator|+
literal|"field=\"tv_text\", "
operator|+
literal|"outcome=\"out_i\", "
