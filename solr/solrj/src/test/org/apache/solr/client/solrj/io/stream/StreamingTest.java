...
name|Exception
argument_list|(
literal|"Equalitors did not match but no excepion was thrown"
argument_list|)
throw|;
block|}
catch|catch
...
name|Exception
argument_list|(
literal|"Sorts did not match up and Exception was not not thrown."
argument_list|)
throw|;
block|}
catch|catch
...
operator|)
assert|;
comment|//The /select handler does not return exceptions in tuple so the generic exception is returned.
assert|assert
operator|(
name|t
operator|.
