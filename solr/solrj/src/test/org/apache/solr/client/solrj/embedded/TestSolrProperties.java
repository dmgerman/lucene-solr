...
argument_list|()
expr_stmt|;
comment|//   fis = new FileInputStream(new File(getSolrXml().getParent(),
...
argument_list|)
expr_stmt|;
comment|//mcr = CoreAdminRequest.persist(SOLR_PERSIST_XML, getRenamedSolrAdmin());
