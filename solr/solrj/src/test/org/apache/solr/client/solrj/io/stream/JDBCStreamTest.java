...
name|executeUpdate
argument_list|(
literal|"create table DUAL(ID int not null primary key)"
argument_list|)
expr_stmt|;
name|statement
operator|.
name|executeUpdate
argument_list|(
literal|"insert into DUAL values(1)"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
argument_list|)
expr_stmt|;
comment|// Additional Types
name|String
name|query
init|=
literal|"select 1 as ID1, {ts '2017-02-18 12:34:56.789'} as TS1, {t '01:02:03'} as T1, "
operator|+
literal|"{d '1593-03-14'} as D1, cast(12.34 AS DECIMAL(4,2)) as DEC4_2, "
operator|+
literal|"cast(1234 AS DECIMAL(4,0)) as DEC4_0, cast('big stuff' as CLOB(100)) as CLOB1 "
operator|+
literal|"from DUAL order by ID1"
decl_stmt|;
name|stream
operator|=
operator|new
