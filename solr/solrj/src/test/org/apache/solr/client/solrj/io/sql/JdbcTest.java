...
annotation|@
name|Test
DECL|method|testOneEqualZeroMetadata
specifier|public
name|void
name|testOneEqualZeroMetadata
parameter_list|()
throws|throws
name|Exception
block|{
comment|// SOLR-8845 - Make sure that 1 = 1 (literal comparison literal) works
try|try
init|(
name|Connection
name|con
