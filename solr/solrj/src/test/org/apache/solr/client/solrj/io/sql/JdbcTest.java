...
argument_list|)
expr_stmt|;
comment|// TODO figure out null checks?
comment|//    assertEquals(null, rs.getObject("testnull_i"));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(null, rs.getObject(5));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(null, rs.getString("testnull_i"));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(null, rs.getString(5));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0D, rs.getDouble("testnull_i"), 0);
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0D, rs.getDouble(5), 0);
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0F, rs.getFloat("testnull_i"), 0);
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0F, rs.getFloat(5), 0);
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0, rs.getInt("testnull_i"));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0, rs.getInt(5));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0L, rs.getLong("testnull_i"));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0L, rs.getLong(5));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0, rs.getShort("testnull_i"));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0, rs.getShort(5));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0, rs.getByte("testnull_i"));
comment|//    assertTrue(rs.wasNull());
comment|//    assertEquals(0, rs.getByte(5));
comment|//    assertTrue(rs.wasNull());
name|assertFalse
argument_list|(
name|rs
