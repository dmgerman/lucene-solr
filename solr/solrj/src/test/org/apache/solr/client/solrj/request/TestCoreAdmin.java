...
annotation|@
name|Test
DECL|method|testValidCoreRename
specifier|public
name|void
name|testValidCoreRename
parameter_list|()
throws|throws
name|Exception
block|{
...
name|Exception
block|{
comment|// index marker docs to core0
name|SolrClient
name|cli0
init|=
name|getSolrCore0
...
argument_list|()
expr_stmt|;
comment|// index a marker doc to core1
name|SolrClient
name|cli1
init|=
name|getSolrCore1
...
argument_list|()
expr_stmt|;
comment|// initial state assertions
name|SolrQuery
name|q
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// assert initial metrics
name|SolrMetricManager
name|metricManager
init|=
name|cores
...
argument_list|)
expr_stmt|;
comment|// assert state after swap
name|cli0
operator|=
name|getSolrCore0
argument_list|()
...
annotation|@
name|Test
DECL|method|testInvalidRequestRecovery
specifier|public
name|void
name|testInvalidRequestRecovery
parameter_list|()
throws|throws
name|SolrServerException
throws|,
...
annotation|@
name|Test
DECL|method|testReloadCoreAfterFailure
specifier|public
name|void
name|testReloadCoreAfterFailure
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assumeTrue
argument_list|(
literal|"test can't handle relative data directory paths (yet?)"
argument_list|,
name|data
operator|.
name|isAbsolute
...
argument_list|)
expr_stmt|;
comment|// Need to run a query to confirm that the core couldn't load
name|expectThrows
argument_list|(
name|SolrException
operator|.
...
argument_list|)
expr_stmt|;
comment|// We didn't fix anything, so should still throw
name|expectThrows
argument_list|(
name|SolrException
operator|.
