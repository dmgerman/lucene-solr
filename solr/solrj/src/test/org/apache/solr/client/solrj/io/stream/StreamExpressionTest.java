...
annotation|@
name|Test
DECL|method|testLetGetStream
specifier|public
name|void
name|testLetGetStream
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|//Test there are no side effects when transforming tuples.
name|expr
operator|=
literal|"search("
operator|+
...
name|expr
operator|+
literal|"), list(select(get(results), id as newid, test_t), get(results)))"
expr_stmt|;
name|paramsLoc
operator|=
operator|new
...
name|COLLECTIONORALIAS
operator|+
literal|", q=\"*:*\", fl=\"id,test_t\", sort=\"id asc\")"
decl_stmt|;
name|cat
operator|=
literal|"let(cell(results,"
...
name|expr
operator|+
literal|"), cell(results1,"
operator|+
name|expr1
operator|+
literal|"), list(select(get(results), id as newid, test_t), get(results1)))"
expr_stmt|;
name|paramsLoc
operator|=
operator|new
