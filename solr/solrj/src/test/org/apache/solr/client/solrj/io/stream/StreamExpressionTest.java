...
name|expr
init|=
literal|"tuple(seq=sequence(20, 0, 1))"
decl_stmt|;
name|ModifiableSolrParams
name|paramsLoc
init|=
...
expr_stmt|;
block|}
comment|//Change the size, stride
name|expr
operator|=
literal|"tuple(seq=sequence(100, 0, 4))"
expr_stmt|;
name|paramsLoc
operator|=
operator|new
...
expr_stmt|;
block|}
comment|//Change the start
name|expr
operator|=
literal|"tuple(seq=sequence(100, 10, 1))"
expr_stmt|;
name|paramsLoc
operator|=
operator|new
