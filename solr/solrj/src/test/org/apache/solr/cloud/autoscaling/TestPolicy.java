...
name|fail
argument_list|(
literal|"expected exception containing "
operator|+
name|msg
argument_list|)
expr_stmt|;
...
name|fromJSONString
argument_list|(
literal|"{replica:0, sysLoadAvg:'<12.7'}"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
...
expr_stmt|;
block|}
DECL|method|testNegativeConditions
specifier|public
name|void
name|testNegativeConditions
parameter_list|()
block|{
name|String
name|autoscaleJson
...
literal|"      'cluster-policy':["
operator|+
literal|"      {'replica':'<4','shard':'#EACH','node':'#ANY'},"
operator|+
literal|"      { 'replica': 0, 'sysprop.fs': '!ssd', 'shard': '#EACH'},"
operator|+
comment|//negative greedy condition
...
return|;
block|}
DECL|method|testEmptyClusterState
specifier|public
name|void
...
literal|"{"
operator|+
literal|"    '127.0.0.1:50097_solr':{"
operator|+
literal|"      'cores':0,"
operator|+
literal|"      'port':'50097'},"
operator|+
literal|"    '127.0.0.1:50096_solr':{"
operator|+
literal|"      'cores':0,"
operator|+
literal|"      'port':'50096'}}"
