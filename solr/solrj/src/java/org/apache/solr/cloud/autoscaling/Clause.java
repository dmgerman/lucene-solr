...
name|RuntimeException
argument_list|(
literal|"replica val cannot be null"
operator|+
name|Utils
operator|.
name|toJSONString
...
expr_stmt|;
block|}
comment|/*           String value = val == null ? null : String.valueOf(val).trim();       if(WILDCARD)        if ((expectedVal = WILDCARD.parse(value)) != null) {         operand = WILDCARD;       } else if ((expectedVal = NOT_EQUAL.parse(value)) != null) {         operand = NOT_EQUAL;       } else if ((expectedVal = GREATER_THAN.parse(value)) != null) {         operand = GREATER_THAN;       } else if ((expectedVal = LESS_THAN.parse(value)) != null) {         operand = LESS_THAN;       } else {         operand = EQUAL;         expectedVal = EQUAL.parse(value);       } */
return|return
operator|new
name|Condition
argument_list|(
...
block|}
block|}
comment|/**    *    * @param name name of the condition    * @param val value of the condition    * @param isRuleVal is this provided in the rule    * @return actual validated value    */
...
argument_list|)
expr_stmt|;
comment|//generic number validation
name|validatetypes
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|//generic string validation
name|validatetypes
operator|.
name|put
argument_list|(
