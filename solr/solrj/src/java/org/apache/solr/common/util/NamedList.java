...
block|}
block|}
comment|/**    * Creates an instance backed by an explicitly specified list of    * pairwise names/values.    *    *<p>    * When using this constructor, runtime type safety is only guaranteed if    * all even numbered elements of the input list are of type "T".    *</p>    *<p>    * This method is package protected and exists solely so SimpleOrderedMap and clone() can utilize it    *</p>    *<p>    * TODO: this method was formerly public, now that it's not we can change the impl details of     * this class to be based on a Map.Entry[]     *</p>    * @lucene.internal    * @see #nameValueMapToList    */
DECL|method|NamedList
name|NamedList
parameter_list|(
name|List
...
expr_stmt|;
block|}
comment|/**    * Method to serialize Map.Entry&lt;String, ?&gt; to a List in which the even    * indexed elements (0,2,4. ..etc) are Strings and odd elements (1,3,5,) are of    * the type "T".    *    *<p>    * NOTE: This a temporary placeholder method until the guts of the class    * are actually replaced by List&lt;String, ?&gt;.    *</p>    *    * @return Modified List as per the above description    * @see<a href="https://issues.apache.org/jira/browse/SOLR-912">SOLR-912</a>    */
...
condition|)
block|{
comment|// we know that there are no duplicates
name|add
argument_list|(
operator|(
name|String
...
parameter_list|()
block|{
comment|//TODO implement more efficiently
return|return
name|NamedList
operator|.
name|this
...
condition|)
block|{
comment|//the maxDepth check is to avoid stack overflow due to infinite recursion
name|val
operator|=
operator|(
operator|(
