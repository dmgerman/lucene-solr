...
argument_list|()
decl_stmt|;
DECL|field|externalWatchedCollections
specifier|private
name|Map
argument_list|<
name|String
...
name|DocCollection
argument_list|>
name|externalWatchedCollections
init|=
operator|new
name|ConcurrentHashMap
argument_list|<
...
name|warn
argument_list|(
literal|"Error checking external collections"
argument_list|,
name|e
argument_list|)
expr_stmt|;
...
block|}
block|}
DECL|method|updateExternCollection
specifier|public
name|void
name|updateExternCollection
parameter_list|(
...
DECL|method|getExternCollection
specifier|public
name|DocCollection
...
return|;
block|}
comment|// this is only set by Overseer not to be set by others. If Overseer has
comment|// unfinished external collections which are yet to be persisted to ZK
comment|// this map is populated and this class can use that information
DECL|field|ephemeralCollectionData
specifier|public
name|Map
name|ephemeralCollectionData
decl_stmt|;
DECL|method|getExternCollectionFresh
specifier|public
specifier|static
name|DocCollection
name|getExternCollectionFresh
