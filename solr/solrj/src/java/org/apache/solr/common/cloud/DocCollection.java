...
argument_list|>
argument_list|>
name|nodeNameReplicas
decl_stmt|;
DECL|field|nodeNameLeaderReplicas
specifier|private
specifier|final
name|Map
argument_list|<
...
decl_stmt|;
DECL|field|numNrtReplicas
specifier|private
specifier|final
name|Integer
name|numNrtReplicas
decl_stmt|;
DECL|field|numTlogReplicas
specifier|private
specifier|final
name|Integer
...
assert|;
block|}
DECL|method|addNodeNameReplica
specifier|private
name|void
name|addNodeNameReplica
parameter_list|(
...
return|;
block|}
comment|/**    * Get the list of replicas hosted on the given node or<code>null</code> if none.    */
...
return|;
block|}
comment|/**    * Get the list of all leaders hosted on the given node or<code>null</code> if none.    */
DECL|method|getLeaderReplicas
specifier|public
name|List
argument_list|<
name|Replica
argument_list|>
name|getLeaderReplicas
parameter_list|(
name|String
name|nodeName
parameter_list|)
...
return|;
block|}
comment|/**    * Get the shardId of a core on a specific node    */
...
return|;
block|}
comment|/**    * @return the number of replicas of type {@link org.apache.solr.common.cloud.Replica.Type#NRT} this collection was created with    */
...
return|;
block|}
comment|/**    * @return the number of replicas of type {@link org.apache.solr.common.cloud.Replica.Type#TLOG} this collection was created with    */
...
return|;
block|}
comment|/**    * @return the number of replicas of type {@link org.apache.solr.common.cloud.Replica.Type#PULL} this collection was created with    */
...
return|;
block|}
comment|/**    * @return the policy associated with this collection if any    */
