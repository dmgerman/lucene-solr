...
expr_stmt|;
block|}
comment|/**    * Creates the path in ZooKeeper, creating each node as necessary.    *    * e.g. If<code>path=/solr/group/node</code> and none of the nodes, solr,    * group, node exist, each will be created.    *     * skipPathParts will force the call to fail if the first skipPathParts do not exist already.    *    * Note: retryOnConnLoss is only respected for the final node - nodes    * before that are always retried on connection loss.    */
DECL|method|makePath
specifier|public
name|void
name|makePath
...
expr_stmt|;
block|}
DECL|method|printLayoutToStream
specifier|public
name|void
name|printLayoutToStream
parameter_list|(
...
expr_stmt|;
block|}
comment|// Some pass-throughs to allow less code disruption to other classes that use SolrZkClient.
DECL|method|clean
specifier|public
name|void
name|clean
