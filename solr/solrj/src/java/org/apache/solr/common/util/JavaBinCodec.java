...
expr_stmt|;
block|}
comment|/**    * Use this to use this as a PushWriter. ensure that close() is called explicitly after use    *    * @param os The output stream    */
DECL|method|JavaBinCodec
specifier|public
name|JavaBinCodec
parameter_list|(
...
condition|)
block|{
comment|//todo find a better way to reuse the map more efficiently
name|writeMap
argument_list|(
operator|(
operator|(
...
return|;
block|}
comment|/**    * create a new Map object    * @param size expected size, -1 means unknown size    */
DECL|method|newMap
specifier|protected
name|Map
argument_list|<
