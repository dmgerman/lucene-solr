...
block|}
block|}
comment|/**    * If the input params are of type MofifiableSolrParams, returns the input, otherwise, constructs a new    * ModifiableSolrParams, copying values from the given params. If params is null, returns an empty    * ModifiableSolrParams instance.    */
DECL|method|of
specifier|public
specifier|static
name|ModifiableSolrParams
