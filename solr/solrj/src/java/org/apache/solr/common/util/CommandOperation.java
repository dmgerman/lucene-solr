...
name|addError
argument_list|(
literal|"value of the command is an object should be primitive"
argument_list|)
expr_stmt|;
block|}
return|return
...
return|;
block|}
comment|/**    * Parse the command operations into command objects from javabin payload    * * @param singletonCommands commands that cannot be repeated    */
DECL|method|parse
specifier|public
specifier|static
name|List
...
return|;
block|}
comment|/**    * Parse the command operations into command objects from a json payload    *    * @param rdr               The payload    * @param singletonCommands commands that cannot be repeated    * @return parsed list of commands    */
DECL|method|parse
specifier|public
specifier|static
name|List
...
name|JSONParser
operator|.
name|ALLOW_MISSING_COLON_COMMA_BEFORE_OBJECT
operator||
name|JSONParser
operator|.
name|OPTIONAL_OUTER_BRACES
argument_list|)
expr_stmt|;
name|ObjectBuilder
name|ob
...
return|;
block|}
comment|/**    * Read commands from request streams    *    * @param streams           the streams    * @param resp              solr query response    * @param singletonCommands , commands that cannot be repeated    * @return parsed list of commands    * @throws IOException if there is an error while parsing the stream    */
DECL|method|readCommands
specifier|public
specifier|static
name|List
...
name|formatString
argument_list|(
literal|"{0} is not a valid integer"
argument_list|,
name|name
argument_list|)
argument_list|)
