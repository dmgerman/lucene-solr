...
return|;
block|}
comment|/**    * Parse the command operations into command objects    *    * @param rdr               The payload    * @param singletonCommands commands that cannot be repeated    * @return parsed list of commands    */
DECL|method|parse
specifier|public
specifier|static
name|List
