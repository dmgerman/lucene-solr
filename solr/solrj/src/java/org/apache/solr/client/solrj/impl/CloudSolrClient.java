...
block|}
block|}
DECL|method|invalidateCollectionState
specifier|private
name|void
name|invalidateCollectionState
parameter_list|(
name|String
name|collection
parameter_list|)
...
condition|)
block|{
comment|// startsWith to deal with stray trailing slashes
comment|// we didn't hit our first-preference server, which means that our cached
comment|// collection state is no longer valid
name|invalidateCollectionState
argument_list|(
name|collection
argument_list|)
