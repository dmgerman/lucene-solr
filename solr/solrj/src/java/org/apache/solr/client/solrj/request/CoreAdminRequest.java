...
return|;
block|}
comment|/**      * Provide the name of the core to be created.      *       * Core names must consist entirely of periods, underscores and alphanumerics.  Other characters are not allowed.      *       * @throws IllegalArgumentException if the core name contains invalid characters.      */
annotation|@
name|Override
...
block|}
block|}
DECL|class|OverrideLastPublished
specifier|public
specifier|static
class|class
name|OverrideLastPublished
extends|extends
name|CoreAdminRequest
block|{
DECL|field|state
...
name|state
decl_stmt|;
DECL|method|OverrideLastPublished
specifier|public
name|OverrideLastPublished
parameter_list|()
block|{
...
argument_list|(
literal|"Please specify non null value for commitName parameter."
argument_list|)
throw|;
block|}
name|this
...
return|;
block|}
comment|/**    * Rename an existing core.    *     * @throws IllegalArgumentException if the new core name contains invalid characters.    */
...
return|;
block|}
comment|/**    * Swap two existing cores.    * @param core1 name of the first core    * @param core2 name of the other core    * @param client SolrClient to use    * @return response    * @throws SolrServerException if one or both cores don't exist    * @throws IOException on IO errors    */
DECL|method|swapCore
specifier|public
specifier|static
name|CoreAdminResponse
name|swapCore
