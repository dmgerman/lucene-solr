...
expr_stmt|;
block|}
comment|// peek at the next object to see if we're at the end
name|o
operator|=
name|readVal
argument_list|(
...
condition|)
block|{
comment|// indicate that we've hit the last doc in the batch, used to enable optimizations when doing replication
name|updateRequest
operator|.
name|lastDocInBatch
argument_list|()
