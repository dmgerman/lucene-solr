...
name|snitch
decl_stmt|;
comment|/**      * @deprecated Use {@link #createCollection(String, String, int, int, int, int)}      */
annotation|@
name|Deprecated
DECL|method|Create
specifier|public
...
argument_list|(
literal|"Please specify a value for parameter "
operator|+
name|param
argument_list|)
throw|;
...
return|;
block|}
comment|/**    * Returns a SolrRequest to add a replica of the specified type to a shard in a collection    */
DECL|method|addReplicaToShard
specifier|public
specifier|static
name|AddReplica
...
name|IllegalArgumentException
argument_list|(
literal|"You must set a collection name for this request"
argument_list|)
throw|;
name|params
operator|.
