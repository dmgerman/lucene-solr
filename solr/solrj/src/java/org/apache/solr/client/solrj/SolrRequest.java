...
name|usev2
decl_stmt|;
DECL|field|useBinaryV2
specifier|protected
name|boolean
name|useBinaryV2
decl_stmt|;
comment|/**If set to true, every request that implements {@link V2RequestSupport} will be converted    * to a V2 API call    */
DECL|method|setUseV2
specifier|public
name|SolrRequest
name|setUseV2
parameter_list|(
...
return|;
block|}
comment|/**If set to true use javabin instead of json (default)    */
DECL|method|setUseBinaryV2
specifier|public
name|SolrRequest
name|setUseBinaryV2
parameter_list|(
