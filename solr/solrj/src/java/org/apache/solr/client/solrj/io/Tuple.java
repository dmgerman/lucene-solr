...
block|{
comment|//Attempt to parse the Boolean
return|return
name|Boolean
operator|.
name|parseBoolean
...
return|;
block|}
comment|// Convenience methods since the dates are actually shipped around as Strings.
DECL|method|getDate
specifier|public
name|Date
name|getDate
...
block|{
comment|//Attempt to parse the Date from a String
return|return
operator|new
name|Date
argument_list|(
