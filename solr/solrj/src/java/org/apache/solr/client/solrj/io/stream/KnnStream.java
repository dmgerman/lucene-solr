...
name|ROOT
argument_list|,
literal|"invalid expression %s - at least two named parameters expected. eg. 'id' and 'qf'"
argument_list|,
name|expression
argument_list|)
argument_list|)
...
name|IOException
argument_list|(
literal|"id parameter is expected for KnnStream"
argument_list|)
throw|;
block|}
if|if
...
name|IOException
argument_list|(
literal|"qf parameter is expected for KnnStream"
argument_list|)
throw|;
block|}
