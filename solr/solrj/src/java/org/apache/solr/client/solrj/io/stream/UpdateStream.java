...
name|IOException
block|{
comment|// An update stream is backward wrt the order in the explanation. This stream is the "child"
comment|// while the collection we're updating is the parent.
name|StreamExplanation
name|explanation
init|=
operator|new
