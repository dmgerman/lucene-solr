...
condition|)
block|{
comment|//TopicStream provides sleepMillis> 0 if the last run had no Tuples.
comment|//This means the topic queue is empty. Time to terminate.
comment|//Remove ourselves from the daemons map.
if|if
condition|(
name|daemons
operator|!=
...
expr_stmt|;
block|}
comment|//Break out of the thread loop and end the run.
break|break
name|OUTER
break|;
block|}
