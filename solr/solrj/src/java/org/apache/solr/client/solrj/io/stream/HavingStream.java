...
begin_comment
comment|/**  * The HavingStream iterates over an internal stream and applies a BooleanOperation to each tuple. If the BooleanOperation  * evaluates to true then the HavingStream emits the tuple, if it returns false the tuple is not emitted.  **/
end_comment
