...
name|IOException
argument_list|(
literal|"scoreNodes operates over a single bucket. Num buckets:"
operator|+
name|facetStream
operator|.
name|getBuckets
...
condition|)
block|{
comment|//Turn the facet tuple into a node.
name|String
name|nodeId
init|=
name|node
...
name|IOException
argument_list|(
literal|"node field not present in the Tuple"
argument_list|)
throw|;
block|}
name|String
...
name|Exception
argument_list|(
literal|"termFreq field not present in the Tuple"
argument_list|)
throw|;
block|}
name|Number
