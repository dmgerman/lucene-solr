...
return|;
block|}
comment|/**    * Add field for MoreLikeThis. Automatically    * enables MoreLikeThis.    *    * @param field the names of the field to be added    * @return this    */
DECL|method|addMoreLikeThisField
specifier|public
name|SolrQuery
...
return|;
block|}
DECL|method|setMoreLikeThisFields
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * @return an array with the fields used to compute similarity.    */
DECL|method|getMoreLikeThisFields
specifier|public
name|String
index|[]
...
return|;
block|}
comment|/**    * Sets the frequency below which terms will be ignored in the source doc    *    * @param mintf the minimum term frequency    * @return this    */
DECL|method|setMoreLikeThisMinTermFreq
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the frequency below which terms will be ignored in the source doc    */
DECL|method|getMoreLikeThisMinTermFreq
specifier|public
name|int
...
return|;
block|}
comment|/**    * Sets the frequency at which words will be ignored which do not occur in    * at least this many docs.    *    * @param mindf the minimum document frequency    * @return this    */
DECL|method|setMoreLikeThisMinDocFreq
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the frequency at which words will be ignored which do not occur in    * at least this many docs.    */
DECL|method|getMoreLikeThisMinDocFreq
specifier|public
name|int
...
return|;
block|}
comment|/**    * Sets the minimum word length below which words will be ignored.    *    * @param minwl the minimum word length    * @return this    */
DECL|method|setMoreLikeThisMinWordLen
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the minimum word length below which words will be ignored.    */
DECL|method|getMoreLikeThisMinWordLen
specifier|public
name|int
...
return|;
block|}
comment|/**    * Sets the maximum word length above which words will be ignored.    *    * @param maxwl the maximum word length    * @return this    */
DECL|method|setMoreLikeThisMaxWordLen
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the maximum word length above which words will be ignored.    */
DECL|method|getMoreLikeThisMaxWordLen
specifier|public
name|int
...
return|;
block|}
comment|/**    * Sets the maximum number of query terms that will be included in any    * generated query.    *    * @param maxqt the maximum number of query terms    * @return this    */
DECL|method|setMoreLikeThisMaxQueryTerms
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the maximum number of query terms that will be included in any    * generated query.    */
DECL|method|getMoreLikeThisMaxQueryTerms
specifier|public
name|int
...
return|;
block|}
comment|/**    * Sets the maximum number of tokens to parse in each example doc field    * that is not stored with TermVector support.    *    * @param maxntp the maximum number of tokens to parse    * @return this    */
DECL|method|setMoreLikeThisMaxTokensParsed
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the maximum number of tokens to parse in each example doc field    * that is not stored with TermVector support.    */
DECL|method|getMoreLikeThisMaxTokensParsed
specifier|public
name|int
...
return|;
block|}
comment|/**    * Sets if the query will be boosted by the interesting term relevance.    *    * @param b set to true to boost the query with the interesting term relevance    * @return this    */
DECL|method|setMoreLikeThisBoost
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets if the query will be boosted by the interesting term relevance.    */
DECL|method|getMoreLikeThisBoost
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Sets the query fields and their boosts using the same format as that    * used in DisMaxQParserPlugin. These fields must also be added    * using {@link #addMoreLikeThisField(String)}.    *    * @param qf the query fields    * @return this    */
DECL|method|setMoreLikeThisQF
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the query fields and their boosts.    */
DECL|method|getMoreLikeThisQF
specifier|public
name|String
...
return|;
block|}
comment|/**    * Sets the number of similar documents to return for each result.    *    * @param count the number of similar documents to return for each result    * @return this    */
DECL|method|setMoreLikeThisCount
specifier|public
name|SolrQuery
...
return|;
block|}
comment|/**    * Gets the number of similar documents to return for each result.    */
DECL|method|getMoreLikeThisCount
specifier|public
name|int
...
return|;
block|}
comment|/**    * Enable/Disable MoreLikeThis. After enabling MoreLikeThis, the fields    * used for computing similarity must be specified calling    * {@link #addMoreLikeThisField(String)}.    *    * @param b flag to indicate if MoreLikeThis should be enabled. if b==false    * removes all mlt.* parameters    * @return this    */
DECL|method|setMoreLikeThis
specifier|public
name|SolrQuery
name|setMoreLikeThis
parameter_list|(
...
return|;
block|}
comment|/**    * @return true if MoreLikeThis is enabled, false otherwise    */
