...
return|;
block|}
DECL|method|getValueOperands
specifier|public
name|List
argument_list|<
name|String
argument_list|>
name|getValueOperands
parameter_list|(
name|StreamExpression
name|expression
parameter_list|)
...
return|;
block|}
DECL|method|doesRepresentTypes
specifier|public
name|boolean
...
name|ROOT
argument_list|,
literal|"Invalid expression %s - expecting a single '%s' parameter of type integer but didn't find one"
argument_list|,
name|expression
argument_list|,
name|paramName
...
name|ROOT
argument_list|,
literal|"invalid expression %s - %s '%s' is not a valid integer."
argument_list|,
name|expression
argument_list|,
name|paramName
...
name|ROOT
argument_list|,
literal|"Invalid expression %s - expecting a single '%s' parameter of type boolean but didn't find one"
argument_list|,
name|expression
argument_list|,
name|paramName
...
throw|;
block|}
DECL|method|constructEvaluator
specifier|public
name|StreamEvaluator
...
name|ROOT
argument_list|,
literal|"Invalid evaluator expression %s - function '%s' is unknown (not mapped to a valid StreamEvaluator)"
argument_list|,
name|expression
argument_list|,
name|expression
