...
name|StreamExpressionParameter
argument_list|>
name|selectAsFieldsExpressions
init|=
name|factory
operator|.
...
name|ROOT
argument_list|,
literal|"Invalid expression %s - evaluators must be given a name, like 'add(...) as result' but found %d evaluators without names"
argument_list|,
name|expression
argument_list|,
name|evaluatorExpressions
