...
begin_comment
comment|/**  * Connects to a datasource using a registered JDBC driver and execute a query. The results of  * that query will be returned as tuples. An EOF tuple will indicate that all have been read.  *   * Supported Datatypes for most types vary by JDBC driver based on the specific   * java type as reported by {@link java.sql.ResultSetMetaData#getColumnClassName(int)}.   * The exception are {@link Types#DATE}, {@link Types#TIME} or {@link Types#TIMESTAMP}  * which are determined by the JDBC type.  *   *<table rules="all" frame="box" cellpadding="3" summary="Supported Java Types">  *<tr>  *<th>Java or JDBC Type</th>  *<th>Tuple Type</th>  *<th>Notes</th>  *</tr>  *<tr>  *<td>Boolean</td>  *<td>Boolean</td>  *<td></td>  *</tr>  *<tr>  *<td>String</td>  *<td>String</td>  *<td></td>  *</tr>  *<tr>  *<td>Short, Integer, Long</td>  *<td>Long</td>  *<td></td>  *</tr>  *<tr>  *<td>Float, Double</td>  *<td>Double</td>  *<td></td>  *</tr>  *<tr>  *<td>{@link Clob} and subclasses</td>  *<td>String</td>  *<td>Clobs up to length 2<sup>31</sup>-1 are supported.</td>  *</tr>  *<tr>  *<td>Other subclasses of {@link Number}</td>  *<td>Long, Double</td>  *<td>Tuple Type based on {@link BigDecimal#scale()}.</td>  *</tr>  *<tr>  *<td>JDBC {@link Types#DATE}</td>  *<td>String</td>  *<td>yyyy-MM-dd, calls {@link Date#toString}</td>  *</tr>  *<tr>  *<td>JDBC {@link Types#TIME}</td>  *<td>String</td>  *<td>hh:mm:ss, calls {@link Time#toString}</td>  *</tr>  *<tr>  *<td>JDBC {@link Types#TIMESTAMP}</td>  *<td>String</td>  *<td>See {@link DateTimeFormatter#ISO_INSTANT}</td>  *</tr>  *</table>  *   **/
end_comment
...
name|ROOT
argument_list|,
literal|"Unable to determine the valueSelector for column '%s' (col #%d) of java class '%s' and type '%s'"
argument_list|,
name|columnName
argument_list|,
name|columnNumber
...
literal|null
decl_stmt|;
comment|// Directly supported types can be just directly returned - no conversion really necessary
if|if
condition|(
name|directSupportedTypes
operator|.
...
expr_stmt|;
block|}
comment|// We're checking the Java class names because there are lots of SQL types across
comment|// lots of database drivers that can be mapped to standard Java types. Basically,
comment|// this makes it easier and we don't have to worry about esoteric type names in the
comment|// JDBC family of types
elseif|else
if|if
condition|(
name|Short
...
expr_stmt|;
block|}
comment|// Here we are switching to check against the SQL type because date/times are
comment|// notorious for not being consistent. We don't know if the driver is mapping
comment|// to a java.time.* type or some old-school type.
elseif|else
if|if
condition|(
name|jdbcType
...
expr_stmt|;
block|}
comment|// Now we're going to start seeing if things are assignable from the returned type
comment|// to a more general type - this allows us to cover cases where something we weren't
comment|// explicitly expecting, but can handle, is being returned.
else|else
block|{
name|Class
argument_list|<
...
name|ROOT
argument_list|,
literal|"Encountered a clob of length #%l in column '%s' (col #%d).  Max supported length is #%i."
argument_list|,
name|length
argument_list|,
name|columnName
