...
begin_class
DECL|class|CumulativeProbabilityEvaluator
specifier|public
class|class
...
literal|1
decl_stmt|;
DECL|method|CumulativeProbabilityEvaluator
specifier|public
name|CumulativeProbabilityEvaluator
parameter_list|(
name|StreamExpression
...
name|ROOT
argument_list|,
literal|"Invalid expression %s - expecting two values (emperical distribution and a number) but found %d"
argument_list|,
name|expression
argument_list|,
name|subEvaluators
