...
literal|"connTimeout"
decl_stmt|;
comment|/**    * A Java system property to select the {@linkplain HttpClientBuilderFactory} used for    * configuring the {@linkplain HttpClientBuilder} instance by default.    */
DECL|field|SYS_PROP_HTTP_CLIENT_BUILDER_FACTORY
specifier|public
specifier|static
specifier|final
name|String
name|SYS_PROP_HTTP_CLIENT_BUILDER_FACTORY
init|=
literal|"solr.httpclient.builder.factory"
decl_stmt|;
DECL|field|NO_RETRY
specifier|static
specifier|final
...
argument_list|()
expr_stmt|;
comment|// Configure the HttpClientBuilder if user has specified the factory type.
name|String
...
argument_list|(
literal|"Unable to instantiate Solr HttpClientBuilderFactory"
argument_list|,
name|e
argument_list|)
throw|;
