...
name|HttpClientFactory
block|{
DECL|field|defaultHttpClientClass
specifier|private
specifier|static
name|Class
argument_list|<
...
name|class
decl_stmt|;
DECL|field|systemDefaultHttpClientClass
specifier|private
specifier|static
name|Class
argument_list|<
...
name|SystemDefaultHttpClient
argument_list|>
name|systemDefaultHttpClientClass
init|=
name|SystemDefaultHttpClient
operator|.
name|class
...
name|SERVER_ERROR
argument_list|,
literal|"Unable to create HttpClient instance. "
argument_list|,
name|e
argument_list|)
throw|;
...
name|SERVER_ERROR
argument_list|,
literal|"Unable to create HttpClient instance, registered class is: "
operator|+
name|defaultHttpClientClass
argument_list|,
name|e
