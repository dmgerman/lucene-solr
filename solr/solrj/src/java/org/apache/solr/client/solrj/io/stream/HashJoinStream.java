...
name|ROOT
argument_list|,
literal|"Invalid expression %s - invalid 'on' parameter - expecting 1 or more instances if 'field' or 'field=hashedField' but found '%s'"
argument_list|,
name|hasher
argument_list|)
argument_list|)
...
expr_stmt|;
block|}
comment|// we know that left and right hashOns are the same size
name|String
name|left
init|=
name|leftHashOn
...
argument_list|)
expr_stmt|;
comment|// this is here to separate fields
block|}
return|return
name|sb
operator|.
