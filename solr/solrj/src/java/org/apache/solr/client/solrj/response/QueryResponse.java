...
literal|null
decl_stmt|;
DECL|field|_moreLikeThisInfo
specifier|private
name|NamedList
argument_list|<
name|SolrDocumentList
argument_list|>
name|_moreLikeThisInfo
init|=
literal|null
decl_stmt|;
...
literal|null
decl_stmt|;
comment|// Clustering Response
DECL|field|_clusterResponse
specifier|private
name|ClusteringResponse
name|_clusterResponse
init|=
literal|null
decl_stmt|;
comment|// Suggester Response
DECL|field|_suggestResponse
specifier|private
name|SuggesterResponse
name|_suggestResponse
init|=
literal|null
decl_stmt|;
...
expr_stmt|;
block|}
DECL|method|extractClusteringInfo
specifier|private
name|void
name|extractClusteringInfo
parameter_list|(
...
expr_stmt|;
block|}
DECL|method|extractSuggesterInfo
specifier|private
name|void
name|extractSuggesterInfo
parameter_list|(
...
block|}
block|}
DECL|method|extractRangeFacets
specifier|private
name|List
argument_list|<
name|RangeFacet
...
return|;
block|}
comment|/**    *    * @return map with each group value as key and the expanded documents that belong to the group as value.    * There is no guarantee on the order of the keys obtained via an iterator.    *    */
...
return|;
block|}
DECL|method|getClusteringResponse
specifier|public
name|ClusteringResponse
...
return|;
block|}
DECL|method|getSuggesterResponse
specifier|public
name|SuggesterResponse
