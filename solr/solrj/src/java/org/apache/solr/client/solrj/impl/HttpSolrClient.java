...
name|soTimeout
decl_stmt|;
comment|/**    * @param baseURL    *          The URL of the Solr server. For example, "    *<code>http://localhost:8983/solr/</code>" if you are using the    *          standard distribution Solr webapp on your local machine.    * @deprecated use {@link Builder} instead.    */
annotation|@
name|Deprecated
...
expr_stmt|;
block|}
comment|/**    * @deprecated use {@link Builder} instead.  This will soon be a 'protected'    * method, and will only be available for use in implementing subclasses.    */
annotation|@
name|Deprecated
DECL|method|HttpSolrClient
specifier|public
...
expr_stmt|;
block|}
comment|/**    * The consturctor.    *    * @param baseURL The base url to communicate with the Solr server    * @param client Http client instance to use for communication    * @param parser Response parser instance to use to decode response from Solr server    * @param allowCompression Should compression be allowed ?    * @param invariantParams The parameters which should be included with every request.    */
DECL|method|HttpSolrClient
specifier|protected
name|HttpSolrClient
parameter_list|(
...
block|}
block|}
comment|// TODO: remove deprecated - first simple attempt failed, see {@link MultipartEntityBuilder}
if|if
condition|(
name|isMultipart
operator|&&
...
expr_stmt|;
block|}
comment|/**    * Close the {@link HttpClientConnectionManager} from the internal client.    */
annotation|@
name|Override
DECL|method|close
specifier|public
...
block|}
block|}
comment|/**    * Constructs {@link HttpSolrClient} instances from provided configuration.    */
DECL|class|Builder
specifier|public
specifier|static
class|class
...
return|;
block|}
comment|/**      * Create a Builder object, based on the provided Solr URL.      *       * By default, compression is not enabled in created HttpSolrClient objects.      *       * @param baseSolrUrl the base URL of the Solr server that will be targeted by any created clients.      */
DECL|method|Builder
specifier|public
name|Builder
parameter_list|(
...
return|;
block|}
comment|/**      * Chooses whether created {@link HttpSolrClient}s use compression by default.      */
DECL|method|allowCompression
specifier|public
name|Builder
name|allowCompression
parameter_list|(
...
return|;
block|}
comment|/**      * Use a delegation token for authenticating via the KerberosPlugin      */
DECL|method|withKerberosDelegationToken
specifier|public
name|Builder
...
annotation|@
name|Deprecated
comment|/**      * @deprecated use {@link withKerberosDelegationToken(String)} instead      */
DECL|method|withDelegationToken
specifier|public
name|Builder
name|withDelegationToken
parameter_list|(
...
return|;
block|}
DECL|method|withInvariantParams
specifier|public
name|Builder
name|withInvariantParams
parameter_list|(
name|ModifiableSolrParams
name|params
parameter_list|)
...
name|params
argument_list|,
literal|"params must be non null!"
argument_list|)
expr_stmt|;
for|for
control|(
