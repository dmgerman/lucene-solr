...
argument_list|)
expr_stmt|;
comment|//Taken from Field evaluator
if|if
condition|(
name|fieldName
operator|!=
...
name|ROOT
argument_list|,
literal|"Invalid field %s - The field must be a string formatted in the ISO_INSTANT date format."
argument_list|,
name|fieldName
argument_list|)
argument_list|)
...
name|ROOT
argument_list|,
literal|"Invalid field %s - The field must be a string formatted ISO_INSTANT or of type Instant,Date or LocalDateTime."
argument_list|,
name|fieldName
argument_list|)
argument_list|)
