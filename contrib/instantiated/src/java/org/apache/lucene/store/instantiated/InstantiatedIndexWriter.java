...
argument_list|)
expr_stmt|;
comment|// todo: not sure this needs to be interned?
name|tokens
operator|.
name|add
argument_list|(
...
literal|1
decl_stmt|;
comment|//private int dimensions = 0; // this is futuristic
DECL|field|position
specifier|private
name|int
name|position
...
literal|false
decl_stmt|;
comment|//private float norm;
comment|//private byte encodedNorm;
DECL|method|equals
specifier|public
name|boolean
name|equals
