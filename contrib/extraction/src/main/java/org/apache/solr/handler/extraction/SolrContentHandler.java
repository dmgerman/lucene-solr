...
block|}
block|}
comment|//make sure we have a unique id, if one is needed
name|SchemaField
name|uniqueField
init|=
name|schema
...
parameter_list|)
block|{
comment|//we don't have a unique field specified, so let's add one
name|String
name|uniqId
init|=
literal|null
...
condition|)
block|{
comment|//last chance, just create one
name|uniqId
operator|=
name|UUID
operator|.
