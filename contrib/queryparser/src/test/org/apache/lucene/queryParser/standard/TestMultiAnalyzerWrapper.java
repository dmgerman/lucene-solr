...
begin_comment
comment|/**  * This test case is a copy of the core Lucene query parser test, it was adapted  * to use new QueryParserWrapper instead of the old query parser.  *   * Test QueryParser's ability to deal with Analyzers that return more than one  * token per position or that return tokens with a position increment&gt; 1.  *   */
end_comment

begin_class
DECL|class|TestMultiAnalyzerWrapper
specifier|public
class|class
name|TestMultiAnalyzerWrapper
extends|extends
name|LuceneTestCase
block|{
...
expr_stmt|;
block|}
comment|/*      * (non-Javadoc)      *       * @see      * org.apache.lucene.analysis.TokenStream#next(org.apache.lucene.analysis      * .Token)      */
annotation|@
name|Override
DECL|method|next
specifier|public
