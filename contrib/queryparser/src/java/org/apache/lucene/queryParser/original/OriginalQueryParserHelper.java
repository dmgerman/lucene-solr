...
name|QueryParserHelper
block|{
comment|/**    * Constructs a {@link OriginalQueryParserHelper} object.    */
DECL|method|OriginalQueryParserHelper
specifier|public
name|OriginalQueryParserHelper
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/**    * Constructs a {@link OriginalQueryParserHelper} object and sets an    * {@link Analyzer} to it. The same as:    *     *<ul>    * OriginalQueryParserHelper qp = new OriginalQueryParserHelper();    * qp.getQueryConfigHandler().setAnalyzer(analyzer);    *</ul>    *     * @param analyzer    *          the analyzer to be used by this query parser helper    */
DECL|method|OriginalQueryParserHelper
specifier|public
name|OriginalQueryParserHelper
parameter_list|(
...
block|{
return|return
literal|"<OriginalQueryParserHelper config=\""
operator|+
name|this
operator|.
