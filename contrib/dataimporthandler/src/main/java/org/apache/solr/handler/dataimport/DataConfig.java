...
begin_comment
comment|/**  *<p>  * Mapping for data-config.xml  *</p>  *<p/>  *<p>  * Refer to<a  * href="http://wiki.apache.org/solr/DataImportHandler">http://wiki.apache.org/solr/DataImportHandler</a>  * for more details.  *</p>  *<p/>  *<b>This API is experimental and subject to change</b>  *  * @version $Id$  * @since solr 1.3  */
end_comment
...
argument_list|)
expr_stmt|;
comment|// entities = new Entity(l.get(0));
name|l
operator|=
name|getChildNodes
argument_list|(
...
name|colNameVsField
decl_stmt|;
DECL|field|lowercaseColNameVsField
specifier|public
name|Map
argument_list|<
name|String
...
name|Field
argument_list|>
name|lowercaseColNameVsField
decl_stmt|;
DECL|field|rootEntity
specifier|public
name|Entity
name|rootEntity
decl_stmt|;
