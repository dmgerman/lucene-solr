...
expr_stmt|;
block|}
comment|/**    *     * A fake IndexReader class to extract the field from a MultiTermQuery    *     */
...
name|FilterIndexReader
block|{
DECL|field|EMPTY_MEMORY_INDEX_READER
specifier|private
specifier|static
specifier|final
name|IndexReader
name|EMPTY_MEMORY_INDEX_READER
init|=
operator|new
name|MemoryIndex
argument_list|()
...
name|IOException
block|{
comment|// only set first fieldname, maybe use a Set?
if|if
condition|(
name|t
operator|!=
