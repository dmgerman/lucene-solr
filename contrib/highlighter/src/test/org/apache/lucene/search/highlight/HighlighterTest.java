...
decl_stmt|;
comment|//Need to explicitly set the QueryParser property to use RangeQuery rather than RangeFilters
name|QueryParser
name|parser
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//add another tokenized word to the overrall length - but set way beyond
comment|//the length of text under consideration (after a large slug of stop words + whitespace)
name|sb
operator|.
name|append
argument_list|(
...
decl_stmt|;
comment|//run the highlighter on the raw content (scorer does not score any tokens for
...
argument_list|)
expr_stmt|;
comment|/////////////////// same tests, just put the bigger overlapping token first
name|query
operator|=
operator|new
name|QueryParser
