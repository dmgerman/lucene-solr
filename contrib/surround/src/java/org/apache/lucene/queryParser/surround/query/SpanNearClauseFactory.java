...
expr_stmt|;
block|}
comment|/* CHECKME: Does the underlying implementation of SpanQuery need sorting? */
if|if
condition|(
literal|false
condition|)
comment|/* true when sorting needed */
name|Arrays
operator|.
name|sort
argument_list|(
...
name|o2
decl_stmt|;
comment|/* compare the text of the first term of each SpanQuery */
return|return
operator|(
operator|(
name|Term
