...
name|StorageException
argument_list|(
literal|"entry version must be 1"
argument_list|)
throw|;
if|if
condition|(
...
name|StorageException
argument_list|(
literal|"ProvidedService must not be null"
argument_list|)
throw|;
...
argument_list|()
decl_stmt|;
comment|// try to set concurrency Lock
name|String
name|key
init|=
name|entry
...
name|ModificationConflictException
argument_list|(
literal|"The entry version does not match -- entry "
operator|+
name|entry
operator|.
name|getId
...
argument_list|()
expr_stmt|;
comment|// release lock for concurrency
name|releaseLock
argument_list|(
name|key
argument_list|)
...
name|StorageException
argument_list|(
literal|"service config is not set -- null"
argument_list|)
throw|;
if|if
condition|(
...
name|ModificationConflictException
argument_list|(
literal|"Can not set lock for entry -- "
operator|+
name|key
argument_list|)
throw|;
...
name|StorageException
argument_list|(
literal|"Can not release lock for key: "
operator|+
name|key
argument_list|)
throw|;
