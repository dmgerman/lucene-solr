...
decl_stmt|;
comment|/*      * client api uses UTF-8 to encode server requests and entries      */
...
literal|"timestamp"
decl_stmt|;
comment|/**      * lucene field name entry version      */
DECL|field|FIELD_VERSION
specifier|public
specifier|final
specifier|static
name|String
...
return|;
block|}
comment|/**      * @return - the version of the entry      */
