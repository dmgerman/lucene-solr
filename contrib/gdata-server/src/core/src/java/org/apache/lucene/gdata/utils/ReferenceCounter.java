...
argument_list|()
decl_stmt|;
comment|/**       * @param resource -       *            the resource to track       *        */
...
expr_stmt|;
block|}
comment|/**       *        * Decrements the reference. If no references remain the       * {@link ReferenceCounter#close()} method will be invoked;       */
...
parameter_list|()
block|{
comment|/*          * close if less or equals 0          */
if|if
condition|(
name|this
operator|.
...
parameter_list|()
function_decl|;
comment|/**       * Increments the reference       *        * @return the reference object       */
