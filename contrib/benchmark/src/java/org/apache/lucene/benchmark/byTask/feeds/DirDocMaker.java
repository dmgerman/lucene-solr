...
begin_comment
comment|/**  * A DocMaker using the Dir collection for its input.  *  * Config properties:  * docs.dir=&lt;path to the docs dir| Default: dir-out&gt;   *  */
end_comment

begin_class
DECL|class|DirDocMaker
specifier|public
class|class
name|DirDocMaker
extends|extends
...
throw|;
block|}
comment|// date format: 30-MAR-1987 14:22:36
name|dateFormat
operator|=
operator|new
name|SimpleDateFormat
argument_list|(
literal|"dd-MMM-yyyy kk:mm:ss"
argument_list|,
name|Locale
operator|.
name|US
