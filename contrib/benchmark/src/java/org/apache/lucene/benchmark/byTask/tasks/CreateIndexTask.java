...
begin_comment
comment|/**  * Create an index.  *<br>Other side effects: index writer object in perfRunData is set.  *<br>Relevant properties:<code>merge.factor, max.buffered,  *  max.field.length</code>.  */
end_comment
