...
argument_list|()
decl_stmt|;
comment|// TODO: Make this use the SolrJ API, rather than "embedded" Solr API
name|context
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO: inject a SolrRequest instead of a SolrQueryRequest
name|context
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// TODO: inject a SolrResponse instead of a SolrQueryResponse
name|context
operator|.
name|put
argument_list|(
