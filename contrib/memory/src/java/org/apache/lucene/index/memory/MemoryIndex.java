...
name|sortedFields
decl_stmt|;
comment|/** template terms sorted ascending by fieldName; lazily computed on demand */
DECL|field|sortedTemplates
specifier|private
specifier|transient
name|Term
index|[]
name|sortedTemplates
decl_stmt|;
...
parameter_list|)
block|{
comment|// used by MemoryIndexReader.terms().term()
