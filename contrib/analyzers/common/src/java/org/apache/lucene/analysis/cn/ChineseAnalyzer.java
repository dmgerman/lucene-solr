...
name|ReusableAnalyzerBase
block|{
comment|/**    * Creates {@link TokenStreamComponents} used to tokenize all the text in the    * provided {@link Reader}.    *     * @return {@link TokenStreamComponents} built from a    *         {@link ChineseTokenizer} filtered with {@link ChineseFilter}    */
annotation|@
name|Override
