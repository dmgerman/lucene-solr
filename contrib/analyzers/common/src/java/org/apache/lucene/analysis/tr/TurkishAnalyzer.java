...
begin_comment
comment|/**  * {@link Analyzer} for Turkish.  */
end_comment

begin_class
DECL|class|TurkishAnalyzer
specifier|public
specifier|final
class|class
...
expr_stmt|;
block|}
comment|/**    * Creates a {@link TokenStreamComponents} which tokenizes all the text in the provided    * {@link Reader}.    *     * @return A {@link TokenStreamComponents} built from an {@link StandardTokenizer}    *         filtered with {@link StandardFilter}, {@link TurkishLowerCaseFilter},    *         {@link StopFilter}, {@link KeywordMarkerTokenFilter} if a stem    *         exclusion set is provided and {@link SnowballFilter}.    */
annotation|@
name|Override
