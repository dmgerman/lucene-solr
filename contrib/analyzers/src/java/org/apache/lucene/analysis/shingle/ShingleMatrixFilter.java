...
DECL|enum|TokenPositioner
specifier|public
specifier|static
enum|enum
name|TokenPositioner
block|{
DECL|enum constant|newColumn
name|newColumn
argument_list|(
literal|0
argument_list|)
block|,
DECL|enum constant|newRow
name|newRow
argument_list|(
literal|1
argument_list|)
block|,
DECL|enum constant|sameRow
name|sameRow
argument_list|(
literal|2
argument_list|)
...
argument_list|)
decl_stmt|;
comment|// paranormal abillity to forsay the future.
for|for
control|(
name|Token
name|shingleToken
