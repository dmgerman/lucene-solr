...
name|index
decl_stmt|;
comment|/**    * Create a new SegToken from a {@link String}    *     * @param word String containing text    * @param start start offset into word    * @param end end offset of word    * @param wordType {@link WordType} of the text    * @param weight word frequency    */
