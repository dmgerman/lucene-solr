...
expr_stmt|;
block|}
comment|/** @see TestRemoveDuplicatesTokenFilter */
...
expr_stmt|;
block|}
DECL|method|testSimpleFacetCountsWithLimits
specifier|public
name|void
name|testSimpleFacetCountsWithLimits
parameter_list|()
block|{
name|assertU
argument_list|(
...
argument_list|)
argument_list|,
literal|"*[count(//lst[@name='facet_fields']/lst[@name='t_s']/int)=7]"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='G'][.='5']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='E'][.='3']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='C'][.='2']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='A'][.='1']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='B'][.='1']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='D'][.='1']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='F'][.='1']"
argument_list|)
expr_stmt|;
name|assertQ
argument_list|(
...
literal|"*[count(//lst[@name='facet_fields']/lst[@name='t_s']/int)=7]"
argument_list|,
literal|"//lst[@name='t_s']/int[1][@name='G'][.='5']"
argument_list|,
literal|"//lst[@name='t_s']/int[2][@name='E'][.='3']"
argument_list|,
literal|"//lst[@name='t_s']/int[3][@name='C'][.='2']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='A'][.='1']"
argument_list|,
literal|"//lst[@name='t_s']/int[@name='B'][.='1']"
...
argument_list|)
argument_list|,
literal|"*[count(//lst[@name='facet_fields']/lst[@name='t_s']/int)=2]"
argument_list|,
literal|"//lst[@name='t_s']/int[1][@name='G'][.='5']"
argument_list|,
literal|"//lst[@name='t_s']/int[2][@name='E'][.='3']"
