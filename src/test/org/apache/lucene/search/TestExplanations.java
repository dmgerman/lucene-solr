...
argument_list|)
expr_stmt|;
comment|//searcher = new IndexSearcher(directory);
block|}
...
return|;
block|}
comment|/**    * MACRO: Wraps a Query in a BooleanQuery so that it is optional, along    * with a second clause which will never match anything    */
DECL|method|optB
specifier|public
name|Query
name|optB
...
return|;
block|}
comment|/**    * MACRO: Wraps a Query in a BooleanQuery so that it is required, along    * with a second clause which will never match anything    */
DECL|method|reqB
specifier|public
name|Query
name|reqB
