...
comment|// documents.  Then, we increase disk space by 1000
...
argument_list|)
expr_stmt|;
comment|/*               for(int i=0;i<startFiles.length;i++) {               System.out.println("  " + i + ": " + startFiles[i]);               }             */
if|if
condition|(
operator|!
name|Arrays
...
argument_list|()
expr_stmt|;
comment|// Try again with 1000 more bytes of free space:
name|diskFree
operator|+=
literal|1000
expr_stmt|;
