...
control|)
block|{
comment|// mix the bits so that sortFields are position dependent
comment|// so that a,b won't hash to the same value as b,a
name|h
operator|^=
operator|(
name|h
...
literal|false
return|;
comment|// NOTE: the factory must be identical!!! use singletons!
block|}
return|return
literal|true
return|;
