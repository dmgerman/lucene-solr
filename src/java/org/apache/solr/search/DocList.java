...
begin_comment
comment|/**  *<code>DocList</code> represents the result of a query: an ordered list of document ids with optional score.  * This list contains a subset of the complete list of documents actually matched:<code>size()</code>  * document ids starting at<code>offset()</code>.  *  * @author yonik  * @version $Id: DocList.java,v 1.6 2005/11/11 21:57:56 yonik Exp $  * @since solr 0.9  */
end_comment
