...
argument_list|)
expr_stmt|;
comment|// Only do minimum-match logic
name|String
name|minShouldMatch
init|=
name|solrParams
...
literal|false
expr_stmt|;
comment|// make boolean queries instead
name|pp
operator|.
name|setRemoveStopFilter
argument_list|(
...
literal|2
expr_stmt|;
comment|// if a stopword is removed, don't add the phrase
...
literal|2
expr_stmt|;
comment|// keep min phrase size at 2 since stopword could have been removed in middle
name|Query
name|phrase
init|=
name|pp
