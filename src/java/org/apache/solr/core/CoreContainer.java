...
expr_stmt|;
block|}
comment|/**    * Load a config file listing the available solr cores.    *     * @param dir the home directory of all resources.    * @param cfgis the configuration file InputStream    * @param configName    * @throws ParserConfigurationException    * @throws IOException    * @throws SAXException    */
DECL|method|load
specifier|public
name|void
name|load
