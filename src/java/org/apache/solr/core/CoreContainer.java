...
expr_stmt|;
block|}
comment|// ---------------- CoreDescriptor related methods ---------------
...
return|;
block|}
comment|/**    * @return a Collection of registered CoreDescriptors    */
...
return|;
block|}
comment|/**    * @return the CoreDescriptor registered under that name    */
...
block|}
block|}
comment|/** Removes& closes a registered core. */
DECL|method|remove
specifier|public
name|void
name|remove
...
return|;
comment|// solr-647
comment|//      if (core != null)
comment|//        return core.open();
comment|//      return null;
block|}
block|}
