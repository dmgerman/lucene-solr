...
begin_comment
comment|/**  * This class provides a simple harness that may be usefull when  * writing testcasses.  *  *<p>  * This class lives in the main source tree (and not in the test source  * tree) so that it will be included with even the most minimal solr  * distribution -- to encourage plugin writers to creat unit tests for their  * plugins.  *  * @author hossman  * @version $Id:$  */
end_comment
...
expr_stmt|;
block|}
comment|/**    * @param dataDirectory path for index data, will not be cleaned up    * @param confFile solrconfig filename    * @param schemaFile schema filename    */
DECL|method|TestHarness
specifier|public
name|TestHarness
parameter_list|(
