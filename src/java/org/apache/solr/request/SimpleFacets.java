...
condition|)
block|{
comment|// This is an optimization... if mincount<=0 and we aren't sorting then
comment|// we know exactly where to start and end in the fieldcache.
for|for
control|(
name|int
name|i
...
condition|)
block|{
comment|/* check df since all docs may be deleted */
name|int
name|c
init|=
name|searcher
