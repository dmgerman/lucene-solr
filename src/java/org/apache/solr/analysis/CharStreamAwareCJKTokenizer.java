...
begin_class
DECL|class|CharStreamAwareCJKTokenizer
specifier|public
specifier|final
class|class
name|CharStreamAwareCJKTokenizer
extends|extends
name|Tokenizer
block|{
...
DECL|method|CharStreamAwareCJKTokenizer
specifier|public
name|CharStreamAwareCJKTokenizer
parameter_list|(
name|CharStream
...
condition|)
block|{
comment|// Don't return an empty string - recurse to get the next token
return|return
name|next
argument_list|(
name|reusableToken
