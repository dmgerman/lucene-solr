...
begin_interface
DECL|interface|SolrFragmentsBuilder
specifier|public
interface|interface
...
parameter_list|)
function_decl|;
comment|/**    * Return a FragmentsBuilder appropriate for this field.    *     * @param fieldName The name of the field    * @param params The params controlling Highlighting    * @return An appropriate FragmentsBuilder.    */
