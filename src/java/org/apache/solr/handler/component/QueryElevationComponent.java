...
name|SERVER_ERROR
argument_list|,
literal|"The QueryElevationComponent needs to be registered 'after' the query component"
argument_list|)
throw|;
block|}
name|String
...
begin_comment
comment|/**  * Comparator source that knows about elevated documents  */
end_comment
...
name|IOException
block|{
comment|// A future alternate version could store internal docids (would need to be regenerated per IndexReader)
comment|// instead of loading the FieldCache instance into memory.
specifier|final
name|FieldCache
operator|.
name|StringIndex
