...
return|;
block|}
comment|/** Moves iterator to the next doc and returns its id;       returns -1 when this iterator is exhausted. */
DECL|method|nextDoc
specifier|public
name|int
name|nextDoc
...
return|;
block|}
comment|/** Behaves like {@link #skipTo(int)} and returns the docId the iterator    *  skipped to; returns -1 if no valid document could be skipped to. */
DECL|method|next
specifier|public
name|int
name|next
