...
return|;
block|}
comment|/**    * creates a weight for<code>query</code>    *     * @deprecated use {@link #createQueryWeight(Query)} instead.    */
...
name|IOException
function_decl|;
comment|/** @deprecated use {@link #search(QueryWeight, Filter, int)} instead. */
DECL|method|search
specifier|public
name|TopDocs
name|search
...
name|IOException
function_decl|;
comment|/** @deprecated use {@link #explain(QueryWeight, int)} instead. */
DECL|method|explain
specifier|public
name|Explanation
name|explain
...
name|IOException
function_decl|;
comment|/** @deprecated use {@link #search(QueryWeight, Filter, int, Sort)} instead. */
DECL|method|search
specifier|public
name|TopFieldDocs
name|search
