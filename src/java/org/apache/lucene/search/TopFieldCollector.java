...
begin_comment
comment|/**  * A {@link Collector} that sorts by {@link SortField} using  * {@link FieldComparator}s.  *   *<p><b>NOTE:</b> This API is experimental and might change in  * incompatible ways in the next release.</p>  */
end_comment
...
expr_stmt|;
block|}
comment|// Compute score only if it competitive.
specifier|final
name|float
name|score
init|=
