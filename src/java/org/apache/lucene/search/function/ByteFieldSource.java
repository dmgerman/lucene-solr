...
name|parser
decl_stmt|;
comment|/**    * Create a cached byte field source with default string-to-byte parser.     */
...
expr_stmt|;
block|}
comment|/**    * Create a cached byte field source with a specific string-to-byte parser.     */
DECL|method|ByteFieldSource
specifier|public
name|ByteFieldSource
parameter_list|(
