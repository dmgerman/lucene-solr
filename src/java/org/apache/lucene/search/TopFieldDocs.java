...
begin_comment
comment|/**  * Expert: Returned by low-level sorted search implementations.  *  *<p>Created: Feb 12, 2004 8:58:46 AM   *  * @since   lucene 1.4  * @version $Id$  * @see Searcher#search(Query,Filter,int,Sort)  */
end_comment
