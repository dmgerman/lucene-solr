...
return|;
block|}
comment|/**    * @deprecated This class was used in previous FuzzyQuery implementations, but is now replaced by    * a new rewrite mode {@link MultiTermQuery#TOP_TERMS_SCORING_BOOLEAN_REWRITE}.    */
annotation|@
name|Deprecated
