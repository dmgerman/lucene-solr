...
comment|// TODO: by default we should create a TopFieldCollector which does not
comment|// track document scores and maxScore. Currently the default is set to true,
comment|// however it will change in 3.0.
