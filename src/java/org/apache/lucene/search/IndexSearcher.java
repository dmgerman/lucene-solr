...
return|;
block|}
comment|/**    * Just like {@link #search(QueryWeight, Filter, int, Sort)}, but you choose    * whether or not the fields in the returned {@link FieldDoc} instances should    * be set by specifying fillFields.<br>    *<b>NOTE:</b> currently, this method tracks document scores and sets them in    * the returned {@link FieldDoc}, however in 3.0 it will move to not track    * document scores. If document scores tracking is still needed, you can use    * {@link #search(QueryWeight, Filter, Collector)} and pass in a    * {@link TopFieldCollector} instance.    */
DECL|method|search
specifier|public
name|TopFieldDocs
name|search
