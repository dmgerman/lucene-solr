...
condition|)
block|{
comment|// We can optimize this case (doing a bulk
comment|// byte copy) since the field numbers are
comment|// identical
name|int
name|start
init|=
...
expr_stmt|;
comment|// If the TV* files are an older format then they
comment|// cannot read raw docs:
if|if
condition|(
name|matchingVectorsReader
operator|!=
...
DECL|method|appendPostingsNoTf
specifier|private
specifier|final
name|int
name|appendPostingsNoTf
