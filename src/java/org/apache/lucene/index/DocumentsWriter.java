...
condition|)
block|{
comment|// Fallback to String token
name|tokenString
operator|=
name|token
operator|.
...
argument_list|)
expr_stmt|;
comment|// System.out.println("  addPosition: field=" + fieldInfo.name + " string=" + tokenString + " pos=" + position + " offsetStart=" + (offset+token.startOffset()) + " offsetEnd=" + (offset+token.endOffset()) + " docID=" + docID + " doPos=" + doVectorPositions + " doOffset=" + doVectorOffsets);
block|}
else|else
block|{
name|tokenString
...
index|]
expr_stmt|;
comment|// System.out.println("  addPosition: buffer=" + new String(tokenText, tokenTextOffset, tokenTextLen) + " pos=" + position + " offsetStart=" + (offset+token.startOffset()) + " offsetEnd=" + (offset + token.endOffset()) + " docID=" + docID + " doPos=" + doVectorPositions + " doOffset=" + doVectorOffsets);
block|}
name|int
name|hashPos
init|=
