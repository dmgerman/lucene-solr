...
name|infoStream
decl_stmt|;
comment|// This Hashmap buffers delete terms in ram before they
comment|// are applied.  The key is delete term; the value is
comment|// number of buffered documents the term applies to.
...
literal|4
decl_stmt|;
comment|// TODO: should be 8 on 64-bit platform
DECL|field|BYTES_PER_CHAR
specifier|private
specifier|static
name|int
name|BYTES_PER_CHAR
...
argument_list|)
expr_stmt|;
comment|// This is coarse approximation of actual bytes used:
name|numBytesUsed
operator|+=
operator|(
name|term
