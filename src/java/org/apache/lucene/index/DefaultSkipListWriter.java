...
begin_comment
comment|/**  * Implements the skip list writer for the default posting list format  * that stores positions and payloads.  *  */
end_comment
...
name|curDoc
expr_stmt|;
comment|//System.out.println("write doc at level " + level + ": " + curDoc);
name|lastSkipFreqPointer
index|[
name|level
index|]
