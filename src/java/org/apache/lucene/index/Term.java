...
name|text
decl_stmt|;
comment|/** Constructs a Term with the given field and text.    *<p>Note that a text value of null results in undefined    * behavior for most Lucene APIs that accept a Term parameter. */
DECL|method|Term
specifier|public
name|Term
parameter_list|(
