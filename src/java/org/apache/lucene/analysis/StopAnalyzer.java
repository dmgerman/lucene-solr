...
decl_stmt|;
comment|/** An array containing some common English words that are not usually useful     for searching.      @deprecated Use {@link #ENGLISH_STOP_WORDS_SET} instead */
...
expr_stmt|;
block|}
comment|/** Builds an analyzer which removes words in the provided array.    * @deprecated Use {@link #StopAnalyzer(Set, boolean)} instead */
DECL|method|StopAnalyzer
specifier|public
name|StopAnalyzer
parameter_list|(
