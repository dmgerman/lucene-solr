...
block|}
block|}
comment|/**    * Empty {@link UnmodifiableCharArraySet} optimized for speed.    * Contains checks will always return<code>false</code> or throw    * NPE if necessary.    */
DECL|class|EmptyCharArraySet
specifier|private
specifier|static
specifier|final
class|class
