...
name|SERVER_ERROR
argument_list|,
literal|"Multicore configuration does not include a default"
argument_list|)
throw|;
block|}
name|singlecore
...
comment|// Only the first registerd core configures the following attributes
name|Config
name|solrConfig
init|=
name|core
...
name|BAD_REQUEST
argument_list|,
literal|"MultiCore path must contain a '/'.  For example: /@corename/handlerpath"
argument_list|)
throw|;
block|}
name|corename
