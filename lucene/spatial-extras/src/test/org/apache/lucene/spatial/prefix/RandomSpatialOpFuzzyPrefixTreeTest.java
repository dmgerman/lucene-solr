...
annotation|@
name|Test
DECL|method|testPackedQuadPointsOnlyBug
specifier|public
name|void
name|testPackedQuadPointsOnlyBug
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// packed quad.  maxLevels doesn't matter.
name|setupCtx2D
argument_list|(
name|ctx
argument_list|)
...
annotation|@
name|Test
DECL|method|testPointsOnlyOptBug
specifier|public
name|void
name|testPointsOnlyOptBug
parameter_list|()
throws|throws
name|IOException
block|{
