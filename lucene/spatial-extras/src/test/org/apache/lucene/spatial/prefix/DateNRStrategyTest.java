...
annotation|@
name|Test
DECL|method|testLastMillionYearPeriod
specifier|public
name|void
name|testLastMillionYearPeriod
parameter_list|()
throws|throws
name|Exception
block|{
...
name|parseShape
argument_list|(
literal|"+292220922-05-17T18:01:57.572"
argument_list|)
argument_list|,
comment|// a year in the last million year period (>=292M)
name|SpatialOperation
operator|.
name|Intersects
argument_list|,
