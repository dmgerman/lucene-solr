...
return|;
block|}
comment|/**    * Returns true if the {@code shape} is a {@link Point}.  For custom spatial contexts, it may make sense to    * have certain other shapes return true.    * @lucene.experimental    */
