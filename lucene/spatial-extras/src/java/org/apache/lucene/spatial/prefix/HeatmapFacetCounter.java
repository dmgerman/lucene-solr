...
argument_list|()
decl_stmt|;
comment|// from a cell (thus doesn't cross DL)
specifier|final
name|int
name|count
init|=
...
block|{
comment|// note: the cell rect might intersect 2 disjoint parts of the heatmap, so we do the left& right separately
specifier|final
name|int
name|leftColumns
init|=
