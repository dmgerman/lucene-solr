...
argument_list|)
decl_stmt|;
DECL|field|doFlipBitsDuringCopy
specifier|final
name|boolean
...
name|startNS
decl_stmt|;
comment|// TODO: maybe ... place some sort of time limit on how long we are willing to wait for slow replica(s) to finish copying?
while|while
condition|(
name|preCopy
operator|.
...
name|message
argument_list|(
literal|"top: warning: now randomly dropping replica from merge warming; files="
operator|+
name|files
operator|.
name|keySet
...
name|message
argument_list|(
literal|"send NEW_NRT_POINT to R"
operator|+
name|replicaID
operator|+
literal|" at tcpPort="
...
literal|19
decl_stmt|;
DECL|field|CMD_DELETE_ALL_DOCS
specifier|static
specifier|final
name|byte
name|CMD_DELETE_ALL_DOCS
...
block|}
block|}
DECL|method|verifyAtLeastMarkerCount
specifier|private
name|void
name|verifyAtLeastMarkerCount
parameter_list|(
...
argument_list|(
literal|"at flush: marker count "
operator|+
name|hitCount
operator|+
literal|" but expected at least "
operator|+
name|expectedAtLeastCount
operator|+
literal|" version="
