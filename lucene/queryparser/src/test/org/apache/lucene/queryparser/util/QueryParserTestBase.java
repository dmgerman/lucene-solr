...
condition|)
block|{
comment|// Always true, since TestStandardQP overrides this method
operator|(
operator|(
name|QueryParser
operator|)
...
argument_list|)
expr_stmt|;
comment|// TODO: Re-enable once flexible standard parser gets multi-word synonym support
comment|//    assertQueryEquals("term phrase term", qpAnalyzer,
comment|//                      "term phrase1 phrase2 term");
name|assertQueryEquals
argument_list|(
...
expr_stmt|;
comment|// TODO: Re-enable once flexible standard parser gets multi-word synonym support
comment|//    assertQueryEquals(cqpc, "field", "term phrase term",
comment|//        "+term +phrase1 +phrase2 +term");
name|assertQueryEquals
argument_list|(
name|cqpc
