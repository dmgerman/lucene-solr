...
argument_list|)
expr_stmt|;
comment|// With the phrase operator, a multi-word synonym source will form span near queries.
name|SpanNearQuery
name|spanGuineaPig
init|=
name|SpanNearQuery
...
name|parse
argument_list|(
literal|"guinea pig cavy"
argument_list|)
argument_list|)
expr_stmt|;
block|}
DECL|method|testEnableGraphQueries
specifier|public
name|void
name|testEnableGraphQueries
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// A multi-word synonym source will just form a boolean query when graph queries are disabled:
name|Query
name|inner
init|=
operator|new
...
name|a
argument_list|,
literal|"((+guinea +pig) cavy) +running"
argument_list|)
expr_stmt|;
name|assertQueryEquals
argument_list|(
...
name|a
argument_list|,
literal|"spanOr([spanNear([guinea, pig], 0, true), cavy])"
argument_list|)
expr_stmt|;
name|assertQueryEquals
argument_list|(
