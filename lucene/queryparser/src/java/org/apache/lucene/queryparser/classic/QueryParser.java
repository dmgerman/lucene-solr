...
name|AND
block|}
comment|/** default split on whitespace behavior */
...
expr_stmt|;
block|}
comment|/**    * Set to true if phrase queries will be automatically generated    * when the analyzer returns more than one term from whitespace    * delimited text.    * NOTE: this behavior may not be suitable for all languages.    *<p>    * Set to false if phrase queries should only be generated when    * surrounded by double quotes.    *<p>    * The combination splitOnWhitespace=false and autoGeneratePhraseQueries=true    * is disallowed.  See<a href="https://issues.apache.org/jira/browse/LUCENE-7533">LUCENE-7533</a>.    */
annotation|@
name|Override
...
argument_list|(
literal|"setAutoGeneratePhraseQueries(true) is disallowed when getSplitOnWhitespace() == false"
argument_list|)
throw|;
block|}
name|this
...
expr_stmt|;
block|}
comment|/**    * @see #setSplitOnWhitespace(boolean)    */
DECL|method|getSplitOnWhitespace
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Whether query text should be split on whitespace prior to analysis.    * Default is<code>{@value #DEFAULT_SPLIT_ON_WHITESPACE}</code>.    *<p>    * The combination splitOnWhitespace=false and autoGeneratePhraseQueries=true    * is disallowed.  See<a href="https://issues.apache.org/jira/browse/LUCENE-7533">LUCENE-7533</a>.    */
DECL|method|setSplitOnWhitespace
specifier|public
name|void
...
name|IllegalArgumentException
argument_list|(
literal|"setSplitOnWhitespace(false) is disallowed when getAutoGeneratePhraseQueries() == true"
argument_list|)
throw|;
block|}
name|this
...
name|DEFAULT_SPLIT_ON_WHITESPACE
decl_stmt|;
DECL|field|disallowedPostMultiTerm
specifier|private
specifier|static
name|Set
argument_list|<
...
argument_list|)
decl_stmt|;
DECL|method|allowedPostMultiTerm
specifier|private
specifier|static
name|boolean
name|allowedPostMultiTerm
parameter_list|(
name|int
name|tokenKind
parameter_list|)
...
throw|;
block|}
comment|/** Returns the first query if splitOnWhitespace=true or otherwise the entire produced query */
DECL|method|MultiTerm
specifier|final
specifier|public
name|Query
name|MultiTerm
...
block|{
comment|// build up the text to send to analysis
name|text
operator|.
name|image
operator|+=
