...
argument_list|)
decl_stmt|;
DECL|field|FUNCTION_VALUES_ARRAY_TYPE
specifier|private
specifier|static
specifier|final
name|Type
name|FUNCTION_VALUES_ARRAY_TYPE
init|=
name|Type
operator|.
name|getType
...
argument_list|)
decl_stmt|;
DECL|field|CONSTRUCTOR_DESC
specifier|private
specifier|static
specifier|final
name|String
name|CONSTRUCTOR_DESC
init|=
name|Type
operator|.
...
argument_list|)
decl_stmt|;
DECL|field|EVALUATE_METHOD_DESC
specifier|private
specifier|static
specifier|final
name|String
name|EVALUATE_METHOD_DESC
init|=
name|Type
operator|.
name|getMethodDescriptor
...
argument_list|)
decl_stmt|;
DECL|field|DOUBLE_VAL_METHOD_DESC
specifier|private
specifier|static
specifier|final
name|String
name|DOUBLE_VAL_METHOD_DESC
init|=
name|Type
operator|.
name|getMethodDescriptor
...
return|;
block|}
comment|/**    * Compiles the given expression, specifying the parent classloader.    *    * @param sourceText The expression to compile    * @param parent Parent classloader    * @return A new compiled expression    * @throws ParseException on failure to compile    */
DECL|method|compile
specifier|public
specifier|static
name|Expression
