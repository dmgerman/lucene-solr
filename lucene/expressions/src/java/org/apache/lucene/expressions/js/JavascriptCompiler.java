...
expr_stmt|;
block|}
comment|// internalCompile is used to create an anonymous inner class around the ANTLR listener
comment|// to completely hide the implementation details of expression compilation
DECL|method|internalCompile
specifier|private
name|void
name|internalCompile
parameter_list|(
