...
block|}
block|}
DECL|field|MAX_CLASS_NAME_LENGTH
specifier|private
specifier|static
specifier|final
name|int
name|MAX_CLASS_NAME_LENGTH
init|=
literal|1024
decl_stmt|;
...
argument_list|)
decl_stmt|;
comment|// System.out.println(sourceText + "|" + className);
try|try
block|{
name|externalsMap
operator|=
