...
begin_class
DECL|class|CountingFacetsAggregatorTest
specifier|public
class|class
name|CountingFacetsAggregatorTest
extends|extends
name|FacetTestCase
block|{
DECL|field|A
...
argument_list|)
expr_stmt|;
comment|// we'll get counts for the 2nd level only
block|}
name|allExpectedCounts
operator|.
name|put
...
argument_list|()
expr_stmt|;
comment|// it's the default, so give it the highest chance
block|}
elseif|else
if|if
condition|(
...
name|assertTrue
argument_list|(
literal|"wrong sort order of sub results: child.value="
operator|+
name|child
operator|.
name|value
...
name|assertTrue
argument_list|(
literal|"wrong sort order of sub results"
argument_list|,
name|child
operator|.
name|ordinal
