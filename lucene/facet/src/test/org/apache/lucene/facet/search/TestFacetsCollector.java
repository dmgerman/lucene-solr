...
annotation|@
name|Test
DECL|method|testNumValidDescendants
specifier|public
name|void
name|testNumValidDescendants
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// ask to count a non-existing category to test labeling
name|FacetSearchParams
name|fsp
init|=
operator|new
...
name|assertEquals
argument_list|(
literal|"incorrect label returned for "
operator|+
name|fa
argument_list|,
name|fsp
...
try|try
block|{
comment|// SortedSetDocValuesAccumulator cannot even be created in such state
name|assertNull
argument_list|(
operator|new
name|SortedSetDocValuesAccumulator
...
argument_list|)
expr_stmt|;
comment|// if this ever changes, make sure FacetResultNode is labeled correctly
name|fail
argument_list|(
literal|"should not have succeeded to execute a request over a category which wasn't indexed as SortedSetDVField"
argument_list|)
expr_stmt|;
block|}
catch|catch
