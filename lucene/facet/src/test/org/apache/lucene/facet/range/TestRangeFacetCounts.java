...
argument_list|)
decl_stmt|;
comment|// NOTE: maxAsLong - minAsLong>= 0 is here to handle the common overflow case!
if|if
condition|(
name|maxAsLong
operator|-
...
block|}
block|}
DECL|method|testCustomDoubleValuesSource
specifier|public
name|void
name|testCustomDoubleValuesSource
parameter_list|()
throws|throws
name|Exception
block|{
