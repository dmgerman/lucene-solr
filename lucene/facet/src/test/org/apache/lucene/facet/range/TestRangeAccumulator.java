...
expr_stmt|;
block|}
comment|/** Tests single request that mixes Range and non-Range    *  faceting, with DrillSideways. */
DECL|method|testMixedRangeAndNonRange
specifier|public
name|void
name|testMixedRangeAndNonRange
parameter_list|()
throws|throws
name|Exception
block|{
...
parameter_list|)
block|{
comment|// Each dim should should up only once, across
