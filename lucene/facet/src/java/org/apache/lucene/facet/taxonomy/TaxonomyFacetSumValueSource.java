...
name|ordinalsReader
decl_stmt|;
comment|/**    * Aggreggates double facet values from the provided    *  {@link ValueSource}, pulling ordinals using {@link    *  DocValuesOrdinalsReader} against the default indexed    *  facet field {@link    *  FacetsConfig#DEFAULT_INDEX_FIELD_NAME}.    *    *  @deprecated {@link #TaxonomyFacetSumValueSource(TaxonomyReader, FacetsConfig, FacetsCollector, DoubleValuesSource)}    */
annotation|@
name|Deprecated
...
expr_stmt|;
block|}
comment|/**    * Aggreggates float facet values from the provided    *  {@link ValueSource}, and pulls ordinals from the    *  provided {@link OrdinalsReader}.    *    *  @deprecated use {@link #TaxonomyFacetSumValueSource(OrdinalsReader, TaxonomyReader, FacetsConfig, FacetsCollector, DoubleValuesSource)}    */
annotation|@
name|Deprecated
DECL|method|TaxonomyFacetSumValueSource
specifier|public
...
expr_stmt|;
block|}
comment|/**    * {@link ValueSource} that returns the score for each    *  hit; use this to aggregate the sum of all hit scores    *  for each facet label.    *    * @deprecated Use {@link DoubleValuesSource#SCORES}    */
