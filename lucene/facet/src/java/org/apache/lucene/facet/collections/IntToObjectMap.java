...
return|;
block|}
comment|/**    * Translates the mapped pairs' values into an array of T    *     * @param a    *            the array into which the elements of the list are to be    *            stored, if it is big enough; otherwise, use whatever space we    *            have, setting the one after the true data as null.    *     * @return an array containing the elements of the list    *     */
DECL|method|toArray
specifier|public
name|T
index|[]
