...
parameter_list|)
block|{
comment|// make sure none of the categories in the given FacetRequests was indexed with NO_PARENTS
for|for
control|(
name|FacetRequest
name|fr
...
block|{
return|return
literal|"this collector does not support aggregating categories that were indexed with OrdinalPolicy.NO_PARENTS"
return|;
block|}
block|}
return|return
