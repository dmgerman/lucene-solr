...
begin_comment
comment|/**  * An {@link Aggregator} which updates the weight of a category by summing the  * weights of the integer association it finds for every document.  *   * @lucene.experimental  */
end_comment
