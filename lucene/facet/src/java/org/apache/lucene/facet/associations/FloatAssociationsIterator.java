...
argument_list|()
decl_stmt|;
comment|/**    * Constructs a new {@link FloatAssociationsIterator} which uses an    * in-memory {@link DocValues#getSource() DocValues source}.    */
...
expr_stmt|;
block|}
comment|/**    * Constructs a new {@link FloatAssociationsIterator} which uses a    * {@link DocValues} {@link Source} per {@code useDirectSource}.    */
DECL|method|FloatAssociationsIterator
specifier|public
name|FloatAssociationsIterator
parameter_list|(
