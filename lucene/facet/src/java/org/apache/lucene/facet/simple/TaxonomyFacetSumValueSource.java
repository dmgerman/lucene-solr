...
return|;
block|}
comment|/** Returns null if this path doesn't exist or all counts    *  were 0, else topN children under the specified path. */
...
return|;
block|}
comment|/** Returns topN labels for any dimension that had hits,    *  sorted by the number of hits that dimension matched. */
