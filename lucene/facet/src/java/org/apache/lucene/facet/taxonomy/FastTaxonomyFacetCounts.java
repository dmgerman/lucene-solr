...
expr_stmt|;
block|}
comment|/** Create {@code FastTaxonomyFacetCounts}, using the    *  specified {@code indexFieldName} for ordinals, and    *  counting all non-deleted documents in the index.  This is     *  the same result as searching on {@link MatchAllDocsQuery},    *  but faster */
DECL|method|FastTaxonomyFacetCounts
specifier|public
name|FastTaxonomyFacetCounts
parameter_list|(
