...
expr_stmt|;
block|}
comment|/**    * Create {@code RangeFacetCounts}, using the provided {@link ValueSource}.    *    * @deprecated Use {@link #LongRangeFacetCounts(String, LongValuesSource, FacetsCollector, LongRange...)}    */
annotation|@
name|Deprecated
DECL|method|LongRangeFacetCounts
specifier|public
...
expr_stmt|;
block|}
comment|/**    * Create {@code RangeFacetCounts}, using the provided {@link ValueSource}.    *    * @deprecated Use {@link #LongRangeFacetCounts(String, LongValuesSource, FacetsCollector, Query, LongRange...)}    */
annotation|@
name|Deprecated
DECL|method|LongRangeFacetCounts
specifier|public
