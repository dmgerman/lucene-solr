...
begin_comment
comment|/** Like {@link SortedSetDocValuesFacetCounts}, but aggregates counts concurrently across segments.  *  * @lucene.experimental */
end_comment

begin_class
DECL|class|ConcurrentSortedSetDocValuesFacetCounts
specifier|public
class|class
...
name|counts
decl_stmt|;
comment|/** Returns all facet counts, same result as searching on {@link MatchAllDocsQuery} but faster. */
DECL|method|ConcurrentSortedSetDocValuesFacetCounts
specifier|public
name|ConcurrentSortedSetDocValuesFacetCounts
parameter_list|(
name|SortedSetDocValuesReaderState
...
expr_stmt|;
block|}
comment|/** Counts all facet dimensions across the provided hits. */
DECL|method|ConcurrentSortedSetDocValuesFacetCounts
specifier|public
name|ConcurrentSortedSetDocValuesFacetCounts
parameter_list|(
...
return|;
block|}
DECL|class|CountOneSegment
specifier|private
class|class
name|CountOneSegment
