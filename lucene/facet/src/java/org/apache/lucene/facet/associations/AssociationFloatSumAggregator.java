...
begin_comment
comment|/**  * An {@link Aggregator} which computes the weight of a category as the sum of  * the float values associated with it in the result documents.  *   * @lucene.experimental  */
end_comment
