...
return|;
block|}
DECL|method|OldFacetsAccumulator
specifier|public
name|OldFacetsAccumulator
parameter_list|(
name|FacetSearchParams
...
return|;
block|}
comment|/**    * Creates an {@link OrdinalValueResolver} for the given {@link FacetRequest}.    * By default this method supports {@link CountFacetRequest} and    * {@link SumScoreFacetRequest}. You should override if you are using other    * requests with this accumulator.    */
...
argument_list|(
literal|"unrecognized FacetRequest "
operator|+
name|fr
operator|.
name|getClass
...
name|IllegalArgumentException
argument_list|(
literal|"complements are not supported by SumScoreFacetRequest"
argument_list|)
throw|;
block|}
else|else
...
name|IllegalArgumentException
argument_list|(
literal|"unknown Aggregator implementation for request "
operator|+
name|fr
operator|.
name|getClass
