...
argument_list|(
literal|"complements are not supported by this SumScoreFacetRequest"
argument_list|)
throw|;
block|}
else|else
...
argument_list|)
decl_stmt|;
comment|// nocommit remove! facetRequest.createAggregator(isUsingComplements, facetArrays, taxonomyReader);
name|CategoryListIterator
name|cli
init|=
name|indexingParams
