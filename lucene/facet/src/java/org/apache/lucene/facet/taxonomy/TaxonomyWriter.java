...
parameter_list|()
function_decl|;
comment|/**    * Sets the commit user data iterable.  See {@link IndexWriter#setLiveCommitData}.    */
...
parameter_list|)
function_decl|;
comment|/**    * Returns the commit user data iterable that was set on    * {@link #setLiveCommitData(Iterable)}.    */
