...
argument_list|()
decl_stmt|;
comment|// Simulate writing into an index that was created on the same version
operator|new
name|SegmentInfos
argument_list|(
name|indexCreatedVersion
...
argument_list|()
expr_stmt|;
comment|// Now check that we forbid calling addIndexes with a different version
name|targetDir
operator|=
name|newDirectory
argument_list|()
