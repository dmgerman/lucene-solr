...
expr_stmt|;
block|}
comment|// ant test -Dtestcase=TestBackwardsCompatibility -Dtestmethod=testCreateSortedIndex -Dtests.codec=default -Dtests.useSecurityManager=false -Dtests.bwcdir=/tmp/sorted
DECL|method|testCreateSortedIndex
specifier|public
name|void
name|testCreateSortedIndex
parameter_list|()
throws|throws
name|Exception
block|{
...
condition|)
block|{
comment|// both indexes are not compatible
name|Directory
name|targetDir2
init|=
name|newDirectory
...
name|startsWith
argument_list|(
literal|"Cannot use addIndexes(Directory) with indexes that have been created by a different Lucene version."
argument_list|)
argument_list|)
expr_stmt|;
name|w
...
argument_list|()
expr_stmt|;
comment|// for the next test, we simulate writing to an index that was created on the same major version
operator|new
name|SegmentInfos
argument_list|(
name|infos
...
argument_list|()
argument_list|,
literal|"Cannot merge a segment that has been created with major version 6 into this index which has been created by major version 7"
argument_list|)
expr_stmt|;
name|w
operator|.
...
literal|null
decl_stmt|;
comment|// true if this index has points (>= 6.0)
specifier|final
name|boolean
name|hasPoints
init|=
...
argument_list|)
decl_stmt|;
comment|// those indexes are created by a single version so we can
comment|// compare the commit version with the created version
name|assertEquals
argument_list|(
name|infos
operator|.
...
block|}
block|}
DECL|method|testSortedIndex
specifier|public
name|void
name|testSortedIndex
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// this will confirm the docs really are sorted:
name|TestUtil
operator|.
name|checkIndex
argument_list|(
