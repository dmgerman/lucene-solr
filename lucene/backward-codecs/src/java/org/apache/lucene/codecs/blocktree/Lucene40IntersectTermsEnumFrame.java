...
begin_comment
comment|/**  * @deprecated Only for 4.x backcompat  */
end_comment
...
annotation|@
name|Deprecated
DECL|class|Lucene40IntersectTermsEnumFrame
specifier|final
class|class
name|Lucene40IntersectTermsEnumFrame
block|{
DECL|field|ord
specifier|final
name|int
...
specifier|private
specifier|final
name|Lucene40IntersectTermsEnum
name|ite
decl_stmt|;
DECL|method|Lucene40IntersectTermsEnumFrame
specifier|public
name|Lucene40IntersectTermsEnumFrame
parameter_list|(
name|Lucene40IntersectTermsEnum
