...
begin_comment
comment|/**  * This GeoBBox represents an area rectangle limited only in latitude.  *  * @lucene.internal  */
end_comment
...
specifier|final
name|boolean
name|bottomBoundaryInsideShape
init|=
name|path
operator|.
name|isWithin
...
block|{
return|return
literal|"GeoLatitudeZone: {planetmodel="
operator|+
name|planetModel
operator|+
literal|", toplat="
