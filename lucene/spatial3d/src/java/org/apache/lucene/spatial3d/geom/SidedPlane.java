...
expr_stmt|;
block|}
comment|/**    * Construct a sided plane from a pair of vectors describing points, and including    * origin, plus a point p which describes the side.    *    * @param pX point X to evaluate    * @param pY point Y to evaluate    * @param pZ point Z to evaluate    * @param A is the first in-plane point    * @param B is the second in-plane point    */
DECL|method|SidedPlane
specifier|public
name|SidedPlane
parameter_list|(
...
throw|;
block|}
comment|/**    * Construct a sided plane from a pair of vectors describing points, and including    * origin, plus a point p which describes the side.    *    * @param p point to evaluate    * @param A is the first in-plane point    * @param BX is the X value of the second in-plane point    * @param BY is the Y value of the second in-plane point    * @param BZ is the Z value of the second in-plane point    */
DECL|method|SidedPlane
specifier|public
name|SidedPlane
parameter_list|(
