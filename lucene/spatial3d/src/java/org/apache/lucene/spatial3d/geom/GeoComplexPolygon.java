...
block|{
comment|/**      * Compare an edge.      * @param edge is the edge to compare.      * @param value is the value to compare.      * @return -1 if "less" than this one, 0 if overlaps, or 1 if "greater".      */
DECL|method|compare
specifier|public
name|int
name|compare
