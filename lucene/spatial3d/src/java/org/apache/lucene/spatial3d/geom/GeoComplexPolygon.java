...
block|{
comment|// This is the expensive part!!
comment|// Changing the code below has an enormous impact on the queries per second we see with the benchmark.
...
comment|// We compute distance we need to travel as a placeholder for the number of intersections we might encounter.
comment|//final double newDistance = p.arcDistance(testPoint) + p.arcDistance(thePoint);
specifier|final
name|double
name|tpDelta1
init|=
...
name|cpDelta2
decl_stmt|;
comment|//final double newDistance = (testPoint.x - p.x) * (testPoint.x - p.x) + (testPoint.z - p.z) * (testPoint.z - p.z)  + (thePoint.y - p.y) * (thePoint.y - p.y) + (thePoint.z - p.z) * (thePoint.z - p.z);
comment|//final double newDistance = Math.abs(testPoint.x - p.x) + Math.abs(thePoint.y - p.y);
if|if
condition|(
name|newDistance
operator|<
...
name|cpDelta2
decl_stmt|;
comment|//final double newDistance = (testPoint.x - p.x) * (testPoint.x - p.x) + (testPoint.y - p.y) * (testPoint.y - p.y)  + (thePoint.y - p.y) * (thePoint.y - p.y) + (thePoint.z - p.z) * (thePoint.z - p.z);
comment|//final double newDistance = Math.abs(testPoint.x - p.x) + Math.abs(thePoint.z - p.z);
if|if
condition|(
name|newDistance
operator|<
...
name|cpDelta2
decl_stmt|;
comment|//final double newDistance = (testPoint.y - p.y) * (testPoint.y - p.y) + (testPoint.z - p.z) * (testPoint.z - p.z)  + (thePoint.x - p.x) * (thePoint.x - p.x) + (thePoint.z - p.z) * (thePoint.z - p.z);
comment|//final double newDistance = Math.abs(testPoint.y - p.y) + Math.abs(thePoint.x - p.x);
if|if
condition|(
name|newDistance
operator|<
...
name|cpDelta2
decl_stmt|;
comment|//final double newDistance = (testPoint.x - p.x) * (testPoint.x - p.x) + (testPoint.y - p.y) * (testPoint.y - p.y)  + (thePoint.x - p.x) * (thePoint.x - p.x) + (thePoint.z - p.z) * (thePoint.z - p.z);
comment|//final double newDistance = Math.abs(testPoint.y - p.y) + Math.abs(thePoint.z - p.z);
if|if
condition|(
name|newDistance
operator|<
...
name|cpDelta2
decl_stmt|;
comment|//final double newDistance = (testPoint.y - p.y) * (testPoint.y - p.y) + (testPoint.z - p.z) * (testPoint.z - p.z)  + (thePoint.y - p.y) * (thePoint.y - p.y) + (thePoint.x - p.x) * (thePoint.x - p.x);
comment|//final double newDistance = Math.abs(testPoint.z - p.z) + Math.abs(thePoint.x - p.x);
if|if
condition|(
name|newDistance
operator|<
...
name|cpDelta2
decl_stmt|;
comment|//final double newDistance = (testPoint.x - p.x) * (testPoint.x - p.x) + (testPoint.z - p.z) * (testPoint.z - p.z)  + (thePoint.y - p.y) * (thePoint.y - p.y) + (thePoint.x - p.x) * (thePoint.x - p.x);
comment|//final double newDistance = Math.abs(testPoint.z - p.z) + Math.abs(thePoint.y - p.y);
if|if
condition|(
name|newDistance
operator|<
...
name|bound2
decl_stmt|;
DECL|field|thePointX
specifier|private
specifier|final
name|double
name|thePointX
decl_stmt|;
DECL|field|thePointY
specifier|private
specifier|final
name|double
name|thePointY
decl_stmt|;
DECL|field|thePointZ
specifier|private
specifier|final
name|double
name|thePointZ
