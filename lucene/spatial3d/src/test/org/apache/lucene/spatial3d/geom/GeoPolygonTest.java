...
argument_list|)
decl_stmt|;
comment|//System.out.println("p = "+p);
name|XYZBounds
name|bounds
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|//System.out.println("point = "+point);
comment|//System.out.println("encodedPoint = "+encodedPoint);
name|assertTrue
argument_list|(
name|p
operator|.
...
annotation|@
name|Test
DECL|method|testPolygonFailureCase1
specifier|public
name|void
name|testPolygonFailureCase1
parameter_list|()
block|{
specifier|final
name|List
...
argument_list|,
operator|-
literal|0.6370451769779303
argument_list|,
literal|2.5318373679431616
argument_list|)
argument_list|)
expr_stmt|;
name|poly2List
...
argument_list|,
operator|-
literal|1.0850383189690824
argument_list|,
literal|2.4457272005608357E
operator|-
literal|47
argument_list|)
argument_list|)
...
name|WGS84
argument_list|,
literal|1.079437865394857
argument_list|,
operator|-
literal|1.720224083538152E
operator|-
literal|11
argument_list|)
argument_list|)
...
argument_list|)
decl_stmt|;
comment|/*    [junit4]   1>       unquantized=[lat=-1.5316724989005415, lon=3.141592653589793([X=-0.03902652216795768, Y=4.779370545484258E-18, Z=-0.9970038705813589])]    [junit4]   1>       quantized=[X=-0.03902652216283731, Y=2.3309121299774915E-10, Z=-0.9970038706538652]     */
specifier|final
name|GeoPoint
name|point
init|=
...
annotation|@
name|Test
DECL|method|testConcavePolygon
specifier|public
name|void
name|testConcavePolygon
parameter_list|()
block|{
name|ArrayList
argument_list|<
...
annotation|@
name|Test
DECL|method|testConcavePolygonWithHole
specifier|public
name|void
name|testConcavePolygonWithHole
parameter_list|()
block|{
name|ArrayList
argument_list|<
...
annotation|@
name|Test
DECL|method|testConvexPolygon
specifier|public
name|void
name|testConvexPolygon
parameter_list|()
block|{
name|ArrayList
argument_list|<
...
annotation|@
name|Test
DECL|method|testConvexPolygonWithHole
specifier|public
name|void
name|testConvexPolygonWithHole
parameter_list|()
block|{
name|ArrayList
argument_list|<
