...
name|assertEquals
argument_list|(
literal|"Geo3DPoint<point: x=0.7094263127744131 y=0.09679758888428691 z=0.6973564619016113>"
argument_list|,
name|point
operator|.
name|toString
...
block|}
block|}
comment|// Takes ~35 seconds on modern-ish 2015 dev box:
annotation|@
name|Nightly
DECL|method|testEncodeIsStableFromIntSide
specifier|public
name|void
name|testEncodeIsStableFromIntSide
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// We can't test the full space of ints (Integer.MIN_VALUE to Integer.MAX_VALUE) because not all ints are allowed:
name|int
name|start
init|=
name|Geo3DUtil
...
argument_list|)
decl_stmt|;
comment|// This prints: 99.99997175764292
comment|//System.out.println("PCTG INT SPACE USED: " + 100.*(((long) end)-(long) start)/(1L<<32));
for|for
control|(
name|int
name|i
...
name|Ignore
argument_list|(
literal|"https://issues.apache.org/jira/browse/LUCENE-7168"
argument_list|)
DECL|method|testCuriousFailure
specifier|public
name|void
name|testCuriousFailure
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|,
operator|-
literal|0.8971654677124566
argument_list|,
operator|-
literal|0.3398482030102755
argument_list|,
literal|1.4775317506492547
argument_list|)
decl_stmt|;
name|GeoPoint
name|point
...
name|GeoPoint
argument_list|(
literal|0.8653002868649471
argument_list|,
literal|0.50134342478497
argument_list|,
literal|0.046203414829601996
argument_list|)
decl_stmt|;
comment|// point is inside our circle shape:
name|assertTrue
argument_list|(
name|shape
operator|.
...
name|xMin
init|=
literal|0.8653002866318559
decl_stmt|;
name|double
name|xMax
init|=
literal|0.8653002870980383
decl_stmt|;
name|double
name|yMin
init|=
literal|0.5013434245518787
decl_stmt|;
name|double
name|yMax
init|=
literal|0.5013434250180612
decl_stmt|;
name|double
name|zMin
init|=
literal|0.04620341459651078
decl_stmt|;
name|double
name|zMax
init|=
literal|0.04620341506269321
decl_stmt|;
name|GeoArea
name|xyzSolid
init|=
...
argument_list|)
decl_stmt|;
comment|// point is also inside our wee tiny box:
name|assertTrue
argument_list|(
name|xyzSolid
operator|.
