...
expr_stmt|;
block|}
comment|// make sure the root cell (XYZBounds) does in fact contain all points that the shape contains
block|{
name|boolean
name|fail
init|=
...
name|docID
operator|+
literal|" is contained by shape but is outside the returned XYZBounds"
argument_list|)
expr_stmt|;
name|log
operator|.
...
name|fail
argument_list|(
literal|"invalid bounds for shape="
operator|+
name|shape
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
comment|// Pick the arc distance randomly; not quite the full range though
name|arcDistance
index|[
name|i
index|]
