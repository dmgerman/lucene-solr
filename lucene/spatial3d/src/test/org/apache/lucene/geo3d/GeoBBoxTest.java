...
argument_list|)
expr_stmt|;
comment|//System.out.println("Shape = " + shape + " Rect = " + box);
name|relationship
operator|=
name|box
operator|.
...
name|SPHERE
argument_list|,
literal|0.7570958596622309
argument_list|,
operator|-
literal|0.7458670829264561
argument_list|,
operator|-
literal|0.9566079379002148
argument_list|,
literal|1.4802570961901191
argument_list|)
expr_stmt|;
name|solid
operator|=
...
name|SPHERE
argument_list|,
literal|0.10922258701604912
argument_list|,
literal|0.1248184603754517
argument_list|,
operator|-
literal|0.8172414690802067
argument_list|,
literal|0.9959041483215542
argument_list|,
operator|-
literal|0.6136586624726926
argument_list|,
literal|0.6821740363641521
argument_list|)
expr_stmt|;
name|point
operator|=
...
name|SPHERE
argument_list|,
literal|0.3719987557178081
argument_list|,
literal|1.4529582778845198
argument_list|)
expr_stmt|;
name|assertTrue
argument_list|(
...
name|SPHERE
argument_list|,
literal|0.006607096847842122
argument_list|,
operator|-
literal|0.002828135860810422
argument_list|,
operator|-
literal|0.0012934461873348349
argument_list|,
literal|0.006727418645092394
argument_list|)
expr_stmt|;
name|solid
operator|=
...
name|SPHERE
argument_list|,
literal|0.9999995988328008
argument_list|,
literal|1.0000000002328306
argument_list|,
operator|-
literal|0.0012934708508166816
argument_list|,
literal|0.006727393021214471
argument_list|,
operator|-
literal|0.002828157275369464
argument_list|,
literal|0.006607074060760007
argument_list|)
expr_stmt|;
name|point
operator|=
...
argument_list|,
operator|-
literal|5.236470872437899E
operator|-
literal|4
argument_list|,
literal|3.992578692654256E
operator|-
literal|4
argument_list|)
expr_stmt|;
