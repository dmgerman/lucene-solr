...
begin_comment
comment|/**  * Removes stop words from a token stream, if  * {@link KeywordAttribute} is set then does not remove the  * word.  *   *<a name="version"/>  *<p>You must specify the required {@link Version}  * compatibility when creating StopFilter:  *<ul>  *<li> As of 3.1, StopFilter correctly handles Unicode 4.0  *         supplementary characters in stopwords and position  *         increments are preserved  *</ul>  */
end_comment

begin_class
DECL|class|StopKeywordFilter
specifier|final
class|class
