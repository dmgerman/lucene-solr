...
literal|"suggest_field"
argument_list|,
literal|"suggest_field2"
argument_list|,
literal|"suggest_field3"
argument_list|)
argument_list|)
decl_stmt|;
name|Document
...
argument_list|)
expr_stmt|;
comment|// need another document so whole segment isn't deleted
name|iw
operator|.
name|addDocument
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// first force merge is OK
name|iw
operator|.
name|forceMerge
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// second force merge causes MultiFields to include "suggest_field" in its iteration, yet a null Terms is returned (no documents have
comment|// this field anymore)
name|iw
operator|.
name|addDocument
argument_list|(
