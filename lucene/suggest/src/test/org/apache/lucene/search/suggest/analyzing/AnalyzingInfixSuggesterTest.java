...
name|assertEquals
argument_list|(
literal|"a<b>penny</b> saved is a<b>penny</b><b>ea</b>rned"
argument_list|,
name|results
operator|.
name|get
...
index|]
decl_stmt|;
comment|// Cannot call refresh on an suggester when no docs are added to the index
name|expectThrows
argument_list|(
...
return|;
block|}
comment|// LUCENE-5528 and LUCENE-6464
...
annotation|@
name|Test
DECL|method|testAddPrefixMatch
specifier|public
name|void
name|testAddPrefixMatch
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// Test SOLR-6085 - the analyzed tokens match due to ss->Ã normalization
name|assertEquals
argument_list|(
literal|"<b>daÃ</b>"
argument_list|,
...
return|;
block|}
DECL|method|testBinaryContext
specifier|public
name|void
name|testBinaryContext
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testContextNotAllTermsRequired
specifier|public
name|void
name|testContextNotAllTermsRequired
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Only one has "foo" context and len
name|results
operator|=
name|suggester
operator|.
...
expr_stmt|;
block|}
DECL|method|testCloseIndexWriterOnBuild
specifier|public
name|void
name|testCloseIndexWriterOnBuild
parameter_list|()
throws|throws
name|Exception
block|{
class|class
name|MyAnalyzingInfixSuggester
extends|extends
name|AnalyzingInfixSuggester
block|{
specifier|public
...
block|}
block|}
comment|// After build(), when closeIndexWriterOnBuild = true:
comment|// * The IndexWriter should be null
comment|// * The SearcherManager should be non-null
comment|// * SearcherManager's IndexWriter reference should be closed
comment|//   (as evidenced by maybeRefreshBlocking() throwing AlreadyClosedException)
name|Analyzer
name|a
init|=
operator|new
...
argument_list|()
expr_stmt|;
comment|// After instantiating from an already-built suggester dir:
comment|// * The IndexWriter should be null
comment|// * The SearcherManager should be non-null
specifier|final
name|MyAnalyzingInfixSuggester
...
expr_stmt|;
block|}
DECL|method|testCommitAfterBuild
specifier|public
name|void
name|testCommitAfterBuild
parameter_list|()
throws|throws
name|Exception
block|{
name|performOperationWithAllOptionCombinations
argument_list|(
name|suggester
lambda|->
block|{
...
expr_stmt|;
block|}
DECL|method|testRefreshAfterBuild
specifier|public
name|void
name|testRefreshAfterBuild
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testDisallowCommitBeforeBuild
specifier|public
name|void
name|testDisallowCommitBeforeBuild
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testDisallowRefreshBeforeBuild
specifier|public
name|void
name|testDisallowRefreshBeforeBuild
parameter_list|()
throws|throws
name|Exception
block|{
...
block|,   }
decl_stmt|;
DECL|interface|SuggesterOperation
specifier|private
interface|interface
name|SuggesterOperation
block|{
DECL|method|operate
name|void
name|operate
...
function_decl|;
block|}
comment|/**    * Perform the given operation on suggesters constructed with all combinations of options    * commitOnBuild and closeIndexWriterOnBuild, including defaults.    */
DECL|method|performOperationWithAllOptionCombinations
specifier|private
name|void
name|performOperationWithAllOptionCombinations
parameter_list|(
