...
decl_stmt|;
comment|/**    * Creates a new dictionary with the contents of the fields named<code>field</code>    * for the terms,<code>payload</code> for the corresponding payloads,<code>contexts</code>    * for the associated contexts and uses the<code>weightsValueSource</code> supplied     * to determine the score.    *    * @deprecated Use {@link #DocumentValueSourceDictionary(IndexReader, String, LongValuesSource, String, String)}    */
annotation|@
name|Deprecated
...
expr_stmt|;
block|}
comment|/**    * Creates a new dictionary with the contents of the fields named<code>field</code>    * for the terms,<code>payloadField</code> for the corresponding payloads    * and uses the<code>weightsValueSource</code> supplied to determine the     * score.    *    * @deprecated Use {@link #DocumentValueSourceDictionary(IndexReader, String, LongValuesSource, String)}    */
annotation|@
name|Deprecated
DECL|method|DocumentValueSourceDictionary
specifier|public
...
expr_stmt|;
block|}
comment|/**     * Creates a new dictionary with the contents of the fields named<code>field</code>    * for the terms and uses the<code>weightsValueSource</code> supplied to determine the     * score.    *    * @deprecated Use {@link #DocumentValueSourceDictionary(IndexReader, String, LongValuesSource)}    */
annotation|@
name|Deprecated
DECL|method|DocumentValueSourceDictionary
specifier|public
