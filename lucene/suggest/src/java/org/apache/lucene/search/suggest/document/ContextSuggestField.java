...
name|contexts
decl_stmt|;
comment|/**    * Creates a context-enabled suggest field    *    * @param name field name    * @param contexts associated contexts    * @param value field value to get suggestion on    * @param weight field weight    *    * @throws IllegalArgumentException if either the name or value is null,    * if value is an empty string, if the weight is negative, if value or    * contexts contains any reserved characters    */
