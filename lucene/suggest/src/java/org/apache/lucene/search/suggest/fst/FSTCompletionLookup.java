...
name|Accountable
block|{
comment|/**     * An invalid bucket count if we're creating an object    * of this class from an existing FST.    *     * @see #FSTCompletionLookup(Directory, String, FSTCompletion, boolean)    */
...
literal|0
decl_stmt|;
comment|/**    * This constructor should only be used to read a previously saved suggester.    */
