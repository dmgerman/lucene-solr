...
name|commitOnBuild
decl_stmt|;
DECL|field|closeIndexWriterOnBuild
specifier|private
specifier|final
name|boolean
name|closeIndexWriterOnBuild
decl_stmt|;
...
literal|4
decl_stmt|;
comment|/** Default boolean clause option for multiple terms matching (all terms required). */
DECL|field|DEFAULT_ALL_TERMS_REQUIRED
specifier|public
specifier|static
specifier|final
name|boolean
...
literal|true
decl_stmt|;
comment|/** Default higlighting option. */
DECL|field|DEFAULT_HIGHLIGHT
specifier|public
specifier|static
specifier|final
name|boolean
...
literal|true
decl_stmt|;
comment|/** Default option to close the IndexWriter once the index has been built. */
DECL|field|DEFAULT_CLOSE_INDEXWRITER_ON_BUILD
specifier|protected
specifier|final
specifier|static
name|boolean
name|DEFAULT_CLOSE_INDEXWRITER_ON_BUILD
init|=
literal|true
decl_stmt|;
...
throw|;
block|}
comment|// else no-op: writer was committed and closed after the index was built, so commit is unnecessary
block|}
else|else
block|{
name|writer
...
expr_stmt|;
block|}
comment|// else no-op: writer was committed and closed after the index was built
comment|//             and before searchMgr was constructed, so refresh is unnecessary
block|}
