...
expr_stmt|;
block|}
comment|/**    * @deprecated Use {@link #AnalyzingInfixSuggester(Directory, Analyzer)}    */
annotation|@
name|Deprecated
DECL|method|AnalyzingInfixSuggester
specifier|public
...
expr_stmt|;
block|}
comment|/**    * @deprecated Use {@link #AnalyzingInfixSuggester(Directory, Analyzer, Analyzer, int, boolean)}    */
annotation|@
name|Deprecated
DECL|method|AnalyzingInfixSuggester
specifier|public
...
comment|// Filter instead to search, but since all of
comment|// these are MUST'd, the change to the score won't
comment|// affect the overall ranking.  Since we indexed
comment|// as DOCS_ONLY, the perf should be the same
comment|// either way (no freq int[] blocks to decode):
comment|// TODO: if we had a BinaryTermField we could fix
comment|// this "must be valid ut8f" limitation:
name|sub
operator|.
