...
name|searcher
decl_stmt|;
comment|/** null if payloads were not indexed: */
...
return|;
block|}
comment|/** Appends the whole matched token to the provided {@code    *  StringBuilder}. */
