...
return|;
block|}
comment|/**      * get the macro averaged precision (see {@link #getPrecision(String)}) over all the classes.      *      * @return the macro averaged precision as computed from the confusion matrix      */
DECL|method|getPrecision
specifier|public
name|double
name|getPrecision
...
return|;
block|}
comment|/**      * get the macro averaged recall (see {@link #getRecall(String)}) over all the classes      *      * @return the recall as computed from the confusion matrix      */
DECL|method|getRecall
specifier|public
name|double
name|getRecall
