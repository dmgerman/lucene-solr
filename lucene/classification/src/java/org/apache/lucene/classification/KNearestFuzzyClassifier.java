...
begin_comment
comment|/**  * A k-Nearest Neighbor classifier based on {@link FuzzyLikeThisQuery}.  *  * @lucene.experimental  */
end_comment

begin_class
DECL|class|KNearestFuzzyClassifier
specifier|public
class|class
...
argument_list|)
expr_stmt|;
comment|// TODO: make this parameters configurable
block|}
name|bq
operator|.
name|add
...
block|{
return|return
literal|"KNearestFuzzyClassifier{"
operator|+
