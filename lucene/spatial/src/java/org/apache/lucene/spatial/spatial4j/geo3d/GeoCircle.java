...
argument_list|)
expr_stmt|;
comment|// Compute a point on the circle boundary.  This can be any point that is easy to compute.
comment|// This requires some math, so I've implemented it in Plane.
name|this
operator|.
name|edgePoints
operator|=
