...
name|detailLevel
assert|;
comment|//assertions help clarify logic
assert|assert
operator|!
name|cell
operator|.
...
argument_list|)
expr_stmt|;
comment|//increment pointer to avoid potential redundant addDocs() below
name|nextCellTerm
operator|=
name|termsEnum
operator|.
