...
comment|// It was easy to implement but could be optimized. For example if the docs
comment|// in question are already marked in the 'outside' bitset then it can be avoided.
name|Collection
argument_list|<
name|Cell
argument_list|>
