...
comment|// We really try to ensure true-positive matches (if the predicate on the raw shapes match
...
name|INTERSECTS
return|;
comment|//might actually be 'CONTAINS' if these 2 are adjacent
return|return
name|DISJOINT
return|;
block|}
