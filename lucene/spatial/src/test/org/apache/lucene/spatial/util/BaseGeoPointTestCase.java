...
return|;
block|}
comment|// for pole crossing: used by surpriseMePolygon()
DECL|method|wrapLat
specifier|private
specifier|static
name|double
...
block|}
block|}
comment|// for dateline crossing: used by surpriseMePolygon()
comment|// TODO: can we remove this? these should not cross dateline...
DECL|method|wrapLon
specifier|private
specifier|static
name|double
...
block|}
block|}
DECL|method|polygonContainsPoint
specifier|static
specifier|final
name|boolean
...
name|polyLons
decl_stmt|;
comment|// TODO: factor this out, maybe if we add Polygon class?
switch|switch
condition|(
name|random
argument_list|()
...
condition|)
block|{
comment|// Not all subclasses can make distance range query!
name|q2
operator|=
name|newDistanceRangeQuery
argument_list|(
