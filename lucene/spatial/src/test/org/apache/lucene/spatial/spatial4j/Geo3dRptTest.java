...
annotation|@
name|Test
DECL|method|testTriangleDisjointRect
specifier|public
name|void
name|testTriangleDisjointRect
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|//unsure if this is correct or not but passes
comment|//if they intersect, then the following rect cell can be "within" the triangle
specifier|final
name|Rectangle
name|cellRect
init|=
...
argument_list|()
assert|;
comment|//assertTrue(cellRect.relate(triangle) != SpatialRelation.WITHIN);
block|}
