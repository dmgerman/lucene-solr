...
annotation|@
name|Test
comment|//@Repeat(iterations = 2000)
annotation|@
name|Seed
argument_list|(
literal|"B808B88D6F8E285C"
argument_list|)
...
annotation|@
name|Test
DECL|method|testBigCircleFailure
specifier|public
name|void
name|testBigCircleFailure
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|//DWS: unsure if this is correct or not but passes
comment|//since they don't intersect, then the following cell rect can't be WITHIN the circle
specifier|final
name|Rectangle
name|cellRect
init|=
...
annotation|@
name|Test
DECL|method|testWideRectFailure
specifier|public
name|void
name|testWideRectFailure
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|//Rect(minX=-22.5,maxX=-11.25,minY=11.25,maxY=16.875)
comment|//since they don't intersect, then the following cell rect can't be WITHIN the geo3d shape
specifier|final
name|Rectangle
name|cellRect
init|=
...
argument_list|)
expr_stmt|;
comment|//    setupStrategy();
comment|//    testOperation(rect, SpatialOperation.Intersects, shape, false);
block|}
