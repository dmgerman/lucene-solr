...
argument_list|()
decl_stmt|;
comment|/* not-tokenized, but indexed field */
if|if
condition|(
name|term
operator|!=
...
return|;
block|}
comment|/**    * Test that we can create ShingleAnalyzerWrappers.    */
...
decl_stmt|;
comment|// Default analyzer, maxShingleSize, and outputUnigrams
name|Benchmark
name|benchmark
init|=
name|execBenchmark
...
argument_list|)
expr_stmt|;
comment|// Default analyzer, maxShingleSize = 3, and outputUnigrams = false
name|benchmark
operator|=
name|execBenchmark
argument_list|(
name|getShingleConfig
argument_list|(
literal|"maxShingleSize:3,outputUnigrams:false"
argument_list|)
argument_list|)
expr_stmt|;
name|assertEqualShingle
...
expr_stmt|;
block|}
DECL|method|assertEqualShingle
specifier|private
name|void
name|assertEqualShingle
parameter_list|(
...
name|assertTrue
argument_list|(
literal|"Extra output term(s), starting with '"
operator|+
operator|new
name|String
argument_list|(
...
name|assertEquals
argument_list|(
literal|"Mismatch in output term # "
operator|+
name|termNum
operator|+
literal|" - "
