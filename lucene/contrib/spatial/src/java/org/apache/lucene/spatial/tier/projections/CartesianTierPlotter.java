...
literal|"_tier_"
decl_stmt|;
DECL|field|DEFALT_MIN_TIER
specifier|public
specifier|static
specifier|final
name|int
name|DEFALT_MIN_TIER
init|=
literal|0
decl_stmt|;
DECL|field|DEFALT_MAX_TIER
specifier|public
specifier|static
specifier|final
name|int
name|DEFALT_MAX_TIER
init|=
literal|15
decl_stmt|;
...
return|;
block|}
comment|/**    * Computes log to base 2 of the given value    *     * @param value    *          Value to compute the log of    * @return Log_2 of the value    */
DECL|method|log2
specifier|public
specifier|static
name|double
...
return|;
block|}
comment|/**    * Returns the ID of the tier level plotting is occuring at    *     * @return ID of the tier level plotting is occuring at    */
DECL|method|getTierLevelId
specifier|public
name|int
name|getTierLevelId
parameter_list|()
