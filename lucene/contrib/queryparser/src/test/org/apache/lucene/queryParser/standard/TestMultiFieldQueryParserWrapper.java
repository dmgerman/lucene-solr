...
specifier|public
class|class
name|TestMultiFieldQueryParserWrapper
extends|extends
name|LuceneTestCase
block|{
...
argument_list|)
expr_stmt|;
comment|// LUCENE-1213: MultiFieldQueryParserWrapper was ignoring slop when phrase
comment|// had a field.
name|q
operator|=
name|mfqp
...
block|}
decl_stmt|;
comment|// int[] flags = {MultiFieldQueryParserWrapper.REQUIRED_FIELD,
comment|// MultiFieldQueryParserWrapper.PROHIBITED_FIELD};
name|BooleanClause
operator|.
name|Occur
index|[]
...
argument_list|)
decl_stmt|;
comment|// , fields, flags, new MockAnalyzer());
name|assertEquals
argument_list|(
literal|"+b:one -t:one"
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// the following queries are not affected as their terms are not analyzed
comment|// anyway:
name|q
operator|=
name|parser
