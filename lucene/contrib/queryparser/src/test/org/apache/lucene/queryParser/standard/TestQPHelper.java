...
comment|// RuleBasedCollator. However, the Arabic Locale seems to order the
comment|// Farsi
...
comment|// orders the U+0698 character before the U+0633 character, so the
comment|// single
...
expr_stmt|;
block|}
comment|// Todo (nocommit): Convert from DateField to DateUtil
