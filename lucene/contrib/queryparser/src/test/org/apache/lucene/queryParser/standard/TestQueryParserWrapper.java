...
specifier|public
class|class
name|TestQueryParserWrapper
extends|extends
name|LocalizedTestCase
block|{
DECL|method|TestQueryParserWrapper
specifier|public
name|TestQueryParserWrapper
parameter_list|(
name|String
...
argument_list|)
expr_stmt|;
comment|// there must be a character after the escape
comment|// char
...
comment|// QueryParser qp = new QueryParserWrapper("field", new
...
comment|// assertEquals(1,type[0]); // could be a valid prefix query in the future
comment|// too
comment|//
