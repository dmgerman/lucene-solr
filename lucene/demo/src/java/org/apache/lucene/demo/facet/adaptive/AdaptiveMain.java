...
begin_package
DECL|package|org.apache.lucene.demo.facet.adaptive
package|package
name|org
operator|.
name|apache
...
begin_comment
comment|/**  * Driver for the adaptive sample, using the {@link AdaptiveFacetsAccumulator}.  * Indexing is the same as in {@link SimpleSearcher}  *   * @lucene.experimental  */
end_comment

begin_class
DECL|class|AdaptiveMain
specifier|public
class|class
name|AdaptiveMain
block|{
...
name|log
argument_list|(
literal|"index the adaptive sample documents..."
argument_list|)
expr_stmt|;
name|SimpleIndexer
operator|.
...
name|log
argument_list|(
literal|"search the adaptive sample documents..."
argument_list|)
expr_stmt|;
name|List
argument_list|<
