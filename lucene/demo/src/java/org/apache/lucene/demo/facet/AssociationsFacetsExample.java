...
expr_stmt|;
block|}
comment|/** User runs a query and aggregates facets by summing their int associations. */
DECL|method|sumIntAssociations
specifier|private
name|List
argument_list|<
name|FacetResult
argument_list|>
name|sumIntAssociations
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// sum the 'tags' dimension
name|FacetSearchParams
name|fsp
init|=
operator|new
...
return|;
block|}
comment|/** User runs a query and aggregates facets by summing their float associations. */
DECL|method|sumFloatAssociations
specifier|private
name|List
argument_list|<
name|FacetResult
argument_list|>
name|sumFloatAssociations
parameter_list|()
throws|throws
name|IOException
block|{
...
return|;
block|}
comment|/** Runs summing int association example. */
DECL|method|runSumIntAssociations
specifier|public
name|List
argument_list|<
name|FacetResult
argument_list|>
name|runSumIntAssociations
parameter_list|()
throws|throws
name|IOException
block|{
...
return|;
block|}
comment|/** Runs summing float association example. */
DECL|method|runSumFloatAssociations
specifier|public
name|List
argument_list|<
name|FacetResult
argument_list|>
name|runSumFloatAssociations
parameter_list|()
throws|throws
name|IOException
block|{
...
name|println
argument_list|(
literal|"Sum int-associations example:"
argument_list|)
expr_stmt|;
name|System
operator|.
...
name|println
argument_list|(
literal|"Sum float-associations example:"
argument_list|)
expr_stmt|;
name|System
operator|.
