...
argument_list|)
expr_stmt|;
comment|// DrillSideways only handles taxonomy and sorted set drill facets by default; to do range facets we must subclass and override the
comment|// buildFacetsResult method.
name|DrillSideways
operator|.
name|DrillSidewaysResult
name|result
...
name|IOException
block|{
comment|// If we had other dims we would also compute their drill-down or drill-sideways facets here:
assert|assert
name|drillSidewaysDims
index|[
literal|0
...
name|println
argument_list|(
literal|"Facet drill-sideways example (timestamp/Past six hours):"
argument_list|)
expr_stmt|;
name|System
operator|.
