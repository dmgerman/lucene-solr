...
expr_stmt|;
block|}
DECL|method|testTraditionalChinese
specifier|public
name|void
name|testTraditionalChinese
parameter_list|()
throws|throws
name|Exception
block|{
...
name|a
argument_list|,
literal|"å®ç¾©ååå­ä¸²çåºæ¬å®ä½æ¯è¨å®åè©æ¨æºçé¦è¦å·¥ä½"
argument_list|,
comment|// From http://godel.iis.sinica.edu.tw/CKIP/paper/wordsegment_standard.pdf
operator|new
name|String
index|[]
block|{
