...
block|}
block|}
comment|/**    * The tag encoding format has been changing in Morfologik from version    * to version. Let's keep both variants and determine which one to run    * based on this flag.    */
DECL|field|multipleTagsPerLemma
specifier|private
specifier|final
specifier|static
name|boolean
name|multipleTagsPerLemma
init|=
literal|true
decl_stmt|;
...
block|{
comment|// One tag (concatenated) per stem (lemma repeated).
name|CharSequence
name|currentStem
decl_stmt|;
name|int
