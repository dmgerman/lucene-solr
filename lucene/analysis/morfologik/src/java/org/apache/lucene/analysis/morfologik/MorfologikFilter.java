...
name|in
argument_list|,
name|DictionaryHolder
operator|.
name|DEFAULT_DICT
argument_list|)
expr_stmt|;
block|}
comment|/**    * Creates a filter with a given dictionary resource.    *    * @param in input token stream.    * @param dictResource Dictionary resource name in classpath.    */
DECL|method|MorfologikFilter
specifier|public
name|MorfologikFilter
parameter_list|(
...
expr_stmt|;
block|}
comment|/**    * Creates a filter with a given dictionary.    *    * @param in input token stream.    * @param dict Dictionary to use for stemming.    */
DECL|method|MorfologikFilter
specifier|public
name|MorfologikFilter
parameter_list|(
...
expr_stmt|;
block|}
comment|/** This method was added, because Morfologik uses context classloader and fails to load from our classloader (bug with absolute path). */
DECL|method|loadDictionaryResource
specifier|static
name|Dictionary
name|loadDictionaryResource
parameter_list|(
...
name|resource
argument_list|,
literal|"Morfologik language code may not be null"
argument_list|)
expr_stmt|;
specifier|final
name|String
name|dictPath
init|=
literal|"/morfologik/dictionaries/"
operator|+
name|resource
operator|+
literal|".dict"
...
argument_list|)
argument_list|,
literal|"Unable to find Morfologik dictionary: "
operator|+
name|dictPath
argument_list|)
init|;
...
argument_list|)
argument_list|,
literal|"Unable to find Morfologik metadata: "
operator|+
name|metaPath
argument_list|)
init|)
...
argument_list|(
literal|"IOException while loading Morfologik dictionary and metadata."
argument_list|,
name|ioe
argument_list|)
throw|;
block|}
block|}
comment|/** This holder is for the default Polish dictionary */
DECL|class|DictionaryHolder
specifier|static
specifier|final
class|class
name|DictionaryHolder
block|{
DECL|field|DEFAULT_DICT
specifier|static
specifier|final
name|Dictionary
name|DEFAULT_DICT
