...
begin_comment
comment|/**  * A dictionary-based {@link Analyzer} for Ukrainian.  */
end_comment

begin_class
DECL|class|UkrainianMorfologikAnalyzer
specifier|public
specifier|final
class|class
...
decl_stmt|;
comment|/** File containing default Ukrainian stopwords. */
...
DECL|method|UkrainianMorfologikAnalyzer
specifier|public
name|UkrainianMorfologikAnalyzer
parameter_list|()
block|{
...
name|getResource
argument_list|(
literal|"ua/net/nlp/ukrainian.dict"
argument_list|)
argument_list|)
return|;
block|}
