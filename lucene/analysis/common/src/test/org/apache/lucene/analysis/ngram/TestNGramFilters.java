...
expr_stmt|;
block|}
comment|/**    * Test NGramFilterFactory on tokens with payloads    */
DECL|method|testNGramFilterPayload
specifier|public
name|void
name|testNGramFilterPayload
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/**    * Test EdgeNGramFilterFactory on tokens with payloads    */
DECL|method|testEdgeNGramFilterPayload
specifier|public
name|void
name|testEdgeNGramFilterPayload
parameter_list|()
throws|throws
name|Exception
block|{
