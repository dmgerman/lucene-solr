...
expr_stmt|;
block|}
comment|/**    * Helper method to validate all strings that can be generated from a token stream.    * Uses {@link TokenStreamToAutomaton} to create an automaton. Asserts the finite strings of the automaton are all    * and only the given valid strings.    * @param analyzer analyzer containing the SynonymFilter under test.    * @param text text to be analyzed.    * @param expectedStrings all expected finite strings.    */
DECL|method|assertAllStrings
specifier|public
name|void
name|assertAllStrings
parameter_list|(
...
name|assertEquals
argument_list|(
literal|"Invalid resulting strings count. Expected "
operator|+
name|expectedStrings
operator|.
name|length
...
name|assertTrue
argument_list|(
literal|"Unexpected string found: "
operator|+
name|s
argument_list|,
name|expectedStringsSet
