...
expr_stmt|;
block|}
DECL|method|testPositionLength
specifier|public
name|void
name|testPositionLength
parameter_list|()
throws|throws
name|Exception
block|{
...
index|[]
block|{
literal|"to be or not"
block|,
literal|"be or not to"
block|,
...
literal|18
argument_list|,
comment|// offsets are correct but assertTokenStreamContents does not handle multiple terms with different offsets
comment|// finishing at the same position
literal|false
argument_list|)
expr_stmt|;
name|a
...
literal|"to be or not"
block|,
literal|"to be or not to"
block|,
literal|"be or not"
block|,
literal|"be or not to"
block|,
literal|"be or not to be"
block|,
literal|"or not to"
block|,
literal|"or not to be"
