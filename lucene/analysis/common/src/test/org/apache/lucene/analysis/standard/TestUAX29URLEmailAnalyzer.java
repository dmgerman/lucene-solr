...
expr_stmt|;
block|}
DECL|method|testMaxTokenLengthDefault
specifier|public
name|void
name|testMaxTokenLengthDefault
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// first bString is exact max default length; next one is 1 too long
name|String
name|input
init|=
literal|"x "
...
expr_stmt|;
block|}
DECL|method|testMaxTokenLengthNonDefault
specifier|public
name|void
name|testMaxTokenLengthNonDefault
parameter_list|()
throws|throws
name|Exception
block|{
