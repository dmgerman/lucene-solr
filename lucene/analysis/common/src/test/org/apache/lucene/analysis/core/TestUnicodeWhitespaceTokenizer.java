...
argument_list|)
expr_stmt|;
comment|// tokeniser will split at 5, Token | izer, no matter what happens
name|WhitespaceTokenizerFactory
name|factory
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// tokeniser will split at 2, To | ke | ni | ze | r, no matter what happens
name|factory
operator|=
operator|new
name|WhitespaceTokenizerFactory
...
argument_list|)
expr_stmt|;
comment|// tokeniser will split at 10, no matter what happens,
comment|// but tokens' length are less than that
name|factory
operator|=
operator|new
name|WhitespaceTokenizerFactory
