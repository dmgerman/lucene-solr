...
expr_stmt|;
block|}
comment|/*    * tests the max word length passed as parameter - tokenizer will split at the passed position char no matter what happens    */
DECL|method|testCustomMaxTokenLength
specifier|public
name|void
name|testCustomMaxTokenLength
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// Tricky, passing two copies of the string to the reader....
name|tokenizer
operator|.
name|setReader
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Let's test that we can get a token longer than 255 through.
name|builder
operator|.
name|setLength
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// Just to be sure what is happening here, token lengths of zero make no sense,
comment|// Let's try the edge cases, token> I/O buffer (4096)
name|builder
operator|.
name|setLength
argument_list|(
...
name|assertEquals
argument_list|(
literal|"maxTokenLen must be greater than 0 and less than 1048576 passed: 10000000"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"maxTokenLen must be greater than 0 and less than 1048576 passed: 2000000"
argument_list|,
name|e
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"maxTokenLen must be greater than 0 and less than 1048576 passed: 3000000"
argument_list|,
name|e
operator|.
name|getMessage
