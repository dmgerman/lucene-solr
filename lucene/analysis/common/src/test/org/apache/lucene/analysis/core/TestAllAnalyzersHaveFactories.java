...
argument_list|)
expr_stmt|;
comment|// TODO: provide fake ResourceLoader
if|if
condition|(
operator|!
operator|(
...
parameter_list|)
block|{
comment|// TODO: For now pass because some factories have not yet a default config that always works, some require ResourceLoader
block|}
block|}
elseif|else
if|if
