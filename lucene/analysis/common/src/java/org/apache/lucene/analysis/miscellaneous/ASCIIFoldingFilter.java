...
block|}
block|}
comment|/**    * Check if foldToASCII generated a different token.    * @param input original term    * @param inputLength length of the original term    * @return true if foldToASCII generated a different token    */
DECL|method|needToPreserve
specifier|private
name|boolean
name|needToPreserve
parameter_list|(
