...
condition|)
block|{
comment|// The main use-case for using preserveOriginal is to match regardless of
comment|// case but to give better scores to exact matches. Since most multi-term
comment|// queries return constant scores anyway, the multi-term component only
comment|// emits the folded token
name|Map
argument_list|<
name|String
argument_list|,
