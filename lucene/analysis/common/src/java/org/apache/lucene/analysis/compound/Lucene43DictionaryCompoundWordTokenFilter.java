...
begin_comment
comment|/**  * A {@link TokenFilter} that decomposes compound words found in many Germanic languages, using  * pre-4.4 behavior.  * @deprecated Use {@link DictionaryCompoundWordTokenFilter}.  */
end_comment

begin_class
annotation|@
name|Deprecated
DECL|class|Lucene43DictionaryCompoundWordTokenFilter
specifier|public
class|class
...
block|{
comment|/**    * Creates a new {@link Lucene43DictionaryCompoundWordTokenFilter}    *    * @param input    *          the {@link TokenStream} to process    * @param dictionary    *          the word dictionary to match against.    */
DECL|method|Lucene43DictionaryCompoundWordTokenFilter
specifier|public
name|Lucene43DictionaryCompoundWordTokenFilter
parameter_list|(
name|TokenStream
