...
begin_comment
comment|/**  * Tokenizes the given token into n-grams of given size(s), using pre-4.4 behavior.  *  * @deprecated Use {@link org.apache.lucene.analysis.ngram.EdgeNGramTokenFilter}.  */
end_comment

begin_class
annotation|@
name|Deprecated
DECL|class|Lucene43EdgeNGramTokenFilter
specifier|public
specifier|final
class|class
...
argument_list|)
decl_stmt|;
comment|/**    * Creates EdgeNGramTokenFilter that can generate n-grams in the sizes of the given range    *    * @param input {@link org.apache.lucene.analysis.TokenStream} holding the input to be tokenized    * @param minGram the smallest n-gram to generate    * @param maxGram the largest n-gram to generate    */
DECL|method|Lucene43EdgeNGramTokenFilter
specifier|public
name|Lucene43EdgeNGramTokenFilter
parameter_list|(
name|TokenStream
