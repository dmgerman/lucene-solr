...
argument_list|(
literal|"Too many affixes, please report this to dev@lucene.apache.org"
argument_list|)
throw|;
block|}
assert|assert
...
name|UnsupportedOperationException
argument_list|(
literal|"Too many unique flags, please report this to dev@lucene.apache.org"
argument_list|)
throw|;
block|}
name|affixWriter
...
comment|// we should really look for any whitespace: currently just tab and space
name|int
name|end
init|=
name|line
