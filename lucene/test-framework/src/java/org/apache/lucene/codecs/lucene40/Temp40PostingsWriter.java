...
begin_comment
comment|/**  * Concrete class that writes the 4.0 frq/prx postings format.  *   * @see Temp40RWPostingsFormat  * @lucene.experimental   */
end_comment

begin_class
DECL|class|Temp40PostingsWriter
specifier|public
specifier|final
class|class
...
comment|/** Creates a {@link Temp40PostingsWriter}, with the    *  {@link #DEFAULT_SKIP_INTERVAL}. */
DECL|method|Temp40PostingsWriter
specifier|public
name|Temp40PostingsWriter
parameter_list|(
name|SegmentWriteState
...
expr_stmt|;
block|}
comment|/** Creates a {@link Temp40PostingsWriter}, with the    *  specified {@code skipInterval}. */
DECL|method|Temp40PostingsWriter
specifier|public
name|Temp40PostingsWriter
parameter_list|(
