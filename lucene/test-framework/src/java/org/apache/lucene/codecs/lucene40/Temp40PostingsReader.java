...
begin_comment
comment|/**   * Concrete class that reads the 4.0 frq/prox  * postings format.   *    *  @see Temp40RWPostingsFormat  *  @deprecated Only for reading old 4.0 segments */
end_comment

begin_class
annotation|@
name|Deprecated
DECL|class|Temp40PostingsReader
specifier|public
class|class
...
name|TERMS_CODEC
init|=
literal|"Temp40PostingsWriterTerms"
decl_stmt|;
...
name|FRQ_CODEC
init|=
literal|"Temp40PostingsWriterFrq"
decl_stmt|;
...
name|PRX_CODEC
init|=
literal|"Temp40PostingsWriterPrx"
decl_stmt|;
...
DECL|method|Temp40PostingsReader
specifier|public
name|Temp40PostingsReader
parameter_list|(
name|Directory
