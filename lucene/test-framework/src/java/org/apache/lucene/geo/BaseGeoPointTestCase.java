...
literal|"point"
decl_stmt|;
comment|// TODO: remove these hooks once all subclasses can pass with new random!
...
block|}
block|}
comment|// this test works in quantized space: for testing inclusiveness of exact edges it must be aware of index-time quantization!
name|rect
operator|=
operator|new
name|Rectangle
...
comment|// TODO: fragile: does not understand quantization in any way yet uses extremely high precision!
name|double
index|[]
index|[]
name|pts
