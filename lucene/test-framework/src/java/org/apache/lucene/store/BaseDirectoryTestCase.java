...
expr_stmt|;
block|}
DECL|method|testCloneThreadSafety
specifier|public
name|void
name|testCloneThreadSafety
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Write file with at least 20 K random bytes:
specifier|final
name|int
name|numBytes
init|=
...
argument_list|()
expr_stmt|;
comment|// Then read the bytes back at random seek points from multiple threads:
specifier|final
name|IndexInput
name|in
init|=
...
control|)
block|{
comment|// First thread uses the original IndexInput, all other threads use clone:
name|IndexInput
name|myIn
decl_stmt|;
if|if
