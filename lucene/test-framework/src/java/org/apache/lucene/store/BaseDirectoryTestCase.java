...
expr_stmt|;
block|}
DECL|method|testCopyFromDestination
specifier|public
name|void
name|testCopyFromDestination
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSetOfStrings
specifier|public
name|void
name|testSetOfStrings
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMapOfStrings
specifier|public
name|void
name|testMapOfStrings
parameter_list|()
throws|throws
name|Exception
block|{
...
comment|// if it's using two FSdirs and so on
if|if
condition|(
name|fsdir
operator|instanceof
...
block|}
comment|// LUCENE-6084
DECL|method|testIndexOutputToString
specifier|public
name|void
name|testIndexOutputToString
parameter_list|()
throws|throws
name|Throwable
block|{
...
expr_stmt|;
block|}
DECL|method|testDoubleCloseDirectory
specifier|public
name|void
name|testDoubleCloseDirectory
parameter_list|()
throws|throws
name|Throwable
block|{
...
expr_stmt|;
block|}
DECL|method|testDoubleCloseInput
specifier|public
name|void
name|testDoubleCloseInput
parameter_list|()
throws|throws
name|Throwable
block|{
...
expr_stmt|;
block|}
DECL|method|testSeekToEndOfFile
specifier|public
name|void
...
block|}
block|}
DECL|method|testSeekBeyondEndOfFile
specifier|public
name|void
name|testSeekBeyondEndOfFile
parameter_list|()
throws|throws
name|IOException
block|{
...
block|}
block|}
comment|// Make sure the FSDirectory impl properly "emulates" deletions on filesystems (Windows) with buggy deleteFile:
DECL|method|testPendingDeletions
specifier|public
name|void
name|testPendingDeletions
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assumeTrue
argument_list|(
literal|"we can only install VirusCheckingFS on an FSDirectory"
argument_list|,
name|dir
operator|instanceof
name|FSDirectory
...
condition|)
block|{
comment|// create a random filename (segment file name style), so it cannot hit windows problem with special filenames ("con", "com1",...):
name|String
name|candidate
init|=
name|IndexFileNames
...
block|}
block|}
comment|// Make sure listAll does NOT include the file:
name|assertFalse
argument_list|(
name|Arrays
operator|.
...
argument_list|)
expr_stmt|;
comment|// Make sure we cannot open it for reading:
name|expectThrows
argument_list|(
name|NoSuchFileException
operator|.
...
block|}
block|}
DECL|method|testListAllIsSorted
specifier|public
name|void
name|testListAllIsSorted
parameter_list|()
throws|throws
name|IOException
block|{
