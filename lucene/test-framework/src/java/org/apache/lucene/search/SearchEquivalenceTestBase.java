...
name|Exception
block|{
comment|// TODO: remove this randomness and just explicitly test the query N times always?
if|if
condition|(
name|filter
operator|!=
...
condition|)
block|{
comment|// use FilteredQuery explicitly
name|q1
operator|=
operator|new
name|FilteredQuery
...
condition|)
block|{
comment|// use BooleanQuery FILTER clause
name|BooleanQuery
name|bq1
init|=
operator|new
...
block|{
comment|// do nothing, we use search(q, filter, int, ...) in this case.
block|}
block|}
