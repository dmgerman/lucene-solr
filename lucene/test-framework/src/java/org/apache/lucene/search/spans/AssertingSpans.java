...
argument_list|)
operator|:
literal|"positionsCost() should not be NaN"
assert|;
assert|assert
name|cost
operator|>
literal|0
operator|:
literal|"positionsCost() must be positive"
assert|;
return|return
name|cost
return|;
...
name|cost
operator|+
literal|" should not be NaN on doc ID "
operator|+
name|approximation
operator|.
name|docID
...
name|cost
operator|+
literal|" should be non negative on doc ID "
operator|+
name|approximation
operator|.
name|docID
