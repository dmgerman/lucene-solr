...
name|done
operator|=
name|handlePossiblyFakeException
argument_list|(
name|ise
argument_list|)
expr_stmt|;
...
block|}
block|}
comment|// TODO: merge w/ BaseIndexFileFormatTestCase.handleFakeIOException
DECL|method|handlePossiblyFakeException
specifier|private
name|boolean
name|handlePossiblyFakeException
parameter_list|(
...
argument_list|)
expr_stmt|;
comment|// dead code yet javac disagrees:
return|return
literal|false
return|;
block|}
...
block|}
comment|// LUCENE-7491
DECL|method|testMixedSchema
specifier|public
name|void
name|testMixedSchema
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|// index has 1 segment now (with 2 docs) and that segment does have points, but the "id" field in particular does NOT
name|Document
name|doc
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// now we write another segment where the id field does have points:
name|w
operator|.
name|forceMerge
argument_list|(
