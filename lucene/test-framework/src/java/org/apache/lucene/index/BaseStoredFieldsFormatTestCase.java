...
expr_stmt|;
block|}
comment|/** A dummy filter reader that reverse the order of documents in stored fields. */
DECL|class|DummyFilterLeafReader
specifier|private
specifier|static
class|class
name|DummyFilterLeafReader
extends|extends
name|FilterLeafReader
block|{
DECL|method|DummyFilterLeafReader
specifier|public
name|DummyFilterLeafReader
parameter_list|(
name|LeafReader
...
block|}
block|}
DECL|method|testMergeFilterReader
specifier|public
name|void
name|testMergeFilterReader
parameter_list|()
throws|throws
name|IOException
block|{
...
expr_stmt|;
block|}
comment|/** mix up field numbers, merge, and check that data is correct */
DECL|method|testMismatchedFields
specifier|public
name|void
name|testMismatchedFields
parameter_list|()
throws|throws
name|Exception
block|{
...
control|)
block|{
comment|// add fields where name=value (e.g. 3=3) so we can detect if stuff gets screwed up.
name|doc
operator|.
name|add
argument_list|(
