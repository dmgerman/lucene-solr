...
block|{
comment|/** Whether this format records min versions. */
...
block|}
block|}
comment|/**     * Test segment infos write that hits exception immediately on open.    * make sure we get our exception back, no file handle leaks, etc.     */
...
expr_stmt|;
block|}
comment|/**     * Test segment infos write that hits exception on close.    * make sure we get our exception back, no file handle leaks, etc.     */
...
expr_stmt|;
block|}
comment|/**     * Test segment infos read that hits exception immediately on open.    * make sure we get our exception back, no file handle leaks, etc.     */
...
expr_stmt|;
block|}
comment|/**     * Test segment infos read that hits exception on close    * make sure we get our exception back, no file handle leaks, etc.     */
