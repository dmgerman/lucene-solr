...
block|{
comment|/** Whether the codec supports sparse values. */
...
block|}
block|}
DECL|method|testSparseByteRange
specifier|public
name|void
name|testSparseByteRange
parameter_list|()
throws|throws
name|Exception
block|{
name|assumeTrue
argument_list|(
literal|"Requires sparse norms support"
argument_list|,
name|codecSupportsSparsity
argument_list|()
argument_list|)
...
block|}
block|}
DECL|method|testSparseShortRange
specifier|public
name|void
name|testSparseShortRange
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testSparseLongRange
specifier|public
name|void
name|testSparseLongRange
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testSparseFullLongRange
specifier|public
name|void
name|testSparseFullLongRange
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testFewSparseValues
specifier|public
name|void
name|testFewSparseValues
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testFewSparseLargeValues
specifier|public
name|void
name|testFewSparseLargeValues
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testSparseAllZeros
specifier|public
name|void
name|testSparseAllZeros
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testSparseOutliers
specifier|public
name|void
name|testSparseOutliers
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
DECL|method|testSparseOutliers2
specifier|public
name|void
name|testSparseOutliers2
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testSparseNCommon
specifier|public
name|void
name|testSparseNCommon
parameter_list|()
throws|throws
name|Exception
block|{
...
block|}
block|}
comment|/**    * a more thorough n-common that tests all low bpv and sparse docs    */
annotation|@
name|Nightly
DECL|method|testSparseNCommonBig
specifier|public
name|void
name|testSparseNCommonBig
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|checkNormsVsDocValues
specifier|private
name|void
name|checkNormsVsDocValues
parameter_list|(
