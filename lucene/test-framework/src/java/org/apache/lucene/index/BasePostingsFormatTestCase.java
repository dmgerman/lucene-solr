...
expr_stmt|;
block|}
comment|// tests that level 2 ghost fields still work
DECL|method|testLevel2Ghosts
specifier|public
name|void
name|testLevel2Ghosts
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// first force merge creates a level 1 ghost field
name|iw
operator|.
name|forceMerge
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// second force merge creates a level 2 ghost field, causing MultiFields to include "suggest_field" in its iteration, yet a null Terms is returned (no documents have
