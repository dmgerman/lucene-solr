...
literal|1000
decl_stmt|;
comment|/**    * Deletes a file or a directory (and everything underneath it).    */
DECL|method|rm
specifier|public
specifier|static
name|void
...
expr_stmt|;
block|}
comment|/**    * Returns a new, empty temporary folder, based on the current test class's name.    *     * @see #createTempDir(String, File)    */
...
return|;
block|}
comment|/**    * @see #createTempDir(String, File)    */
DECL|method|createTempDir
specifier|public
specifier|static
name|File
...
return|;
block|}
comment|/**    * Returns a new and empty temporary folder, based on the given name. The folder will be    * deleted at the end of the test suite. Failure to delete the temporary folder will cause    * an exception (typically happens on Windows on unclosed file handles).    */
DECL|method|createTempDir
specifier|public
specifier|static
name|File
...
argument_list|(
literal|"The prefix must be at least 3 characters: "
operator|+
name|prefix
argument_list|)
throw|;
...
name|RuntimeException
argument_list|(
literal|"Parent location does not exist: "
operator|+
name|parent
operator|.
name|getAbsolutePath
...
name|RuntimeException
argument_list|(
literal|"Parent location is not a folder: "
operator|+
name|parent
operator|.
name|getAbsolutePath
...
name|RuntimeException
argument_list|(
literal|"Parent folder not writeable: "
operator|+
name|parent
operator|.
name|getAbsolutePath
...
return|;
block|}
DECL|method|maybeRemoveAfterSuite
specifier|private
specifier|static
name|File
name|maybeRemoveAfterSuite
...
name|println
argument_list|(
literal|"WARNING: Will leave temporary files (bugUrl: "
operator|+
name|suiteClass
operator|.
name|getAnnotation
...
return|;
block|}
comment|/**    * Do NOT expose this method public. Use {@link #createTempDir()} instead.    */
DECL|method|tempDirectory
specifier|private
specifier|static
name|File
name|tempDirectory
...
return|;
block|}
comment|/**     * Insecure, fast version of {@link File#createTempFile(String, String)}, uses     * Random instead of SecureRandom.    */
DECL|method|createTempFile
specifier|public
specifier|static
name|File
...
break|break;
block|}
comment|// TODO: cast to DocsAndPositionsEnum?
name|DocsAndPositionsEnum
