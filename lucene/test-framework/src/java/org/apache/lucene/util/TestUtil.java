...
expr_stmt|;
block|}
comment|/**    * Returns a new, empty temporary folder, based on the given name. The folder will be    * deleted at the end of the suite. Failure to delete the temporary folder will cause    * an exception (typically on Windows).    */
