...
condition|)
block|{
comment|// change merge integrity check parameters
name|c
operator|.
name|setCheckIntegrityAtMerge
argument_list|(
...
expr_stmt|;
block|}
comment|// TODO: mergepolicy, mergescheduler, etc have mutable state on indexwriter
comment|// every setter must be tested
block|}
