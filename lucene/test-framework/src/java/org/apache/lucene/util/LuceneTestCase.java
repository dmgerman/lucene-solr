...
literal|2
case|:
comment|// HÃ¤ckidy-Hick-Hack: this will create FC insanity, so we patch MultiReader to
comment|// return a fake cache key, so insanity checker cannot walk along our reader:
name|r
operator|=
operator|new
name|MultiReader
