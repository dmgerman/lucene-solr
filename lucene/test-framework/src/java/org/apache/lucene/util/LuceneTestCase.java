...
decl_stmt|;
comment|/**    * If true, enables assertions on writing to system streams.    *     * @see TestRuleDisallowSysouts    */
...
function_decl|;
block|}
comment|/**    * Marks any suite which is known to print to {@link System#out} or {@link System#err},    * even when {@link #VERBOSE} is disabled.    *     * @see TestRuleDisallowSysouts    */
annotation|@
name|Documented
annotation|@
name|Inherited
...
name|LUCENE_50
decl_stmt|;
comment|/**    * True if and only if tests are run in verbose mode. If this flag is false    * tests are not expected to print any messages. Enforced with {@link TestRuleDisallowSysouts}.    */
DECL|field|VERBOSE
specifier|public
specifier|static
specifier|final
...
argument_list|(
operator|new
name|TemporaryFilesCleanupRule
argument_list|()
argument_list|)
operator|.
name|around
...
name|forName
argument_list|(
literal|"org.apache.lucene.index.DocumentsWriterPerThreadPool"
argument_list|)
argument_list|)
decl_stmt|;
name|setIndexerThreadPoolMethod
...
block|}
block|}
comment|/**    * A base location for temporary files of a given test. Helps in figuring out    * which tests left which files and where.    */
