...
begin_comment
comment|/**  * Function that returns {@link org.apache.lucene.index.PostingsEnum#freq()} for the  * supplied term in every document.  *<p>  * If the term does not exist in the document, returns 0.  * If frequencies are omitted, returns 1.  */
end_comment
