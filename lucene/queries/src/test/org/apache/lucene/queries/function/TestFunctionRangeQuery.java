...
annotation|@
name|Test
DECL|method|testRangeIntMultiValued
specifier|public
name|void
name|testRangeIntMultiValued
parameter_list|()
throws|throws
name|IOException
block|{
name|doTestRange
argument_list|(
name|INT_MV_MAX_VALUESOURCE
argument_list|)
expr_stmt|;
name|doTestRange
argument_list|(
name|INT_MV_MIN_VALUESOURCE
argument_list|)
expr_stmt|;
block|}
annotation|@
...
annotation|@
name|Test
DECL|method|testRangeFloatMultiValued
specifier|public
name|void
name|testRangeFloatMultiValued
parameter_list|()
throws|throws
name|IOException
block|{
name|doTestRange
argument_list|(
name|FLOAT_MV_MAX_VALUESOURCE
argument_list|)
expr_stmt|;
name|doTestRange
argument_list|(
name|FLOAT_MV_MIN_VALUESOURCE
argument_list|)
expr_stmt|;
block|}
...
annotation|@
name|Test
DECL|method|testDeletedMultiValued
specifier|public
name|void
name|testDeletedMultiValued
parameter_list|()
throws|throws
name|IOException
block|{
...
name|IOException
block|{
comment|// We delete doc with #3. Note we don't commit it to disk; we search using a near real-time reader.
name|IndexWriter
name|writer
init|=
operator|new
...
annotation|@
name|Test
DECL|method|testExplainMultiValued
specifier|public
name|void
name|testExplainMultiValued
parameter_list|()
throws|throws
name|IOException
block|{
