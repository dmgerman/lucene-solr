...
name|bytesPerDim
expr_stmt|;
comment|// Optimize this common case, effectively doing a merge sort of the indexed values vs the queried set:
name|values
operator|.
name|intersect
argument_list|(
...
name|field
argument_list|,
comment|// nocommit don't make new instance of this for each point?
operator|new
name|IntersectVisitor
argument_list|()
block|{
...
argument_list|)
expr_stmt|;
comment|// nocommit fix me to convert back to the numbers/etc.:
name|sb
operator|.
name|append
argument_list|(
