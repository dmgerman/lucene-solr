...
name|collector
operator|:
literal|"You must collect using the same SpanCollector as was passed to the NearSpans constructor"
assert|;
name|buffer
operator|.
name|replay
