...
block|}
block|}
comment|// Check whether some clauses are both required and excluded
specifier|final
name|Collection
argument_list|<
name|Query
...
name|MatchNoDocsQuery
argument_list|(
literal|"FILTER or MUST clause also in MUST_NOT"
argument_list|)
return|;
block|}
if|if
...
name|MatchNoDocsQuery
argument_list|(
literal|"MUST_NOT clause is MatchAllDocsQuery"
argument_list|)
return|;
block|}
block|}
...
block|}
block|}
comment|// convert FILTER clauses that are also SHOULD clauses to MUST clauses
if|if
condition|(
name|clauseSets
operator|.
