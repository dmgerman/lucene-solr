...
DECL|field|OLD_LENGTH_TABLE
specifier|private
specifier|static
specifier|final
name|float
index|[]
name|OLD_LENGTH_TABLE
init|=
operator|new
name|float
index|[
...
block|}
block|}
comment|/** Encodes the document length in the same way as {@link BM25Similarity}. */
annotation|@
name|Override
