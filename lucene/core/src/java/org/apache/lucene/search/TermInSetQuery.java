...
comment|/**    * Creates a new {@link TermInSetQuery} from the given collection of terms.    */
...
expr_stmt|;
block|}
comment|/**    * Creates a new {@link TermInSetQuery} from the given array of terms.    */
DECL|method|TermInSetQuery
specifier|public
name|TermInSetQuery
parameter_list|(
...
parameter_list|)
block|{
comment|// no need to check 'field' explicitly since it is encoded in 'termData'
