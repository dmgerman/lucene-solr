...
return|;
block|}
comment|/**    * Same as {@link #merge(Sort, int, TopDocs[])} but also slices the result at the same time based    * on the provided start and size. The return TopDocs will always have a scoreDocs with length of at most size.    */
DECL|method|merge
specifier|public
specifier|static
name|TopDocs
