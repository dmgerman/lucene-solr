...
argument_list|>
block|{
comment|// sentinels, just used internally in this comparator
DECL|field|MISSING_BYTES
specifier|private
specifier|static
specifier|final
name|byte
...
index|]
decl_stmt|;
comment|// TODO: this is seriously not good, we should nuke this comparator, or
comment|// instead we should represent missing as null, or use missingValue from the user...
comment|// but it was always this way...
DECL|field|MISSING_BYTESREF
specifier|private
specifier|final
name|BytesRef
name|MISSING_BYTESREF
init|=
operator|new
name|BytesRef
argument_list|(
...
return|;
block|}
comment|/**      * Given a document and a term, return the term itself if it exists or      * {@link #MISSING_BYTESREF} otherwise.      */
