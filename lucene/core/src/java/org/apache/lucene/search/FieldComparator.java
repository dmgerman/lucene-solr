...
argument_list|)
expr_stmt|;
comment|//System.out.println("IntComparator.init");
...
return|;
block|}
comment|/** Check whether the given value represents<tt>null</tt>. This can be      *  useful if the {@link BinaryDocValues} returned by {@link #getBinaryDocValues}      *  use a special value as a sentinel.      *<p>NOTE: The null value can only be an EMPTY {@link BytesRef}. */
DECL|method|isNull
specifier|protected
name|boolean
name|isNull
