...
expr_stmt|;
block|}
DECL|method|notifyRefreshListeners
specifier|private
name|void
name|notifyRefreshListeners
parameter_list|()
...
name|RefreshListener
block|{
comment|/**      * Called after a successful refresh and a new reference has been installed. When this is called {@link #acquire()} is guaranteed to return a new instance.      */
