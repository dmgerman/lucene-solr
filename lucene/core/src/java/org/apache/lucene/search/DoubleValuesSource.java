...
parameter_list|()
function_decl|;
comment|/**    * An explanation of the value for the named document.    *    * @param ctx the readers context to create the {@link Explanation} for.    * @param docId the document's id relative to the given context's reader    * @return an Explanation for the value    * @throws IOException if an {@link IOException} occurs    */
DECL|method|explain
specifier|public
specifier|abstract
name|Explanation
...
block|}
decl_stmt|;
comment|/**    * Creates a DoubleValuesSource that always returns a constant value    */
...
return|;
block|}
comment|/**    * Creates a DoubleValuesSource that is a function of another DoubleValuesSource    */
...
return|;
block|}
comment|/**    * Creates a DoubleValuesSource that is a function of another DoubleValuesSource and a score    * @param in        the DoubleValuesSource to use as an input    * @param description a description of the function    * @param function  a function of the form (source, score) == result    */
DECL|method|scoringFunction
specifier|public
specifier|static
name|DoubleValuesSource
