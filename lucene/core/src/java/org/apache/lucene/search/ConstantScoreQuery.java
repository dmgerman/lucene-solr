...
block|}
block|}
comment|/** We return this as our {@link TopScorer} so that if the CSQ    *  wraps a query with its own optimized top-level    *  scorer (e.g. BooleanScorer) we can use that    *  top-level scorer. */
DECL|class|ConstantTopScorer
specifier|protected
class|class
name|ConstantTopScorer
extends|extends
