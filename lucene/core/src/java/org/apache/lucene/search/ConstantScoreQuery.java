...
begin_comment
comment|/**  * A query that wraps another query and simply returns a constant score equal to  * 1 for every document that matches the query.  * It therefore simply strips of all scores and always returns 1.  */
end_comment
...
name|query
decl_stmt|;
comment|/** Strips off scores from the passed in Query. The hits will get a constant score    * of 1. */
