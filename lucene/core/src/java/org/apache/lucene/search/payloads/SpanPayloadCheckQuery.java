...
block|}
block|}
comment|/**    * Check to see if the collected payloads match the required set.    *    * This is called for Near span queries which collect their sub spans    * out-of-order, meaning that we can't rely on the order of payloads    * in the collection    *    * @param candidate a collection of payloads from the current Spans    * @return whether or not the payloads match    */
DECL|method|checkOrderedPayloads
specifier|protected
name|AcceptStatus
name|checkOrderedPayloads
parameter_list|(
...
block|}
block|}
comment|/**    * Check to see if the collected payloads match the required set.    * @param candidate a collection of payloads from the current Spans    * @return whether or not the payloads match    */
DECL|method|checkCompositePayloads
specifier|protected
name|AcceptStatus
name|checkCompositePayloads
parameter_list|(
