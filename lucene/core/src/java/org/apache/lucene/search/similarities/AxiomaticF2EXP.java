...
begin_comment
comment|/**  * F2EXP is defined as Sum(tfln(term_doc_freq, docLen)*IDF(term))  * where IDF(t) = pow((N+1)/df(t), k) N=total num of docs, df=doc freq  *  * @lucene.experimental  */
end_comment

begin_class
DECL|class|AxiomaticF2EXP
specifier|public
class|class
name|AxiomaticF2EXP
extends|extends
