...
index|]
decl_stmt|;
comment|// Carefully pack lower and upper bounds
for|for
control|(
name|int
name|dim
...
return|;
block|}
comment|// Cannot use Arrays.equals here, because it in turn uses byte[].equals
comment|// to compare each value, which only uses "=="
for|for
control|(
name|int
name|dim
