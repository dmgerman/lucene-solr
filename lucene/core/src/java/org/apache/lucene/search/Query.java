...
parameter_list|)
function_decl|;
comment|/**    * Override and implement query hash code properly in a subclass.     * This is required so that {@link QueryCache} works properly.    *     * @see #equals(Object)    */
annotation|@
name|Override
...
parameter_list|()
function_decl|;
comment|/**    * Utility method to check whether<code>other</code> is not null and is exactly     * of the same class as this object's class.    *     * When this method is used in an implementation of {@link #equals(Object)},    * consider using {@link #classHash()} in the implementation    * of {@link #hashCode} to differentiate different class    */
DECL|method|sameClassAs
specifier|protected
specifier|final
name|boolean
name|sameClassAs
...
argument_list|()
decl_stmt|;
comment|/**    * Provides a constant integer for a given class, derived from the name of the class.    * The rationale for not using just {@link Class#hashCode()} is that classes may be    * assigned different hash codes for each execution and we want hashes to be possibly    * consistent to facilitate debugging.        */
DECL|method|classHash
specifier|protected
specifier|final
name|int
name|classHash
