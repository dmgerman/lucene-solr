...
return|;
block|}
comment|/** Base class for reading input from a RandomAccessFile */
...
block|{
comment|/** the underlying RandomAccessFile */
DECL|field|file
specifier|protected
specifier|final
name|RandomAccessFile
...
name|end
decl_stmt|;
comment|/** Create a new FSIndexInput, reading the entire file from<code>path</code> */
...
expr_stmt|;
block|}
comment|/** Create a new FSIndexInput, representing a slice of an existing open<code>file</code> */
DECL|method|FSIndexInput
specifier|protected
name|FSIndexInput
parameter_list|(
