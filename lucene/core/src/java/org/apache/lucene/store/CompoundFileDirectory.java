...
name|CompoundFileWriter
operator|.
name|VERSION_SEGMENTHEADER
condition|)
block|{
comment|// nocommit: remove this null "hack", its because old rw test codecs cant properly impersonate
if|if
condition|(
name|segmentID
operator|==
...
name|CorruptIndexException
argument_list|(
literal|"unexpected segment suffix, expected zero-length, got="
operator|+
operator|(
name|suffixLength
operator|&
