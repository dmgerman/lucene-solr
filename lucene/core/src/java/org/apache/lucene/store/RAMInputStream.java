...
argument_list|()
decl_stmt|;
comment|// If another thread was using our instance, this new clone could have a mismatched currentBuffer and currentBufferIndex, so we do
comment|// a "fresh seek" here:
name|clone
operator|.
name|currentBuffer
operator|=
