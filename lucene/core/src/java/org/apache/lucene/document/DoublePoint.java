...
name|Field
block|{
comment|/**    * Return the least double that compares greater than {@code d} consistently    * with {@link Double#compare}. The only difference with    * {@link Math#nextUp(double)} is that this method returns {@code +0d} when    * the argument is {@code -0d}.    */
DECL|method|nextUp
specifier|public
specifier|static
name|double
...
argument_list|)
operator|==
literal|0x8000_0000_0000_0000L
condition|)
block|{
comment|// -0d
return|return
...
return|;
block|}
comment|/**    * Return the greatest double that compares less than {@code d} consistently    * with {@link Double#compare}. The only difference with    * {@link Math#nextDown(double)} is that this method returns {@code -0d} when    * the argument is {@code +0d}.    */
