...
condition|)
block|{
comment|// all ranges have at least one point outside of the query
return|return
name|Relation
operator|.
name|CELL_OUTSIDE_QUERY
...
condition|)
block|{
comment|// all ranges are either less than the query max or greater than the query min
return|return
name|Relation
operator|.
name|CELL_OUTSIDE_QUERY
