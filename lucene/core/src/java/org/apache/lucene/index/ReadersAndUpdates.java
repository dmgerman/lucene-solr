...
argument_list|()
expr_stmt|;
comment|// Merge sort of the original doc values with updated doc values:
return|return
operator|new
name|NumericDocValues
argument_list|()
block|{
comment|// merged docID
specifier|private
name|int
name|docIDOut
init|=
...
literal|1
decl_stmt|;
comment|// docID from our original doc values
specifier|private
name|int
name|docIDIn
init|=
...
literal|1
decl_stmt|;
comment|// docID from our updates
specifier|private
name|int
name|updateDocID
init|=
