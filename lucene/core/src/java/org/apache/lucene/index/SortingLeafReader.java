...
block|{
comment|//TODO remove from here; move to FreqProxTermsWriter or FreqProxFields?
...
name|CachedBinaryDVs
block|{
comment|// TODO: at least cutover to BytesRefArray here:
DECL|field|values
specifier|private
specifier|final
name|BytesRef
...
block|}
block|}
comment|// TODO: pack long[][] into an int[] (offset) and long[] instead:
DECL|field|cachedSortedSetDVs
specifier|private
specifier|final
name|Map
argument_list|<
...
block|}
block|}
DECL|field|cachedSortedNumericDVs
specifier|private
specifier|final
name|Map
argument_list|<
