...
name|writer
decl_stmt|;
DECL|method|SegmentByteSizeDescending
name|SegmentByteSizeDescending
parameter_list|(
name|IndexWriter
name|writer
...
expr_stmt|;
block|}
comment|// We should never see an empty candidate: we iterated over maxMergeAtOnce
comment|// segments, and already pre-excluded the too-large segments:
assert|assert
name|candidate
operator|.
name|size
