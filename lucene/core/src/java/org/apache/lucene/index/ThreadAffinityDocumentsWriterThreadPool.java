...
condition|)
block|{
comment|// Another thread just flushed this thread state and cleared our binding; put it back:
name|threadBindings
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// make sure we get the same state next time
block|}
return|return
name|minThreadState
return|;
...
parameter_list|)
block|{
comment|// Remove all previous bindings to this ThreadState on flush:
name|Iterator
argument_list|<
name|Map
operator|.
