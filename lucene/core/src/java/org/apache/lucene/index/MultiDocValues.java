...
argument_list|(
literal|"can only advance beyond current document: on docID="
operator|+
name|docID
operator|+
literal|" but targetDocID="
operator|+
name|targetDocID
argument_list|)
throw|;
...
block|}
block|}
comment|/**      * Create an ordinal map that uses the number of unique values of each      * {@link SortedDocValues} instance as a weight.      * @see #build(IndexReader.CacheKey, TermsEnum[], long[], float)      */
DECL|method|build
specifier|public
specifier|static
name|OrdinalMap
...
return|;
block|}
comment|/**      * Create an ordinal map that uses the number of unique values of each      * {@link SortedSetDocValues} instance as a weight.      * @see #build(IndexReader.CacheKey, TermsEnum[], long[], float)      */
DECL|method|build
specifier|public
specifier|static
name|OrdinalMap
...
name|currentValues
decl_stmt|;
DECL|field|currentDocStart
specifier|private
name|int
name|currentDocStart
decl_stmt|;
DECL|field|docID
specifier|private
name|int
