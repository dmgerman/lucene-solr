...
comment|// this to assert dvConsumer != null!
if|if
condition|(
name|fmt
operator|==
...
argument_list|)
expr_stmt|;
comment|// nocommit must null it out now else next seg
comment|// will flush even if no docs had DV...?
block|}
if|if
condition|(
name|field
...
expr_stmt|;
block|}
comment|// nocommit the DV indexing should be just another
comment|// consumer in the chain, not stuck inside here?  this
comment|// source should just "dispatch"
specifier|final
name|DocValues
operator|.
name|Type
