...
name|name
operator|+
literal|"\": cannot index term vector positions while using custom TermFrequencyAttribute"
argument_list|)
throw|;
block|}
if|if
...
name|name
operator|+
literal|"\": cannot index term vector offsets while using custom TermFrequencyAttribute"
argument_list|)
throw|;
block|}
block|}
