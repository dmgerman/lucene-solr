...
name|hasPositions
decl_stmt|;
comment|// if we are checking vectors, we have freqs implicitly
specifier|final
name|boolean
name|hasFreqs
init|=
...
literal|0
decl_stmt|;
comment|// if we are checking vectors, offsets are a free-for-all anyway
specifier|final
name|boolean
name|hasOffsets
init|=
