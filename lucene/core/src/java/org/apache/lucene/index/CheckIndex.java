...
name|pointsStatus
decl_stmt|;
comment|/** Status of index sort */
DECL|field|indexSortStatus
specifier|public
...
decl_stmt|;
block|}
comment|/**      * Status from testing index sort      */
DECL|class|IndexSortStatus
specifier|public
specifier|static
specifier|final
class|class
...
name|IOException
block|{
comment|// This segment claims its documents are sorted according to the incoming sort ... let's make sure:
name|long
name|startNS
init|=
name|System
...
argument_list|(
operator|new
name|ConstantRelationIntersectVisitor
argument_list|(
name|Relation
operator|.
...
name|RuntimeException
argument_list|(
literal|"estimatePointCount should return>= size when all cells fully match"
argument_list|)
throw|;
block|}
specifier|final
...
name|RuntimeException
argument_list|(
literal|"estimatePointCount should return 0 when no cells match"
argument_list|)
throw|;
block|}
name|VerifyPointsVisitor
name|visitor
init|=
operator|new
name|VerifyPointsVisitor
...
name|ROOT
argument_list|,
literal|"OK [%d fields, %d points] [took %.3f sec]"
argument_list|,
name|status
operator|.
name|totalValueFields
...
return|;
block|}
comment|/** Walks the entire N-dimensional points space, verifying that all points fall within the last cell's boundaries.    *    * @lucene.internal */
DECL|class|VerifyPointsVisitor
specifier|public
specifier|static
class|class
name|VerifyPointsVisitor
...
decl_stmt|;
DECL|field|globalMinPackedValue
specifier|private
specifier|final
name|byte
index|[]
...
decl_stmt|;
DECL|field|globalMaxPackedValue
specifier|private
specifier|final
name|byte
index|[]
...
DECL|method|VerifyPointsVisitor
specifier|public
name|VerifyPointsVisitor
parameter_list|(
name|String
...
block|}
block|}
comment|/** Returns total number of points in this BKD tree */
DECL|method|getPointCountSeen
specifier|public
name|long
name|getPointCountSeen
parameter_list|()
...
return|;
block|}
comment|/** Returns total number of unique docIDs in this BKD tree */
DECL|method|getDocCountSeen
specifier|public
name|long
name|getDocCountSeen
parameter_list|()
...
block|}
block|}
DECL|class|ConstantRelationIntersectVisitor
specifier|private
specifier|static
class|class
name|ConstantRelationIntersectVisitor
...
name|relation
decl_stmt|;
DECL|method|ConstantRelationIntersectVisitor
name|ConstantRelationIntersectVisitor
parameter_list|(
name|Relation
name|relation
...
DECL|interface|DocValuesIteratorSupplier
specifier|private
specifier|static
interface|interface
name|DocValuesIteratorSupplier
block|{
DECL|method|get
...
function_decl|;
block|}
DECL|method|checkDVIterator
specifier|private
specifier|static
name|void
name|checkDVIterator
parameter_list|(
name|FieldInfo
name|fi
parameter_list|,
...
name|doc
operator|+
literal|" was not found through advance() (got: "
operator|+
name|doc2
operator|+
literal|")"
...
name|doc
operator|+
literal|" reports wrong doc ID (got: "
operator|+
name|it2
operator|.
name|docID
...
operator|)
operator|+
literal|" disagrees about whether document exists (got: "
operator|+
name|found
operator|+
literal|")"
...
operator|)
operator|+
literal|" has unstable advanceExact"
argument_list|)
throw|;
block|}
if|if
...
name|RuntimeException
argument_list|(
literal|"binary dv iterator for field: "
operator|+
name|fieldName
operator|+
literal|" should start at docID=-1, but got "
operator|+
name|bdv
operator|.
name|docID
...
throw|;
block|}
comment|// TODO: we could add stats to DVs, e.g. total doc count w/ a value for this field
while|while
condition|(
operator|(
name|doc
...
name|RuntimeException
argument_list|(
literal|"sorted dv iterator for field: "
operator|+
name|fieldName
operator|+
literal|" should start at docID=-1, but got "
...
name|RuntimeException
argument_list|(
literal|"sorted numeric dv for field: "
operator|+
name|fieldName
operator|+
literal|" returned docValueCount=0 for docID="
operator|+
name|docID
argument_list|)
throw|;
