...
condition|)
block|{
comment|// Also test with the 1 doc deleted; we only do this for first doc because this really is just looking for a [slightly] buggy
comment|// TermVectors impl that fails to respect the incoming live docs:
name|checkFields
argument_list|(
name|tfv
argument_list|,
