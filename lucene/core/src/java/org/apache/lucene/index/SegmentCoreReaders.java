...
name|field
operator|+
literal|"\" was not indexed as a numeric doc values field"
argument_list|)
throw|;
block|}
if|if
...
name|field
operator|+
literal|"\" was not indexed as a binary doc values field"
argument_list|)
throw|;
block|}
if|if
...
name|field
operator|+
literal|"\" was not indexed as a sorted doc values field"
argument_list|)
throw|;
block|}
if|if
...
name|IOException
block|{
comment|//System.out.println("core.decRef seg=" + owner.getSegmentInfo() + " rc=" + ref);
if|if
condition|(
name|ref
operator|.
