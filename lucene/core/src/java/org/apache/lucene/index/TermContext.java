...
expr_stmt|;
block|}
comment|/**    * Expert: Registers and associates a {@link TermState} with an leaf ordinal. The    * leaf ordinal should be derived from a {@link IndexReaderContext}'s leaf ord.    * On the contrary to {@link #register(TermState, int, int, long)} this method    * does NOT update term statistics.    */
DECL|method|register
specifier|public
name|void
name|register
...
expr_stmt|;
block|}
comment|/** Expert: Accumulate term statistics. */
DECL|method|accumulateStatistics
specifier|public
name|void
name|accumulateStatistics
parameter_list|(
