...
name|AssertionError
argument_list|(
literal|"wrapForMerge should be called from MergeThread. Current thread: "
operator|+
name|mergeThread
argument_list|)
throw|;
block|}
comment|// Return a wrapped Directory which has rate-limited output.
name|RateLimiter
name|rateLimiter
init|=
operator|(
...
name|context
assert|;
comment|// Because rateLimiter is bound to a particular merge thread, this method should
comment|// always be called from that context. Verify this.
assert|assert
name|mergeThread
operator|==
name|Thread
...
argument_list|()
operator|:
literal|"Not the same merge thread, current="
operator|+
name|Thread
operator|.
name|currentThread
