...
name|longOrds
decl_stmt|;
DECL|field|sharedReader
specifier|private
name|OfflinePointReader
name|sharedReader
decl_stmt|;
DECL|field|nextSharedRead
specifier|private
name|long
name|nextSharedRead
decl_stmt|;
...
name|expectedCount
decl_stmt|;
comment|/** Create a new writer with an unknown number of incoming points */
...
argument_list|)
expr_stmt|;
comment|// Make sure the OfflinePointReader intends to verify its checksum:
assert|assert
name|sharedReader
operator|.
name|in
...
condition|)
block|{
comment|// At this point, the shared reader should have done a full sweep of the file:
assert|assert
name|nextSharedRead
operator|==
name|count
