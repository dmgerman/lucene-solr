...
expr_stmt|;
block|}
comment|/** Get a value from this buffer.     *<p>    *<b>NOTE</b>: This class is not really designed for random access!    *  You will likely get better performance by using packed ints in another way! */
DECL|method|get
specifier|public
name|long
name|get
...
argument_list|()
assert|;
comment|// TODO: do a better check, and throw IndexOutOfBoundsException?
comment|// This class is currently only used by the indexer.
name|int
name|block
init|=
name|index
