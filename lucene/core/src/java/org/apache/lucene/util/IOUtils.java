...
name|AssertionError
argument_list|(
literal|"rethrow argument must not be null."
argument_list|)
throw|;
block|}
if|if
...
block|}
block|}
comment|/**    * @deprecated This method is deprecated in favor of {@link #rethrowAlways}. Code should    * be updated to {@link #rethrowAlways} and guarded with an additional null-argument check    * (because {@link #rethrowAlways} is not accepting null arguments).     */
annotation|@
name|Deprecated
