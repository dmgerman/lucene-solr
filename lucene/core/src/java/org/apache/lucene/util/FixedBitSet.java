...
expr_stmt|;
block|}
comment|/**    * Makes a full copy of the bits, while allowing to expand/shrink the bitset.    * If {@code numBits&lt; other.numBits}, then only the first {@code numBits}    * are copied from other.    */
DECL|method|FixedBitSet
specifier|public
name|FixedBitSet
parameter_list|(
...
parameter_list|()
block|{
comment|// define locally so we don't have "enclosing acces" issue
specifier|final
name|long
index|[]
name|bits
