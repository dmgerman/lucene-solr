...
return|;
block|}
comment|/**      * Computes how many blocks are needed to store<code>values</code> values      * of size<code>bitsPerValue</code>.      */
DECL|method|nblocks
specifier|public
specifier|abstract
name|int
...
parameter_list|()
function_decl|;
comment|/**      * The number of values that can be stored in<code>blocks()</code> long      * blocks.      */
DECL|method|values
name|int
name|values
parameter_list|()
function_decl|;
comment|/**      * Read<code>iterations * blocks()</code> blocks from<code>blocks</code>,      * decode them and write<code>iterations * values()</code> values into      *<code>values</code>.      *      * @param blocks       the long blocks that hold packed integer values      * @param values       the values buffer      * @param iterations   controls how much data to decode      */
DECL|method|decode
name|void
name|decode
parameter_list|(
...
parameter_list|)
function_decl|;
comment|/**      * Read<code>iterations * blocks()</code> blocks from<code>blocks</code>,      * decode them and write<code>iterations * values()</code> values into      *<code>values</code>. This method will throw an      * {@link UnsupportedOperationException} if the values require more than      * 32 bits of storage.      *      * @param blocks       the long blocks that hold packed integer values      * @param values       the values buffer      * @param iterations   controls how much data to decode      */
DECL|method|decode
name|void
name|decode
parameter_list|(
...
parameter_list|()
function_decl|;
comment|/**      * Read<code>iterations * values()</code> values from<code>values</code>,      * encode them and write<code>iterations * blocks()</code> blocks into      *<code>blocks</code>.      *      * @param blocks       the long blocks that hold packed integer values      * @param values       the values buffer      * @param iterations   controls how much data to encode      */
DECL|method|encode
name|void
name|encode
parameter_list|(
...
return|;
block|}
comment|/**    * Expert: Construct a direct {@link Reader} from a stream without reading    * metadata at the beginning of the stream. This method is useful to restore    * data from streams which have been created using    * {@link PackedInts#getWriterNoHeader(DataOutput, Format, int, int, int)}.    *</p><p>    * The returned reader will have very little memory overhead, but every call    * to {@link Reader#get(int)} is likely to perform a disk seek.    *    * @param in           the stream to read data from    * @param format       the format used to serialize    * @param version      the version used to serialize the data    * @param valueCount   how many values the stream holds    * @param bitsPerValue the number of bits per value    * @return a direct Reader    * @throws IOException    * @lucene.internal    */
