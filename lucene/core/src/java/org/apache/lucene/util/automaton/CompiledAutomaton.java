...
parameter_list|)
block|{
comment|//automaton.writeDot("/l/la/lucene/core/ca.dot");
if|if
condition|(
name|simplify
condition|)
...
expr_stmt|;
block|}
comment|//System.out.println("finite=" + this.finite);
comment|//System.out.println("\nPRE");
comment|//automaton.writeDot("/l/la/lucene/core/ain.dot");
comment|//System.out.println("\nNOW BUILD");
comment|//la.writeDot("/l/la/lucene/core/la.dot");
name|LightAutomaton
name|utf8
init|=
operator|new
...
comment|// commonSuffixRef = SpecialOperations.getCommonSuffixBytesRef(utf8);
name|commonSuffixRef
operator|=
literal|null
expr_stmt|;
...
parameter_list|)
block|{
comment|//System.out.println("CA simplify=" + simplify);
comment|//automaton.writeDot("ca");
if|if
condition|(
name|simplify
condition|)
...
expr_stmt|;
block|}
comment|//System.out.println("CHECK PREFIX: commonPrefix=" + commonPrefix);
if|if
condition|(
name|singleton
operator|!=
