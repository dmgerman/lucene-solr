...
condition|)
block|{
comment|// we have a graph query that has at least one boolean sub-query
comment|// re-build and set minimum should match on each boolean found
name|List
argument_list|<
name|Query
argument_list|>
...
return|;
block|}
comment|/**    * Creates a query from a graph token stream by extracting all the finite strings from the graph and using them to create the query.    */
DECL|method|analyzeGraph
specifier|protected
name|Query
name|analyzeGraph
parameter_list|(
