...
condition|)
block|{
comment|// fits within current buffer
name|System
operator|.
name|arraycopy
argument_list|(
...
block|{
comment|// fill up this buffer and move to next one
if|if
condition|(
name|bufferLeft
operator|>
...
block|}
block|}
comment|/** Read a single byte at the given {@code offset}. */
