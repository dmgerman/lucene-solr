...
parameter_list|)
block|{
comment|// NOTE: block-size was previously calculated as
comment|// valueCount * bitsPerValue / BLOCK_SIZE + 1
comment|// due to memory layout requirements dictated by non-branching code
name|this
argument_list|(
operator|new
name|long
...
index|]
expr_stmt|;
comment|// Previously +1 due to non-conditional tricks
for|for
control|(
name|int
name|i
