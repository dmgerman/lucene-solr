...
expr_stmt|;
block|}
comment|/** Sort out trivial cases and reduce the scope of the merge as much as    *  possible before calling {@link #merge}/ */
DECL|method|runMerge
specifier|private
name|void
name|runMerge
parameter_list|(
...
condition|)
block|{
comment|// all values from the first run are below all values from the 2nd run
comment|// this shortcut makes mergeSort run in linear time on sorted arrays
return|return;
block|}
while|while
condition|(
