...
parameter_list|()
function_decl|;
comment|/** Return the number of leaves below the current node. */
DECL|method|getNumLeaves
specifier|public
name|int
name|getNumLeaves
parameter_list|()
...
condition|)
block|{
comment|// both are on the same level
name|numLeaves
operator|=
name|rightMostLeafNode
operator|-
...
block|{
comment|// left is one level deeper than right
name|numLeaves
operator|=
name|rightMostLeafNode
operator|-
...
condition|)
block|{
comment|// could be>MAX_VALUE if there are more than 2B points in total
name|state
operator|.
name|visitor
operator|.
...
argument_list|()
decl_stmt|;
comment|// No need to call grow(), it has been called up-front
if|if
condition|(
name|version
operator|<
