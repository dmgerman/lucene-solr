...
condition|)
block|{
comment|/**        * If all readers are compressed and they have the same fieldinfos then we can merge the serialized document        * directly.        */
name|List
argument_list|<
name|CompressingStoredFieldsMergeSub
argument_list|>
name|subs
init|=
operator|new
...
return|;
block|}
DECL|class|CompressingStoredFieldsMergeSub
specifier|private
specifier|static
class|class
name|CompressingStoredFieldsMergeSub
...
literal|1
decl_stmt|;
DECL|method|CompressingStoredFieldsMergeSub
specifier|public
name|CompressingStoredFieldsMergeSub
parameter_list|(
name|CompressingStoredFieldsReader
