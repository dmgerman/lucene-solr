...
literal|128
decl_stmt|;
comment|/** Creates {@code TempBlockTreePostingsFormat} with default    *  settings. */
DECL|method|TempBlockTreePostingsFormat
specifier|public
name|TempBlockTreePostingsFormat
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/** Creates {@code TempBlockTreePostingsFormat} with custom    *  values for {@code minBlockSize} and {@code    *  maxBlockSize} passed to block terms dictionary.    *  @see TempBlockTreeTermsWriter#TempBlockTreeTermsWriter(SegmentWriteState,TempPostingsWriterBase,int,int) */
DECL|method|TempBlockTreePostingsFormat
specifier|public
name|TempBlockTreePostingsFormat
parameter_list|(
