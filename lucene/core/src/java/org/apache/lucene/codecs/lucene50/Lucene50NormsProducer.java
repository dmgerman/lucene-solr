...
name|CorruptIndexException
argument_list|(
literal|"TABLE_COMPRESSED only supports bpv=1, bpv=2 and bpv=4, got="
operator|+
name|bitsPerValue
argument_list|,
name|data
...
name|CorruptIndexException
argument_list|(
literal|"PATCHED_TABLE only supports bpv=2 and bpv=4, got="
operator|+
name|bitsPerValue
argument_list|,
name|data
...
try|try
block|{
comment|// doing a try/catch here eliminates a seemingly unavoidable branch in hotspot...
return|return
name|decode
index|[
name|ord
