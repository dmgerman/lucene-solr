...
begin_comment
comment|/**  * Implements the Lucene 7.0 index format, with configurable per-field postings  * and docvalues formats.  *<p>  * If you want to reuse functionality of this codec in another codec, extend  * {@link FilterCodec}.  *  * @see org.apache.lucene.codecs.lucene70 package documentation for file format details.  *  * @lucene.experimental  */
end_comment

begin_class
DECL|class|Lucene70Codec
specifier|public
class|class
name|Lucene70Codec
extends|extends
...
return|;
block|}
comment|/** Returns the docvalues format that should be used for writing     *  new segments of<code>field</code>.    *      *  The default implementation always returns "Lucene70".    *<p>    *<b>WARNING:</b> if you subclass, you are responsible for index     *  backwards compatibility: future version of Lucene are only     *  guaranteed to be able to read the default implementation.     */
