...
literal|128
decl_stmt|;
comment|/** Creates {@code TempBlockPostingsFormat} with default    *  settings. */
DECL|method|TempBlockPostingsFormat
specifier|public
name|TempBlockPostingsFormat
parameter_list|()
block|{
...
expr_stmt|;
block|}
comment|/** Creates {@code TempBlockPostingsFormat} with custom    *  values for {@code minBlockSize} and {@code    *  maxBlockSize} passed to block terms dictionary.    *  @see TempBlockTermsWriter#TempBlockTermsWriter(SegmentWriteState,TempPostingsWriterBase,int,int) */
DECL|method|TempBlockPostingsFormat
specifier|public
name|TempBlockPostingsFormat
parameter_list|(
