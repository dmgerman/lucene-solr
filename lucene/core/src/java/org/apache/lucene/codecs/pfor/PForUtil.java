...
comment|// TODO: exception num should never be equal with uncompressed int num!!!
comment|// first exception ranges from -1 ~ 255
comment|// the problem is that we don't need first exception to be -1 ...
comment|// it is ok to range from 0~255, and judge exception for exception num (0~255)
comment|// uncompressed int num: (1~256)
