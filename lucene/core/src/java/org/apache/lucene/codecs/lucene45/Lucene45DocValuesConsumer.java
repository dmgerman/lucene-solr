...
literal|2
decl_stmt|;
comment|/** Compressed using just bitpacked integers */
DECL|field|BITPACK_COMPRESSED
specifier|public
specifier|static
specifier|final
name|int
name|BITPACK_COMPRESSED
init|=
literal|3
decl_stmt|;
...
expr_stmt|;
block|}
comment|// packed ints doesnt support valueCount> maxValue, and
comment|// we must represent missing ordinal (-1)
if|if
condition|(
name|count
operator|<
