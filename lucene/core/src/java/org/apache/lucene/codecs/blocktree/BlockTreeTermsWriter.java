...
argument_list|)
expr_stmt|;
comment|// So at read time we know, globally, that there will be no auto-prefix terms:
if|if
condition|(
name|minItemsInAutoPrefix
operator|==
