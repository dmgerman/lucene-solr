...
condition|)
block|{
comment|// dense but split into blocks of different bits per value
specifier|final
name|int
name|shift
init|=
...
condition|)
block|{
comment|// sparse and split into blocks of different bits per value
specifier|final
name|int
name|shift
init|=
...
name|block
operator|:
literal|"Reading backwards is illegal: "
operator|+
name|this
operator|.
name|block
