...
return|;
block|}
comment|/** Create a predicate that checks whether points are within a polygon.    *  It works the same way as {@link #createDistancePredicate}.    *  @lucene.internal */
DECL|method|createPolygonPredicate
specifier|public
specifier|static
name|PolygonPredicate
name|createPolygonPredicate
parameter_list|(
name|Polygon
index|[]
name|polygons
...
condition|)
block|{
comment|// the box cannot match any quantized point
return|return
operator|new
name|Grid
argument_list|(
...
block|}
block|}
comment|/** A predicate that checks whether a given point is within a polygon. */
DECL|class|PolygonPredicate
specifier|public
specifier|static
class|class
name|PolygonPredicate
...
expr_stmt|;
block|}
comment|/** Check whether the given point is within the considered polygon.      *  NOTE: this operates directly on the encoded representation of points. */
DECL|method|test
specifier|public
name|boolean
name|test
