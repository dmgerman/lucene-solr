...
expr_stmt|;
block|}
DECL|method|testEndsWithHole
specifier|public
name|void
name|testEndsWithHole
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
comment|/** Returns all paths */
DECL|method|toPathStrings
specifier|private
name|Set
argument_list|<
name|String
...
name|fail
argument_list|(
literal|"accepted language is different:\n\n"
operator|+
name|b
operator|.
name|toString
...
block|}
block|}
DECL|method|testTokenStreamGraphWithHoles
specifier|public
name|void
name|testTokenStreamGraphWithHoles
parameter_list|()
throws|throws
name|Exception
block|{
