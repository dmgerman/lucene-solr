...
expr_stmt|;
block|}
comment|/**    * Should not encode extra information other than header    */
DECL|method|testPForAllZeros
specifier|public
name|void
name|testPForAllZeros
parameter_list|()
throws|throws
name|Exception
block|{
...
assert|;
block|}
DECL|method|testForAllZeros
specifier|public
name|void
name|testForAllZeros
parameter_list|()
throws|throws
name|Exception
block|{
...
operator|)
assert|;
comment|// at least we have a header along with an exception, right?
name|resBuffer
operator|.
name|rewind
argument_list|()
