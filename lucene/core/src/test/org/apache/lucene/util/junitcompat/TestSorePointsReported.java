...
begin_class
DECL|class|TestSorePointsReported
specifier|public
class|class
name|TestSorePointsReported
extends|extends
...
block|}
comment|/*    * ASSUMPTIONS.    */
DECL|method|TestSorePointsReported
specifier|public
name|TestSorePointsReported
parameter_list|()
block|{
...
argument_list|()
decl_stmt|;
comment|// syserr.println("Type: " + type + ", point: " + where + " resulted in:\n" + err);
return|return
name|err
return|;
block|}
