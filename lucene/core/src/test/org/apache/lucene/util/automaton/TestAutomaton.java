...
expr_stmt|;
block|}
comment|// NOTE: This can add a dead state:
name|a
operator|=
name|Operations
operator|.
...
expr_stmt|;
block|}
comment|/** Runs topo sort, verifies transitions then only "go forwards", and    *  builds and returns new automaton with those remapped toposorted states. */
DECL|method|verifyTopoSort
specifier|private
name|Automaton
name|verifyTopoSort
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// This can be< if we removed dead states:
name|assertTrue
argument_list|(
name|sorted
operator|.
...
argument_list|)
expr_stmt|;
comment|// Each state should only appear once in the sort:
name|assertEquals
argument_list|(
operator|-
literal|1
...
expr_stmt|;
block|}
comment|// 2nd pass: add new transitions
for|for
control|(
name|int
name|state
...
return|;
block|}
DECL|method|makeBinaryInterval
specifier|private
name|Automaton
...
name|println
argument_list|(
literal|"Original was not minimal:"
argument_list|)
expr_stmt|;
name|System
operator|.
...
return|;
block|}
DECL|method|testMakeBinaryIntervalFiniteCasesBasic
specifier|public
name|void
name|testMakeBinaryIntervalFiniteCasesBasic
parameter_list|()
throws|throws
name|Exception
block|{
comment|// 0 (incl) - 00 (incl)
name|byte
index|[]
name|zeros
init|=
...
expr_stmt|;
block|}
DECL|method|testMakeBinaryIntervalFiniteCasesRandom
specifier|public
name|void
name|testMakeBinaryIntervalFiniteCasesRandom
parameter_list|()
throws|throws
name|Exception
block|{
...
block|{
comment|// Enumerate all finite strings and verify the count matches what we expect:
name|assertEquals
argument_list|(
name|expectedCount
argument_list|,
...
block|}
block|}
DECL|method|testMakeBinaryIntervalRandom
specifier|public
name|void
name|testMakeBinaryIntervalRandom
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|method|testMakeBinaryIntervalBasic
specifier|public
name|void
name|testMakeBinaryIntervalBasic
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMakeBinaryIntervalEqual
specifier|public
name|void
name|testMakeBinaryIntervalEqual
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMakeBinaryIntervalCommonPrefix
specifier|public
name|void
name|testMakeBinaryIntervalCommonPrefix
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMakeBinaryIntervalOpenMax
specifier|public
name|void
name|testMakeBinaryIntervalOpenMax
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMakeBinaryIntervalOpenMin
specifier|public
name|void
name|testMakeBinaryIntervalOpenMin
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testMakeBinaryIntervalOpenBoth
specifier|public
name|void
name|testMakeBinaryIntervalOpenBoth
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testAcceptAllEmptyStringMin
specifier|public
name|void
name|testAcceptAllEmptyStringMin
parameter_list|()
throws|throws
name|Exception
block|{
...
return|;
block|}
DECL|method|testGetSingleton
specifier|public
name|void
name|testGetSingleton
parameter_list|()
block|{
name|int
name|iters
...
block|}
block|}
DECL|method|testGetSingletonEmptyString
specifier|public
name|void
name|testGetSingletonEmptyString
parameter_list|()
block|{
name|Automaton
name|a
...
expr_stmt|;
block|}
DECL|method|testGetSingletonNothing
specifier|public
name|void
name|testGetSingletonNothing
parameter_list|()
block|{
name|Automaton
name|a
...
expr_stmt|;
block|}
DECL|method|testGetSingletonTwo
specifier|public
name|void
name|testGetSingletonTwo
parameter_list|()
block|{
name|Automaton
name|a
