...
block|}
block|}
comment|// LUCENE-3590, AIOOBE if you append to a charsref with offset != 0
...
expr_stmt|;
block|}
comment|// LUCENE-3590, AIOOBE if you copy to a charsref with offset != 0
DECL|method|testCopyChars
specifier|public
name|void
name|testCopyChars
parameter_list|()
...
block|}
comment|// LUCENE-3590, AIOOBE if you copy to a charsref with offset != 0
DECL|method|testCopyCharsRef
specifier|public
name|void
name|testCopyCharsRef
parameter_list|()
block|{
name|char
name|chars
