...
begin_comment
comment|// OfflineSorter should not call my BytesSequencesReader.next() again after it already returned null:
end_comment

begin_function
DECL|method|testOverNexting
specifier|public
name|void
name|testOverNexting
parameter_list|()
throws|throws
name|Exception
block|{
...
name|IOException
block|{
comment|// if we returned null already, OfflineSorter should not call next() again
name|assertFalse
argument_list|(
name|alreadyEnded
argument_list|)
