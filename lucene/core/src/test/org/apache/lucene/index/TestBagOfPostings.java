...
argument_list|)
decl_stmt|;
comment|//System.out.println("maxTermsPerDoc=" + maxTermsPerDoc);
comment|//System.out.println("numTerms=" + numTerms);
for|for
control|(
name|int
name|i
...
argument_list|)
decl_stmt|;
comment|//System.out.println("threadCount=" + threadCount);
name|Thread
index|[]
name|threads
init|=
