...
argument_list|()
expr_stmt|;
comment|// System.out.println("TEST: after rollback: " + Arrays.toString(dir.listAll()));
name|writer
operator|=
operator|new
name|IndexWriter
...
expr_stmt|;
block|}
comment|// LUCENE-7335: make sure commit data is late binding
DECL|method|testCommitDataIsLive
specifier|public
name|void
name|testCommitDataIsLive
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// make sure "foo" / "bar" doesn't take
name|w
operator|.
name|setLiveCommitData
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// this finally does the commit, and should burn "boo" / "baz"
name|w
operator|.
name|close
argument_list|()
