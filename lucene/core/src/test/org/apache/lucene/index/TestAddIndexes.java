...
expr_stmt|;
block|}
DECL|method|testIllegalIndexSortChange1
specifier|public
name|void
name|testIllegalIndexSortChange1
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// so the index sort is in fact burned into the index:
name|w1
operator|.
name|forceMerge
argument_list|(
...
name|assertEquals
argument_list|(
literal|"cannot change index sort from<int: \"foo\"> to<string: \"foo\">"
argument_list|,
name|message
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|testIllegalIndexSortChange2
specifier|public
name|void
name|testIllegalIndexSortChange2
parameter_list|()
throws|throws
name|Exception
block|{
