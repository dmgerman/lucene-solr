...
block|}
block|}
comment|// here we do better, there is no current segments file, so we don't delete anything.
comment|// however, if you actually go and make a commit, the next time you run indexwriter
comment|// this file will be gone.
DECL|method|testOtherFiles2
specifier|public
name|void
name|testOtherFiles2
parameter_list|()
throws|throws
name|Throwable
block|{
