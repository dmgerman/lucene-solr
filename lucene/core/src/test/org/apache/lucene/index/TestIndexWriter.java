...
argument_list|)
decl_stmt|;
comment|// When interrupt arrives in w.shutdown(), this can
...
argument_list|(
operator|new
name|RandomFailingFieldIterable
argument_list|(
name|docs
argument_list|,
name|random
...
expr_stmt|;
block|}
DECL|class|RandomFailingFieldIterable
specifier|private
specifier|static
class|class
name|RandomFailingFieldIterable
...
name|random
decl_stmt|;
DECL|method|RandomFailingFieldIterable
specifier|public
name|RandomFailingFieldIterable
parameter_list|(
name|List
...
expr_stmt|;
block|}
DECL|method|testUncommittedChanges
specifier|public
name|void
name|testUncommittedChanges
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|// If version is< 50 IW.close should throw an exception
comment|// on uncommitted changes:
name|IndexWriterConfig
name|iwc
init|=
name|newIndexWriterConfig
...
name|contains
argument_list|(
literal|"this writer is closed, but some pending changes or running merges were discarded"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
decl_stmt|;
comment|// If version is< 50 IW.close should throw an exception
comment|// on still-running merges:
name|IndexWriterConfig
name|iwc
init|=
name|newIndexWriterConfig
