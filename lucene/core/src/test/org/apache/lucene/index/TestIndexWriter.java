...
argument_list|)
decl_stmt|;
comment|// NOTE: on Unix, we cannot use MMapDir, because WindowsFS doesn't see/think it keeps file handles open.  Yet, on Windows, we MUST use
comment|// MMapDir because the windows OS will in fact prevent file deletion for us, and fails otherwise:
name|FSDirectory
name|dir
decl_stmt|;
if|if
...
block|{
comment|// now FSDir can remove it
name|dir
operator|.
...
argument_list|)
decl_stmt|;
comment|// use an infostream that "takes a long time" to commit
specifier|final
name|IndexWriter
name|iw
init|=
...
expr_stmt|;
block|}
DECL|method|testManySeparateThreads
specifier|public
name|void
name|testManySeparateThreads
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Index 100 docs, each from a new thread, but always only 1 thread is in IW at once:
for|for
control|(
name|int
name|i
...
block|}
comment|// LUCENE-6505
DECL|method|testNRTSegmentsFile
specifier|public
name|void
name|testNRTSegmentsFile
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// creates segments_1
name|w
operator|.
name|commit
argument_list|()
expr_stmt|;
comment|// newly opened NRT reader should see gen=1 segments file
name|DirectoryReader
name|r
init|=
name|DirectoryReader
...
argument_list|)
expr_stmt|;
comment|// newly opened non-NRT reader should see gen=1 segments file
name|DirectoryReader
name|r2
init|=
name|DirectoryReader
...
argument_list|()
expr_stmt|;
comment|// make a change and another commit
name|w
operator|.
name|addDocument
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// reopened NRT reader should see gen=2 segments file
name|assertEquals
argument_list|(
literal|2
argument_list|,
...
argument_list|()
expr_stmt|;
comment|// newly opened non-NRT reader should see gen=2 segments file
name|DirectoryReader
name|r4
init|=
name|DirectoryReader
...
block|}
comment|// LUCENE-6505
DECL|method|testNRTAfterCommit
specifier|public
name|void
name|testNRTAfterCommit
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// commit even with no other changes counts as a "change" that NRT reader reopen will see:
name|DirectoryReader
name|r2
init|=
name|DirectoryReader
...
block|}
comment|// LUCENE-6505
DECL|method|testNRTAfterSetUserDataWithoutCommit
specifier|public
name|void
name|testNRTAfterSetUserDataWithoutCommit
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// setLiveCommitData with no other changes should count as an NRT change:
name|DirectoryReader
name|r2
init|=
name|DirectoryReader
...
block|}
comment|// LUCENE-6505
DECL|method|testNRTAfterSetUserDataWithCommit
specifier|public
name|void
name|testNRTAfterSetUserDataWithCommit
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
expr_stmt|;
comment|// setLiveCommitData and also commit, with no other changes, should count as an NRT change:
name|DirectoryReader
name|r2
init|=
name|DirectoryReader
...
block|}
comment|// LUCENE-6523
DECL|method|testCommitImmediatelyAfterNRTReopen
specifier|public
name|void
name|testCommitImmediatelyAfterNRTReopen
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// segments_N should have changed:
name|assertFalse
argument_list|(
name|r2
operator|.
...
expr_stmt|;
block|}
DECL|method|testWithPendingDeletions
specifier|public
name|void
name|testWithPendingDeletions
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Use WindowsFS to prevent open files from being deleted:
name|FileSystem
name|fs
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// MMapDirectory doesn't work because it closes its file handles after mapping!
try|try
init|(
name|FSDirectory
name|dir
...
argument_list|)
expr_stmt|;
comment|// make sure we get NFSF if we try to delete and already-pending-delete file:
name|expectThrows
argument_list|(
name|NoSuchFileException
operator|.
...
block|}
block|}
DECL|method|testLeftoverTempFiles
specifier|public
name|void
name|testLeftoverTempFiles
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Make sure IW deleted the unref'd file:
try|try
block|{
name|dir
operator|.
...
name|Ignore
argument_list|(
literal|"requires running tests with biggish heap"
argument_list|)
DECL|method|testMassiveField
specifier|public
name|void
name|testMassiveField
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|//doc.add(new TextField("big", b.toString(), Field.Store.YES));
name|doc
operator|.
name|add
argument_list|(
...
name|assertEquals
argument_list|(
literal|"stored field \"big\" is too large ("
operator|+
name|b
operator|.
name|length
...
argument_list|)
expr_stmt|;
comment|// make sure writer is still usable:
name|Document
name|doc2
init|=
operator|new
...
expr_stmt|;
block|}
DECL|method|testRecordsIndexCreatedVersion
specifier|public
name|void
name|testRecordsIndexCreatedVersion
parameter_list|()
throws|throws
name|IOException
block|{
