...
begin_comment
comment|// TODO: randomize the bkd settings w/ Lucene60DimensionalFormat
end_comment

begin_comment
comment|// TODO: factor out a BaseTestDimensionFormat
end_comment
...
expr_stmt|;
block|}
comment|// TODO: enable this, but not using simple text:
comment|/*   @Nightly   public void testRandomBinaryBig() throws Exception {     doTestRandomBinary(200000);   }   */
...
name|assertEquals
argument_list|(
literal|"numDims must be 1 .. 255 (got: 256)"
argument_list|,
name|iae
operator|.
name|getMessage
...
expr_stmt|;
block|}
comment|//System.out.println("DIR: " + ((FSDirectory) dir).getDirectory());
comment|//IndexWriterConfig iwc = new IndexWriterConfig(new MockAnalyzer(random()));
name|IndexWriterConfig
name|iwc
init|=
name|newIndexWriterConfig
argument_list|()
decl_stmt|;
comment|//iwc.setUseCompoundFile(false);
comment|//iwc.getMergePolicy().setNoCFSRatio(0.0);
name|iwc
operator|.
name|setCodec
argument_list|(
...
argument_list|()
expr_stmt|;
comment|//System.out.println("TEST: r=" + r);
name|DimensionalValues
name|dimValues
init|=
name|MultiDimensionalValues
...
control|)
block|{
comment|//System.out.println("  dim=" + dim + " value=" + new BytesRef(packedValue, dim*bytesPerDim, bytesPerDim));
if|if
condition|(
name|BKDUtil
operator|.
