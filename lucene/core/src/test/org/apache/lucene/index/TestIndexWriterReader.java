...
expr_stmt|;
block|}
DECL|method|testSimpleMergedSegmentWramer
specifier|public
name|void
name|testSimpleMergedSegmentWramer
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// If we get TieredMP and it's maxMergedSegmentMB is 0
comment|// then this test falsely fails:
if|if
condition|(
name|mp
operator|instanceof
