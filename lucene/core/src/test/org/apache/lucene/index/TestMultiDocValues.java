...
argument_list|)
expr_stmt|;
comment|// this makes a sorted segment:
name|w
operator|.
name|forceMerge
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// this makes another segment, so that MultiDocValues isn't just a no-op:
name|w
operator|.
name|addDocument
argument_list|(
...
name|contains
argument_list|(
literal|"cannot handle index sort"
argument_list|)
argument_list|)
expr_stmt|;
name|assertTrue
