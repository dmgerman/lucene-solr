...
expr_stmt|;
block|}
comment|// if field's value was unset before, unset it from all new added documents too
for|for
control|(
name|int
name|field
...
condition|)
block|{
comment|//        System.out.println("[" + Thread.currentThread().getName() + "]: unset field '" + updateField + "'");
name|fieldHasValue
index|[
name|fieldIdx
index|]
...
condition|)
block|{
comment|// sometimes unset a value
comment|//                System.err.println("[" + Thread.currentThread().getName() + "] t=" + t + ", f=" + f + ", updValue=UNSET");
name|writer
operator|.
name|updateBinaryDocValue
argument_list|(
