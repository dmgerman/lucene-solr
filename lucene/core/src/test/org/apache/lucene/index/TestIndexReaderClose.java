...
block|}
block|}
DECL|method|testRegisterListenerOnClosedReader
specifier|public
name|void
name|testRegisterListenerOnClosedReader
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
expr_stmt|;
comment|// The reader is open, everything should work
name|r
operator|.
name|getReaderCacheHelper
argument_list|()
