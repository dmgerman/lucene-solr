...
expr_stmt|;
block|}
DECL|method|testMaxFixedLength
specifier|public
name|void
name|testMaxFixedLength
parameter_list|()
throws|throws
name|Exception
block|{
...
decl_stmt|;
name|int
name|actualFixedLength
init|=
operator|-
literal|2
decl_stmt|;
name|int
name|actualMaxLength
init|=
operator|-
literal|1
decl_stmt|;
...
argument_list|)
expr_stmt|;
comment|// No field cache insanity because close purges FC entries:
name|r
operator|.
name|close
argument_list|()
