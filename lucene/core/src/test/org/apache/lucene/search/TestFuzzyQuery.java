...
argument_list|()
decl_stmt|;
comment|//System.out.println("TEST: reader=" + r);
name|IndexSearcher
name|s
init|=
name|newSearcher
...
argument_list|)
decl_stmt|;
comment|/*         System.out.println("\nTEST: query=" + queryTerm + " ed=" + ed + " queueSize=" + queueSize + " vs expected match size=" + expected[ed].size() + " prefixLength=" + prefixLength);         for(TermAndScore ent : expected[ed]) {           System.out.println("  " + ent);         }         */
name|FuzzyQuery
name|query
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|//System.out.println("   actual: " + doc.get("field") + " score=" + hit.score);
block|}
name|Set
argument_list|<
name|String
...
name|queueSize
operator|+
literal|" vs expected match size="
operator|+
name|expected
index|[
name|ed
...
parameter_list|)
block|{
comment|// higher score sorts first, and if scores are tied, lower term sorts first
if|if
condition|(
name|score
operator|>
