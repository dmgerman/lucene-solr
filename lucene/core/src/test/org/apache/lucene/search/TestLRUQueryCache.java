...
expr_stmt|;
block|}
comment|/**    * Tests CachingWrapperWeight.scorer() propagation of {@link QueryCachingPolicy#onUse(Query)} when the first segment    * is skipped.    *    * #f:foo #f:bar causes all frequencies to increment    * #f:bar #f:foo does not increment the frequency for f:foo    */
DECL|method|testOnUseWithRandomFirstSegmentSkipping
specifier|public
name|void
name|testOnUseWithRandomFirstSegmentSkipping
parameter_list|()
throws|throws
name|IOException
block|{
...
block|}
block|}
DECL|class|FrequencyCountingPolicy
specifier|private
specifier|static
class|class
name|FrequencyCountingPolicy
...
name|FilterWeight
block|{
DECL|field|scorerCalled
specifier|private
specifier|final
name|AtomicBoolean
name|scorerCalled
decl_stmt|;
DECL|field|bulkScorerCalled
specifier|private
specifier|final
name|AtomicBoolean
name|bulkScorerCalled
decl_stmt|;
DECL|method|WeightWrapper
specifier|protected
name|WeightWrapper
parameter_list|(
name|Weight
...
block|}
block|}
DECL|method|testPropagateBulkScorer
specifier|public
name|void
name|testPropagateBulkScorer
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// test that the bulk scorer is propagated when a scorer should not be cached
name|Weight
name|weight
init|=
name|searcher
...
argument_list|)
expr_stmt|;
comment|// test that the doc id set is computed using the bulk scorer
name|bulkScorerCalled
operator|.
name|set
argument_list|(
...
expr_stmt|;
block|}
DECL|method|testEvictEmptySegmentCache
specifier|public
name|void
name|testEvictEmptySegmentCache
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
expr_stmt|;
comment|// make sure this does not trigger eviction of segment caches with no entries
name|w
operator|.
name|close
argument_list|()
...
expr_stmt|;
block|}
DECL|method|testMinSegmentSizePredicate
specifier|public
name|void
name|testMinSegmentSizePredicate
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// don't cache if the reader does not expose a cache helper
name|assertNull
argument_list|(
name|reader
operator|.
...
name|Query
block|{
DECL|field|scorerCreated
specifier|private
specifier|final
name|AtomicBoolean
name|scorerCreated
decl_stmt|;
DECL|method|DummyQuery2
name|DummyQuery2
parameter_list|(
name|AtomicBoolean
name|scorerCreated
...
block|}
block|}
DECL|method|testPropagatesScorerSupplier
specifier|public
name|void
name|testPropagatesScorerSupplier
parameter_list|()
throws|throws
name|IOException
block|{
