...
expr_stmt|;
block|}
comment|// Duplicate Should and Filter query is converted to Must (with minShouldMatch -1)
DECL|method|testConvertShouldAndFilterToMust
specifier|public
name|void
name|testConvertShouldAndFilterToMust
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// minShouldMatch is set to -1
name|bq
operator|=
operator|new
name|BooleanQuery
...
expr_stmt|;
block|}
comment|// Duplicate Must or Filter with MustNot returns no match
DECL|method|testDuplicateMustOrFilterWithMustNot
specifier|public
name|void
name|testDuplicateMustOrFilterWithMustNot
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// Test Must with MustNot
name|BooleanQuery
name|bq
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Test Filter with MustNot
name|BooleanQuery
name|bq2
init|=
operator|new
...
expr_stmt|;
block|}
comment|// MatchAllQuery as MUST_NOT clause cannot return anything
DECL|method|testMatchAllMustNot
specifier|public
name|void
name|testMatchAllMustNot
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
decl_stmt|;
comment|// Test Must with MatchAll MustNot
name|BooleanQuery
name|bq
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Test Must with MatchAll MustNot and other MustNot
name|BooleanQuery
name|bq2
init|=
operator|new
...
name|assertEquals
argument_list|(
literal|"Set of matching documents differs"
argument_list|,
name|expectedScores
operator|.
name|keySet
