...
expr_stmt|;
block|}
DECL|method|testBooleanBoostPropagation
specifier|public
name|void
name|testBooleanBoostPropagation
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|()
decl_stmt|;
comment|// Applying boost2 over the term or boolean query should have the same effect
name|Query
name|q1
init|=
operator|new
...
expr_stmt|;
block|}
DECL|method|testBooleanOrVsSynonym
specifier|public
name|void
name|testBooleanOrVsSynonym
parameter_list|()
throws|throws
name|Exception
block|{
