...
return|;
block|}
comment|/** Return an anonym class so that ConjunctionDISI cannot optimize it    *  like it does eg. for BitSetIterators. */
DECL|method|anonymizeIterator
specifier|private
specifier|static
name|DocIdSetIterator
name|anonymizeIterator
