...
name|iter
decl_stmt|;
comment|// nocommit add SF.setMissingValue too
annotation|@
name|Override
DECL|method|setUp
specifier|public
...
argument_list|)
expr_stmt|;
comment|// nocommit randomly commit so we exercise segments
block|}
name|reader
operator|=
name|iw
...
name|FIELD_DOC
block|,
comment|// nocommit add RELEVANCE too
block|}
decl_stmt|;
...
condition|)
block|{
comment|// nocommit randomly sometimes doScores& doMaxScore:
name|all
operator|=
name|searcher
operator|.
