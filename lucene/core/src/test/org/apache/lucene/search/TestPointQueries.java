...
argument_list|)
decl_stmt|;
comment|// nocommit multi-valued too
name|int
index|[]
name|docValues
init|=
...
condition|)
block|{
comment|// nocommit fix test to sometimes use "narrow" range of values
name|valuesToQuery
operator|.
name|add
argument_list|(
...
begin_comment
comment|// nocommit fix existing randomized tests to sometimes randomly use PointInSet instead
end_comment

begin_comment
comment|// nocommit need 2D test too
end_comment
...
begin_function
DECL|method|testPointInSetQueryManyEqualValuesBigGap
specifier|public
name|void
name|testPointInSetQueryManyEqualValuesBigGap
parameter_list|()
throws|throws
name|Exception
block|{
