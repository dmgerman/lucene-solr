...
begin_comment
unit|}
comment|/** ensure good exception when boolean[]s for inclusive have wrong length */
end_comment

begin_function
DECL|method|testWrongNumBooleans
unit|public
name|void
name|testWrongNumBooleans
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"lowerInclusive has length=1 but expected=2"
argument_list|,
name|expected
operator|.
name|getMessage
...
name|assertEquals
argument_list|(
literal|"upperInclusive has length=1 but expected=2"
argument_list|,
name|expected
operator|.
name|getMessage
