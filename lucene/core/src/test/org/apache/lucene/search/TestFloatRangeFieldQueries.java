...
begin_comment
comment|/**  * Random testing for FloatRange Queries.  */
end_comment
...
expr_stmt|;
block|}
comment|/** FloatRange test class implementation - use to validate FloatRange */
DECL|class|FloatTestRange
specifier|private
class|class
name|FloatTestRange
extends|extends
