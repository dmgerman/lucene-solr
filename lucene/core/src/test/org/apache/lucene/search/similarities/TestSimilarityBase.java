...
block|}
block|}
comment|/**    * make sure the similarity does not go crazy when tested against all possible norm values.    */
DECL|method|testCrazyIndexTimeBoosts
specifier|public
name|void
name|testCrazyIndexTimeBoosts
parameter_list|()
throws|throws
name|Exception
block|{
...
condition|)
block|{
comment|// score goes infinite for tiny doc lengths and negative for huge doc lengths
...
condition|)
block|{
comment|// score goes NaN for tiny doc lengths
comment|// TODO: fix this
continue|continue;
block|}
elseif|else
...
condition|)
block|{
comment|// score goes negative infinity for tiny doc lengths
comment|// TODO: fix this
continue|continue;
block|}
block|}
