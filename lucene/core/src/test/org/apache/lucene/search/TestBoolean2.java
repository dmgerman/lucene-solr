...
name|Exception
block|{
comment|// in some runs, test immediate adjacency of matches - in others, force a full bucket gap between docs
name|NUM_FILLER_DOCS
operator|=
name|random
argument_list|()
...
name|println
argument_list|(
literal|"TEST: NUM_FILLER_DOCS="
operator|+
name|NUM_FILLER_DOCS
operator|+
literal|" PRE_FILLER_DOCS="
operator|+
name|PRE_FILLER_DOCS
argument_list|)
expr_stmt|;
...
argument_list|)
decl_stmt|;
comment|// randomized codecs are sometimes too costly for this test:
name|iwc
operator|.
name|setCodec
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// we'll make a ton of docs, disable store/norms/vectors
name|FieldType
name|ft
init|=
operator|new
