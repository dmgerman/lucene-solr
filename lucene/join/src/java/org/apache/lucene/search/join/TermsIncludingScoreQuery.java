...
DECL|field|topReaderContextId
specifier|private
specifier|final
name|Object
name|topReaderContextId
decl_stmt|;
...
name|ROOT
argument_list|,
literal|"TermsIncludingScoreQuery{field=%s;fromQuery=%s}"
argument_list|,
name|toField
argument_list|,
name|fromQuery
...
condition|)
block|{
comment|// We don't need scores then quickly change the query:
name|TermsQuery
name|termsQuery
init|=
operator|new
