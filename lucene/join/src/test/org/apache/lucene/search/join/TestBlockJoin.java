...
argument_list|)
decl_stmt|;
comment|// produce a segment that doesn't have a value in the docType field
for|for
control|(
name|int
name|i
...
expr_stmt|;
block|}
DECL|method|testNestedDocScoringWithDeletes
specifier|public
name|void
name|testNestedDocScoringWithDeletes
parameter_list|()
throws|throws
name|Exception
block|{
