...
block|}
comment|// LUCENE-3143
DECL|method|testInvalidFilesToCreateCompound
specifier|public
name|void
name|testInvalidFilesToCreateCompound
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
decl_stmt|;
comment|// Create an index w/ .del file
name|w
operator|.
name|addDocument
argument_list|(
...
argument_list|()
expr_stmt|;
comment|// Assert that SM fails if .del exists
name|SegmentMerger
name|sm
init|=
operator|new
