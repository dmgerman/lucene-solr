...
argument_list|)
expr_stmt|;
comment|// provider.register(new MockSepCodec()); // TODO enable once we have
comment|// files per codec
comment|// provider.register(new PulsingCodec());
for|for
control|(
name|int
name|j
...
argument_list|)
expr_stmt|;
comment|// TODO enable other codecs once possible
block|}
name|IndexWriterConfig
name|config
init|=
