...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": add doc id:" + doc.get("docid"));
block|}
if|if
condition|(
name|random
...
condition|)
block|{
comment|// Add a pack of adjacent sub-docs
specifier|final
name|String
name|packID
decl_stmt|;
...
name|println
argument_list|(
literal|"TEST: update pack packID="
operator|+
name|delSubDocs
operator|.
name|packID
...
argument_list|)
expr_stmt|;
comment|/*                       // non-atomic:                       writer.deleteDocuments(new Term("packID", delSubDocs.packID));                       for(Document subDoc : docsList) {                         writer.addDocument(subDoc);                       }                       */
block|}
else|else
block|{
if|if
...
argument_list|)
expr_stmt|;
comment|/*                       // non-atomic:                       for(Document subDoc : docsList) {                         writer.addDocument(subDoc);                       }                       */
block|}
name|doc
operator|.
name|removeField
...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": buffer del id:" + packID);
block|}
name|toDeleteSubDocs
operator|.
name|add
...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": buffer del id:" + doc.get("docid"));
block|}
name|toDeleteIDs
operator|.
name|add
...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": update doc id:" + doc.get("docid"));
block|}
name|writer
operator|.
name|updateDocument
...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": apply " + toDeleteIDs.size() + " deletes");
block|}
for|for
control|(
name|String
...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": del term=id:" + id);
block|}
name|writer
operator|.
...
condition|)
block|{
comment|//System.out.println(Thread.currentThread().getName() + ": tot " + count + " deletes");
block|}
name|delIDs
operator|.
name|addAll
...
block|}
block|}
comment|// Make sure each group of sub-docs are still in docID order:
for|for
control|(
name|SubDocs
name|subDocs
