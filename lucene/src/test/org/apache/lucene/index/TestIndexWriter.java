...
argument_list|)
expr_stmt|;
comment|// Make sure last term comes before current one, in
comment|// UTF16 sort order
name|int
name|i
init|=
literal|0
...
argument_list|)
operator|+
literal|" incorrectly sorted after code unit "
operator|+
name|termDesc
argument_list|(
operator|new
...
block|}
block|}
comment|// Terms should not have been identical
name|assertTrue
argument_list|(
name|lastLength
operator|!=
