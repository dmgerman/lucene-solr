...
annotation|@
name|Deprecated
comment|// remove with hasVector and hasProx
DECL|field|CHECK_FIELDINFOS
specifier|static
specifier|final
name|int
name|CHECK_FIELDINFOS
init|=
operator|-
literal|2
decl_stmt|;
comment|// hasVector and hasProx use this for bw compatibility
DECL|field|NO
specifier|static
specifier|final
name|int
...
annotation|@
name|Deprecated
comment|// remove when we don't have to support old indexes anymore that had this field
DECL|field|hasProx
specifier|private
name|int
name|hasProx
