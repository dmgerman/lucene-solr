...
expr_stmt|;
block|}
comment|/** Returns an enumeration of all the terms in the index. The    * enumeration is ordered by Term.compareTo(). Each term is greater    * than all that precede it in the enumeration. Note that after    * calling terms(), {@link TermEnum#next()} must be called    * on the resulting enumeration before calling other methods such as    * {@link TermEnum#term()}.    * @deprecated Use the new flex API ({@link #fields()}) instead.    * @throws IOException if there is a low-level IO error    */
annotation|@
name|Deprecated
DECL|method|terms
specifier|public
...
name|IOException
function_decl|;
comment|/** Returns the number of documents containing the term<code>t</code>.    * @throws IOException if there is a low-level IO error    * @deprecated Use {@link #docFreq(String,BytesRef)} instead.    */
annotation|@
name|Deprecated
DECL|method|docFreq
specifier|public
...
return|;
block|}
comment|/** Returns an enumeration of all the documents which contain    *<code>term</code>. For each document, the document number, the frequency of    * the term in that document is also provided, for use in    * search scoring.  If term is null, then all non-deleted    * docs are returned with freq=1.    * Thus, this method implements the mapping:    *<p><ul>    * Term&nbsp;&nbsp; =&gt;&nbsp;&nbsp;&lt;docNum, freq&gt;<sup>*</sup>    *</ul>    *<p>The enumeration is ordered by document number.  Each document number    * is greater than all that precede it in the enumeration.    * @deprecated Use the new flex API ({@link #termDocsEnum}) instead.    * @throws IOException if there is a low-level IO error    */
annotation|@
name|Deprecated
...
block|}
block|}
comment|/** Returns an unpositioned {@link TermDocs} enumerator.    * @deprecated Use the new flex API ({@link #fields()}) instead.    * @throws IOException if there is a low-level IO error    */
annotation|@
name|Deprecated
DECL|method|termDocs
specifier|public
...
name|IOException
function_decl|;
comment|/** Returns an enumeration of all the documents which contain    *<code>term</code>.  For each document, in addition to the document number    * and frequency of the term in that document, a list of all of the ordinal    * positions of the term in the document is available.  Thus, this method    * implements the mapping:    *    *<p><ul>    * Term&nbsp;&nbsp; =&gt;&nbsp;&nbsp;&lt;docNum, freq,    *&lt;pos<sub>1</sub>, pos<sub>2</sub>, ...    * pos<sub>freq-1</sub>&gt;    *&gt;<sup>*</sup>    *</ul>    *<p> This positional information facilitates phrase and proximity searching.    *<p>The enumeration is ordered by document number.  Each document number is    * greater than all that precede it in the enumeration.    * @deprecated Please switch the flex API ({@link    * #termDocsEnum}) instead    * @throws IOException if there is a low-level IO error    */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/** Returns an unpositioned {@link TermPositions} enumerator.    * @deprecated Please switch the flex API ({@link    * #termDocsEnum}) instead    * @throws IOException if there is a low-level IO error    */
annotation|@
name|Deprecated
DECL|method|termPositions
specifier|public
...
return|;
block|}
comment|/** Expert: returns the docID base for this subReader. */
