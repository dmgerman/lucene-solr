...
name|Error
argument_list|(
literal|"This class should never be directly extended, subclass AtomicReader or CompositeReader instead!"
argument_list|)
throw|;
name|refCount
operator|.
