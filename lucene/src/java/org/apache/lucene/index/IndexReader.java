...
throw|;
block|}
comment|// nocommit -- should this expose the iterator API via Fields and access Source only via getIndexValuesCache?
...
throw|;
block|}
DECL|field|indexValuesCache
specifier|private
specifier|final
name|Cache
name|indexValuesCache
init|=
operator|new
name|Cache
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// nocommit -- don't expose readers if we have this?
DECL|method|getIndexValuesCache
specifier|public
name|Cache
name|getIndexValuesCache
parameter_list|()
block|{
return|return
name|indexValuesCache
