...
expr_stmt|;
block|}
DECL|method|loadNumericField
specifier|private
name|NumericField
name|loadNumericField
parameter_list|(
name|FieldInfo
name|fi
parameter_list|,
...
return|;
block|}
comment|/**    * A Lazy implementation of Fieldable that defers loading of fields until asked for, instead of when the Document is    * loaded.    */
