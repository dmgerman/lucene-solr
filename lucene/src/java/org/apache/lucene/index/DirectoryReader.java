...
return|return
operator|new
name|MultiValueReader
argument_list|(
name|field
argument_list|)
return|;
block|}
DECL|class|MultiValueReader
specifier|private
class|class
name|MultiValueReader
extends|extends
...
literal|null
condition|)
comment|// nocommit does that work with default
comment|// values?
name|enumCache
index|[
name|idx
...
literal|null
condition|)
comment|//nocommit does that work with default values?
name|current
operator|=
operator|new
name|DummySource
