...
condition|)
block|{
comment|// TODO: we could be smarter here, eg cherry
comment|// picking smaller merges that'd sum up to just
comment|// around the max size
break|break;
block|}
name|totAfterMergeBytes
operator|+=
...
condition|)
block|{
comment|// Single segment is too big; grace it
name|start
operator|++
expr_stmt|;
continue|continue;
