...
return|;
block|}
comment|/** Closes the current open doc stores an sets the    *  docStoreSegment and docStoreUseCFS on the provided    *  SegmentInfo. */
...
name|message
argument_list|(
literal|"closeDocStore: create compound file "
operator|+
name|compoundFileName
argument_list|)
expr_stmt|;
...
name|message
argument_list|(
literal|"closeDocStore: after compound file index="
operator|+
name|segmentInfos
argument_list|)
expr_stmt|;
...
name|message
argument_list|(
literal|"skip flushing segment: no docs"
argument_list|)
expr_stmt|;
block|}
name|newSegment
