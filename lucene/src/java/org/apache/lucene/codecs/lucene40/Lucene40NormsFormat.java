...
name|IOException
block|{
comment|// see the comment in all the other codecs... its bogus that we do fileExists here, but its
comment|// a harder problem since fieldinfos are never 'cleaned'
specifier|final
name|String
name|normsFileName
init|=
