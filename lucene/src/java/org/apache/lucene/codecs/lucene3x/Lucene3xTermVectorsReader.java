...
comment|// TODO: if we are worried, maybe we could eliminate the
comment|// extra fd somehow when you also have vectors...
...
DECL|method|Lucene3xTermVectorsReader
name|Lucene3xTermVectorsReader
parameter_list|(
name|FieldInfos
name|fieldInfos
...
block|}
block|}
DECL|class|TermAndPostings
specifier|static
class|class
name|TermAndPostings
block|{
DECL|field|term
name|BytesRef
name|term
