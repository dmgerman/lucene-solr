...
return|;
block|}
comment|/**    * A struct like class encapsulating a scorer's context variables.    * ScorerContex is a strictly immutable struct that follows a    *<tt>create on modification</tt> pattern. If a context variable changes    * through one of the modifiers like {@link #topScorer(boolean)} a new    * {@link ScorerContext} instance is creates. If the modifier call doesn't    * change the instance the method call has no effect and the same instance is    * returned from the modifier.    *     * @lucene.experimental    */
DECL|class|ScorerContext
specifier|public
specifier|static
specifier|final
class|class
...
decl_stmt|;
comment|/**      * if<code>true</code>, {@link Scorer#score(Collector)} will be called; if      * false, {@link Scorer#nextDoc()} and/or {@link Scorer#advance(int)} will      * be called instead.      */
...
argument_list|)
decl_stmt|;
comment|/**      * Returns a default {@link ScorerContext} template initialized with:      *<ul>      *<li>{@link #scoreDocsInOrder} =<code>true</code></li>      *<li>{@link #topScorer} =<code>false</code></li>      *</ul>      */
DECL|method|def
specifier|public
specifier|static
name|ScorerContext
...
expr_stmt|;
block|}
comment|/**      * Creates and returns a copy of this context with the given value for      * {@link #scoreDocsInOrder} and returns a new instance of      * {@link ScorerContext} iff the given value differs from the      * {@link #scoreDocsInOrder}. Otherwise, this method has no effect and      * returns this instance.      */
...
return|;
block|}
comment|/**      * Creates and returns a copy of this context with the given value for      * {@link #topScorer} and returns a new instance of      * {@link ScorerContext} iff the given value differs from the      * {@link #topScorer}. Otherwise, this method has no effect and      * returns this instance.      */
