...
block|}
block|}
comment|/** Returned from {@link #merge}, to include the merged    *  TopDocs as well as the reference to which original    *  TopDocs shard each hit came from.    *    * @lucene.experimental */
DECL|class|TopDocsAndShards
specifier|public
specifier|static
class|class
...
name|TopDocs
block|{
comment|/** Parallel array matching<code>hits.scoreDocs</code> */
DECL|field|shardIndex
specifier|public
specifier|final
name|int
