...
index|]
decl_stmt|;
comment|//System.out.println("FC: getStringIndex field=" + field);
name|Terms
name|terms
init|=
name|MultiFields
...
argument_list|()
expr_stmt|;
comment|//System.out.println("FC:  ord=" + t + " term=" + term.toBytesString());
name|docs
operator|=
name|termsEnum
operator|.
...
break|break;
block|}
comment|//System.out.println("FC:    docID=" + docID);
name|retArray
index|[
name|docID
index|]
...
argument_list|)
decl_stmt|;
comment|//System.out.println("FC: done\n");
return|return
name|value
return|;
block|}
