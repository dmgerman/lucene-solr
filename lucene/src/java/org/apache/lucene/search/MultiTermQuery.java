...
literal|0
decl_stmt|;
comment|/** @deprecated remove when getEnum is removed */
DECL|field|getEnumMethod
specifier|private
specifier|static
specifier|final
name|VirtualMethod
...
name|TermCollector
block|{
comment|/** this field is only set if a boostAttribute is used (e.g. {@link FuzzyTermsEnum}) */
DECL|field|boostAtt
specifier|private
name|BoostAttribute
name|boostAtt
...
comment|// @deprecated: in 4.0 use BytesRef for collectTerms()
name|docVisitCount
operator|+=
name|reader
operator|.
...
expr_stmt|;
block|}
comment|/**    * Constructs a query matching terms that cannot be represented with a single    * Term.    * @deprecated Use {@link #MultiTermQuery(String)}, as the flex branch can    * only work on one field per terms enum. If you override    * {@link #getTermsEnum(IndexReader)}, you cannot use this ctor.    */
annotation|@
name|Deprecated
DECL|method|MultiTermQuery
specifier|public
...
return|;
block|}
comment|/** Construct the enumeration to be used, expanding the    * pattern term.    * @deprecated Please override {@link #getTermsEnum} instead */
annotation|@
name|Deprecated
DECL|method|getEnum
specifier|protected
...
comment|// TODO 4.0: make this method abstract
