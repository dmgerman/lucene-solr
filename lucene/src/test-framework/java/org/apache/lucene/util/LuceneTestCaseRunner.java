...
return|;
block|}
DECL|method|removeAnnotatedTests
specifier|private
name|void
name|removeAnnotatedTests
parameter_list|(
...
condition|)
block|{
comment|/* the test class is annotated with the annotation, remove all methods */
name|String
name|className
init|=
name|getTestClass
...
block|{
comment|/* remove all methods with the annotation*/
for|for
control|(
name|int
name|i
