...
expr_stmt|;
block|}
DECL|method|testFieldsOnlyReturnsIndexedFields
specifier|public
name|void
name|testFieldsOnlyReturnsIndexedFields
parameter_list|()
throws|throws
name|IOException
block|{
...
name|assertEquals
argument_list|(
literal|"cannot change DocValues type from NUMERIC to BINARY for field \"field\""
argument_list|,
name|e
operator|.
name|getMessage
...
block|}
block|}
DECL|method|testMissingPoints
specifier|public
name|void
name|testMissingPoints
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|// field that exists but does not have points
name|assertNull
argument_list|(
name|indexSearcher
operator|.
...
argument_list|)
expr_stmt|;
comment|// field that does not exist
name|assertNull
argument_list|(
name|indexSearcher
operator|.
...
expr_stmt|;
block|}
DECL|method|testMultiValuedPointsSortedCorrectly
specifier|public
name|void
name|testMultiValuedPointsSortedCorrectly
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testToStringDebug
specifier|public
name|void
name|testToStringDebug
parameter_list|()
block|{
name|MemoryIndex
name|mi
...
literal|"analyzedField:\n"
operator|+
literal|"\t'[61 61]':2: [(0, 0, 2, [70 6f 73 3a 20 30]), (1, 6, 8, [70 6f 73 3a 20 32])]\n"
operator|+
literal|"\t'[62 62]':1: [(1, 3, 5, [70 6f 73 3a 20 31])]\n"
operator|+
literal|"\tterms=2, positions=3\n"
operator|+
literal|"pointAndDvField:\n"
operator|+
literal|"\tterms=0, positions=0\n"
operator|+
literal|"\n"
operator|+
literal|"fields=2, terms=2, positions=3"
argument_list|,
name|mi
operator|.
name|toStringDebug
