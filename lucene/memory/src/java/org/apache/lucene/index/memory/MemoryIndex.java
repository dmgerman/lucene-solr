...
block|}
block|}
comment|/**    * Returns a String representation of the index data for debugging purposes.    *     * @return the string representation    * @lucene.experimental    */
...
condition|)
block|{
comment|// PointInSetQuery.MergePointVisitor expects values to be visited in increasing order,
comment|// this is a 1d optimization which has to be done here too. Otherwise we emit values
comment|// out of order which causes mismatches.
name|Arrays
operator|.
name|sort
argument_list|(
...
comment|///////////////////////////////////////////////////////////////////////////////
DECL|class|MemoryDocValuesIterator
specifier|private
specifier|static
class|class
name|MemoryDocValuesIterator
block|{
DECL|field|doc
name|int
name|doc
...
name|info
decl_stmt|;
DECL|method|MemoryIndexPointValues
name|MemoryIndexPointValues
parameter_list|(
name|Info
name|info
...
name|pointValues
argument_list|,
literal|"Field does not have points"
argument_list|)
expr_stmt|;
block|}
annotation|@
