...
begin_class
DECL|class|TempPulsingPostingsReader
specifier|public
class|class
...
name|fields
decl_stmt|;
DECL|method|TempPulsingPostingsReader
specifier|public
name|TempPulsingPostingsReader
parameter_list|(
name|SegmentReadState
...
argument_list|)
expr_stmt|;
comment|// nocommit: here open file to load field summary
name|maxPositions
operator|=
name|termsIn
operator|.
...
comment|// term dict have no chance to init this
comment|// nocommit: nuke this?
if|if
condition|(
name|termState
operator|.
