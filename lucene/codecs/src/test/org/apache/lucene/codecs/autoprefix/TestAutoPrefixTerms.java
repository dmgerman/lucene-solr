...
condition|)
block|{
comment|// Auto-prefix terms were used in this test
name|long
...
condition|)
block|{
comment|// When maxPrefixCount is small (< 16), each byte of the term can require more than one "level" of auto-prefixing:
comment|// NOTE: this is still only approximate ... it's tricky to get a closed form max bound that's "tight"
name|allowedMaxTerms
operator|+=
name|MathUtil
operator|.
