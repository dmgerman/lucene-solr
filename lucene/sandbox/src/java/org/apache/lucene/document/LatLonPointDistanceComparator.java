...
return|;
block|}
comment|// sort by first part of the haversin computation. note that this value is meaningless to the user.
comment|// invoke haversin2() to "complete" the calculation and get a distance in meters.
DECL|method|haversin1
specifier|static
name|double
name|haversin1
parameter_list|(
