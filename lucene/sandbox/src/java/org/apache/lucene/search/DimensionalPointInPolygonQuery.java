...
begin_comment
comment|/** Finds all previously indexed points that fall within the specified polygon.  *  *<p>The field must be indexed with using {@link DimensionalLatLonField} added per document.  *  *  @lucene.experimental */
end_comment

begin_class
DECL|class|DimensionalPointInPolygonQuery
specifier|public
class|class
...
DECL|method|DimensionalPointInPolygonQuery
specifier|public
name|DimensionalPointInPolygonQuery
parameter_list|(
name|String
...
condition|)
block|{
comment|// No docs in this segment had any dimensional fields
return|return
literal|null
return|;
block|}
