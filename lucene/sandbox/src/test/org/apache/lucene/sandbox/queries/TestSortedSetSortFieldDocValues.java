...
DECL|class|TestSortedSetSortFieldDocValues
specifier|public
class|class
name|TestSortedSetSortFieldDocValues
extends|extends
name|LuceneTestCase
block|{
annotation|@
...
argument_list|()
expr_stmt|;
comment|// ensure there is nothing in fieldcache before test starts
name|FieldCache
operator|.
name|DEFAULT
operator|.
...
expr_stmt|;
block|}
DECL|method|assertNoFieldCaches
specifier|private
name|void
name|assertNoFieldCaches
parameter_list|()
block|{
comment|// docvalues sorting should NOT create any fieldcache entries!
name|assertEquals
argument_list|(
literal|0
argument_list|,
