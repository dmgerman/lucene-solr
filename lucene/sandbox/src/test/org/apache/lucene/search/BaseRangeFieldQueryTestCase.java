...
begin_comment
comment|/**  * Abstract class to do basic tests for a RangeField query.  */
end_comment
...
literal|0
decl_stmt|;
comment|// don't step on missing boxes:
while|while
condition|(
literal|true
condition|)
...
expr_stmt|;
block|}
comment|// occasionally test open ended bounding boxes
name|Box
name|queryBox
init|=
name|nextBox
