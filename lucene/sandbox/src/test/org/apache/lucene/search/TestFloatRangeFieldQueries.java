...
begin_comment
comment|/**  * Random testing for FloatRangeField Queries.  */
end_comment

begin_class
DECL|class|TestFloatRangeFieldQueries
specifier|public
class|class
name|TestFloatRangeFieldQueries
extends|extends
...
name|FIELD_NAME
init|=
literal|"floatRangeField"
decl_stmt|;
DECL|method|nextFloatInternal
specifier|private
name|float
name|nextFloatInternal
parameter_list|()
block|{
if|if
condition|(
...
expr_stmt|;
block|}
comment|/** FloatRange test class implementation - use to validate FloatRangeField */
