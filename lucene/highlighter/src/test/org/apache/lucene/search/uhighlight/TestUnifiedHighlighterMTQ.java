...
argument_list|)
decl_stmt|;
comment|// use a variety of common MTQ types
name|BooleanQuery
name|query
init|=
operator|new
...
name|assertEquals
argument_list|(
literal|"<b>Test(body:te*)</b> a<b>one(body:*one*)</b><b>sentence(body:zentence~~2)</b> document."
argument_list|,
name|snippets
index|[
literal|0
...
expr_stmt|;
block|}
DECL|method|testWithMaxLenAndMultipleWildcardMatches
specifier|public
name|void
name|testWithMaxLenAndMultipleWildcardMatches
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|//tests interleaving of multiple wildcard matches with the CompositePostingsEnum
comment|//In this case the CompositePostingsEnum will have an underlying PostingsEnum that jumps form pos 1 to 9 for bravo
comment|//and a second with position 2 for Bravado
name|body
operator|.
name|setStringValue
argument_list|(
literal|"Alpha Bravo Bravado foo foo foo. Foo foo Alpha Bravo"
argument_list|)
expr_stmt|;
name|iw
operator|.
...
index|[]
block|{
literal|"<b>Alpha</b><b>Bravo</b><b>Bravado</b> foo foo foo."
block|}
argument_list|,
name|snippets
argument_list|)
...
expr_stmt|;
block|}
DECL|method|testCustomSpanQueryHighlighting
specifier|public
name|void
name|testCustomSpanQueryHighlighting
parameter_list|()
throws|throws
name|Exception
block|{
...
literal|"body"
argument_list|,
literal|"alpha bravo charlie delta echo foxtrot golf hotel india juliet"
argument_list|,
name|fieldType
argument_list|)
argument_list|)
...
name|assertEquals
argument_list|(
literal|"alpha bravo charlie delta echo<b>foxtrot</b> golf hotel india juliet"
argument_list|,
name|snippets
index|[
literal|0
...
name|originalQuery
decl_stmt|;
DECL|method|MyWrapperSpanQuery
specifier|private
name|MyWrapperSpanQuery
parameter_list|(
name|SpanQuery
...
block|}
block|}
comment|// LUCENE-7717 bug, ordering of MTQ AutomatonQuery detection
DECL|method|testRussianPrefixQuery
specifier|public
name|void
name|testRussianPrefixQuery
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|)
expr_stmt|;
comment|// Russian char; uses 2 UTF8 bytes
name|iw
operator|.
name|addDocument
argument_list|(
...
block|}
comment|// LUCENE-7719
DECL|method|testMultiByteMTQ
specifier|public
name|void
name|testMultiByteMTQ
parameter_list|()
throws|throws
name|IOException
block|{
...
block|{
continue|continue;
comment|// even though we ask RandomStrings for a String with 3 code points, it seems sometimes it's less
block|}
comment|// Test WildcardQuery
name|query
operator|=
operator|new
name|WildcardQuery
...
argument_list|)
expr_stmt|;
comment|//TODO hmmm; how to randomly generate RegexpQuery? Low priority; we've covered the others well.
block|}
block|}
block|}
block|}
DECL|method|highlightAndAssertMatch
specifier|private
name|void
name|highlightAndAssertMatch
parameter_list|(
