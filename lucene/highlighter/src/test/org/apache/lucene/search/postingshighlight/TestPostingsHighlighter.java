...
expr_stmt|;
block|}
DECL|method|testFieldSometimesMissingFromSegment
specifier|public
name|void
name|testFieldSometimesMissingFromSegment
parameter_list|()
throws|throws
name|Exception
block|{
...
argument_list|)
expr_stmt|;
comment|// Make a 2nd segment where body is only stored:
name|iw
operator|.
name|commit
argument_list|()
...
name|assertEquals
argument_list|(
literal|"This piece of text refers to Kennedy at the beginning then has a longer piece of text that is<b>very</b> long in the middle and finally ends with another reference to Kennedy"
argument_list|,
name|snippets
index|[
literal|0
