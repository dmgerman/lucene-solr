...
block|}
block|}
comment|//shows the need to sum the increments in WeightedSpanTermExtractor
...
name|TEXT
init|=
literal|"the ab the the cd the the the ef the"
decl_stmt|;
specifier|final
name|Directory
name|directory
...
argument_list|)
decl_stmt|;
comment|//equivalent of "ab the the cd the the the ef"
specifier|final
name|PhraseQuery
name|phraseQuery
init|=
...
block|}
block|}
comment|//shows the need to require inOrder if getSlop() == 0, not if final slop == 0
comment|//in WeightedSpanTermExtractor
DECL|method|testInOrderWithStopWords
specifier|public
name|void
name|testInOrderWithStopWords
parameter_list|()
throws|throws
name|IOException
throws|,
...
name|TEXT
init|=
literal|"the cd the ab the the the the the the the ab the cd the"
decl_stmt|;
specifier|final
name|Directory
name|directory
...
argument_list|)
decl_stmt|;
comment|//equivalent of "ab the cd"
specifier|final
name|PhraseQuery
name|phraseQuery
init|=
...
name|assertTrue
argument_list|(
literal|"contains<B>ab</B> the<B>cd</B>"
argument_list|,
operator|(
name|frags
index|[
...
name|assertTrue
argument_list|(
literal|"does not contain<B>cd</B> the<B>ab</B>"
argument_list|,
operator|(
operator|!
name|frags
