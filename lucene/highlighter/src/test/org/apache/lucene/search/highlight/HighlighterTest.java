...
expr_stmt|;
block|}
DECL|method|testHighlightingSynonymQuery
specifier|public
name|void
name|testHighlightingSynonymQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"John<B>Kennedy</B> has been shot"
argument_list|,
name|fragment
argument_list|)
expr_stmt|;
...
expr_stmt|;
block|}
DECL|method|testNotRewriteMultiTermQuery
specifier|public
name|void
name|testNotRewriteMultiTermQuery
parameter_list|()
throws|throws
name|IOException
block|{
comment|// field "bar": (not the field we ultimately want to extract)
name|MultiTermQuery
name|mtq
init|=
operator|new
...
expr_stmt|;
block|}
DECL|method|testHighlighterWithMultiPhraseQuery
specifier|public
name|void
name|testHighlighterWithMultiPhraseQuery
parameter_list|()
throws|throws
name|IOException
throws|,
...
expr_stmt|;
block|}
DECL|method|assertHighlighting
specifier|private
name|void
name|assertHighlighting
parameter_list|(
