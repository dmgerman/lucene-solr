...
literal|0
decl_stmt|;
comment|// query1: simple synonym query
name|SynonymQuery
name|synQuery
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// query2: boolean query with synonym query
name|BooleanQuery
operator|.
name|Builder
name|bq
...
name|assertEquals
argument_list|(
literal|"the<b>quick</b> brown<b>fox</b>"
argument_list|,
name|bestFragments
index|[
literal|0
...
expr_stmt|;
block|}
DECL|method|testPhrasesSpanningFieldValues
specifier|public
name|void
name|testPhrasesSpanningFieldValues
parameter_list|()
throws|throws
name|IOException
block|{
...
argument_list|()
decl_stmt|;
comment|// positionIncrementGap is 0 so the pharse is found across multiple field
comment|// values.
name|IndexWriter
name|writer
init|=
...
literal|"field"
argument_list|,
literal|"six seven eight nine eight nine eight "
operator|+
literal|"nine eight nine eight nine eight nine"
argument_list|,
name|type
argument_list|)
argument_list|)
...
literal|0
decl_stmt|;
comment|// Phrase that spans a field value
name|Query
name|q
init|=
operator|new
...
argument_list|)
expr_stmt|;
comment|// Phrase that ends at a field value
name|q
operator|=
operator|new
name|PhraseQuery
...
name|assertEquals
argument_list|(
literal|"one two<b>three five</b>"
argument_list|,
name|bestFragments
index|[
literal|0
...
argument_list|)
expr_stmt|;
comment|// Phrase that spans across three values
name|q
operator|=
operator|new
name|PhraseQuery
...
argument_list|)
expr_stmt|;
comment|// Term query that appears in multiple values
name|q
operator|=
operator|new
name|TermQuery
...
name|assertEquals
argument_list|(
literal|"one<b>two</b> three five"
argument_list|,
name|bestFragments
index|[
literal|0
