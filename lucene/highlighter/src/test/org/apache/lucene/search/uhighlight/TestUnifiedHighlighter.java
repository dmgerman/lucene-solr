...
expr_stmt|;
block|}
DECL|method|indexSomeFields
specifier|private
name|IndexReader
name|indexSomeFields
parameter_list|()
throws|throws
name|IOException
block|{
...
name|setStringValue
argument_list|(
literal|"This is the title field."
argument_list|)
expr_stmt|;
name|text
operator|.
name|setStringValue
argument_list|(
literal|"This is the text field. You can put some text if you want."
argument_list|)
expr_stmt|;
name|category
operator|.
name|setStringValue
argument_list|(
literal|"This is the category field."
argument_list|)
expr_stmt|;
name|iw
operator|.
...
return|;
block|}
DECL|method|testFieldMatcherTermQuery
specifier|public
name|void
name|testFieldMatcherTermQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
parameter_list|)
block|{
comment|// requireFieldMatch=false
return|return
parameter_list|(
name|qf
parameter_list|)
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the title<b>field</b>."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the title field."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b> is the title<b>field</b>."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the text<b>field</b>. You can put<b>some</b> text if you want."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b> is the text<b>field</b>. You can put<b>some</b> text if you want."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the text field. "
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the<b>category</b><b>field</b>."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b> is the<b>category</b> field."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the category field."
argument_list|,
name|snippets
index|[
literal|0
...
expr_stmt|;
block|}
DECL|method|testFieldMatcherMultiTermQuery
specifier|public
name|void
name|testFieldMatcherMultiTermQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
expr_stmt|;
block|}
DECL|method|testFieldMatcherPhraseQuery
specifier|public
name|void
name|testFieldMatcherPhraseQuery
parameter_list|()
throws|throws
name|Exception
block|{
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b><b>the</b><b>title</b><b>field</b>."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b><b>the</b><b>title</b> field."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b><b>the</b><b>text</b><b>field</b>.<b>You</b><b>can</b><b>put</b> some<b>text</b> if you want."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b> the<b>text</b> field.<b>You</b><b>can</b><b>put</b> some<b>text</b> if you want."
argument_list|,
name|snippets
index|[
literal|0
...
name|assertEquals
argument_list|(
literal|"<b>This</b><b>is</b><b>the</b> category<b>field</b>."
argument_list|,
name|snippets
index|[
literal|0
