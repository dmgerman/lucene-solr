...
begin_comment
comment|/**  * Uses an {@link Analyzer} on content to get offsets and then populates a {@link MemoryIndex}.  *  * @lucene.internal  */
end_comment

begin_class
DECL|class|MemoryIndexOffsetStrategy
specifier|public
class|class
...
decl_stmt|;
DECL|method|MemoryIndexOffsetStrategy
specifier|public
name|MemoryIndexOffsetStrategy
parameter_list|(
name|String
...
argument_list|()
expr_stmt|;
comment|// appears to be re-usable
