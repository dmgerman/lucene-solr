...
argument_list|>
argument_list|>
name|preExtractRewriteFunction
parameter_list|,
name|boolean
...
init|=
operator|new
name|SingleFieldFilterLeafReader
argument_list|(
name|leafReader
argument_list|,
name|fieldName
...
return|;
block|}
comment|/**    * Simple TreeSet that filters out Terms not matching the provided predicate on {@code add()}.    */
DECL|class|FieldFilteringTermSet
specifier|private
class|class
name|FieldFilteringTermSet
extends|extends
...
block|}
block|}
comment|//TODO move up; it's currently inbetween other inner classes that are related
comment|/**    * Needed to support the ability to highlight a query irrespective of the field a query refers to    * (aka requireFieldMatch=false).    * This reader will just delegate every call to a single field in the wrapped    * LeafReader. This way we ensure that all queries going through this reader target the same field.    */
DECL|class|SingleFieldFilterLeafReader
specifier|static
specifier|final
class|class
name|SingleFieldFilterLeafReader
...
name|fieldName
decl_stmt|;
DECL|method|SingleFieldFilterLeafReader
name|SingleFieldFilterLeafReader
parameter_list|(
name|LeafReader
name|in
