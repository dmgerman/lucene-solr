...
DECL|field|defaultPassageRelevancyOverSpeed
specifier|private
name|boolean
name|defaultPassageRelevancyOverSpeed
init|=
literal|true
decl_stmt|;
comment|//For analysis, prefer MemoryIndexOffsetStrategy
...
argument_list|)
decl_stmt|;
DECL|field|defaultFieldMatcher
specifier|private
name|Predicate
argument_list|<
name|String
argument_list|>
name|defaultFieldMatcher
decl_stmt|;
...
return|;
block|}
DECL|method|shouldPreferPassageRelevancyOverSpeed
specifier|protected
name|boolean
name|shouldPreferPassageRelevancyOverSpeed
parameter_list|(
name|String
name|field
parameter_list|)
...
return|;
block|}
comment|/**    * Returns the predicate to use for extracting the query part that must be highlighted.    * By default only queries that target the current field are kept. (AKA requireFieldMatch)    */
...
block|{
comment|// requireFieldMatch = true
return|return
parameter_list|(
name|qf
parameter_list|)
...
parameter_list|)
block|{
comment|// Strip off the redundant field and sort the remaining terms
name|SortedSet
argument_list|<
name|BytesRef
argument_list|>
...
name|HighlightFlag
operator|.
name|PASSAGE_RELEVANCY_OVER_SPEED
argument_list|)
expr_stmt|;
block|}
return|return
...
condition|)
block|{
comment|//skip using a memory index since it's pure term filtering
return|return
operator|new
...
return|return
operator|new
name|MemoryIndexOffsetStrategy
argument_list|(
name|field
argument_list|,
name|getFieldMatcher
...
name|MULTI_TERM_QUERY
block|,
DECL|enum constant|PASSAGE_RELEVANCY_OVER_SPEED
name|PASSAGE_RELEVANCY_OVER_SPEED
