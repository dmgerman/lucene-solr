...
literal|null
decl_stmt|;
DECL|field|failOnUnsupportedJava
specifier|private
name|boolean
name|failOnUnsupportedJava
init|=
literal|false
decl_stmt|;
DECL|field|loader
...
argument_list|()
decl_stmt|;
comment|// check if we can load runtime classes (e.g. java.lang.String).
comment|// If this fails, we have a newer Java version than ASM supports:
try|try
block|{
name|getClassFromClassLoader
argument_list|(
...
name|ROOT
argument_list|,
literal|"Your Java version (%s) is not supported by<%s/>. Please run the checks with a supported JDK!"
argument_list|,
name|System
operator|.
name|getProperty
...
return|;
block|}
DECL|method|setFailOnUnsupportedJava
specifier|public
name|void
name|setFailOnUnsupportedJava
parameter_list|(
name|boolean
name|failOnUnsupportedJava
parameter_list|)
