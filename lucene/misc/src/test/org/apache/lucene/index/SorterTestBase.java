...
argument_list|)
expr_stmt|;
comment|// TODO: index time sorting doesn't yet support points
comment|//doc.add(new BinaryPoint(DIMENSIONAL_FIELD, bytes));
return|return
name|doc
return|;
block|}
