...
return|;
block|}
comment|/*   private String groupToString(BytesRef b) {     if (b == null) {       return "null";     } else {       return b.utf8ToString();     }   }   */
...
operator|++
expr_stmt|;
comment|//System.out.println("  match id=" + d.id);
if|if
condition|(
name|doAllGroups
condition|)
...
argument_list|)
decl_stmt|;
comment|//final int topNGroups = 4;
specifier|final
name|int
name|docsPerGroup
init|=
