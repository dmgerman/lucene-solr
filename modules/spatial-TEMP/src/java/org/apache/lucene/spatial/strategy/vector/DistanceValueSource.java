...
begin_package
DECL|package|org.apache.lucene.spatial.strategy.vector
package|package
name|org
operator|.
name|apache
...
return|;
block|}
comment|/**    * Determines if this ValueSource is equal to another.    * @param obj the ValueSource to compare    * @return<code>true</code> if the two objects are based upon the same query envelope    */
annotation|@
name|Override
DECL|method|equals
specifier|public
