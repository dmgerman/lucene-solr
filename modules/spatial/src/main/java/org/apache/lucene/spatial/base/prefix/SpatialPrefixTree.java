...
return|;
block|}
comment|/**    * See {@link org.apache.lucene.spatial.base.query.SpatialArgs#getDistPrecision()}.    * A grid level looked up via {@link #getLevelForDistance(double)} is returned.    *    * @param shape    * @param precision 0-0.5    * @return 1-maxLevels    */
...
block|}
block|}
comment|/**    * Subclasses might override {@link #getNodes(org.apache.lucene.spatial.base.shape.Shape, int, boolean)}    * and check if the argument is a shape and if so, delegate    * to this implementation, which calls {@link #getNode(org.apache.lucene.spatial.base.shape.Point, int)} and    * then calls {@link #getNode(String)} repeatedly if inclParents is true.    */
