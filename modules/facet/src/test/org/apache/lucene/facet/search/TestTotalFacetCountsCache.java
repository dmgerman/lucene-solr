...
argument_list|)
expr_stmt|;
comment|// delete a doc from the reader and commit - should recompute
name|origReader
operator|.
name|close
argument_list|()
...
name|prevGen
argument_list|,
literal|"after opening a writable reader - 9th attempt!"
argument_list|)
expr_stmt|;
...
name|prevGen
argument_list|,
literal|"after deleting docs the index - 10th attempt!"
argument_list|)
expr_stmt|;
name|origReader
operator|.
