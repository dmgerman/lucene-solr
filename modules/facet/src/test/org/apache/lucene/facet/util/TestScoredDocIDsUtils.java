...
block|}
block|}
comment|/**    * Creates an index with n documents, this method is meant for testing purposes ONLY    * Node that this reader is NOT read-only and document can be deleted.      */
