...
argument_list|)
expr_stmt|;
comment|// only docs 0& 2 have payloads!
block|}
name|dts2
operator|.
name|setIdx
...
expr_stmt|;
block|}
comment|// add more documents to expose the bug.
comment|// for some reason, this bug is not exposed unless these additional documents are added.
for|for
control|(
name|int
name|i
...
argument_list|)
expr_stmt|;
comment|// Ok.. went through the first 4 docs, now lets try the 6th doc (docid 5)
name|assertFalse
argument_list|(
literal|"Doc #6 (docid=5) should not have a payload!"
argument_list|,
name|cli
operator|.
name|skipTo
