...
begin_comment
comment|/**  * Sample indexer creates an index, and adds to it sample documents and facets.  *   * @lucene.experimental  */
end_comment

begin_class
DECL|class|SimpleIndexer
specifier|public
class|class
name|SimpleIndexer
block|{
...
control|)
block|{
comment|// obtain the sample facets for current document
name|List
argument_list|<
name|CategoryPath
argument_list|>
...
comment|// we commit changes to the taxonomy index prior to committing them to the search index.
comment|// this is important, so that all facets referred to by documents in the search index
