...
literal|"$posDict.dat"
decl_stmt|;
DECL|field|INFLDICT_FILENAME_SUFFIX
specifier|public
specifier|static
specifier|final
name|String
...
argument_list|)
return|;
comment|// Skip left id and right id
block|}
annotation|@
name|Override
...
literal|0xff
decl_stmt|;
comment|// read index into posDict
return|return
name|posDict
index|[
name|posIndex
...
literal|0xfe
decl_stmt|;
comment|// mask away pronunciation bit
return|return
name|offset
operator|+
name|baseFormLength
...
return|;
block|}
DECL|method|hasInflectionData
specifier|private
name|boolean
name|hasInflectionData
parameter_list|(
name|int
name|wordId
parameter_list|)
...
return|;
block|}
DECL|method|getInflectionIndex
specifier|private
name|int
name|getInflectionIndex
parameter_list|(
...
literal|1
return|;
comment|// common case: no inflection data
block|}
comment|// skip past reading/pronunciation at the end
name|int
name|offset
init|=
name|hasPronunciationData
