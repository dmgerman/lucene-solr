...
name|StopwordAnalyzerBase
block|{
comment|/**    * File containing default CJK stopwords.    *<p/>    * Currently it concains some common English words that are not usually    * useful for searching and some double-byte interpunctions.    */
