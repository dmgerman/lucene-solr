...
control|)
block|{
comment|// don't test deprecated ctors, they likely have known bugs:
if|if
condition|(
name|ctor
operator|.
...
argument_list|)
decl_stmt|;
comment|//System.out.println("seed=" + seed + ",tokenizerSpec=" + tokenizerspec.toString);
comment|//System.out.println("seed=" + seed + ",tokenfilterSpec=" + filterspec.toString);
return|return
operator|new
name|TokenStreamComponents
argument_list|(
...
argument_list|)
decl_stmt|;
comment|//System.out.println("seed=" + seed + ",charFilterSpec=" + charfilterspec.toString);
return|return
name|charfilterspec
operator|.
name|reader
