...
return|;
block|}
comment|// delete, line 157
name|slice_del
argument_list|()
expr_stmt|;
comment|// try, line 158
name|v_5
operator|=
name|limit
operator|-
...
do|do
block|{
comment|// call mark_regions, line 214
if|if
condition|(
operator|!
name|r_mark_regions
...
do|do
block|{
comment|// call attached_pronoun, line 216
if|if
condition|(
operator|!
name|r_attached_pronoun
...
do|do
block|{
comment|// call standard_suffix, line 217
if|if
condition|(
operator|!
name|r_standard_suffix
...
do|do
block|{
comment|// call y_verb_suffix, line 218
if|if
condition|(
operator|!
name|r_y_verb_suffix
...
name|v_4
expr_stmt|;
comment|// call verb_suffix, line 219
if|if
condition|(
operator|!
name|r_verb_suffix
...
do|do
block|{
comment|// call residual_suffix, line 221
if|if
condition|(
operator|!
name|r_residual_suffix
...
do|do
block|{
comment|// call postlude, line 223
if|if
condition|(
operator|!
name|r_postlude
