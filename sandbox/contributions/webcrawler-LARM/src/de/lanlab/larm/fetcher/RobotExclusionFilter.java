...
begin_comment
comment|/**  * Title: LARM Lanlab Retrieval Machine<p>  *  * Description:<p>  *  * Copyright: Copyright (c)<p>  *  * Company:<p>  *  *  *  * @author    Clemens Marschner  * @version   1.0  */
end_comment
...
begin_comment
comment|/**  * this factory simply creates fetcher threads. It's gonna be passed to the  * ThreadPool because the pool is creating the threads on its own  *  * @author    Administrator  * @created   17. Februar 2002  */
end_comment
