...
argument_list|)
expr_stmt|;
comment|// test that reload affects aliases
name|CoreAdminRequest
operator|.
name|reloadCore
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// this is only an effective test for embedded, where we have
comment|// direct access to the core container.
name|SolrCore
name|c1
init|=
name|cores
...
name|fail
argument_list|(
literal|"corefoo should be gone"
argument_list|)
expr_stmt|;
block|}
catch|catch
...
parameter_list|)
block|{}
comment|// aliased core should still work
name|assertEquals
argument_list|(
literal|1
argument_list|,
