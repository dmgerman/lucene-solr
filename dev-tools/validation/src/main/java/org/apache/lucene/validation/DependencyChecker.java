...
argument_list|(
literal|"Print the JAR and it's license to a file.  Arg is the name of the file"
argument_list|)
operator|.
name|create
argument_list|(
...
name|withDescription
argument_list|(
literal|"Check that every jar in the specified dir has an associated license file"
argument_list|)
operator|.
name|create
argument_list|(
